...
Additional examples for NI-SCOPE are located in src/niscope/examples/ directory `on GitHub <https://github.com/ni/nimi-python/tree/master/src/niscope/examples>`_.
