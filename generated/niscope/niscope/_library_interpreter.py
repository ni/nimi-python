...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def acquisition_status(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def actual_meas_wfm_size(self, session_handle, encoding, array_meas_function):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def actual_num_wfms(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def add_waveform_processing(self, session_handle, encoding, channel_list, meas_function):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def auto_setup(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niScope_AutoSetup(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def cal_fetch_date(self, session_handle, encoding, which_one):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def cal_fetch_temperature(self, session_handle, encoding, which_one):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def self_cal(self, session_handle, encoding, channel_list, option):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def clear_waveform_measurement_stats(self, session_handle, encoding, channel_list, clearable_measurement_function):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def clear_waveform_processing(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def configure_chan_characteristics(self, session_handle, encoding, channel_list, input_impedance, max_input_frequency):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def configure_equalization_filter_coefficients(self, session_handle, encoding, channel_list, coefficients):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def configure_horizontal_timing(self, session_handle, encoding, min_sample_rate, min_num_pts, ref_position, num_records, enforce_realtime):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def configure_ref_levels(self, session_handle, encoding, low, mid, high):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def configure_trigger_digital(self, session_handle, encoding, trigger_source, slope, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_source_ctype = ctypes.create_string_buffer(trigger_source.encode(encoding))  # case C020
    ...
    def configure_trigger_edge(self, session_handle, encoding, trigger_source, level, slope, trigger_coupling, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_source_ctype = ctypes.create_string_buffer(trigger_source.encode(encoding))  # case C020
    ...
    def configure_trigger_hysteresis(self, session_handle, encoding, trigger_source, level, hysteresis, slope, trigger_coupling, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_source_ctype = ctypes.create_string_buffer(trigger_source.encode(encoding))  # case C020
        level_ctype = _visatype.ViReal64(level)  # case S150
    ...
    def configure_trigger_immediate(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niScope_ConfigureTriggerImmediate(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def configure_trigger_software(self, session_handle, encoding, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        holdoff_ctype = _converters.convert_timedelta_to_seconds_real64(holdoff)  # case S140
        delay_ctype = _converters.convert_timedelta_to_seconds_real64(delay)  # case S140
    ...
    def configure_trigger_video(self, session_handle, encoding, trigger_source, enable_dc_restore, signal_format, event, line_number, polarity, trigger_coupling, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_source_ctype = ctypes.create_string_buffer(trigger_source.encode(encoding))  # case C020
    ...
    def configure_trigger_window(self, session_handle, encoding, trigger_source, low_level, high_level, window_mode, trigger_coupling, holdoff, delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_source_ctype = ctypes.create_string_buffer(trigger_source.encode(encoding))  # case C020
    ...
    def configure_vertical(self, session_handle, encoding, channel_list, range, offset, coupling, probe_attenuation, enabled):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def fetch(self, session_handle, encoding, channel_list, timeout, num_samples):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        ...
        waveform_size = (num_samples * self.actual_num_wfms(session_handle, encoding, channel_list))  # case B560
        ...
        wfm_info_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return waveform_array, [waveform_info.WaveformInfo(wfm_info_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))]

    def fetch_into_numpy(self, session_handle, encoding, channel_list, num_samples, waveform, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        num_samples_ctype = _visatype.ViInt32(num_samples)  # case S150
        ...
        error_code = self._library.niScope_Fetch(vi_ctype, channel_list_ctype, timeout_ctype, num_samples_ctype, waveform_ctype, wfm_info_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [waveform_info.WaveformInfo(wfm_info_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))]

    def fetch_array_measurement(self, session_handle, encoding, channel_list, timeout, array_meas_function, measurement_waveform_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        array_meas_function_ctype = _visatype.ViInt32(array_meas_function.value)  # case S130
        measurement_waveform_size_ctype = _visatype.ViInt32(measurement_waveform_size)  # case S150
        meas_wfm_size = (measurement_waveform_size * self.actual_num_wfms(session_handle, encoding, channel_list))  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [float(meas_wfm_ctype[i]) for i in range((measurement_waveform_size * self.actual_num_wfms(session_handle, encoding, channel_list)))], [waveform_info.WaveformInfo(wfm_info_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))]

    def fetch_binary16_into_numpy(self, session_handle, encoding, channel_list, num_samples, waveform, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        num_samples_ctype = _visatype.ViInt32(num_samples)  # case S150
    ...
    def fetch_binary32_into_numpy(self, session_handle, encoding, channel_list, num_samples, waveform, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        num_samples_ctype = _visatype.ViInt32(num_samples)  # case S150
    ...
    def fetch_binary8_into_numpy(self, session_handle, encoding, channel_list, num_samples, waveform, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        num_samples_ctype = _visatype.ViInt32(num_samples)  # case S150
    ...
    def fetch_measurement_stats(self, session_handle, encoding, channel_list, timeout, scalar_meas_function):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        scalar_meas_function_ctype = _visatype.ViInt32(scalar_meas_function.value)  # case S130
        result_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        result_ctype = _get_ctypes_pointer_for_buffer(library_type=_visatype.ViReal64, size=result_size)  # case B560
        mean_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        mean_ctype = _get_ctypes_pointer_for_buffer(library_type=_visatype.ViReal64, size=mean_size)  # case B560
        stdev_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        stdev_ctype = _get_ctypes_pointer_for_buffer(library_type=_visatype.ViReal64, size=stdev_size)  # case B560
        min_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        min_ctype = _get_ctypes_pointer_for_buffer(library_type=_visatype.ViReal64, size=min_size)  # case B560
        max_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        max_ctype = _get_ctypes_pointer_for_buffer(library_type=_visatype.ViReal64, size=max_size)  # case B560
        num_in_stats_size = self.actual_num_wfms(session_handle, encoding, channel_list)  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [float(result_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))], [float(mean_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))], [float(stdev_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))], [float(min_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))], [float(max_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))], [int(num_in_stats_ctype[i]) for i in range(self.actual_num_wfms(session_handle, encoding, channel_list))]

    def get_attribute_vi_boolean(self, session_handle, encoding, channel_list, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def get_attribute_vi_int32(self, session_handle, encoding, channel_list, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_attribute_vi_int64(self, session_handle, encoding, channel_list, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_attribute_vi_real64(self, session_handle, encoding, channel_list, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_attribute_vi_string(self, session_handle, encoding, channel_list, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_equalization_filter_coefficients(self, session_handle, encoding, channel, number_of_coefficients):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_ctype = ctypes.create_string_buffer(channel.encode(encoding))  # case C010
    ...
    def initiate_acquisition(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def probe_compensation_signal_start(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niScope_ProbeCompensationSignalStart(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def probe_compensation_signal_stop(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niScope_ProbeCompensationSignalStop(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def read(self, session_handle, encoding, channel_list, timeout, num_samples):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        num_samples_ctype = _visatype.ViInt32(num_samples)  # case S150
    ...
    def send_software_trigger_edge(self, session_handle, encoding, which_trigger):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def set_attribute_vi_boolean(self, session_handle, encoding, channel_list, attribute_id, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_int32(self, session_handle, encoding, channel_list, attribute_id, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_int64(self, session_handle, encoding, channel_list, attribute_id, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_real64(self, session_handle, encoding, channel_list, attribute_id, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_string(self, session_handle, encoding, channel_list, attribute_id, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
