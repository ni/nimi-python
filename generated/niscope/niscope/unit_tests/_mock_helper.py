...
class SideEffectsHelper(object):
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niScope_Abort_cfunc.side_effect = MockFunctionCallError("niScope_Abort_cfunc")
        mock_library.niScope_Abort_cfunc.return_value = 0
        mock_library.niScope_AcquisitionStatus_cfunc.side_effect = MockFunctionCallError("niScope_AcquisitionStatus_cfunc")
        mock_library.niScope_AcquisitionStatus_cfunc.return_value = 0
        mock_library.niScope_ActualMeasWfmSize_cfunc.side_effect = MockFunctionCallError("niScope_ActualMeasWfmSize_cfunc")
        mock_library.niScope_ActualMeasWfmSize_cfunc.return_value = 0
        mock_library.niScope_ActualNumWfms_cfunc.side_effect = MockFunctionCallError("niScope_ActualNumWfms_cfunc")
        mock_library.niScope_ActualNumWfms_cfunc.return_value = 0
        mock_library.niScope_AddWaveformProcessing_cfunc.side_effect = MockFunctionCallError("niScope_AddWaveformProcessing_cfunc")
        mock_library.niScope_AddWaveformProcessing_cfunc.return_value = 0
        mock_library.niScope_AutoSetup_cfunc.side_effect = MockFunctionCallError("niScope_AutoSetup_cfunc")
        mock_library.niScope_AutoSetup_cfunc.return_value = 0
        mock_library.niScope_CalFetchDate_cfunc.side_effect = MockFunctionCallError("niScope_CalFetchDate_cfunc")
        mock_library.niScope_CalFetchDate_cfunc.return_value = 0
        mock_library.niScope_CalFetchTemperature_cfunc.side_effect = MockFunctionCallError("niScope_CalFetchTemperature_cfunc")
        mock_library.niScope_CalFetchTemperature_cfunc.return_value = 0
        mock_library.niScope_CalSelfCalibrate_cfunc.side_effect = MockFunctionCallError("niScope_CalSelfCalibrate_cfunc")
        mock_library.niScope_CalSelfCalibrate_cfunc.return_value = 0
        mock_library.niScope_ClearWaveformMeasurementStats_cfunc.side_effect = MockFunctionCallError("niScope_ClearWaveformMeasurementStats_cfunc")
        mock_library.niScope_ClearWaveformMeasurementStats_cfunc.return_value = 0
        mock_library.niScope_ClearWaveformProcessing_cfunc.side_effect = MockFunctionCallError("niScope_ClearWaveformProcessing_cfunc")
        mock_library.niScope_ClearWaveformProcessing_cfunc.return_value = 0
        mock_library.niScope_Commit_cfunc.side_effect = MockFunctionCallError("niScope_Commit_cfunc")
        mock_library.niScope_Commit_cfunc.return_value = 0
        mock_library.niScope_ConfigureChanCharacteristics_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureChanCharacteristics_cfunc")
        mock_library.niScope_ConfigureChanCharacteristics_cfunc.return_value = 0
        mock_library.niScope_ConfigureEqualizationFilterCoefficients_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureEqualizationFilterCoefficients_cfunc")
        mock_library.niScope_ConfigureEqualizationFilterCoefficients_cfunc.return_value = 0
        mock_library.niScope_ConfigureHorizontalTiming_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureHorizontalTiming_cfunc")
        mock_library.niScope_ConfigureHorizontalTiming_cfunc.return_value = 0
        mock_library.niScope_ConfigureRefLevels_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureRefLevels_cfunc")
        mock_library.niScope_ConfigureRefLevels_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerDigital_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerDigital_cfunc")
        mock_library.niScope_ConfigureTriggerDigital_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerEdge_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerEdge_cfunc")
        mock_library.niScope_ConfigureTriggerEdge_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerHysteresis_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerHysteresis_cfunc")
        mock_library.niScope_ConfigureTriggerHysteresis_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerImmediate_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerImmediate_cfunc")
        mock_library.niScope_ConfigureTriggerImmediate_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerSoftware_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerSoftware_cfunc")
        mock_library.niScope_ConfigureTriggerSoftware_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerVideo_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerVideo_cfunc")
        mock_library.niScope_ConfigureTriggerVideo_cfunc.return_value = 0
        mock_library.niScope_ConfigureTriggerWindow_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureTriggerWindow_cfunc")
        mock_library.niScope_ConfigureTriggerWindow_cfunc.return_value = 0
        mock_library.niScope_ConfigureVertical_cfunc.side_effect = MockFunctionCallError("niScope_ConfigureVertical_cfunc")
        mock_library.niScope_ConfigureVertical_cfunc.return_value = 0
        mock_library.niScope_Disable_cfunc.side_effect = MockFunctionCallError("niScope_Disable_cfunc")
        mock_library.niScope_Disable_cfunc.return_value = 0
        mock_library.niScope_ExportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niScope_ExportAttributeConfigurationBuffer_cfunc")
        mock_library.niScope_ExportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niScope_ExportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niScope_ExportAttributeConfigurationFile_cfunc")
        mock_library.niScope_ExportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niScope_Fetch_cfunc.side_effect = MockFunctionCallError("niScope_Fetch_cfunc")
        mock_library.niScope_Fetch_cfunc.return_value = 0
        mock_library.niScope_FetchArrayMeasurement_cfunc.side_effect = MockFunctionCallError("niScope_FetchArrayMeasurement_cfunc")
        mock_library.niScope_FetchArrayMeasurement_cfunc.return_value = 0
        mock_library.niScope_FetchBinary16_cfunc.side_effect = MockFunctionCallError("niScope_FetchBinary16_cfunc")
        mock_library.niScope_FetchBinary16_cfunc.return_value = 0
        mock_library.niScope_FetchBinary32_cfunc.side_effect = MockFunctionCallError("niScope_FetchBinary32_cfunc")
        mock_library.niScope_FetchBinary32_cfunc.return_value = 0
        mock_library.niScope_FetchBinary8_cfunc.side_effect = MockFunctionCallError("niScope_FetchBinary8_cfunc")
        mock_library.niScope_FetchBinary8_cfunc.return_value = 0
        mock_library.niScope_FetchMeasurementStats_cfunc.side_effect = MockFunctionCallError("niScope_FetchMeasurementStats_cfunc")
        mock_library.niScope_FetchMeasurementStats_cfunc.return_value = 0
        mock_library.niScope_GetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niScope_GetAttributeViBoolean_cfunc")
        mock_library.niScope_GetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niScope_GetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niScope_GetAttributeViInt32_cfunc")
        mock_library.niScope_GetAttributeViInt32_cfunc.return_value = 0
        mock_library.niScope_GetAttributeViInt64_cfunc.side_effect = MockFunctionCallError("niScope_GetAttributeViInt64_cfunc")
        mock_library.niScope_GetAttributeViInt64_cfunc.return_value = 0
        mock_library.niScope_GetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niScope_GetAttributeViReal64_cfunc")
        mock_library.niScope_GetAttributeViReal64_cfunc.return_value = 0
        mock_library.niScope_GetAttributeViString_cfunc.side_effect = MockFunctionCallError("niScope_GetAttributeViString_cfunc")
        mock_library.niScope_GetAttributeViString_cfunc.return_value = 0
        mock_library.niScope_GetEqualizationFilterCoefficients_cfunc.side_effect = MockFunctionCallError("niScope_GetEqualizationFilterCoefficients_cfunc")
        mock_library.niScope_GetEqualizationFilterCoefficients_cfunc.return_value = 0
        mock_library.niScope_GetError_cfunc.side_effect = MockFunctionCallError("niScope_GetError_cfunc")
        mock_library.niScope_GetError_cfunc.return_value = 0
        mock_library.niScope_ImportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niScope_ImportAttributeConfigurationBuffer_cfunc")
        mock_library.niScope_ImportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niScope_ImportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niScope_ImportAttributeConfigurationFile_cfunc")
        mock_library.niScope_ImportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niScope_InitWithOptions_cfunc.side_effect = MockFunctionCallError("niScope_InitWithOptions_cfunc")
        mock_library.niScope_InitWithOptions_cfunc.return_value = 0
        mock_library.niScope_InitiateAcquisition_cfunc.side_effect = MockFunctionCallError("niScope_InitiateAcquisition_cfunc")
        mock_library.niScope_InitiateAcquisition_cfunc.return_value = 0
        mock_library.niScope_LockSession_cfunc.side_effect = MockFunctionCallError("niScope_LockSession_cfunc")
        mock_library.niScope_LockSession_cfunc.return_value = 0
        mock_library.niScope_ProbeCompensationSignalStart_cfunc.side_effect = MockFunctionCallError("niScope_ProbeCompensationSignalStart_cfunc")
        mock_library.niScope_ProbeCompensationSignalStart_cfunc.return_value = 0
        mock_library.niScope_ProbeCompensationSignalStop_cfunc.side_effect = MockFunctionCallError("niScope_ProbeCompensationSignalStop_cfunc")
        mock_library.niScope_ProbeCompensationSignalStop_cfunc.return_value = 0
        mock_library.niScope_Read_cfunc.side_effect = MockFunctionCallError("niScope_Read_cfunc")
        mock_library.niScope_Read_cfunc.return_value = 0
        mock_library.niScope_ResetDevice_cfunc.side_effect = MockFunctionCallError("niScope_ResetDevice_cfunc")
        mock_library.niScope_ResetDevice_cfunc.return_value = 0
        mock_library.niScope_ResetWithDefaults_cfunc.side_effect = MockFunctionCallError("niScope_ResetWithDefaults_cfunc")
        mock_library.niScope_ResetWithDefaults_cfunc.return_value = 0
        mock_library.niScope_SendSoftwareTriggerEdge_cfunc.side_effect = MockFunctionCallError("niScope_SendSoftwareTriggerEdge_cfunc")
        mock_library.niScope_SendSoftwareTriggerEdge_cfunc.return_value = 0
        mock_library.niScope_SetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niScope_SetAttributeViBoolean_cfunc")
        mock_library.niScope_SetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niScope_SetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niScope_SetAttributeViInt32_cfunc")
        mock_library.niScope_SetAttributeViInt32_cfunc.return_value = 0
        mock_library.niScope_SetAttributeViInt64_cfunc.side_effect = MockFunctionCallError("niScope_SetAttributeViInt64_cfunc")
        mock_library.niScope_SetAttributeViInt64_cfunc.return_value = 0
        mock_library.niScope_SetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niScope_SetAttributeViReal64_cfunc")
        mock_library.niScope_SetAttributeViReal64_cfunc.return_value = 0
        mock_library.niScope_SetAttributeViString_cfunc.side_effect = MockFunctionCallError("niScope_SetAttributeViString_cfunc")
        mock_library.niScope_SetAttributeViString_cfunc.return_value = 0
        mock_library.niScope_UnlockSession_cfunc.side_effect = MockFunctionCallError("niScope_UnlockSession_cfunc")
        mock_library.niScope_UnlockSession_cfunc.return_value = 0
        mock_library.niScope_close_cfunc.side_effect = MockFunctionCallError("niScope_close_cfunc")
        mock_library.niScope_close_cfunc.return_value = 0
        mock_library.niScope_error_message_cfunc.side_effect = MockFunctionCallError("niScope_error_message_cfunc")
        mock_library.niScope_error_message_cfunc.return_value = 0
        mock_library.niScope_reset_cfunc.side_effect = MockFunctionCallError("niScope_reset_cfunc")
        mock_library.niScope_reset_cfunc.return_value = 0
        mock_library.niScope_self_test_cfunc.side_effect = MockFunctionCallError("niScope_self_test_cfunc")
        mock_library.niScope_self_test_cfunc.return_value = 0
