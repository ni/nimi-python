...
class SideEffectsHelper(object):
    ...
    def niScope_AcquisitionStatus(self, vi, acquisition_status):  # noqa: N802
        ...
        if self._defaults["AcquisitionStatus"]["acquisitionStatus"] is None:
            raise MockFunctionCallError(
                "niScope_AcquisitionStatus", param="acquisitionStatus"
            )
        if acquisition_status is not None:
            acquisition_status.contents.value = self._defaults["AcquisitionStatus"][
                "acquisitionStatus"
            ]
        return self._defaults["AcquisitionStatus"]["return"]
    ...
    def niScope_ActualMeasWfmSize(
        ...
        if self._defaults["ActualMeasWfmSize"]["measWaveformSize"] is None:
            raise MockFunctionCallError(
                "niScope_ActualMeasWfmSize", param="measWaveformSize"
            )
        if meas_waveform_size is not None:
            meas_waveform_size.contents.value = self._defaults["ActualMeasWfmSize"][
                "measWaveformSize"
            ]
        return self._defaults["ActualMeasWfmSize"]["return"]
    ...
    def niScope_CalFetchTemperature(self, vi, which_one, temperature):  # noqa: N802
        ...
        if self._defaults["CalFetchTemperature"]["temperature"] is None:
            raise MockFunctionCallError(
                "niScope_CalFetchTemperature", param="temperature"
            )
        if temperature is not None:
            temperature.contents.value = self._defaults["CalFetchTemperature"][
                "temperature"
            ]
        return self._defaults["CalFetchTemperature"]["return"]
    ...
    def niScope_ExportAttributeConfigurationBuffer(
        ...
        if (
            ...
            raise MockFunctionCallError(
                "niScope_ExportAttributeConfigurationBuffer", param="configuration"
            )
    ...
    def niScope_FetchArrayMeasurement(
        ...
        if self._defaults["FetchArrayMeasurement"]["measWfm"] is None:
            raise MockFunctionCallError(
                "niScope_FetchArrayMeasurement", param="measWfm"
            )
        ...
        if self._defaults["FetchArrayMeasurement"]["wfmInfo"] is None:
            raise MockFunctionCallError(
                "niScope_FetchArrayMeasurement", param="wfmInfo"
            )
    ...
    def niScope_FetchMeasurementStats(
        ...
        if self._defaults["FetchMeasurementStats"]["numInStats"] is None:
            raise MockFunctionCallError(
                "niScope_FetchMeasurementStats", param="numInStats"
            )
    ...
    def niScope_GetEqualizationFilterCoefficients(
        ...
        if self._defaults["GetEqualizationFilterCoefficients"]["coefficients"] is None:
            raise MockFunctionCallError(
                "niScope_GetEqualizationFilterCoefficients", param="coefficients"
            )
    ...
    def set_side_effects_and_return_values(self, mock_library):
        ...
        mock_library.niScope_AcquisitionStatus.side_effect = MockFunctionCallError(
            "niScope_AcquisitionStatus"
        )
        mock_library.niScope_AcquisitionStatus.return_value = 0
        mock_library.niScope_ActualMeasWfmSize.side_effect = MockFunctionCallError(
            "niScope_ActualMeasWfmSize"
        )
        mock_library.niScope_ActualMeasWfmSize.return_value = 0
        mock_library.niScope_ActualNumWfms.side_effect = MockFunctionCallError(
            "niScope_ActualNumWfms"
        )
        mock_library.niScope_ActualNumWfms.return_value = 0
        mock_library.niScope_AddWaveformProcessing.side_effect = MockFunctionCallError(
            "niScope_AddWaveformProcessing"
        )
        mock_library.niScope_AddWaveformProcessing.return_value = 0
        mock_library.niScope_AutoSetup.side_effect = MockFunctionCallError(
            "niScope_AutoSetup"
        )
        mock_library.niScope_AutoSetup.return_value = 0
        mock_library.niScope_CalFetchDate.side_effect = MockFunctionCallError(
            "niScope_CalFetchDate"
        )
        mock_library.niScope_CalFetchDate.return_value = 0
        mock_library.niScope_CalFetchTemperature.side_effect = MockFunctionCallError(
            "niScope_CalFetchTemperature"
        )
        mock_library.niScope_CalFetchTemperature.return_value = 0
        mock_library.niScope_CalSelfCalibrate.side_effect = MockFunctionCallError(
            "niScope_CalSelfCalibrate"
        )
        mock_library.niScope_CalSelfCalibrate.return_value = 0
        mock_library.niScope_ClearWaveformMeasurementStats.side_effect = (
            MockFunctionCallError("niScope_ClearWaveformMeasurementStats")
        )
        mock_library.niScope_ClearWaveformMeasurementStats.return_value = 0
        mock_library.niScope_ClearWaveformProcessing.side_effect = (
            MockFunctionCallError("niScope_ClearWaveformProcessing")
        )
        mock_library.niScope_ClearWaveformProcessing.return_value = 0
        mock_library.niScope_Commit.side_effect = MockFunctionCallError(
            "niScope_Commit"
        )
        mock_library.niScope_Commit.return_value = 0
        mock_library.niScope_ConfigureChanCharacteristics.side_effect = (
            MockFunctionCallError("niScope_ConfigureChanCharacteristics")
        )
        mock_library.niScope_ConfigureChanCharacteristics.return_value = 0
        mock_library.niScope_ConfigureEqualizationFilterCoefficients.side_effect = (
            MockFunctionCallError("niScope_ConfigureEqualizationFilterCoefficients")
        )
        mock_library.niScope_ConfigureEqualizationFilterCoefficients.return_value = 0
        mock_library.niScope_ConfigureHorizontalTiming.side_effect = (
            MockFunctionCallError("niScope_ConfigureHorizontalTiming")
        )
        mock_library.niScope_ConfigureHorizontalTiming.return_value = 0
        mock_library.niScope_ConfigureRefLevels.side_effect = MockFunctionCallError(
            "niScope_ConfigureRefLevels"
        )
        mock_library.niScope_ConfigureRefLevels.return_value = 0
        mock_library.niScope_ConfigureTriggerDigital.side_effect = (
            MockFunctionCallError("niScope_ConfigureTriggerDigital")
        )
        mock_library.niScope_ConfigureTriggerDigital.return_value = 0
        mock_library.niScope_ConfigureTriggerEdge.side_effect = MockFunctionCallError(
            "niScope_ConfigureTriggerEdge"
        )
        mock_library.niScope_ConfigureTriggerEdge.return_value = 0
        mock_library.niScope_ConfigureTriggerHysteresis.side_effect = (
            MockFunctionCallError("niScope_ConfigureTriggerHysteresis")
        )
        mock_library.niScope_ConfigureTriggerHysteresis.return_value = 0
        mock_library.niScope_ConfigureTriggerImmediate.side_effect = (
            MockFunctionCallError("niScope_ConfigureTriggerImmediate")
        )
        mock_library.niScope_ConfigureTriggerImmediate.return_value = 0
        mock_library.niScope_ConfigureTriggerSoftware.side_effect = (
            MockFunctionCallError("niScope_ConfigureTriggerSoftware")
        )
        mock_library.niScope_ConfigureTriggerSoftware.return_value = 0
        mock_library.niScope_ConfigureTriggerVideo.side_effect = MockFunctionCallError(
            "niScope_ConfigureTriggerVideo"
        )
        mock_library.niScope_ConfigureTriggerVideo.return_value = 0
        mock_library.niScope_ConfigureTriggerWindow.side_effect = MockFunctionCallError(
            "niScope_ConfigureTriggerWindow"
        )
        mock_library.niScope_ConfigureTriggerWindow.return_value = 0
        mock_library.niScope_ConfigureVertical.side_effect = MockFunctionCallError(
            "niScope_ConfigureVertical"
        )
        mock_library.niScope_ConfigureVertical.return_value = 0
        mock_library.niScope_Disable.side_effect = MockFunctionCallError(
            "niScope_Disable"
        )
        mock_library.niScope_Disable.return_value = 0
        mock_library.niScope_ExportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niScope_ExportAttributeConfigurationBuffer")
        )
        mock_library.niScope_ExportAttributeConfigurationBuffer.return_value = 0
        mock_library.niScope_ExportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niScope_ExportAttributeConfigurationFile")
        )
        ...
        mock_library.niScope_FetchArrayMeasurement.side_effect = MockFunctionCallError(
            "niScope_FetchArrayMeasurement"
        )
        mock_library.niScope_FetchArrayMeasurement.return_value = 0
        mock_library.niScope_FetchBinary16.side_effect = MockFunctionCallError(
            "niScope_FetchBinary16"
        )
        mock_library.niScope_FetchBinary16.return_value = 0
        mock_library.niScope_FetchBinary32.side_effect = MockFunctionCallError(
            "niScope_FetchBinary32"
        )
        mock_library.niScope_FetchBinary32.return_value = 0
        mock_library.niScope_FetchBinary8.side_effect = MockFunctionCallError(
            "niScope_FetchBinary8"
        )
        mock_library.niScope_FetchBinary8.return_value = 0
        mock_library.niScope_FetchMeasurementStats.side_effect = MockFunctionCallError(
            "niScope_FetchMeasurementStats"
        )
        mock_library.niScope_FetchMeasurementStats.return_value = 0
        mock_library.niScope_GetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niScope_GetAttributeViBoolean"
        )
        mock_library.niScope_GetAttributeViBoolean.return_value = 0
        mock_library.niScope_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niScope_GetAttributeViInt32"
        )
        mock_library.niScope_GetAttributeViInt32.return_value = 0
        mock_library.niScope_GetAttributeViInt64.side_effect = MockFunctionCallError(
            "niScope_GetAttributeViInt64"
        )
        mock_library.niScope_GetAttributeViInt64.return_value = 0
        mock_library.niScope_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niScope_GetAttributeViReal64"
        )
        mock_library.niScope_GetAttributeViReal64.return_value = 0
        mock_library.niScope_GetAttributeViString.side_effect = MockFunctionCallError(
            "niScope_GetAttributeViString"
        )
        mock_library.niScope_GetAttributeViString.return_value = 0
        mock_library.niScope_GetEqualizationFilterCoefficients.side_effect = (
            MockFunctionCallError("niScope_GetEqualizationFilterCoefficients")
        )
        mock_library.niScope_GetEqualizationFilterCoefficients.return_value = 0
        mock_library.niScope_GetError.side_effect = MockFunctionCallError(
            "niScope_GetError"
        )
        mock_library.niScope_GetError.return_value = 0
        mock_library.niScope_ImportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niScope_ImportAttributeConfigurationBuffer")
        )
        ...
        mock_library.niScope_InitWithOptions.side_effect = MockFunctionCallError(
            "niScope_InitWithOptions"
        )
        mock_library.niScope_InitWithOptions.return_value = 0
        mock_library.niScope_InitiateAcquisition.side_effect = MockFunctionCallError(
            "niScope_InitiateAcquisition"
        )
        mock_library.niScope_InitiateAcquisition.return_value = 0
        mock_library.niScope_LockSession.side_effect = MockFunctionCallError(
            "niScope_LockSession"
        )
        mock_library.niScope_LockSession.return_value = 0
        mock_library.niScope_ProbeCompensationSignalStart.side_effect = (
            MockFunctionCallError("niScope_ProbeCompensationSignalStart")
        )
        mock_library.niScope_ProbeCompensationSignalStart.return_value = 0
        mock_library.niScope_ProbeCompensationSignalStop.side_effect = (
            MockFunctionCallError("niScope_ProbeCompensationSignalStop")
        )
        ...
        mock_library.niScope_ResetDevice.side_effect = MockFunctionCallError(
            "niScope_ResetDevice"
        )
        mock_library.niScope_ResetDevice.return_value = 0
        mock_library.niScope_ResetWithDefaults.side_effect = MockFunctionCallError(
            "niScope_ResetWithDefaults"
        )
        mock_library.niScope_ResetWithDefaults.return_value = 0
        mock_library.niScope_SendSoftwareTriggerEdge.side_effect = (
            MockFunctionCallError("niScope_SendSoftwareTriggerEdge")
        )
        mock_library.niScope_SendSoftwareTriggerEdge.return_value = 0
        mock_library.niScope_SetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niScope_SetAttributeViBoolean"
        )
        mock_library.niScope_SetAttributeViBoolean.return_value = 0
        mock_library.niScope_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niScope_SetAttributeViInt32"
        )
        mock_library.niScope_SetAttributeViInt32.return_value = 0
        mock_library.niScope_SetAttributeViInt64.side_effect = MockFunctionCallError(
            "niScope_SetAttributeViInt64"
        )
        mock_library.niScope_SetAttributeViInt64.return_value = 0
        mock_library.niScope_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niScope_SetAttributeViReal64"
        )
        mock_library.niScope_SetAttributeViReal64.return_value = 0
        mock_library.niScope_SetAttributeViString.side_effect = MockFunctionCallError(
            "niScope_SetAttributeViString"
        )
        mock_library.niScope_SetAttributeViString.return_value = 0
        mock_library.niScope_UnlockSession.side_effect = MockFunctionCallError(
        ...
        mock_library.niScope_error_message.side_effect = MockFunctionCallError(
        ...
        mock_library.niScope_self_test.side_effect = MockFunctionCallError(
            "niScope_self_test"
        )
