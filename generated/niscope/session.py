...
class _SessionBase(object):
    ...
    **Related topics:**
    ...
    def fetch_double(self, num_samples, timeout=5.0):
        '''fetch_double
    ...
    def fetch_double_into(self, num_samples, wfm, timeout=5.0):
        '''fetch_double
    ...
    def fetch(self, num_samples, timeout=5.0, wfm=None):
        '''fetch
        ...
        niscope.Session instance, and calling this method on the result.:
            ...
            session['0,1'].fetch(num_samples, timeout=5.0, wfm=None)
    ...
    def read(self, num_samples, timeout=5.0):
        ...
        acquisition_status, and fetch_double. The only difference is
