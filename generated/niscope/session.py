...
class _SessionBase(object):
    ...
    **Related topics:**
    ...
    def fetch_array_measurement(self, timeout, array_meas_function):
        ...
        wfm_info_ctype = (waveform_info.struct_niScope_wfmInfo * self._actual_num_wfms(array_meas_function))()  # case 0.4
        ...
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
        return [float(meas_wfm_ctype[i]) for i in range((self._actual_meas_wfm_size(array_meas_function) * self._actual_num_wfms()))], [waveform_info.WaveformInfo(wfm_info_ctype[i]) for i in range(self._actual_num_wfms(array_meas_function))]
    ...
    def _fetch_binary8_numpy(self, timeout, num_samples):
        ...
        timeout_ctype = visatype.ViReal64(timeout)  # case 9
        num_samples_ctype = visatype.ViInt32(num_samples)  # case 9
        wfm_ctype = numpy.ctypeslib.as_ctypes(numpy.empty((num_samples * self._actual_num_wfms()), dtype=numpy.int8))  # case 0.2
        wfm_info_ctype = (waveform_info.struct_niScope_wfmInfo * self._actual_num_wfms())()  # case 0.4
        ...
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
        return wfm_ctype, [waveform_info.WaveformInfo(wfm_info_ctype[i]) for i in range(self._actual_num_wfms())]
