...
class _SessionBase(object):
    ...
    **Related topics:**
    ...
    def _actual_num_wfms(self):
        ...
        channel_list_ctype = None if channel_list is None else (visatype.ViChar * len(channel_list))(*channel_list)  # case B550
    ...
    def configure_equalization_filter_coefficients(self, coefficients):
        ...
        coefficients_ctype = None if coefficients is None else (visatype.ViReal64 * len(coefficients))(*coefficients)  # case B550
    ...
    def _fetch(self, num_samples, timeout=5.0):
        ...
        wfm_ctype = (visatype.ViReal64 * (num_samples * self._actual_num_wfms()))()  # case B560
    ...
    def _fetch_into(self, num_samples, wfm, timeout=5.0):
        ...
        timeout_ctype = visatype.ViReal64(timeout)  # case S150
        num_samples_ctype = visatype.ViInt32(num_samples)  # case S150
        wfm_ctype = numpy.ctypeslib.as_ctypes(wfm)  # case B510
        wfm_info_ctype = (waveform_info.struct_niScope_wfmInfo * self._actual_num_wfms())()  # case B560
        error_code = self._library.niScope_Fetch(vi_ctype, channel_list_ctype, timeout_ctype, num_samples_ctype, wfm_ctype, wfm_info_ctype)
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
    ...
    def fetch_measurement(self, scalar_meas_function, timeout=5.0):
        ...
        result_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
    ...
    def fetch_measurement_stats(self, scalar_meas_function, timeout=5.0):
        ...
        scalar_meas_function_ctype = visatype.ViInt32(scalar_meas_function.value)  # case S130
        result_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
        mean_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
        stdev_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
        min_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
        max_ctype = (visatype.ViReal64 * self._actual_num_wfms())()  # case B560
        num_in_stats_ctype = (visatype.ViInt32 * self._actual_num_wfms())()  # case B560
    ...
    def _get_attribute_vi_string(self, attribute_id):
        ...
        **bufSize** is 4, the function places 123 into the buffer and returns 7.
        ...
        error_code = self._library.niScope_GetAttributeViString(vi_ctype, channel_list_ctype, attribute_id_ctype, buf_size_ctype, value_ctype)
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
        return [int(value_ctype[i]) for i in range(buf_size_ctype.value)]
    ...
    def get_equalization_filter_coefficients(self, number_of_coefficients):
        ...
        '''
        vi_ctype = visatype.ViSession(self._vi)  # case S110
        channel_ctype = None if channel is None else (visatype.ViChar * len(channel))(*channel)  # case B550
    ...
    def _get_error(self):
        ...
        return int(error_code_ctype.value), [int(description_ctype[i]) for i in range(buffer_size_ctype.value)]
    ...
    def _set_attribute_vi_string(self, attribute_id, value):
        ...
        channel_list_ctype = None if channel_list is None else (visatype.ViChar * len(channel_list))(*channel_list)  # case B550
        attribute_id_ctype = visatype.ViAttr(attribute_id)  # case S150
        value_ctype = None if value is None else (visatype.ViChar * len(value))(*value)  # case B550
...
class Session(_SessionBase):
    ...
    def configure_trigger_digital(self, trigger_source, slope=enums.TriggerSlope.POSITIVE, holdoff=0.0, delay=0.0):
        ...
        vi_ctype = visatype.ViSession(self._vi)  # case S110
        trigger_source_ctype = None if trigger_source is None else (visatype.ViChar * len(trigger_source))(*trigger_source)  # case B550
    ...
    def self_test(self):
        ...
        errors.handle_error(self, error_code, ignore_warnings=False, is_error_handling=False)
        return int(self_test_result_ctype.value), [int(self_test_message_ctype[i]) for i in range(256)]
