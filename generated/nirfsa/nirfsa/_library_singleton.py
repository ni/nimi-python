...
import ctypes
import ctypes.util
import nirfsa._library as _library
...
_library_info = {'Linux': {'64bit': {'name': 'nirfsa', 'type': 'cdll'}},
                 'Windows': {'32bit': {'name': 'niRFSA.dll', 'type': 'windll'},
                             '64bit': {'name': 'niRFSA_64.dll', 'type': 'cdll'}}}
...
def get():
    ...
    Returns the library.Library singleton for nirfsa.
    '''
    global _instance
