...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        super(DriverNotInstalledError, self).__init__('The NI-RFSA runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it.')
...
class DriverTooOldError(Error):
    ...
    def __init__(self):
        super(DriverTooOldError, self).__init__('A function was not found in the NI-RFSA runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.')
...
class DriverTooNewError(Error):
    ...
    def __init__(self):
        super(DriverTooNewError, self).__init__('The NI-RFSA runtime returned an unexpected value. This can occur if it is too new for the nirfsa Python module. Upgrade the nirfsa Python module.')
...
def handle_error(library_interpreter, code, ignore_warnings, is_error_handling):
    ...
    Helper function for handling errors returned by nirfsa.Library.
