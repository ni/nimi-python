...
class AttributeEnumWithConverter(Attribute):
    '''Class for attributes that use enums internally but are exposed in the nirfsa Python module as something else, thus need conversion.'''
...
class AttributeSessionReference(Attribute):
    ...
    def __get__(self, session, session_type):
        ...
        from nirfsa.session import SessionReference
