...
class SideEffectsHelper(object):
    ...
    def niFake_GetErrorMessage(self, vi, error_code, buffer_size, error_message):  # noqa: N802
        ...
        t = nifake.ctypes_types.ViString(self._defaults['GetErrorMessage']['errorMessage'].encode('ascii'))
        error_message.value = ctypes.cast(t, nifake.ctypes_types.ViString).value
        return self._defaults['GetErrorMessage']['return']
    ...
    def set_side_effects_and_return_values(self, mock_library):
        ...
        mock_library.niFake_GetErrorMessage.return_value = 0
