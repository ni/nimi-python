...
class SideEffectsHelper(object):
    ...
    def niFake_BoolArrayOutputFunction(
        ...
        if self._defaults["BoolArrayOutputFunction"]["anArray"] is None:
            raise MockFunctionCallError(
                "niFake_BoolArrayOutputFunction", param="anArray"
            )
    ...
    def niFake_EnumArrayOutputFunction(
        ...
        if self._defaults["EnumArrayOutputFunction"]["anArray"] is None:
            raise MockFunctionCallError(
                "niFake_EnumArrayOutputFunction", param="anArray"
            )
    ...
    def niFake_ExportAttributeConfigurationBuffer(
        ...
        if (
            ...
            raise MockFunctionCallError(
                "niFake_ExportAttributeConfigurationBuffer", param="configuration"
            )
    ...
    def niFake_FetchWaveform(
        ...
        if self._defaults["FetchWaveform"]["actualNumberOfSamples"] is None:
            raise MockFunctionCallError(
                "niFake_FetchWaveform", param="actualNumberOfSamples"
            )
        if actual_number_of_samples is not None:
            actual_number_of_samples.contents.value = self._defaults["FetchWaveform"][
    ...
    def niFake_GetAStringOfFixedMaximumSize(self, vi, a_string):  # noqa: N802
        ...
        if self._defaults["GetAStringOfFixedMaximumSize"]["aString"] is None:
            raise MockFunctionCallError(
                "niFake_GetAStringOfFixedMaximumSize", param="aString"
            )
    ...
    def niFake_GetAStringUsingPythonCode(self, vi, a_number, a_string):  # noqa: N802
        ...
        if self._defaults["GetAStringUsingPythonCode"]["aString"] is None:
            raise MockFunctionCallError(
                "niFake_GetAStringUsingPythonCode", param="aString"
            )
    ...
    def niFake_GetAnIviDanceString(self, vi, buffer_size, a_string):  # noqa: N802
        ...
        a_string.value = self._defaults["GetAnIviDanceString"]["aString"].encode(
            "ascii"
        )
        return self._defaults["GetAnIviDanceString"]["return"]
    ...
    def niFake_GetAnIviDanceWithATwistString(
        ...
        if self._defaults["GetAnIviDanceWithATwistString"]["actualSize"] is None:
            raise MockFunctionCallError(
                "niFake_GetAnIviDanceWithATwistString", param="actualSize"
            )
        if actual_size is not None:
            actual_size.contents.value = self._defaults[
                "GetAnIviDanceWithATwistString"
            ]["actualSize"]
        if self._defaults["GetAnIviDanceWithATwistString"]["aString"] is None:
            raise MockFunctionCallError(
                "niFake_GetAnIviDanceWithATwistString", param="aString"
            )
        if buffer_size.value == 0:
            return len(self._defaults["GetAnIviDanceWithATwistString"]["aString"])
        a_string.value = self._defaults["GetAnIviDanceWithATwistString"][
            "aString"
        ].encode("ascii")
        return self._defaults["GetAnIviDanceWithATwistString"]["return"]
    ...
    def niFake_GetArrayForPythonCodeCustomType(
        ...
        if self._defaults["GetArrayForPythonCodeCustomType"]["arrayOut"] is None:
            raise MockFunctionCallError(
                "niFake_GetArrayForPythonCodeCustomType", param="arrayOut"
            )
    ...
    def niFake_GetArrayForPythonCodeDouble(
        ...
        if self._defaults["GetArrayForPythonCodeDouble"]["arrayOut"] is None:
            raise MockFunctionCallError(
                "niFake_GetArrayForPythonCodeDouble", param="arrayOut"
            )
    ...
    def niFake_GetArraySizeForPythonCode(self, vi, size_out):  # noqa: N802
        ...
        if self._defaults["GetArraySizeForPythonCode"]["sizeOut"] is None:
            raise MockFunctionCallError(
                "niFake_GetArraySizeForPythonCode", param="sizeOut"
            )
        if size_out is not None:
            size_out.contents.value = self._defaults["GetArraySizeForPythonCode"][
                "sizeOut"
            ]
        return self._defaults["GetArraySizeForPythonCode"]["return"]
    ...
    def niFake_GetArrayUsingIviDance(self, vi, array_size, array_out):  # noqa: N802
        ...
        if self._defaults["GetArrayUsingIviDance"]["arrayOut"] is None:
            raise MockFunctionCallError(
                "niFake_GetArrayUsingIviDance", param="arrayOut"
            )
    ...
    def niFake_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFake_GetAttributeViBoolean", param="attributeValue"
            )
    ...
    def niFake_GetAttributeViInt32(
        ...
        if self._defaults["GetAttributeViInt32"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFake_GetAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niFake_GetAttributeViInt64(
        ...
        if self._defaults["GetAttributeViInt64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFake_GetAttributeViInt64", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niFake_GetAttributeViReal64(
        ...
        if self._defaults["GetAttributeViReal64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFake_GetAttributeViReal64", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niFake_GetAttributeViString(
        ...
        if self._defaults["GetAttributeViString"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFake_GetAttributeViString", param="attributeValue"
            )
        if buffer_size.value == 0:
    ...
    def niFake_GetCustomType(self, vi, cs):  # noqa: N802
        ...
        for field in self._defaults["GetCustomType"]["cs"]._fields_:
            ...
            setattr(
                cs.contents,
                field_name,
                getattr(self._defaults["GetCustomType"]["cs"], field_name),
            )
        return self._defaults["GetCustomType"]["return"]
    ...
    def niFake_MultipleArrayTypes(
        ...
        if self._defaults["MultipleArrayTypes"]["outputArray"] is None:
            raise MockFunctionCallError(
                "niFake_MultipleArrayTypes", param="outputArray"
            )
        ...
        if self._defaults["MultipleArrayTypes"]["outputArrayOfFixedLength"] is None:
            raise MockFunctionCallError(
                "niFake_MultipleArrayTypes", param="outputArrayOfFixedLength"
            )
    ...
    def niFake_ReturnANumberAndAString(self, vi, a_number, a_string):  # noqa: N802
        ...
        if self._defaults["ReturnANumberAndAString"]["aNumber"] is None:
            raise MockFunctionCallError(
                "niFake_ReturnANumberAndAString", param="aNumber"
            )
        if a_number is not None:
            a_number.contents.value = self._defaults["ReturnANumberAndAString"][
                "aNumber"
            ]
        # a_string
        if self._defaults["ReturnANumberAndAString"]["aString"] is None:
            raise MockFunctionCallError(
                "niFake_ReturnANumberAndAString", param="aString"
            )
    ...
    def niFake_ReturnDurationInSeconds(self, vi, timedelta):  # noqa: N802
        ...
        if self._defaults["ReturnDurationInSeconds"]["timedelta"] is None:
            raise MockFunctionCallError(
                "niFake_ReturnDurationInSeconds", param="timedelta"
            )
        if timedelta is not None:
            timedelta.contents.value = self._defaults["ReturnDurationInSeconds"][
                "timedelta"
            ]
        return self._defaults["ReturnDurationInSeconds"]["return"]
    ...
    def niFake_ReturnListOfDurationsInSeconds(
        ...
        if self._defaults["ReturnListOfDurationsInSeconds"]["timedeltas"] is None:
            raise MockFunctionCallError(
                "niFake_ReturnListOfDurationsInSeconds", param="timedeltas"
            )
    ...
    def niFake_ReturnMultipleTypes(
        ...
        if an_int_enum is not None:
            an_int_enum.contents.value = self._defaults["ReturnMultipleTypes"][
                "anIntEnum"
            ]
        # a_float
        ...
        if self._defaults["ReturnMultipleTypes"]["aFloatEnum"] is None:
            raise MockFunctionCallError(
                "niFake_ReturnMultipleTypes", param="aFloatEnum"
            )
        if a_float_enum is not None:
            a_float_enum.contents.value = self._defaults["ReturnMultipleTypes"][
                "aFloatEnum"
            ]
        # an_array
        ...
        a_string.value = self._defaults["ReturnMultipleTypes"]["aString"].encode(
            "ascii"
        )
        return self._defaults["ReturnMultipleTypes"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        ...
        mock_library.niFake_AcceptListOfDurationsInSeconds.side_effect = (
            MockFunctionCallError("niFake_AcceptListOfDurationsInSeconds")
        )
        mock_library.niFake_AcceptListOfDurationsInSeconds.return_value = 0
        mock_library.niFake_BoolArrayOutputFunction.side_effect = MockFunctionCallError(
            "niFake_BoolArrayOutputFunction"
        )
        mock_library.niFake_BoolArrayOutputFunction.return_value = 0
        mock_library.niFake_DoubleAllTheNums.side_effect = MockFunctionCallError(
            "niFake_DoubleAllTheNums"
        )
        mock_library.niFake_DoubleAllTheNums.return_value = 0
        mock_library.niFake_EnumArrayOutputFunction.side_effect = MockFunctionCallError(
            "niFake_EnumArrayOutputFunction"
        )
        mock_library.niFake_EnumArrayOutputFunction.return_value = 0
        mock_library.niFake_EnumInputFunctionWithDefaults.side_effect = (
            MockFunctionCallError("niFake_EnumInputFunctionWithDefaults")
        )
        mock_library.niFake_EnumInputFunctionWithDefaults.return_value = 0
        mock_library.niFake_ExportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niFake_ExportAttributeConfigurationBuffer")
        )
        mock_library.niFake_ExportAttributeConfigurationBuffer.return_value = 0
        mock_library.niFake_FetchWaveform.side_effect = MockFunctionCallError(
            "niFake_FetchWaveform"
        )
        mock_library.niFake_FetchWaveform.return_value = 0
        mock_library.niFake_GetABoolean.side_effect = MockFunctionCallError(
            "niFake_GetABoolean"
        )
        mock_library.niFake_GetABoolean.return_value = 0
        mock_library.niFake_GetANumber.side_effect = MockFunctionCallError(
            "niFake_GetANumber"
        )
        mock_library.niFake_GetANumber.return_value = 0
        mock_library.niFake_GetAStringOfFixedMaximumSize.side_effect = (
            MockFunctionCallError("niFake_GetAStringOfFixedMaximumSize")
        )
        mock_library.niFake_GetAStringOfFixedMaximumSize.return_value = 0
        mock_library.niFake_GetAStringUsingPythonCode.side_effect = (
            MockFunctionCallError("niFake_GetAStringUsingPythonCode")
        )
        mock_library.niFake_GetAStringUsingPythonCode.return_value = 0
        mock_library.niFake_GetAnIviDanceString.side_effect = MockFunctionCallError(
            "niFake_GetAnIviDanceString"
        )
        mock_library.niFake_GetAnIviDanceString.return_value = 0
        mock_library.niFake_GetAnIviDanceWithATwistString.side_effect = (
            MockFunctionCallError("niFake_GetAnIviDanceWithATwistString")
        )
        mock_library.niFake_GetAnIviDanceWithATwistString.return_value = 0
        mock_library.niFake_GetArrayForPythonCodeCustomType.side_effect = (
            MockFunctionCallError("niFake_GetArrayForPythonCodeCustomType")
        )
        mock_library.niFake_GetArrayForPythonCodeCustomType.return_value = 0
        mock_library.niFake_GetArrayForPythonCodeDouble.side_effect = (
            MockFunctionCallError("niFake_GetArrayForPythonCodeDouble")
        )
        mock_library.niFake_GetArrayForPythonCodeDouble.return_value = 0
        mock_library.niFake_GetArraySizeForPythonCode.side_effect = (
            MockFunctionCallError("niFake_GetArraySizeForPythonCode")
        )
        mock_library.niFake_GetArraySizeForPythonCode.return_value = 0
        mock_library.niFake_GetArrayUsingIviDance.side_effect = MockFunctionCallError(
            "niFake_GetArrayUsingIviDance"
        )
        mock_library.niFake_GetArrayUsingIviDance.return_value = 0
        mock_library.niFake_GetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niFake_GetAttributeViBoolean"
        )
        mock_library.niFake_GetAttributeViBoolean.return_value = 0
        mock_library.niFake_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niFake_GetAttributeViInt32"
        )
        mock_library.niFake_GetAttributeViInt32.return_value = 0
        mock_library.niFake_GetAttributeViInt64.side_effect = MockFunctionCallError(
            "niFake_GetAttributeViInt64"
        )
        mock_library.niFake_GetAttributeViInt64.return_value = 0
        mock_library.niFake_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niFake_GetAttributeViReal64"
        )
        mock_library.niFake_GetAttributeViReal64.return_value = 0
        mock_library.niFake_GetAttributeViString.side_effect = MockFunctionCallError(
            "niFake_GetAttributeViString"
        )
        mock_library.niFake_GetAttributeViString.return_value = 0
        mock_library.niFake_GetCalDateAndTime.side_effect = MockFunctionCallError(
            "niFake_GetCalDateAndTime"
        )
        mock_library.niFake_GetCalDateAndTime.return_value = 0
        mock_library.niFake_GetCalInterval.side_effect = MockFunctionCallError(
            "niFake_GetCalInterval"
        )
        mock_library.niFake_GetCalInterval.return_value = 0
        mock_library.niFake_GetCustomType.side_effect = MockFunctionCallError(
            "niFake_GetCustomType"
        )
        mock_library.niFake_GetCustomType.return_value = 0
        mock_library.niFake_GetCustomTypeArray.side_effect = MockFunctionCallError(
            "niFake_GetCustomTypeArray"
        )
        mock_library.niFake_GetCustomTypeArray.return_value = 0
        mock_library.niFake_GetEnumValue.side_effect = MockFunctionCallError(
            "niFake_GetEnumValue"
        )
        mock_library.niFake_GetEnumValue.return_value = 0
        mock_library.niFake_GetError.side_effect = MockFunctionCallError(
            "niFake_GetError"
        )
        mock_library.niFake_GetError.return_value = 0
        mock_library.niFake_ImportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niFake_ImportAttributeConfigurationBuffer")
        )
        mock_library.niFake_ImportAttributeConfigurationBuffer.return_value = 0
        mock_library.niFake_InitWithOptions.side_effect = MockFunctionCallError(
            "niFake_InitWithOptions"
        )
        mock_library.niFake_InitWithOptions.return_value = 0
        mock_library.niFake_Initiate.side_effect = MockFunctionCallError(
            "niFake_Initiate"
        )
        mock_library.niFake_Initiate.return_value = 0
        mock_library.niFake_LockSession.side_effect = MockFunctionCallError(
            "niFake_LockSession"
        )
        mock_library.niFake_LockSession.return_value = 0
        mock_library.niFake_MultipleArrayTypes.side_effect = MockFunctionCallError(
            "niFake_MultipleArrayTypes"
        )
        mock_library.niFake_MultipleArrayTypes.return_value = 0
        mock_library.niFake_MultipleArraysSameSize.side_effect = MockFunctionCallError(
            "niFake_MultipleArraysSameSize"
        )
        mock_library.niFake_MultipleArraysSameSize.return_value = 0
        mock_library.niFake_OneInputFunction.side_effect = MockFunctionCallError(
            "niFake_OneInputFunction"
        )
        mock_library.niFake_OneInputFunction.return_value = 0
        mock_library.niFake_ParametersAreMultipleTypes.side_effect = (
            MockFunctionCallError("niFake_ParametersAreMultipleTypes")
        )
        mock_library.niFake_ParametersAreMultipleTypes.return_value = 0
        mock_library.niFake_PoorlyNamedSimpleFunction.side_effect = (
            MockFunctionCallError("niFake_PoorlyNamedSimpleFunction")
        )
        ...
        mock_library.niFake_ReadFromChannel.side_effect = MockFunctionCallError(
            "niFake_ReadFromChannel"
        )
        mock_library.niFake_ReadFromChannel.return_value = 0
        mock_library.niFake_ReturnANumberAndAString.side_effect = MockFunctionCallError(
            "niFake_ReturnANumberAndAString"
        )
        mock_library.niFake_ReturnANumberAndAString.return_value = 0
        mock_library.niFake_ReturnDurationInSeconds.side_effect = MockFunctionCallError(
            "niFake_ReturnDurationInSeconds"
        )
        mock_library.niFake_ReturnDurationInSeconds.return_value = 0
        mock_library.niFake_ReturnListOfDurationsInSeconds.side_effect = (
            MockFunctionCallError("niFake_ReturnListOfDurationsInSeconds")
        )
        mock_library.niFake_ReturnListOfDurationsInSeconds.return_value = 0
        mock_library.niFake_ReturnMultipleTypes.side_effect = MockFunctionCallError(
            "niFake_ReturnMultipleTypes"
        )
        mock_library.niFake_ReturnMultipleTypes.return_value = 0
        mock_library.niFake_SetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niFake_SetAttributeViBoolean"
        )
        mock_library.niFake_SetAttributeViBoolean.return_value = 0
        mock_library.niFake_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niFake_SetAttributeViInt32"
        )
        mock_library.niFake_SetAttributeViInt32.return_value = 0
        mock_library.niFake_SetAttributeViInt64.side_effect = MockFunctionCallError(
            "niFake_SetAttributeViInt64"
        )
        mock_library.niFake_SetAttributeViInt64.return_value = 0
        mock_library.niFake_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niFake_SetAttributeViReal64"
        )
        mock_library.niFake_SetAttributeViReal64.return_value = 0
        mock_library.niFake_SetAttributeViString.side_effect = MockFunctionCallError(
            "niFake_SetAttributeViString"
        )
        mock_library.niFake_SetAttributeViString.return_value = 0
        mock_library.niFake_SetCustomType.side_effect = MockFunctionCallError(
            "niFake_SetCustomType"
        )
        mock_library.niFake_SetCustomType.return_value = 0
        mock_library.niFake_SetCustomTypeArray.side_effect = MockFunctionCallError(
            "niFake_SetCustomTypeArray"
        )
        mock_library.niFake_SetCustomTypeArray.return_value = 0
        mock_library.niFake_StringValuedEnumInputFunctionWithDefaults.side_effect = (
            MockFunctionCallError("niFake_StringValuedEnumInputFunctionWithDefaults")
        )
        mock_library.niFake_StringValuedEnumInputFunctionWithDefaults.return_value = 0
        mock_library.niFake_TwoInputFunction.side_effect = MockFunctionCallError(
            "niFake_TwoInputFunction"
        )
        mock_library.niFake_TwoInputFunction.return_value = 0
        mock_library.niFake_UnlockSession.side_effect = MockFunctionCallError(
            "niFake_UnlockSession"
        )
        mock_library.niFake_UnlockSession.return_value = 0
        mock_library.niFake_Use64BitNumber.side_effect = MockFunctionCallError(
            "niFake_Use64BitNumber"
        )
        mock_library.niFake_Use64BitNumber.return_value = 0
        mock_library.niFake_WriteWaveform.side_effect = MockFunctionCallError(
        ...
        mock_library.niFake_error_message.side_effect = MockFunctionCallError(
            "niFake_error_message"
        )
        mock_library.niFake_error_message.return_value = 0
        mock_library.niFake_self_test.side_effect = MockFunctionCallError(
            "niFake_self_test"
        )
