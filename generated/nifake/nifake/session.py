...
class _SessionBase(object):
    ...
    def function_with_repeated_capability_type(self):
        ...
        '''
        return self._library_interpreter.function_with_repeated_capability_type(self._vi, self._encoding, self._repeated_capability)
    ...
    def read_from_channel(self, maximum_time):
        ...
        '''
        return self._library_interpreter.read_from_channel(self._vi, self._encoding, self._repeated_capability, maximum_time)
...
class Session(_SessionBase):
    ...
    def accept_list_of_durations_in_seconds(self, delays):
        ...
        '''
        return self._library_interpreter.accept_list_of_durations_in_seconds(self._vi, self._encoding, delays)
    ...
    def bool_array_output_function(self, number_of_elements):
        ...
        '''
        return self._library_interpreter.bool_array_output_function(self._vi, self._encoding, number_of_elements)
    ...
    def double_all_the_nums(self, numbers):
        ...
        '''
        return self._library_interpreter.double_all_the_nums(self._vi, self._encoding, numbers)
    ...
    def enum_array_output_function(self, number_of_elements):
        ...
        '''
        return self._library_interpreter.enum_array_output_function(self._vi, self._encoding, number_of_elements)
    ...
    def enum_input_function_with_defaults(self, a_turtle=enums.Turtle.LEONARDO):
        ...
        return self._library_interpreter.enum_input_function_with_defaults(self._vi, self._encoding, a_turtle)
    ...
    def fetch_waveform(self, number_of_samples):
        ...
        '''
        return self._library_interpreter.fetch_waveform(self._vi, self._encoding, number_of_samples)
    ...
    def fetch_waveform_into(self, waveform_data):
        ...
        return self._library_interpreter.fetch_waveform_into(self._vi, self._encoding, waveform_data)
    ...
    def get_a_boolean(self):
        ...
        '''
        return self._library_interpreter.get_a_boolean(self._vi, self._encoding)
    ...
    def get_a_number(self):
        ...
        '''
        return self._library_interpreter.get_a_number(self._vi, self._encoding)
    ...
    def get_a_string_of_fixed_maximum_size(self):
        ...
        '''
        return self._library_interpreter.get_a_string_of_fixed_maximum_size(self._vi, self._encoding)
    ...
    def get_a_string_using_python_code(self, a_number):
        ...
        '''
        return self._library_interpreter.get_a_string_using_python_code(self._vi, self._encoding, a_number)
    ...
    def get_an_ivi_dance_string(self):
        ...
        '''
        return self._library_interpreter.get_an_ivi_dance_string(self._vi, self._encoding)
    ...
    def get_an_ivi_dance_with_a_twist_string(self):
        ...
        '''
        return self._library_interpreter.get_an_ivi_dance_with_a_twist_string(self._vi, self._encoding)
    ...
    def get_array_for_python_code_custom_type(self):
        ...
        '''
        return self._library_interpreter.get_array_for_python_code_custom_type(self._vi, self._encoding)
    ...
    def get_array_for_python_code_double(self):
        ...
        '''
        return self._library_interpreter.get_array_for_python_code_double(self._vi, self._encoding)
    ...
    def get_array_size_for_python_code(self):
        ...
        '''
        return self._library_interpreter.get_array_size_for_python_code(self._vi, self._encoding)
    ...
    def get_array_using_ivi_dance(self):
        ...
        '''
        return self._library_interpreter.get_array_using_ivi_dance(self._vi, self._encoding)
    ...
    def _get_cal_date_and_time(self, cal_type):
        ...
        '''
        return self._library_interpreter.get_cal_date_and_time(self._vi, self._encoding, cal_type)
    ...
    def get_cal_interval(self):
        ...
        '''
        return self._library_interpreter.get_cal_interval(self._vi, self._encoding)
    ...
    def get_custom_type(self):
        ...
        '''
        return self._library_interpreter.get_custom_type(self._vi, self._encoding)
    ...
    def get_custom_type_array(self, number_of_elements):
        ...
        '''
        return self._library_interpreter.get_custom_type_array(self._vi, self._encoding, number_of_elements)
    ...
    def get_custom_type_typedef(self):
        ...
        '''
        return self._library_interpreter.get_custom_type_typedef(self._vi, self._encoding)
    ...
    def get_enum_value(self):
        ...
        '''
        return self._library_interpreter.get_enum_value(self._vi, self._encoding)
    ...
    def multiple_array_types(self, output_array_size, input_array_of_floats, input_array_of_integers=None):
        ...
        '''
        return self._library_interpreter.multiple_array_types(self._vi, self._encoding, output_array_size, input_array_of_floats, input_array_of_integers)
    ...
    def multiple_arrays_same_size(self, values1, values2, values3, values4):
        ...
        '''
        return self._library_interpreter.multiple_arrays_same_size(self._vi, self._encoding, values1, values2, values3, values4)
    ...
    def one_input_function(self, a_number):
        ...
        '''
        return self._library_interpreter.one_input_function(self._vi, self._encoding, a_number)
    ...
    def parameters_are_multiple_types(self, a_boolean, an_int32, an_int64, an_int_enum, a_float, a_float_enum, a_string):
        ...
        return self._library_interpreter.parameters_are_multiple_types(self._vi, self._encoding, a_boolean, an_int32, an_int64, an_int_enum, a_float, a_float_enum, a_string)
    ...
    def simple_function(self):
        ...
        '''
        return self._library_interpreter.simple_function(self._vi, self._encoding)
    ...
    def read(self, maximum_time):
        ...
        '''
        return self._library_interpreter.read(self._vi, self._encoding, maximum_time)
    ...
    def return_a_number_and_a_string(self):
        ...
        '''
        return self._library_interpreter.return_a_number_and_a_string(self._vi, self._encoding)
    ...
    def return_duration_in_seconds(self):
        ...
        '''
        return self._library_interpreter.return_duration_in_seconds(self._vi, self._encoding)
    ...
    def return_list_of_durations_in_seconds(self, number_of_elements):
        ...
        '''
        return self._library_interpreter.return_list_of_durations_in_seconds(self._vi, self._encoding, number_of_elements)
    ...
    def return_multiple_types(self, array_size):
        ...
        '''
        return self._library_interpreter.return_multiple_types(self._vi, self._encoding, array_size)
    ...
    def set_custom_type(self, cs):
        ...
        '''
        return self._library_interpreter.set_custom_type(self._vi, self._encoding, cs)
    ...
    def set_custom_type_array(self, cs):
        ...
        '''
        return self._library_interpreter.set_custom_type_array(self._vi, self._encoding, cs)
    ...
    def string_valued_enum_input_function_with_defaults(self, a_mobile_os_name=enums.MobileOSNames.ANDROID):
        ...
        return self._library_interpreter.string_valued_enum_input_function_with_defaults(self._vi, self._encoding, a_mobile_os_name)
    ...
    def two_input_function(self, a_number, a_string):
        ...
        '''
        return self._library_interpreter.two_input_function(self._vi, self._encoding, a_number, a_string)
    ...
    def use64_bit_number(self, input):
        ...
        '''
        return self._library_interpreter.use64_bit_number(self._vi, self._encoding, input)
    ...
    def write_waveform(self, waveform):
        ...
        '''
        return self._library_interpreter.write_waveform(self._vi, self._encoding, waveform)
    ...
    def write_waveform_numpy(self, waveform):
        ...
        return self._library_interpreter.write_waveform_numpy(self._vi, self._encoding, waveform)
