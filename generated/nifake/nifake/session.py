...
class _SessionBase(object):
    ...
    float_enum = _attributes.AttributeEnum(
        _attributes.AttributeViReal64, enums.FloatEnum, 1000005
    )
    ...
    """
    read_write_color = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.Color, 1000003
    )
    """Type: enums.Color
    ...
    """
    read_write_double_with_converter = _attributes.AttributeViReal64TimeDeltaSeconds(
        1000007
    )
    ...
    """
    read_write_integer_with_converter = (
        _attributes.AttributeViInt32TimeDeltaMilliseconds(1000008)
    )
    ...
    """
    read_write_string_repeated_capability = (
        _attributes.AttributeViStringRepeatedCapability(1000010)
    )
    ...
    def __repr__(self):
        return "{0}.{1}({2})".format(
            "nifake", self.__class__.__name__, self._param_list
        )
    ...
    def _get_attribute_vi_boolean(self, attribute_id):
        ...
        error_code = self._library.niFake_GetAttributeViBoolean(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_int32(self, attribute_id):
        ...
        error_code = self._library.niFake_GetAttributeViInt32(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_int64(self, attribute_id):
        ...
        error_code = self._library.niFake_GetAttributeViInt64(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_real64(self, attribute_id):
        ...
        error_code = self._library.niFake_GetAttributeViReal64(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_string(self, attribute_id):
        ...
        error_code = self._library.niFake_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            buffer_size_ctype,
    ...
    def _get_error(self):
        ...
        error_code = self._library.niFake_GetError(
            vi_ctype,
    ...
    def read_from_channel(self, maximum_time):
        ...
        maximum_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(
            maximum_time
        )  # case S140
        reading_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niFake_ReadFromChannel(
            vi_ctype,
            channel_name_ctype,
            maximum_time_ctype,
            None if reading_ctype is None else (ctypes.pointer(reading_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _set_attribute_vi_boolean(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFake_SetAttributeViBoolean(
    ...
    def _set_attribute_vi_int32(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFake_SetAttributeViInt32(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_int64(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFake_SetAttributeViInt64(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_real64(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFake_SetAttributeViReal64(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_string(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFake_SetAttributeViString(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _error_message(self, error_code):
        ...
        error_code = self._library.niFake_error_message(
...
class Session(_SessionBase):
    ...
    def __init__(self, resource_name, options={}, id_query=False, reset_device=False):
        ...
        self._vi = self._init_with_options(
            resource_name, options, id_query, reset_device
        )
    ...
    def accept_list_of_durations_in_seconds(self, delays):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        count_ctype = _visatype.ViInt32(
            0 if delays is None else len(delays)
        )  # case S160
        delays_converted = _converters.convert_timedeltas_to_seconds_real64(
            delays
        )  # case B520
        delays_ctype = get_ctypes_pointer_for_buffer(
            value=delays_converted, library_type=_visatype.ViReal64
        )  # case B520
        error_code = self._library.niFake_AcceptListOfDurationsInSeconds(
            vi_ctype, count_ctype, delays_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def bool_array_output_function(self, number_of_elements):
        ...
        an_array_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViBoolean, size=an_array_size
        )  # case B600
        error_code = self._library.niFake_BoolArrayOutputFunction(
            vi_ctype, number_of_elements_ctype, an_array_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def double_all_the_nums(self, numbers):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        number_count_ctype = _visatype.ViInt32(
            0 if numbers is None else len(numbers)
        )  # case S160
        numbers_converted = _converters.convert_double_each_element(
            numbers
        )  # case B520
        numbers_ctype = get_ctypes_pointer_for_buffer(
            value=numbers_converted, library_type=_visatype.ViReal64
        )  # case B520
        error_code = self._library.niFake_DoubleAllTheNums(
            vi_ctype, number_count_ctype, numbers_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def enum_array_output_function(self, number_of_elements):
        ...
        an_array_size = number_of_elements  # case B600
        an_array_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt16, size=an_array_size
        )  # case B600
        error_code = self._library.niFake_EnumArrayOutputFunction(
            vi_ctype, number_of_elements_ctype, an_array_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        ...
        return [
            enums.Turtle(an_array_ctype[i])
            for i in range(number_of_elements_ctype.value)
        ]
    ...
    def enum_input_function_with_defaults(self, a_turtle=enums.Turtle.LEONARDO):
        ...
        error_code = self._library.niFake_EnumInputFunctionWithDefaults(
            vi_ctype, a_turtle_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def export_attribute_configuration_buffer(self):
        ...
        error_code = self._library.niFake_ExportAttributeConfigurationBuffer(
    ...
    def fetch_waveform(self, number_of_samples):
        ...
        error_code = self._library.niFake_FetchWaveform(
            vi_ctype,
            number_of_samples_ctype,
            waveform_data_ctype,
            None
            if actual_number_of_samples_ctype is None
            else (ctypes.pointer(actual_number_of_samples_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def fetch_waveform_into(self, waveform_data):
        ...
        if type(waveform_data) is not numpy.ndarray:
            raise TypeError(
                "waveform_data must be {0}, is {1}".format(
                    numpy.ndarray, type(waveform_data)
                )
            )
        ...
        if waveform_data.dtype is not numpy.dtype("float64"):
            raise TypeError(
                "waveform_data must be numpy.ndarray of dtype=float64, is "
                + str(waveform_data.dtype)
            )
    ...
    def get_a_boolean(self):
        ...
        error_code = self._library.niFake_GetABoolean(
            vi_ctype,
            None if a_boolean_ctype is None else (ctypes.pointer(a_boolean_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_a_number(self):
        ...
        error_code = self._library.niFake_GetANumber(
            vi_ctype,
            None if a_number_ctype is None else (ctypes.pointer(a_number_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_a_string_of_fixed_maximum_size(self):
        ...
        error_code = self._library.niFake_GetAStringOfFixedMaximumSize(
            vi_ctype, a_string_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_a_string_using_python_code(self, a_number):
        ...
        error_code = self._library.niFake_GetAStringUsingPythonCode(
            vi_ctype, a_number_ctype, a_string_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_an_ivi_dance_string(self):
        ...
        error_code = self._library.niFake_GetAnIviDanceString(
            vi_ctype, buffer_size_ctype, a_string_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def get_an_ivi_dance_with_a_twist_string(self):
        ...
        error_code = self._library.niFake_GetAnIviDanceWithATwistString(
            vi_ctype,
            buffer_size_ctype,
            a_string_ctype,
            None if actual_size_ctype is None else (ctypes.pointer(actual_size_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def get_array_for_python_code_custom_type(self):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(
            self.get_array_size_for_python_code()
        )  # case S120
        array_out_size = self.get_array_size_for_python_code()  # case B560
        array_out_ctype = get_ctypes_pointer_for_buffer(
            library_type=custom_struct.struct_CustomStruct, size=array_out_size
        )  # case B560
        error_code = self._library.niFake_GetArrayForPythonCodeCustomType(
            vi_ctype, number_of_elements_ctype, array_out_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return [
            custom_struct.CustomStruct(array_out_ctype[i])
            for i in range(self.get_array_size_for_python_code())
        ]
    ...
    def get_array_for_python_code_double(self):
        ...
        array_out_size = self.get_array_size_for_python_code()  # case B560
        array_out_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=array_out_size
        )  # case B560
        error_code = self._library.niFake_GetArrayForPythonCodeDouble(
            vi_ctype, number_of_elements_ctype, array_out_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def get_array_size_for_python_code(self):
        ...
        error_code = self._library.niFake_GetArraySizeForPythonCode(
            vi_ctype,
            None if size_out_ctype is None else (ctypes.pointer(size_out_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_array_using_ivi_dance(self):
        ...
        error_code = self._library.niFake_GetArrayUsingIviDance(
            vi_ctype, array_size_ctype, array_out_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def get_cal_interval(self):
        ...
        error_code = self._library.niFake_GetCalInterval(
    ...
    def get_custom_type(self):
        ...
        error_code = self._library.niFake_GetCustomType(
            vi_ctype, None if cs_ctype is None else (ctypes.pointer(cs_ctype))
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_custom_type_array(self, number_of_elements):
        ...
        cs_ctype = get_ctypes_pointer_for_buffer(
            library_type=custom_struct.struct_CustomStruct, size=cs_size
        )  # case B600
        error_code = self._library.niFake_GetCustomTypeArray(
            vi_ctype, number_of_elements_ctype, cs_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return [
            custom_struct.CustomStruct(cs_ctype[i])
            for i in range(number_of_elements_ctype.value)
        ]
    ...
    def get_enum_value(self):
        ...
        error_code = self._library.niFake_GetEnumValue(
            vi_ctype,
            None if a_quantity_ctype is None else (ctypes.pointer(a_quantity_ctype)),
            None if a_turtle_ctype is None else (ctypes.pointer(a_turtle_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def import_attribute_configuration_buffer(self, configuration):
        ...
        error_code = self._library.niFake_ImportAttributeConfigurationBuffer(
            vi_ctype, size_in_bytes_ctype, configuration_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _init_with_options(
        self, resource_name, option_string, id_query=False, reset_device=False
    ):
        ...
        error_code = self._library.niFake_InitWithOptions(
            resource_name_ctype,
            id_query_ctype,
            reset_device_ctype,
            option_string_ctype,
    ...
    @ivi_synchronized
    def multiple_array_types(
        self, output_array_size, input_array_of_floats, input_array_of_integers=None
    ):
        ...
        output_array_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=output_array_size
        )  # case B600
        output_array_of_fixed_length_size = 3  # case B570
        output_array_of_fixed_length_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=output_array_of_fixed_length_size
        )  # case B570
        input_array_sizes_ctype = _visatype.ViInt32(
            0 if input_array_of_floats is None else len(input_array_of_floats)
        )  # case S160
        if input_array_of_integers is not None and len(input_array_of_integers) != len(
            input_array_of_floats
        ):  # case S160
            raise ValueError(
                "Length of input_array_of_integers and input_array_of_floats parameters do not match."
            )  # case S160
        input_array_of_floats_ctype = get_ctypes_pointer_for_buffer(
            value=input_array_of_floats, library_type=_visatype.ViReal64
        )  # case B550
        input_array_of_integers_ctype = get_ctypes_pointer_for_buffer(
            value=input_array_of_integers, library_type=_visatype.ViInt16
        )  # case B550
        error_code = self._library.niFake_MultipleArrayTypes(
            vi_ctype,
            output_array_size_ctype,
            output_array_ctype,
            output_array_of_fixed_length_ctype,
            input_array_sizes_ctype,
            input_array_of_floats_ctype,
            input_array_of_integers_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return [
            float(output_array_ctype[i]) for i in range(output_array_size_ctype.value)
        ], [float(output_array_of_fixed_length_ctype[i]) for i in range(3)]
    ...
    def multiple_arrays_same_size(self, values1, values2, values3, values4):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        values1_ctype = get_ctypes_pointer_for_buffer(
            value=values1, library_type=_visatype.ViReal64
        )  # case B550
        values2_ctype = get_ctypes_pointer_for_buffer(
            value=values2, library_type=_visatype.ViReal64
        )  # case B550
        values3_ctype = get_ctypes_pointer_for_buffer(
            value=values3, library_type=_visatype.ViReal64
        )  # case B550
        values4_ctype = get_ctypes_pointer_for_buffer(
            value=values4, library_type=_visatype.ViReal64
        )  # case B550
        size_ctype = _visatype.ViInt32(
            0 if values1 is None else len(values1)
        )  # case S160
        if values2 is not None and len(values2) != len(values1):  # case S160
            raise ValueError(
                "Length of values2 and values1 parameters do not match."
            )  # case S160
        if values3 is not None and len(values3) != len(values1):  # case S160
            raise ValueError(
                "Length of values3 and values1 parameters do not match."
            )  # case S160
        if values4 is not None and len(values4) != len(values1):  # case S160
            raise ValueError(
                "Length of values4 and values1 parameters do not match."
            )  # case S160
        error_code = self._library.niFake_MultipleArraysSameSize(
            vi_ctype,
            values1_ctype,
            values2_ctype,
            values3_ctype,
    ...
    @ivi_synchronized
    def parameters_are_multiple_types(
        self,
        a_boolean,
        an_int32,
        an_int64,
        ...
        if type(an_int_enum) is not enums.Turtle:
            raise TypeError(
                "Parameter an_int_enum must be of type " + str(enums.Turtle)
            )
        if type(a_float_enum) is not enums.FloatEnum:
            raise TypeError(
                "Parameter a_float_enum must be of type " + str(enums.FloatEnum)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        ...
        string_size_ctype = _visatype.ViInt32(
            0 if a_string is None else len(a_string)
        )  # case S160
        a_string_ctype = ctypes.create_string_buffer(
            a_string.encode(self._encoding)
        )  # case C020
        error_code = self._library.niFake_ParametersAreMultipleTypes(
            vi_ctype,
            a_boolean_ctype,
            an_int32_ctype,
            an_int64_ctype,
    ...
    def read(self, maximum_time):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        maximum_time_ctype = _converters.convert_timedelta_to_seconds_real64(
            maximum_time
        )  # case S140
        reading_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niFake_Read(
            vi_ctype,
            maximum_time_ctype,
            None if reading_ctype is None else (ctypes.pointer(reading_ctype)),
        )
    ...
    def return_a_number_and_a_string(self):
        ...
        a_number_ctype = _visatype.ViInt16()  # case S220
        a_string_ctype = (_visatype.ViChar * 256)()  # case C070
        error_code = self._library.niFake_ReturnANumberAndAString(
            vi_ctype,
            None if a_number_ctype is None else (ctypes.pointer(a_number_ctype)),
            a_string_ctype,
        )
    ...
    def return_duration_in_seconds(self):
        ...
        error_code = self._library.niFake_ReturnDurationInSeconds(
            vi_ctype,
            None if timedelta_ctype is None else (ctypes.pointer(timedelta_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return _converters.convert_seconds_real64_to_timedelta(
            float(timedelta_ctype.value)
        )
    ...
    def return_list_of_durations_in_seconds(self, number_of_elements):
        ...
        timedeltas_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=timedeltas_size
        )  # case B600
        error_code = self._library.niFake_ReturnListOfDurationsInSeconds(
            vi_ctype, number_of_elements_ctype, timedeltas_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return _converters.convert_seconds_real64_to_timedeltas(
            [float(timedeltas_ctype[i]) for i in range(number_of_elements_ctype.value)]
        )
    ...
    def return_multiple_types(self, array_size):
        ...
        a_string_ctype = None  # case C050
        error_code = self._library.niFake_ReturnMultipleTypes(
            vi_ctype,
            None if a_boolean_ctype is None else (ctypes.pointer(a_boolean_ctype)),
            None if an_int32_ctype is None else (ctypes.pointer(an_int32_ctype)),
            None if an_int64_ctype is None else (ctypes.pointer(an_int64_ctype)),
            None if an_int_enum_ctype is None else (ctypes.pointer(an_int_enum_ctype)),
            None if a_float_ctype is None else (ctypes.pointer(a_float_ctype)),
            None
            if a_float_enum_ctype is None
            else (ctypes.pointer(a_float_enum_ctype)),
            array_size_ctype,
            an_array_ctype,
            string_size_ctype,
            a_string_ctype,
        ...
        return (
            bool(a_boolean_ctype.value),
            int(an_int32_ctype.value),
            int(an_int64_ctype.value),
            enums.Turtle(an_int_enum_ctype.value),
            float(a_float_ctype.value),
            enums.FloatEnum(a_float_enum_ctype.value),
            [float(an_array_ctype[i]) for i in range(array_size_ctype.value)],
            a_string_ctype.value.decode(self._encoding),
        )
    ...
    def set_custom_type_array(self, cs):
        ...
        cs_ctype = get_ctypes_pointer_for_buffer(
            [custom_struct.struct_CustomStruct(c) for c in cs],
            library_type=custom_struct.struct_CustomStruct,
        )  # case B540
        error_code = self._library.niFake_SetCustomTypeArray(
            vi_ctype, number_of_elements_ctype, cs_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    @ivi_synchronized
    def string_valued_enum_input_function_with_defaults(
        self, a_mobile_os_name=enums.MobileOSNames.ANDROID
    ):
        ...
        if type(a_mobile_os_name) is not enums.MobileOSNames:
            raise TypeError(
                "Parameter a_mobile_os_name must be of type " + str(enums.MobileOSNames)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        a_mobile_os_name_ctype = ctypes.create_string_buffer(
            a_mobile_os_name.value.encode(self._encoding)
        )  # case C030
    ...
    def two_input_function(self, a_number, a_string):
        ...
        error_code = self._library.niFake_TwoInputFunction(
            vi_ctype, a_number_ctype, a_string_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def use64_bit_number(self, input):
        ...
        error_code = self._library.niFake_Use64BitNumber(
            vi_ctype,
            input_ctype,
            None if output_ctype is None else (ctypes.pointer(output_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def write_waveform(self, waveform):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        number_of_samples_ctype = _visatype.ViInt32(
            0 if waveform is None else len(waveform)
        )  # case S160
        waveform_array = get_ctypes_and_array(
            value=waveform, array_type="d"
        )  # case B550
        waveform_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_array, library_type=_visatype.ViReal64
        )  # case B550
        error_code = self._library.niFake_WriteWaveform(
            vi_ctype, number_of_samples_ctype, waveform_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _self_test(self):
        ...
        error_code = self._library.niFake_self_test(
            vi_ctype,
            None
