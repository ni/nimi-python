...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def accept_list_of_durations_in_seconds(self, session_handle, encoding, delays):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def bool_array_output_function(self, session_handle, encoding, number_of_elements):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def double_all_the_nums(self, session_handle, encoding, numbers):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def enum_array_output_function(self, session_handle, encoding, number_of_elements):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(number_of_elements)  # case S210
        an_array_size = number_of_elements  # case B600
    ...
    def enum_input_function_with_defaults(self, session_handle, encoding, a_turtle):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def fetch_waveform(self, session_handle, encoding, number_of_samples):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def fetch_waveform_into(self, session_handle, encoding, waveform_data):  # noqa: N802
    ...
    def function_with_repeated_capability_type(self, session_handle, encoding, site_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_a_boolean(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_a_number(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_a_string_of_fixed_maximum_size(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return a_string_ctype.value.decode(encoding)

    def get_a_string_using_python_code(self, session_handle, encoding, a_number):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_an_ivi_dance_string(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_an_ivi_dance_with_a_twist_string(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_array_for_python_code_custom_type(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(self.get_array_size_for_python_code(session_handle, encoding))  # case S120
        array_out_size = self.get_array_size_for_python_code(session_handle, encoding)  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [custom_struct.CustomStruct(array_out_ctype[i]) for i in range(self.get_array_size_for_python_code(session_handle, encoding))]

    def get_array_for_python_code_double(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(self.get_array_size_for_python_code(session_handle, encoding))  # case S120
        array_out_size = self.get_array_size_for_python_code(session_handle, encoding)  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [float(array_out_ctype[i]) for i in range(self.get_array_size_for_python_code(session_handle, encoding))]

    def get_array_size_for_python_code(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_array_using_ivi_dance(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_cal_interval(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_custom_type(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_custom_type_array(self, session_handle, encoding, number_of_elements):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(number_of_elements)  # case S210
    ...
    def get_custom_type_typedef(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_enum_value(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def multiple_array_types(self, session_handle, encoding, output_array_size, input_array_of_floats, input_array_of_integers):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def multiple_arrays_same_size(self, session_handle, encoding, values1, values2, values3, values4):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def one_input_function(self, session_handle, encoding, a_number):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def parameters_are_multiple_types(self, session_handle, encoding, a_boolean, an_int32, an_int64, an_int_enum, a_float, a_float_enum, a_string):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        ...
        a_string_ctype = ctypes.create_string_buffer(a_string.encode(encoding))  # case C020
    ...
    def simple_function(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def read_from_channel(self, session_handle, encoding, channel_name, maximum_time):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def return_a_number_and_a_string(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        a_number_ctype = _visatype.ViInt16()  # case S220
        a_string_ctype = (_visatype.ViChar * 256)()  # case C070
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return int(a_number_ctype.value), a_string_ctype.value.decode(encoding)

    def return_duration_in_seconds(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def return_list_of_durations_in_seconds(self, session_handle, encoding, number_of_elements):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_elements_ctype = _visatype.ViInt32(number_of_elements)  # case S210
    ...
    def return_multiple_types(self, session_handle, encoding, array_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        a_boolean_ctype = _visatype.ViBoolean()  # case S220
        ...
        error_code = self._library.niFake_ReturnMultipleTypes(vi_ctype, None if a_boolean_ctype is None else (ctypes.pointer(a_boolean_ctype)), None if an_int32_ctype is None else (ctypes.pointer(an_int32_ctype)), None if an_int64_ctype is None else (ctypes.pointer(an_int64_ctype)), None if an_int_enum_ctype is None else (ctypes.pointer(an_int_enum_ctype)), None if a_float_ctype is None else (ctypes.pointer(a_float_ctype)), None if a_float_enum_ctype is None else (ctypes.pointer(a_float_enum_ctype)), array_size_ctype, an_array_ctype, string_size_ctype, a_string_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return bool(a_boolean_ctype.value), int(an_int32_ctype.value), int(an_int64_ctype.value), enums.Turtle(an_int_enum_ctype.value), float(a_float_ctype.value), enums.FloatEnum(a_float_enum_ctype.value), [float(an_array_ctype[i]) for i in range(array_size_ctype.value)], a_string_ctype.value.decode(encoding)
    ...
    def set_custom_type(self, session_handle, encoding, cs):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def set_custom_type_array(self, session_handle, encoding, cs):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def string_valued_enum_input_function_with_defaults(self, session_handle, encoding, a_mobile_os_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        a_mobile_os_name_ctype = ctypes.create_string_buffer(a_mobile_os_name.value.encode(encoding))  # case C030
        error_code = self._library.niFake_StringValuedEnumInputFunctionWithDefaults(vi_ctype, a_mobile_os_name_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def two_input_function(self, session_handle, encoding, a_number, a_string):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def use64_bit_number(self, session_handle, encoding, input):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def write_waveform(self, session_handle, encoding, waveform):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def write_waveform_numpy(self, session_handle, encoding, waveform):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        number_of_samples_ctype = _visatype.ViInt32(0 if waveform is None else len(waveform))  # case S160
