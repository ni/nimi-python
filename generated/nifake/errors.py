...
class DriverNotInstalledError(Exception):
    ...
    def __init__(self):
        super(DriverNotInstalledError, self).__init__('The NI-FAKE runtime not found. The bitness of Python must be supported by the installed runtime. Please visit http://www.ni.com/downloads/drivers/ to download and install it.')
