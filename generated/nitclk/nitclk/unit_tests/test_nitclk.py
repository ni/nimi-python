...
multiple_sessions_reference = [nitclk.SessionReference(x) for x in multiple_sessions]
...
class TestNitclkApi(object):
    ...
    def test_initialize_multiple_sessions(self):
        self.patched_library.niTClk_Initiate.side_effect = self.side_effects_helper.niTClk_Initiate
        nitclk.initiate(multiple_sessions_reference)
    ...
    def test_configure_for_homogeneous_triggers(self):
        ...
        nitclk.configure_for_homogeneous_triggers(multiple_sessions_reference)
    ...
    def test_finish_sync_pulse_sender_synchronize(self):
        ...
        nitclk.finish_sync_pulse_sender_synchronize(multiple_sessions_reference, min_time)
    ...
    def test_is_done(self):
        ...
        actual_result = nitclk.is_done(multiple_sessions_reference)
    ...
    def test_setup_for_sync_pulse_sender_synchronize(self):
        ...
        nitclk.setup_for_sync_pulse_sender_synchronize(multiple_sessions_reference, min_time)
    ...
    def test_synchronize(self):
        ...
        nitclk.synchronize(multiple_sessions_reference, min_time)
    ...
    def test_synchronize_to_sync_pulse_sender(self):
        ...
        nitclk.synchronize_to_sync_pulse_sender(multiple_sessions_reference, min_time)
    ...
    def test_wait_until_done(self):
        ...
        nitclk.wait_until_done(multiple_sessions_reference, min_time)
    ...
    def test_api_error(self):
        ...
        try:
            nitclk.synchronize(multiple_sessions_reference, 0.42)
