...
class SideEffectsHelper(object):
    ...
    def niTClk_GetExtendedErrorInfo(
        ...
        if self._defaults["GetExtendedErrorInfo"]["errorString"] is None:
            raise MockFunctionCallError(
                "niTClk_GetExtendedErrorInfo", param="errorString"
            )
        if error_string_size.value == 0:
            return len(self._defaults["GetExtendedErrorInfo"]["errorString"])
        error_string.value = self._defaults["GetExtendedErrorInfo"][
            "errorString"
        ].encode("ascii")
        return self._defaults["GetExtendedErrorInfo"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niTClk_ConfigureForHomogeneousTriggers.side_effect = (
            MockFunctionCallError("niTClk_ConfigureForHomogeneousTriggers")
        )
        mock_library.niTClk_ConfigureForHomogeneousTriggers.return_value = 0
        mock_library.niTClk_FinishSyncPulseSenderSynchronize.side_effect = (
            MockFunctionCallError("niTClk_FinishSyncPulseSenderSynchronize")
        )
        mock_library.niTClk_FinishSyncPulseSenderSynchronize.return_value = 0
        mock_library.niTClk_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niTClk_GetAttributeViReal64"
        )
        mock_library.niTClk_GetAttributeViReal64.return_value = 0
        mock_library.niTClk_GetAttributeViSession.side_effect = MockFunctionCallError(
            "niTClk_GetAttributeViSession"
        )
        mock_library.niTClk_GetAttributeViSession.return_value = 0
        mock_library.niTClk_GetAttributeViString.side_effect = MockFunctionCallError(
            "niTClk_GetAttributeViString"
        )
        mock_library.niTClk_GetAttributeViString.return_value = 0
        mock_library.niTClk_GetExtendedErrorInfo.side_effect = MockFunctionCallError(
            "niTClk_GetExtendedErrorInfo"
        )
        mock_library.niTClk_GetExtendedErrorInfo.return_value = 0
        mock_library.niTClk_Initiate.side_effect = MockFunctionCallError(
            "niTClk_Initiate"
        )
        ...
        mock_library.niTClk_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niTClk_SetAttributeViReal64"
        )
        mock_library.niTClk_SetAttributeViReal64.return_value = 0
        mock_library.niTClk_SetAttributeViSession.side_effect = MockFunctionCallError(
            "niTClk_SetAttributeViSession"
        )
        mock_library.niTClk_SetAttributeViSession.return_value = 0
        mock_library.niTClk_SetAttributeViString.side_effect = MockFunctionCallError(
            "niTClk_SetAttributeViString"
        )
        mock_library.niTClk_SetAttributeViString.return_value = 0
        mock_library.niTClk_SetupForSyncPulseSenderSynchronize.side_effect = (
            MockFunctionCallError("niTClk_SetupForSyncPulseSenderSynchronize")
        )
        mock_library.niTClk_SetupForSyncPulseSenderSynchronize.return_value = 0
        mock_library.niTClk_Synchronize.side_effect = MockFunctionCallError(
            "niTClk_Synchronize"
        )
        mock_library.niTClk_Synchronize.return_value = 0
        mock_library.niTClk_SynchronizeToSyncPulseSender.side_effect = (
            MockFunctionCallError("niTClk_SynchronizeToSyncPulseSender")
        )
        mock_library.niTClk_SynchronizeToSyncPulseSender.return_value = 0
        mock_library.niTClk_WaitUntilDone.side_effect = MockFunctionCallError(
