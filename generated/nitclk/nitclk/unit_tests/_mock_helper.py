...
class SideEffectsHelper(object):
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niTClk_ConfigureForHomogeneousTriggers_cfunc.side_effect = MockFunctionCallError("niTClk_ConfigureForHomogeneousTriggers_cfunc")
        mock_library.niTClk_ConfigureForHomogeneousTriggers_cfunc.return_value = 0
        mock_library.niTClk_FinishSyncPulseSenderSynchronize_cfunc.side_effect = MockFunctionCallError("niTClk_FinishSyncPulseSenderSynchronize_cfunc")
        mock_library.niTClk_FinishSyncPulseSenderSynchronize_cfunc.return_value = 0
        mock_library.niTClk_GetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niTClk_GetAttributeViReal64_cfunc")
        mock_library.niTClk_GetAttributeViReal64_cfunc.return_value = 0
        mock_library.niTClk_GetAttributeViSession_cfunc.side_effect = MockFunctionCallError("niTClk_GetAttributeViSession_cfunc")
        mock_library.niTClk_GetAttributeViSession_cfunc.return_value = 0
        mock_library.niTClk_GetAttributeViString_cfunc.side_effect = MockFunctionCallError("niTClk_GetAttributeViString_cfunc")
        mock_library.niTClk_GetAttributeViString_cfunc.return_value = 0
        mock_library.niTClk_GetExtendedErrorInfo_cfunc.side_effect = MockFunctionCallError("niTClk_GetExtendedErrorInfo_cfunc")
        mock_library.niTClk_GetExtendedErrorInfo_cfunc.return_value = 0
        mock_library.niTClk_Initiate_cfunc.side_effect = MockFunctionCallError("niTClk_Initiate_cfunc")
        mock_library.niTClk_Initiate_cfunc.return_value = 0
        mock_library.niTClk_IsDone_cfunc.side_effect = MockFunctionCallError("niTClk_IsDone_cfunc")
        mock_library.niTClk_IsDone_cfunc.return_value = 0
        mock_library.niTClk_SetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niTClk_SetAttributeViReal64_cfunc")
        mock_library.niTClk_SetAttributeViReal64_cfunc.return_value = 0
        mock_library.niTClk_SetAttributeViSession_cfunc.side_effect = MockFunctionCallError("niTClk_SetAttributeViSession_cfunc")
        mock_library.niTClk_SetAttributeViSession_cfunc.return_value = 0
        mock_library.niTClk_SetAttributeViString_cfunc.side_effect = MockFunctionCallError("niTClk_SetAttributeViString_cfunc")
        mock_library.niTClk_SetAttributeViString_cfunc.return_value = 0
        mock_library.niTClk_SetupForSyncPulseSenderSynchronize_cfunc.side_effect = MockFunctionCallError("niTClk_SetupForSyncPulseSenderSynchronize_cfunc")
        mock_library.niTClk_SetupForSyncPulseSenderSynchronize_cfunc.return_value = 0
        mock_library.niTClk_Synchronize_cfunc.side_effect = MockFunctionCallError("niTClk_Synchronize_cfunc")
        mock_library.niTClk_Synchronize_cfunc.return_value = 0
        mock_library.niTClk_SynchronizeToSyncPulseSender_cfunc.side_effect = MockFunctionCallError("niTClk_SynchronizeToSyncPulseSender_cfunc")
        mock_library.niTClk_SynchronizeToSyncPulseSender_cfunc.return_value = 0
        mock_library.niTClk_WaitUntilDone_cfunc.side_effect = MockFunctionCallError("niTClk_WaitUntilDone_cfunc")
        mock_library.niTClk_WaitUntilDone_cfunc.return_value = 0
