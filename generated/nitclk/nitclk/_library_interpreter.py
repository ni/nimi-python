...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def configure_for_homogeneous_triggers(self, session_handle, encoding, sessions):  # noqa: N802
        ...
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
    ...
    def finish_sync_pulse_sender_synchronize(self, session_handle, encoding, sessions, min_time):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
    ...
    def get_attribute_vi_real64(self, session_handle, encoding, channel_name, attribute_id):  # noqa: N802
        session_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_attribute_vi_session(self, session_handle, encoding, channel_name, attribute_id):  # noqa: N802
        session_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_extended_error_info(self, session_handle, encoding):  # noqa: N802
        ...
        return error_string_ctype.value.decode(encoding)

    def initiate(self, session_handle, encoding, sessions):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
    ...
    def is_done(self, session_handle, encoding, sessions):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
    ...
    def set_attribute_vi_real64(self, session_handle, encoding, channel_name, attribute_id, value):  # noqa: N802
        session_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_session(self, session_handle, encoding, channel_name, attribute_id, value):  # noqa: N802
        session_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_attribute_vi_string(self, session_handle, encoding, channel_name, attribute_id, value):  # noqa: N802
        session_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def setup_for_sync_pulse_sender_synchronize(self, session_handle, encoding, sessions, min_time):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
        min_time_ctype = _converters.convert_timedelta_to_seconds_real64(min_time)  # case S140
    ...
    def synchronize(self, session_handle, encoding, sessions, min_tclk_period):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
    ...
    def synchronize_to_sync_pulse_sender(self, session_handle, encoding, sessions, min_time):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
        min_time_ctype = _converters.convert_timedelta_to_seconds_real64(min_time)  # case S140
    ...
    def wait_until_done(self, session_handle, encoding, sessions, timeout):  # noqa: N802
        session_count_ctype = _visatype.ViUInt32(0 if sessions is None else len(sessions))  # case S160
        sessions_converted = _converters.convert_to_nitclk_session_number_list(sessions)  # case B520
        sessions_ctype = _get_ctypes_pointer_for_buffer(value=sessions_converted, library_type=_visatype.ViSession)  # case B520
