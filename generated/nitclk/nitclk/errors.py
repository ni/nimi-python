...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        super(DriverNotInstalledError, self).__init__(
            "The NI-TClk runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it."
        )
...
class DriverTooOldError(Error):
    ...
    def __init__(self):
        super(DriverTooOldError, self).__init__(
            "A function was not found in the NI-TClk runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it."
        )
