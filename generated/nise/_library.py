    ...
    def niSE_CloseSession(self, session_handle):  # noqa: N802
        with self._func_lock:
            if self.niSE_CloseSession_cfunc is None:
                ...
                self.niSE_CloseSession_cfunc.argtypes = [NISESession]  # noqa: F405
                self.niSE_CloseSession_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_Connect(self, session_handle, connect_spec, multiconnect_mode, wait_for_debounce):  # noqa: N802
        with self._func_lock:
            if self.niSE_Connect_cfunc is None:
                ...
                self.niSE_Connect_cfunc.argtypes = [NISESession, NISEConstString, NISEInt32, NISEBoolean]  # noqa: F405
                self.niSE_Connect_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_ConnectAndDisconnect(self, session_handle, connect_spec, disconnect_spec, multiconnect_mode, operation_order, wait_for_debounce):  # noqa: N802
        with self._func_lock:
            if self.niSE_ConnectAndDisconnect_cfunc is None:
                ...
                self.niSE_ConnectAndDisconnect_cfunc.argtypes = [NISESession, NISEConstString, NISEConstString, NISEInt32, NISEInt32, NISEBoolean]  # noqa: F405
                self.niSE_ConnectAndDisconnect_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_Disconnect(self, session_handle, disconnect_spec):  # noqa: N802
        with self._func_lock:
            if self.niSE_Disconnect_cfunc is None:
                ...
                self.niSE_Disconnect_cfunc.argtypes = [NISESession, NISEConstString]  # noqa: F405
                self.niSE_Disconnect_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_DisconnectAll(self, session_handle):  # noqa: N802
        with self._func_lock:
            if self.niSE_DisconnectAll_cfunc is None:
                ...
                self.niSE_DisconnectAll_cfunc.argtypes = [NISESession]  # noqa: F405
                self.niSE_DisconnectAll_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_ExpandRouteSpec(self, session_handle, route_spec, expand_action, expanded_route_spec, expanded_route_spec_size):  # noqa: N802
        with self._func_lock:
            if self.niSE_ExpandRouteSpec_cfunc is None:
                ...
                self.niSE_ExpandRouteSpec_cfunc.argtypes = [NISESession, NISEConstString, NISEInt32, ctypes.POINTER(NISEBuffer), ctypes.POINTER(NISEInt32)]  # noqa: F405
                self.niSE_ExpandRouteSpec_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_FindRoute(self, session_handle, channel1, channel2, route_spec, route_spec_size, path_capability):  # noqa: N802
        with self._func_lock:
            if self.niSE_FindRoute_cfunc is None:
                ...
                self.niSE_FindRoute_cfunc.argtypes = [NISESession, NISEConstString, NISEConstString, ctypes.POINTER(NISEBuffer), ctypes.POINTER(NISEInt32), ctypes.POINTER(NISEInt32)]  # noqa: F405
                self.niSE_FindRoute_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_GetAllConnections(self, session_handle, route_spec, route_spec_size):  # noqa: N802
        with self._func_lock:
            if self.niSE_GetAllConnections_cfunc is None:
                ...
                self.niSE_GetAllConnections_cfunc.argtypes = [NISESession, ctypes.POINTER(NISEBuffer), ctypes.POINTER(NISEInt32)]  # noqa: F405
                self.niSE_GetAllConnections_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_GetError(self, session_handle, error_number, error_description, error_description_size):  # noqa: N802
        with self._func_lock:
            if self.niSE_GetError_cfunc is None:
                ...
                self.niSE_GetError_cfunc.argtypes = [NISESession, ctypes.POINTER(NISEInt32), ctypes.POINTER(NISEBuffer), ctypes.POINTER(NISEInt32)]  # noqa: F405
                self.niSE_GetError_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_GetIviDeviceSession(self, session_handle, ivi_logical_name, ivi_session_handle):  # noqa: N802
        with self._func_lock:
            if self.niSE_GetIviDeviceSession_cfunc is None:
                ...
                self.niSE_GetIviDeviceSession_cfunc.argtypes = [NISESession, NISEConstString, ctypes.POINTER(ViSession)]  # noqa: F405
                self.niSE_GetIviDeviceSession_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_IsConnected(self, session_handle, route_spec, is_connected):  # noqa: N802
        with self._func_lock:
            if self.niSE_IsConnected_cfunc is None:
                ...
                self.niSE_IsConnected_cfunc.argtypes = [NISESession, NISEConstString, ctypes.POINTER(NISEBoolean)]  # noqa: F405
                self.niSE_IsConnected_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_IsDebounced(self, session_handle, is_debounced):  # noqa: N802
        with self._func_lock:
            if self.niSE_IsDebounced_cfunc is None:
                ...
                self.niSE_IsDebounced_cfunc.argtypes = [NISESession, ctypes.POINTER(NISEBoolean)]  # noqa: F405
                self.niSE_IsDebounced_cfunc.restype = NISEStatus  # noqa: F405
    ...
    def niSE_OpenSession(self, virtual_device_name, option_string, session_handle):  # noqa: N802
        with self._func_lock:
            if self.niSE_OpenSession_cfunc is None:
                ...
                self.niSE_OpenSession_cfunc.argtypes = [NISEConstString, NISEConstString, ctypes.POINTER(NISESession)]  # noqa: F405
    ...
    def niSE_WaitForDebounce(self, session_handle, maximum_time_ms):  # noqa: N802
        with self._func_lock:
            if self.niSE_WaitForDebounce_cfunc is None:
                ...
                self.niSE_WaitForDebounce_cfunc.argtypes = [NISESession, NISEInt32]  # noqa: F405
                self.niSE_WaitForDebounce_cfunc.restype = NISEStatus  # noqa: F405
