...
def get_diagnostic_information():
    ...
    if platform.system() == 'Windows':
        ...
        os_name = 'Windows'
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\NI Switch Executive\CurrentVersion")
    ...
    info['module']['version'] = "0.9.0.dev0"
