...
Additional examples for NI Switch Executive are located in src/nise/examples/ directory `on GitHub <https://github.com/ni/nimi-python/tree/master/src/nise/examples>`_.
