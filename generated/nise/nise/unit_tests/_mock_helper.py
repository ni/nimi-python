...
class SideEffectsHelper(object):
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niSE_CloseSession_cfunc.side_effect = MockFunctionCallError("niSE_CloseSession_cfunc")
        mock_library.niSE_CloseSession_cfunc.return_value = 0
        mock_library.niSE_Connect_cfunc.side_effect = MockFunctionCallError("niSE_Connect_cfunc")
        mock_library.niSE_Connect_cfunc.return_value = 0
        mock_library.niSE_ConnectAndDisconnect_cfunc.side_effect = MockFunctionCallError("niSE_ConnectAndDisconnect_cfunc")
        mock_library.niSE_ConnectAndDisconnect_cfunc.return_value = 0
        mock_library.niSE_Disconnect_cfunc.side_effect = MockFunctionCallError("niSE_Disconnect_cfunc")
        mock_library.niSE_Disconnect_cfunc.return_value = 0
        mock_library.niSE_DisconnectAll_cfunc.side_effect = MockFunctionCallError("niSE_DisconnectAll_cfunc")
        mock_library.niSE_DisconnectAll_cfunc.return_value = 0
        mock_library.niSE_ExpandRouteSpec_cfunc.side_effect = MockFunctionCallError("niSE_ExpandRouteSpec_cfunc")
        mock_library.niSE_ExpandRouteSpec_cfunc.return_value = 0
        mock_library.niSE_FindRoute_cfunc.side_effect = MockFunctionCallError("niSE_FindRoute_cfunc")
        mock_library.niSE_FindRoute_cfunc.return_value = 0
        mock_library.niSE_GetAllConnections_cfunc.side_effect = MockFunctionCallError("niSE_GetAllConnections_cfunc")
        mock_library.niSE_GetAllConnections_cfunc.return_value = 0
        mock_library.niSE_GetError_cfunc.side_effect = MockFunctionCallError("niSE_GetError_cfunc")
        mock_library.niSE_GetError_cfunc.return_value = 0
        mock_library.niSE_IsConnected_cfunc.side_effect = MockFunctionCallError("niSE_IsConnected_cfunc")
        mock_library.niSE_IsConnected_cfunc.return_value = 0
        mock_library.niSE_IsDebounced_cfunc.side_effect = MockFunctionCallError("niSE_IsDebounced_cfunc")
        mock_library.niSE_IsDebounced_cfunc.return_value = 0
        mock_library.niSE_OpenSession_cfunc.side_effect = MockFunctionCallError("niSE_OpenSession_cfunc")
        mock_library.niSE_OpenSession_cfunc.return_value = 0
        mock_library.niSE_WaitForDebounce_cfunc.side_effect = MockFunctionCallError("niSE_WaitForDebounce_cfunc")
        mock_library.niSE_WaitForDebounce_cfunc.return_value = 0
