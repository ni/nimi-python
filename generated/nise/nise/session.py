...
class Session(_SessionBase):
    ...
    def __init__(self, virtual_device_name, options={}):
        ...
        # And then once _open_session succeeds, we can update _vi
    ...
    def _close_session(self):
        ...
        virtual device again until you call __init__.
        '''
        return self._library_interpreter.close_session(self._vi, self._encoding)
    ...
    def connect(self, connect_spec, multiconnect_mode=enums.MulticonnectMode.DEFAULT, wait_for_debounce=True):
        ...
        return self._library_interpreter.connect(self._vi, self._encoding, connect_spec, multiconnect_mode, wait_for_debounce)
    ...
    def connect_and_disconnect(self, connect_spec, disconnect_spec, multiconnect_mode=enums.MulticonnectMode.DEFAULT, operation_order=enums.OperationOrder.AFTER, wait_for_debounce=True):
        ...
        return self._library_interpreter.connect_and_disconnect(self._vi, self._encoding, connect_spec, disconnect_spec, multiconnect_mode, operation_order, wait_for_debounce)
    ...
    def disconnect(self, disconnect_spec):
        ...
        '''
        return self._library_interpreter.disconnect(self._vi, self._encoding, disconnect_spec)
    ...
    def expand_route_spec(self, route_spec, expand_action=enums.ExpandAction.ROUTES, expanded_route_spec_size=[1024]):
        ...
        return self._library_interpreter.expand_route_spec(self._vi, self._encoding, route_spec, expand_action, expanded_route_spec_size)
    ...
    def find_route(self, channel1, channel2, route_spec_size=[1024]):
        ...
        '''
        return self._library_interpreter.find_route(self._vi, self._encoding, channel1, channel2, route_spec_size)
    ...
    def get_all_connections(self, route_spec_size=[1024]):
        ...
        '''
        return self._library_interpreter.get_all_connections(self._vi, self._encoding, route_spec_size)
    ...
    def is_connected(self, route_spec):
        ...
        '''
        return self._library_interpreter.is_connected(self._vi, self._encoding, route_spec)
    ...
    def is_debounced(self):
        ...
        '''
        return self._library_interpreter.is_debounced(self._vi, self._encoding)
    ...
    def _open_session(self, virtual_device_name, option_string=""):
        ...
        '''
        return self._library_interpreter.open_session(self._vi, self._encoding, virtual_device_name, option_string)
