    ...
    def niRFSG_GetDeembeddingSparameters(self, vi, sparameters, number_of_sparameters, number_of_ports):  # noqa: N802
        with self._func_lock:
            if self.niRFSG_GetDeembeddingSparameters_cfunc is None:
                ...
                self.niRFSG_GetDeembeddingSparameters_cfunc.argtypes = [ViSession, ctypes.POINTER(NIComplexNumber), ctypes.POINTER(ViInt32), ctypes.POINTER(ViInt32)]  # noqa: F405
                self.niRFSG_GetDeembeddingSparameters_cfunc.restype = ViStatus  # noqa: F405
        return self.niRFSG_GetDeembeddingSparameters_cfunc(vi, sparameters, number_of_sparameters, number_of_ports)
