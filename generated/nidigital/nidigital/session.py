...
class Session(_SessionBase):
    ...
    def __init__(self, resource_name, id_query=False, reset_device=False, options={}, *, grpc_options=None):
        ...
        Args:
            ...
            driver_warning_event (nidigital.DriverWarningEvent): Driver warning event which can be subscribed to, with a callback method.
                Sample callback method:

                def sample_callback_method(driver_warning: nidigital.DriverWarning):
