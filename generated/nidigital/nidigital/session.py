...
class _SessionBase(object):
    ...
    """
    conditional_jump_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerType, 1150033
    )
    ...
    """
    cycle_number_history_ram_trigger_cycle_number = _attributes.AttributeViInt64(
        1150044
    )
    """Type: int
    ...
    """
    digital_edge_conditional_jump_trigger_edge = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.DigitalEdge, 1150035
    )
    ...
    """
    digital_edge_conditional_jump_trigger_source = _attributes.AttributeViString(
        1150034
    )
    """Type: str
    ...
    """
    digital_edge_rio_trigger_edge = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.DigitalEdge, 1150088
    )
    """Type: enums.DigitalEdge
    ...
    """
    digital_edge_start_trigger_edge = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.DigitalEdge, 1150031
    )
    """Type: enums.DigitalEdge
    ...
    """
    exported_conditional_jump_trigger_output_terminal = _attributes.AttributeViString(
        1150036
    )
    """Type: str
    ...
    """
    exported_pattern_opcode_event_output_terminal = _attributes.AttributeViString(
        1150041
    )
    """Type: str
    ...
    """
    frequency_counter_measurement_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.FrequencyMeasurementMode, 1150084
    )
    ...
    +-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    """
    frequency_counter_measurement_time = _attributes.AttributeViReal64TimeDeltaSeconds(
        1150069
    )
    ...
    +---------------+
    """
    history_ram_cycles_to_acquire = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.HistoryRAMCyclesToAcquire, 1150047
    )
    ...
    """
    history_ram_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.HistoryRAMTriggerType, 1150043
    )
    ...
    """
    pattern_label_history_ram_trigger_cycle_offset = _attributes.AttributeViInt64(
        1150045
    )
    """Type: int
    ...
    """
    pattern_label_history_ram_trigger_vector_offset = _attributes.AttributeViInt64(
        1150052
    )
    """Type: int
    ...
    """
    ppmu_aperture_time_units = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.PPMUApertureTimeUnits, 1150038
    )
    ...
    """
    ppmu_current_limit_behavior = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.PPMUCurrentLimitBehavior, 1150064
    )
    ...
    """
    ppmu_output_function = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.PPMUOutputFunction, 1150015
    )
    ...
    """
    rio_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerType, 1150086
    )
    """Type: enums.TriggerType
    ...
    """
    selected_function = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.SelectedFunction, 1150004
    )
    ...
    start_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerType, 1150029
    )
    """Type: enums.TriggerType
    ...
    """
    tdr_endpoint_termination = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TDREndpointTermination, 1150081
    )
    ...
    """
    termination_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TerminationMode, 1150006
    )
    ...
    def __init__(
        ...
        self.pattern_opcode_events = _RepeatedCapabilities(
            self, "patternOpcodeEvent", repeated_capability_list
        )
        self.conditional_jump_triggers = _RepeatedCapabilities(
            self, "conditionalJumpTrigger", repeated_capability_list
        )
        self.sites = _RepeatedCapabilities(self, "site", repeated_capability_list)
        self.rio_events = _RepeatedCapabilities(
            self, "RIOEvent", repeated_capability_list
        )
        self.rio_triggers = _RepeatedCapabilities(
    ...
    def __repr__(self):
        return "{0}.{1}({2})".format(
            "nidigital", self.__class__.__name__, self._param_list
        )
    ...
    def apply_levels_and_timing(
        ...
        site_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        levels_sheet_ctype = ctypes.create_string_buffer(
            levels_sheet.encode(self._encoding)
        )  # case C020
        timing_sheet_ctype = ctypes.create_string_buffer(
            timing_sheet.encode(self._encoding)
        )  # case C020
        initial_state_high_pins_ctype = ctypes.create_string_buffer(
            _converters.convert_repeated_capabilities_without_prefix(
                initial_state_high_pins
            ).encode(self._encoding)
        )  # case C040
        initial_state_low_pins_ctype = ctypes.create_string_buffer(
            _converters.convert_repeated_capabilities_without_prefix(
                initial_state_low_pins
            ).encode(self._encoding)
        )  # case C040
        initial_state_tristate_pins_ctype = ctypes.create_string_buffer(
            _converters.convert_repeated_capabilities_without_prefix(
                initial_state_tristate_pins
            ).encode(self._encoding)
        )  # case C040
        error_code = self._library.niDigital_ApplyLevelsAndTiming(
            vi_ctype,
            site_list_ctype,
            levels_sheet_ctype,
            timing_sheet_ctype,
            initial_state_high_pins_ctype,
            initial_state_low_pins_ctype,
            initial_state_tristate_pins_ctype,
        )
        errors.handle_error(
    ...
    def apply_tdr_offsets(self, offsets):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        num_offsets_ctype = _visatype.ViInt32(
            0 if offsets is None else len(offsets)
        )  # case S160
        offsets_converted = _converters.convert_timedeltas_to_seconds_real64(
            offsets
        )  # case B520
        offsets_ctype = get_ctypes_pointer_for_buffer(
            value=offsets_converted, library_type=_visatype.ViReal64
        )  # case B520
        error_code = self._library.niDigital_ApplyTDROffsets(
            vi_ctype, channel_list_ctype, num_offsets_ctype, offsets_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _burst_pattern(
        ...
        start_label_ctype = ctypes.create_string_buffer(
            start_label.encode(self._encoding)
        )  # case C020
        select_digital_function_ctype = _visatype.ViBoolean(
        ...
        error_code = self._library.niDigital_BurstPattern(
            vi_ctype,
            site_list_ctype,
            start_label_ctype,
            select_digital_function_ctype,
            wait_until_done_ctype,
            timeout_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def clock_generator_abort(self):
        ...
        error_code = self._library.niDigital_ClockGenerator_Abort(
            vi_ctype, channel_list_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def clock_generator_generate_clock(self, frequency, select_digital_function=True):
        ...
        error_code = self._library.niDigital_ClockGenerator_GenerateClock(
    ...
    def configure_active_load_levels(self, iol, ioh, vcom):
        ...
        error_code = self._library.niDigital_ConfigureActiveLoadLevels(
            vi_ctype, channel_list_ctype, iol_ctype, ioh_ctype, vcom_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_pattern_burst_sites(self):
        ...
        error_code = self._library.niDigital_ConfigurePatternBurstSites(
            vi_ctype, site_list_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_compare_edges_strobe(self, time_set_name, strobe_edge):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(
            time_set_name.encode(self._encoding)
        )  # case C020
        strobe_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            strobe_edge
        )  # case S140
        error_code = self._library.niDigital_ConfigureTimeSetCompareEdgesStrobe(
            vi_ctype, pin_list_ctype, time_set_name_ctype, strobe_edge_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_compare_edges_strobe2x(
        self, time_set_name, strobe_edge, strobe2_edge
    ):
        ...
        strobe2_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            strobe2_edge
        )  # case S140
        error_code = self._library.niDigital_ConfigureTimeSetCompareEdgesStrobe2x(
            vi_ctype,
            pin_list_ctype,
            time_set_name_ctype,
            strobe_edge_ctype,
    ...
    @ivi_synchronized
    def configure_time_set_drive_edges(
        self,
        time_set_name,
        format,
        drive_on_edge,
        ...
        if type(format) is not enums.DriveFormat:
            raise TypeError(
                "Parameter format must be of type " + str(enums.DriveFormat)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        drive_on_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_on_edge
        )  # case S140
        drive_data_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_data_edge
        )  # case S140
        drive_return_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_return_edge
        )  # case S140
        drive_off_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_off_edge
        )  # case S140
        error_code = self._library.niDigital_ConfigureTimeSetDriveEdges(
            vi_ctype,
            pin_list_ctype,
            time_set_name_ctype,
            format_ctype,
            drive_on_edge_ctype,
            drive_data_edge_ctype,
            drive_return_edge_ctype,
            drive_off_edge_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_drive_edges2x(
        ...
        drive_data2_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_data2_edge
        )  # case S140
        drive_return2_edge_ctype = _converters.convert_timedelta_to_seconds_real64(
            drive_return2_edge
        )  # case S140
        error_code = self._library.niDigital_ConfigureTimeSetDriveEdges2x(
            vi_ctype,
            pin_list_ctype,
            time_set_name_ctype,
            format_ctype,
            ...
            drive_return_edge_ctype,
            drive_off_edge_ctype,
            drive_data2_edge_ctype,
            drive_return2_edge_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_drive_format(self, time_set_name, drive_format):
        ...
        if type(drive_format) is not enums.DriveFormat:
            raise TypeError(
                "Parameter drive_format must be of type " + str(enums.DriveFormat)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_ConfigureTimeSetDriveFormat(
            vi_ctype, pin_list_ctype, time_set_name_ctype, drive_format_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_edge(self, time_set_name, edge, time):
        ...
        if type(edge) is not enums.TimeSetEdgeType:
            raise TypeError(
                "Parameter edge must be of type " + str(enums.TimeSetEdgeType)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_ConfigureTimeSetEdge(
            vi_ctype, pin_list_ctype, time_set_name_ctype, edge_ctype, time_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_time_set_edge_multiplier(self, time_set_name, edge_multiplier):
        ...
        error_code = self._library.niDigital_ConfigureTimeSetEdgeMultiplier(
            vi_ctype, pin_list_ctype, time_set_name_ctype, edge_multiplier_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_voltage_levels(self, vil, vih, vol, voh, vterm):
        ...
        error_code = self._library.niDigital_ConfigureVoltageLevels(
            vi_ctype,
            channel_list_ctype,
            vil_ctype,
            vih_ctype,
    ...
    def create_capture_waveform_parallel(self, waveform_name):
        ...
        waveform_name_ctype = ctypes.create_string_buffer(
            waveform_name.encode(self._encoding)
        )  # case C020
        error_code = self._library.niDigital_CreateCaptureWaveformParallel(
            vi_ctype, pin_list_ctype, waveform_name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def create_capture_waveform_serial(self, waveform_name, sample_width, bit_order):
        ...
        if type(bit_order) is not enums.BitOrder:
            raise TypeError(
                "Parameter bit_order must be of type " + str(enums.BitOrder)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_CreateCaptureWaveformSerial(
            vi_ctype,
            pin_list_ctype,
            waveform_name_ctype,
            sample_width_ctype,
    ...
    def create_source_waveform_parallel(self, waveform_name, data_mapping):
        ...
        if type(data_mapping) is not enums.SourceDataMapping:
            raise TypeError(
                "Parameter data_mapping must be of type " + str(enums.SourceDataMapping)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_CreateSourceWaveformParallel(
            vi_ctype, pin_list_ctype, waveform_name_ctype, data_mapping_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def create_source_waveform_serial(
        self, waveform_name, data_mapping, sample_width, bit_order
    ):
        ...
        sample_width_ctype = _visatype.ViUInt32(sample_width)  # case S150
        bit_order_ctype = _visatype.ViInt32(bit_order.value)  # case S130
        error_code = self._library.niDigital_CreateSourceWaveformSerial(
            vi_ctype,
            pin_list_ctype,
            waveform_name_ctype,
            data_mapping_ctype,
    ...
    def fetch_capture_waveform(
        self, waveform_name, samples_to_read, timeout=hightime.timedelta(seconds=10.0)
    ):
        ...
        ) = self._fetch_capture_waveform(waveform_name, samples_to_read, timeout)

        # Get the site list
        site_list = self._get_site_results_site_numbers(
            enums._SiteResultType.CAPTURE_WAVEFORM
        )
    ...
    def _fetch_capture_waveform(self, waveform_name, samples_to_read, timeout):
        ...
        error_code = self._library.niDigital_FetchCaptureWaveformU32(
            vi_ctype,
            site_list_ctype,
            waveform_name_ctype,
            samples_to_read_ctype,
            timeout_ctype,
            data_buffer_size_ctype,
            data_ctype,
            None
            if actual_num_waveforms_ctype is None
            else (ctypes.pointer(actual_num_waveforms_ctype)),
            None
            if actual_samples_per_waveform_ctype is None
            else (ctypes.pointer(actual_samples_per_waveform_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        data_buffer_size_ctype = _visatype.ViInt32(
            actual_num_waveforms_ctype.value * actual_samples_per_waveform_ctype.value
        )  # case S200 (modified)
        data_size = (
            actual_num_waveforms_ctype.value * actual_samples_per_waveform_ctype.value
        )  # case B620 (modified)
        data_array = array.array("L", [0] * data_size)  # case B620
        data_ctype = get_ctypes_pointer_for_buffer(
            value=data_array, library_type=_visatype.ViUInt32
        )  # case B620
        error_code = self._library.niDigital_FetchCaptureWaveformU32(
            vi_ctype,
            site_list_ctype,
    ...
    def fetch_history_ram_cycle_information(self, position, samples_to_read):
        ...
        pins = (
            "" if len(repeated_capability_lists) == 1 else repeated_capability_lists[1]
        )
        ...
        if position > samples_available:
            raise ValueError(
                "position: Specified value = {0}, Maximum value = {1}.".format(
                    position, samples_available - 1
                )
            )
        ...
        if position + samples_to_read > samples_available:
            raise ValueError(
                "position: Specified value = {0}, samples_to_read: Specified value = {1}; Samples available = {2}.".format(
                    position, samples_to_read, samples_available - position
                )
            )
        ...
        for _ in range(samples_to_read):
            ...
            (
                ...
                cycle_number,
                num_dut_cycles,
            ) = self._fetch_history_ram_cycle_information(position)
            ...
            for dut_cycle_index in range(num_dut_cycles):
                # site is passed as repeated capability
                (
                    cycle_expected_pin_states,
                    cycle_actual_pin_states,
                    cycle_per_pin_pass_fail,
                ) = self._fetch_history_ram_cycle_pin_data(
                    pins, position, dut_cycle_index
                )
            ...
            cycle_infos.append(
                history_ram_cycle_information.HistoryRAMCycleInformation(
    ...
    def get_pin_results_pin_information(self):
        ...
        PinInfo = collections.namedtuple(
            "PinInformation", ["pin_name", "site_number", "channel_name"]
        )
        ...
        (
            ...
            site_numbers,
            channel_indexes,
        ) = self._get_pin_results_pin_information()
        assert len(pin_indexes) == len(
            site_numbers
        ), "length of returned arrays don't match"
        assert len(pin_indexes) == len(
            channel_indexes
        ), "length of returned arrays don't match"
        ...
        for i in range(len(pin_indexes)):
            pin_name = (
                "" if pin_indexes[i] == -1 else self._get_pin_name(pin_indexes[i])
            )
            channel_names = self.get_channel_names(
                channel_indexes[i] - 1
            )  # channel_indexes are 1-based
            assert 1 == len(channel_names)
            pin_infos.append(
                PinInfo(
                    pin_name=pin_name,
                    site_number=site_numbers[i],
    ...
    def _fetch_history_ram_cycle_information(self, sample_index):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        site_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        ...
        error_code = self._library.niDigital_FetchHistoryRAMCycleInformation(
            vi_ctype,
            site_ctype,
            sample_index_ctype,
            None
            if pattern_index_ctype is None
            else (ctypes.pointer(pattern_index_ctype)),
            None
            if time_set_index_ctype is None
            else (ctypes.pointer(time_set_index_ctype)),
            None
            if vector_number_ctype is None
            else (ctypes.pointer(vector_number_ctype)),
            None
            if cycle_number_ctype is None
            else (ctypes.pointer(cycle_number_ctype)),
            None
            if num_dut_cycles_ctype is None
            else (ctypes.pointer(num_dut_cycles_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return (
            int(pattern_index_ctype.value),
            int(time_set_index_ctype.value),
            int(vector_number_ctype.value),
            int(cycle_number_ctype.value),
            int(num_dut_cycles_ctype.value),
        )

    @ivi_synchronized
    def _fetch_history_ram_cycle_pin_data(
        self, pin_list, sample_index, dut_cycle_index
    ):
        ...
        pin_list_ctype = ctypes.create_string_buffer(
            pin_list.encode(self._encoding)
        )  # case C020
        sample_index_ctype = _visatype.ViInt64(sample_index)  # case S150
        ...
        error_code = self._library.niDigital_FetchHistoryRAMCyclePinData(
            ...
            pin_list_ctype,
            sample_index_ctype,
            dut_cycle_index_ctype,
            pin_data_buffer_size_ctype,
            expected_pin_states_ctype,
            actual_pin_states_ctype,
            per_pin_pass_fail_ctype,
            None
            if actual_num_pin_data_ctype is None
            else (ctypes.pointer(actual_num_pin_data_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        pin_data_buffer_size_ctype = _visatype.ViInt32(
            actual_num_pin_data_ctype.value
        )  # case S200
        expected_pin_states_size = actual_num_pin_data_ctype.value  # case B620
        expected_pin_states_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViUInt8, size=expected_pin_states_size
        )  # case B620
        actual_pin_states_size = actual_num_pin_data_ctype.value  # case B620
        actual_pin_states_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViUInt8, size=actual_pin_states_size
        )  # case B620
        per_pin_pass_fail_size = actual_num_pin_data_ctype.value  # case B620
        per_pin_pass_fail_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViBoolean, size=per_pin_pass_fail_size
        )  # case B620
        error_code = self._library.niDigital_FetchHistoryRAMCyclePinData(
            vi_ctype,
            site_ctype,
        ...
        return (
            [
                enums.PinState(expected_pin_states_ctype[i])
                for i in range(pin_data_buffer_size_ctype.value)
            ],
            [
                enums.PinState(actual_pin_states_ctype[i])
                for i in range(pin_data_buffer_size_ctype.value)
            ],
            [
                bool(per_pin_pass_fail_ctype[i])
                for i in range(pin_data_buffer_size_ctype.value)
            ],
        )
    ...
    def _fetch_history_ram_scan_cycle_number(self, sample_index):
        ...
        error_code = self._library.niDigital_FetchHistoryRAMScanCycleNumber(
            vi_ctype,
            site_ctype,
            sample_index_ctype,
            None
            if scan_cycle_number_ctype is None
            else (ctypes.pointer(scan_cycle_number_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def frequency_counter_measure_frequency(self):
        ...
        error_code = self._library.niDigital_FrequencyCounter_MeasureFrequency(
            vi_ctype,
            channel_list_ctype,
            frequencies_buffer_size_ctype,
            frequencies_ctype,
            None
            if actual_num_frequencies_ctype is None
            else (ctypes.pointer(actual_num_frequencies_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        frequencies_buffer_size_ctype = _visatype.ViInt32(
            actual_num_frequencies_ctype.value
        )  # case S200
        frequencies_size = actual_num_frequencies_ctype.value  # case B620
        frequencies_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=frequencies_size
        )  # case B620
        error_code = self._library.niDigital_FrequencyCounter_MeasureFrequency(
            vi_ctype,
            channel_list_ctype,
        ...
        return [
            float(frequencies_ctype[i])
            for i in range(frequencies_buffer_size_ctype.value)
        ]
    ...
    def _get_attribute_vi_boolean(self, attribute):
        ...
        error_code = self._library.niDigital_GetAttributeViBoolean(
            vi_ctype,
            channel_name_ctype,
            attribute_ctype,
    ...
    def _get_attribute_vi_int32(self, attribute):
        ...
        error_code = self._library.niDigital_GetAttributeViInt32(
            vi_ctype,
            channel_name_ctype,
            attribute_ctype,
            None if value_ctype is None else (ctypes.pointer(value_ctype)),
    ...
    def _get_attribute_vi_int64(self, attribute):
        ...
        error_code = self._library.niDigital_GetAttributeViInt64(
            vi_ctype,
            channel_name_ctype,
            attribute_ctype,
            None if value_ctype is None else (ctypes.pointer(value_ctype)),
    ...
    def _get_attribute_vi_real64(self, attribute):
        ...
        error_code = self._library.niDigital_GetAttributeViReal64(
            vi_ctype,
            channel_name_ctype,
            attribute_ctype,
            None if value_ctype is None else (ctypes.pointer(value_ctype)),
    ...
    def _get_attribute_vi_string(self, attribute):
        ...
        error_code = self._library.niDigital_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
            attribute_ctype,
            buffer_size_ctype,
    ...
    def get_channel_names(self, indices):
        ...
        error_code = self._library.niDigital_GetChannelNameFromString(
            vi_ctype, indices_ctype, name_buffer_size_ctype, names_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def _get_error(self):
        ...
        error_code = self._library.niDigital_GetError(
            vi_ctype,
            None if error_code_ctype is None else (ctypes.pointer(error_code_ctype)),
            error_description_buffer_size_ctype,
        ...
        error_description_ctype = (
            _visatype.ViChar * error_description_buffer_size_ctype.value
        )()  # case C060
        error_code = self._library.niDigital_GetError(
            vi_ctype,
            None if error_code_ctype is None else (ctypes.pointer(error_code_ctype)),
        ...
        return int(error_code_ctype.value), error_description_ctype.value.decode(
            self._encoding
        )
    ...
    def get_fail_count(self):
        ...
        error_code = self._library.niDigital_GetFailCount(
            vi_ctype,
            channel_list_ctype,
            buffer_size_ctype,
            failure_count_ctype,
            None
            if actual_num_read_ctype is None
            else (ctypes.pointer(actual_num_read_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        ...
        failure_count_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt64, size=failure_count_size
        )  # case B620
        error_code = self._library.niDigital_GetFailCount(
            vi_ctype,
            channel_list_ctype,
    ...
    def get_history_ram_sample_count(self):
        ...
        error_code = self._library.niDigital_GetHistoryRAMSampleCount(
            vi_ctype,
            site_ctype,
            None
            if sample_count_ctype is None
            else (ctypes.pointer(sample_count_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _get_pattern_name(self, pattern_index):
        ...
        error_code = self._library.niDigital_GetPatternName(
            vi_ctype, pattern_index_ctype, name_buffer_size_ctype, name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def _get_pin_name(self, pin_index):
        ...
        name_buffer_size_ctype = _visatype.ViInt32()  # case S170
        name_ctype = None  # case C050
        error_code = self._library.niDigital_GetPinName(
            vi_ctype, pin_index_ctype, name_buffer_size_ctype, name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def _get_pin_results_pin_information(self):
        ...
        error_code = self._library.niDigital_GetPinResultsPinInformation(
            vi_ctype,
            channel_list_ctype,
            buffer_size_ctype,
            pin_indexes_ctype,
            site_numbers_ctype,
            channel_indexes_ctype,
            None
            if actual_num_values_ctype is None
            else (ctypes.pointer(actual_num_values_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        buffer_size_ctype = _visatype.ViInt32(
            actual_num_values_ctype.value
        )  # case S200
        pin_indexes_size = actual_num_values_ctype.value  # case B620
        pin_indexes_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt32, size=pin_indexes_size
        )  # case B620
        site_numbers_size = actual_num_values_ctype.value  # case B620
        site_numbers_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt32, size=site_numbers_size
        )  # case B620
        channel_indexes_size = actual_num_values_ctype.value  # case B620
        channel_indexes_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt32, size=channel_indexes_size
        )  # case B620
        error_code = self._library.niDigital_GetPinResultsPinInformation(
            vi_ctype,
            channel_list_ctype,
        ...
        return (
            [int(pin_indexes_ctype[i]) for i in range(buffer_size_ctype.value)],
            [int(site_numbers_ctype[i]) for i in range(buffer_size_ctype.value)],
            [int(channel_indexes_ctype[i]) for i in range(buffer_size_ctype.value)],
        )
    ...
    def _get_site_pass_fail(self):
        ...
        error_code = self._library.niDigital_GetSitePassFail(
            vi_ctype,
            site_list_ctype,
            pass_fail_buffer_size_ctype,
            pass_fail_ctype,
            None
            if actual_num_sites_ctype is None
            else (ctypes.pointer(actual_num_sites_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        pass_fail_buffer_size_ctype = _visatype.ViInt32(
            actual_num_sites_ctype.value
        )  # case S200
        pass_fail_size = actual_num_sites_ctype.value  # case B620
        pass_fail_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViBoolean, size=pass_fail_size
        )  # case B620
        error_code = self._library.niDigital_GetSitePassFail(
            vi_ctype,
            site_list_ctype,
        ...
        return [
            bool(pass_fail_ctype[i]) for i in range(pass_fail_buffer_size_ctype.value)
        ]
    ...
    def _get_site_results_site_numbers(self, site_result_type):
        ...
        if type(site_result_type) is not enums._SiteResultType:
            raise TypeError(
                "Parameter site_result_type must be of type "
                + str(enums._SiteResultType)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        site_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_GetSiteResultsSiteNumbers(
            vi_ctype,
            site_list_ctype,
            site_result_type_ctype,
            site_numbers_buffer_size_ctype,
            site_numbers_ctype,
            None
            if actual_num_site_numbers_ctype is None
            else (ctypes.pointer(actual_num_site_numbers_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        site_numbers_buffer_size_ctype = _visatype.ViInt32(
            actual_num_site_numbers_ctype.value
        )  # case S200
        ...
        return [
            int(site_numbers_ctype[i])
            for i in range(site_numbers_buffer_size_ctype.value)
        ]
    ...
    def get_time_set_drive_format(self, time_set_name):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        pin_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(
            time_set_name.encode(self._encoding)
        ...
        error_code = self._library.niDigital_GetTimeSetDriveFormat(
            vi_ctype,
            pin_ctype,
            time_set_name_ctype,
            None if format_ctype is None else (ctypes.pointer(format_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_time_set_edge(self, time_set_name, edge):
        ...
        error_code = self._library.niDigital_GetTimeSetEdge(
            vi_ctype,
            pin_ctype,
            time_set_name_ctype,
            edge_ctype,
            None if time_ctype is None else (ctypes.pointer(time_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_time_set_edge_multiplier(self, time_set_name):
        ...
        error_code = self._library.niDigital_GetTimeSetEdgeMultiplier(
            vi_ctype,
            pin_ctype,
            time_set_name_ctype,
            None
            if edge_multiplier_ctype is None
            else (ctypes.pointer(edge_multiplier_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _get_time_set_name(self, time_set_index):
        ...
        name_buffer_size_ctype = _visatype.ViInt32()  # case S170
        name_ctype = None  # case C050
        error_code = self._library.niDigital_GetTimeSetName(
            vi_ctype, time_set_index_ctype, name_buffer_size_ctype, name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def is_site_enabled(self):
        ...
        error_code = self._library.niDigital_IsSiteEnabled(
            vi_ctype,
            site_ctype,
            None if enable_ctype is None else (ctypes.pointer(enable_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def ppmu_measure(self, measurement_type):
        ...
        actual_num_read_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDigital_PPMU_Measure(
            vi_ctype,
            channel_list_ctype,
        ...
        measurements_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=measurements_size
        )  # case B620
        error_code = self._library.niDigital_PPMU_Measure(
            vi_ctype,
            channel_list_ctype,
    ...
    def read_static(self):
        ...
        data_ctype = None  # case B610
        actual_num_read_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDigital_ReadStatic(
            vi_ctype,
            channel_list_ctype,
            buffer_size_ctype,
            data_ctype,
        ...
        data_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViUInt8, size=data_size
        )  # case B620
        error_code = self._library.niDigital_ReadStatic(
            vi_ctype,
            channel_list_ctype,
    ...
    def _set_attribute_vi_boolean(self, attribute, value):
        ...
        error_code = self._library.niDigital_SetAttributeViBoolean(
            vi_ctype, channel_name_ctype, attribute_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _set_attribute_vi_int32(self, attribute, value):
        ...
        error_code = self._library.niDigital_SetAttributeViInt32(
            vi_ctype, channel_name_ctype, attribute_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_int64(self, attribute, value):
        ...
        error_code = self._library.niDigital_SetAttributeViInt64(
            vi_ctype, channel_name_ctype, attribute_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_real64(self, attribute, value):
        ...
        error_code = self._library.niDigital_SetAttributeViReal64(
            vi_ctype, channel_name_ctype, attribute_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_string(self, attribute, value):
        ...
        error_code = self._library.niDigital_SetAttributeViString(
            vi_ctype, channel_name_ctype, attribute_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def tdr(self, apply_offsets=True):
        ...
        error_code = self._library.niDigital_TDR(
            vi_ctype,
            channel_list_ctype,
            apply_offsets_ctype,
            offsets_buffer_size_ctype,
            offsets_ctype,
            None
            if actual_num_offsets_ctype is None
            else (ctypes.pointer(actual_num_offsets_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        offsets_buffer_size_ctype = _visatype.ViInt32(
            actual_num_offsets_ctype.value
        )  # case S200
        offsets_size = actual_num_offsets_ctype.value  # case B620
        offsets_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViReal64, size=offsets_size
        )  # case B620
        error_code = self._library.niDigital_TDR(
            vi_ctype,
            channel_list_ctype,
        ...
        return _converters.convert_seconds_real64_to_timedeltas(
            [float(offsets_ctype[i]) for i in range(offsets_buffer_size_ctype.value)]
        )
    ...
    @ivi_synchronized
    def _write_source_waveform_site_unique_u32(
        self, waveform_name, num_waveforms, samples_per_waveform, waveform_data
    ):
        ...
        samples_per_waveform_ctype = _visatype.ViInt32(
            samples_per_waveform
        )  # case S150
        waveform_data_array = get_ctypes_and_array(
            value=waveform_data, array_type="L"
        )  # case B550
        waveform_data_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_data_array, library_type=_visatype.ViUInt32
        )  # case B550
        error_code = self._library.niDigital_WriteSourceWaveformSiteUniqueU32(
            vi_ctype,
            site_list_ctype,
            waveform_name_ctype,
            num_waveforms_ctype,
            samples_per_waveform_ctype,
            waveform_data_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def write_static(self, state):
        ...
        if type(state) is not enums.WriteStaticPinState:
            raise TypeError(
                "Parameter state must be of type " + str(enums.WriteStaticPinState)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niDigital_WriteStatic(
            vi_ctype, channel_list_ctype, state_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _error_message(self, error_code):
        ...
        error_code = self._library.niDigital_error_message(
...
class Session(_SessionBase):
    ...
    def __init__(self, resource_name, id_query=False, reset_device=False, options={}):
        ...
        self._vi = self._init_with_options(
            resource_name, id_query, reset_device, options
        )
    ...
    def configure_time_set_period(self, time_set_name, period):
        ...
        period_ctype = _converters.convert_timedelta_to_seconds_real64(
            period
        )  # case S140
        error_code = self._library.niDigital_ConfigureTimeSetPeriod(
            vi_ctype, time_set_name_ctype, period_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def create_capture_waveform_from_file_digicapture(
        self, waveform_name, waveform_file_path
    ):
        ...
        waveform_file_path_ctype = ctypes.create_string_buffer(
            waveform_file_path.encode(self._encoding)
        )  # case C020
        error_code = self._library.niDigital_CreateCaptureWaveformFromFileDigicapture(
            vi_ctype, waveform_name_ctype, waveform_file_path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def create_source_waveform_from_file_tdms(
        self, waveform_name, waveform_file_path, write_waveform_data=True
    ):
        ...
        write_waveform_data_ctype = _visatype.ViBoolean(
            write_waveform_data
        )  # case S150
        error_code = self._library.niDigital_CreateSourceWaveformFromFileTDMS(
            vi_ctype,
            waveform_name_ctype,
            waveform_file_path_ctype,
            write_waveform_data_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def create_time_set(self, name):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        name_ctype = ctypes.create_string_buffer(
            name.encode(self._encoding)
        )  # case C020
    ...
    @ivi_synchronized
    def load_specifications_levels_and_timing(
        self,
        specifications_file_paths=None,
        ...
        """
        self._call_method_with_iterable(
            self._load_specifications, specifications_file_paths
        )
    ...
    def write_source_waveform_site_unique(self, waveform_name, waveform_data):
        ...
        if not isinstance(waveform_data, Mapping):
            raise TypeError(
                "Expecting waveform_data to be a dictionary but got {}".format(
                    type(waveform_data)
                )
            )
        site_list = []
        ...
        data = array.array(
            "L", [0] * (len(waveform_data) * actual_samples_per_waveform)
        )
        mv = memoryview(data)
        ...
        for site in waveform_data:
            if len(waveform_data[site]) != actual_samples_per_waveform:
                raise ValueError(
                    "Mismatched length of waveforms. All must be the same length."
                )
            ...
            if str(type(waveform_data[site])).find("'numpy.ndarray'") != -1:
                ...
                if waveform_data[site].dtype == numpy.uint32:
                    ...
                    raise TypeError(
                        "Unsupported dtype for waveform_data array element type. Is {0}, expected {1}".format(
                            waveform_data[site].dtype, numpy.int32
                        )
                    )
                ...
                if waveform_data[site].typecode == "L":
                    ...
                    raise TypeError(
                        'Wrong waveform_data array element type. Must be unsigned 32 bit int ("L"), was {}'.format(
                            waveform_data[site].typecode
                        )
                    )
                ...
                raise TypeError(
                    "Unknown array type: {}".format(type(waveform_data[site]))
                )
        ...
        self.sites[site_list]._write_source_waveform_site_unique_u32(
            waveform_name, len(waveform_data), actual_samples_per_waveform, data
        )
    ...
    def get_pattern_pin_names(self, start_label):
        ...
        error_code = self._library.niDigital_GetPatternPinList(
            vi_ctype, start_label_ctype, pin_list_buffer_size_ctype, pin_list_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        ...
        pin_list_ctype = (
            _visatype.ViChar * pin_list_buffer_size_ctype.value
        )()  # case C060
        error_code = self._library.niDigital_GetPatternPinList(
            vi_ctype, start_label_ctype, pin_list_buffer_size_ctype, pin_list_ctype
        )
        ...
        return _converters.convert_comma_separated_string_to_list(
            pin_list_ctype.value.decode(self._encoding)
        )
    ...
    def get_time_set_period(self, time_set_name):
        ...
        error_code = self._library.niDigital_GetTimeSetPeriod(
            vi_ctype,
            time_set_name_ctype,
            None if period_ctype is None else (ctypes.pointer(period_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return _converters.convert_seconds_real64_to_timedelta(
            float(period_ctype.value)
        )

    def _init_with_options(
        self, resource_name, id_query=False, reset_device=False, option_string=""
    ):
        ...
        error_code = self._library.niDigital_InitWithOptions(
            resource_name_ctype,
            id_query_ctype,
            reset_device_ctype,
            option_string_ctype,
            None if new_vi_ctype is None else (ctypes.pointer(new_vi_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def is_done(self):
        ...
        error_code = self._library.niDigital_IsDone(
            vi_ctype, None if done_ctype is None else (ctypes.pointer(done_ctype))
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _load_specifications(self, file_path):
        ...
        error_code = self._library.niDigital_LoadSpecifications(
    ...
    def read_sequencer_flag(self, flag):
        ...
        if type(flag) is not enums.SequencerFlag:
            raise TypeError(
                "Parameter flag must be of type " + str(enums.SequencerFlag)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        flag_ctype = ctypes.create_string_buffer(
            flag.value.encode(self._encoding)
        )  # case C030
        value_ctype = _visatype.ViBoolean()  # case S220
        error_code = self._library.niDigital_ReadSequencerFlag(
            vi_ctype,
            flag_ctype,
            None if value_ctype is None else (ctypes.pointer(value_ctype)),
        )
    ...
    def read_sequencer_register(self, reg):
        ...
        if type(reg) is not enums.SequencerRegister:
            raise TypeError(
                "Parameter reg must be of type " + str(enums.SequencerRegister)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        reg_ctype = ctypes.create_string_buffer(
            reg.value.encode(self._encoding)
        )  # case C030
        value_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDigital_ReadSequencerRegister(
            vi_ctype,
            reg_ctype,
            None if value_ctype is None else (ctypes.pointer(value_ctype)),
        )
    ...
    def send_software_edge_trigger(self, trigger, trigger_identifier):
        ...
        if type(trigger) is not enums.SoftwareTrigger:
            raise TypeError(
                "Parameter trigger must be of type " + str(enums.SoftwareTrigger)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        trigger_ctype = _visatype.ViInt32(trigger.value)  # case S130
        trigger_identifier_ctype = ctypes.create_string_buffer(
            trigger_identifier.encode(self._encoding)
        )  # case C020
        error_code = self._library.niDigital_SendSoftwareEdgeTrigger(
            vi_ctype, trigger_ctype, trigger_identifier_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def unload_all_patterns(self, unload_keep_alive_pattern=False):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        unload_keep_alive_pattern_ctype = _visatype.ViBoolean(
            unload_keep_alive_pattern
        )  # case S150
        error_code = self._library.niDigital_UnloadAllPatterns(
            vi_ctype, unload_keep_alive_pattern_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _unload_specifications(self, file_path):
        ...
        error_code = self._library.niDigital_UnloadSpecifications(
            vi_ctype, file_path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def write_sequencer_flag(self, flag, value):
        ...
        value_ctype = _visatype.ViBoolean(value)  # case S150
        error_code = self._library.niDigital_WriteSequencerFlag(
            vi_ctype, flag_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def write_sequencer_register(self, reg, value):
        ...
        value_ctype = _visatype.ViInt32(value)  # case S150
        error_code = self._library.niDigital_WriteSequencerRegister(
            vi_ctype, reg_ctype, value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def write_source_waveform_broadcast(self, waveform_name, waveform_data):
        ...
        waveform_size_ctype = _visatype.ViInt32(
            0 if waveform_data is None else len(waveform_data)
        )  # case S160
        waveform_data_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_data, library_type=_visatype.ViUInt32
        )  # case B550
        error_code = self._library.niDigital_WriteSourceWaveformBroadcastU32(
            vi_ctype, waveform_name_ctype, waveform_size_ctype, waveform_data_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def write_source_waveform_data_from_file_tdms(
        ...
        error_code = self._library.niDigital_WriteSourceWaveformDataFromFileTDMS(
            vi_ctype, waveform_name_ctype, waveform_file_path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _self_test(self):
        ...
        error_code = self._library.niDigital_self_test(
            vi_ctype,
            None if test_result_ctype is None else (ctypes.pointer(test_result_ctype)),
            test_message_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return int(test_result_ctype.value), test_message_ctype.value.decode(
            self._encoding
        )
