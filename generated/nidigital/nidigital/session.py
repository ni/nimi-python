...
class Session(_SessionBase):
    ...
    def __init__(self, resource_name, id_query=False, reset_device=False, options={}):
        ...
        self.conditional_jump_trigger = _RepeatedCapabilities(self, 'conditionalJumpTrigger')
        self.pattern_opcode_event = _RepeatedCapabilities(self, 'patternOpcodeEvent')
