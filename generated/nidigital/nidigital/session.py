...
class _SessionBase(object):
    ...
    | Defined Values:            |                                                                               |
    +============================+===============================================================================+
    | DigitalEdge.RISING (1800)  | Asserts the trigger when the signal transitions from low level to high level. |
    +----------------------------+-------------------------------------------------------------------------------+
    | DigitalEdge.FALLING (1801) | Asserts the trigger when the signal transitions from high level to low level. |
    +----------------------------+-------------------------------------------------------------------------------+
    '''
    ...
    | Defined Values:                         |                                                                                   |
    +=========================================+===================================================================================+
    | HistoryRAMCyclesToAcquire.FAILED (2303) | Only acquires cycles that fail a compare after the triggering conditions are met. |
    +-----------------------------------------+-----------------------------------------------------------------------------------+
    | HistoryRAMCyclesToAcquire.ALL (2304)    | Acquires all cycles after the triggering conditions are met.                      |
    +-----------------------------------------+-----------------------------------------------------------------------------------+
    '''
    ...
    | Defined Values:                            |                                                                                                                                     |
    +============================================+=====================================================================================================================================+
    | HistoryRAMTriggerType.FIRST_FAILURE (2200) | Starts acquiring pattern information in History RAM on the first failed cycle in a pattern burst.                                   |
    +--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
    | HistoryRAMTriggerType.CYCLE_NUMBER (2201)  | Starts acquiring pattern information in History RAM starting from a specified cycle number.                                         |
    +--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
    | HistoryRAMTriggerType.PATTERN_LABEL (2202) | Starts acquiring pattern information in History RAM starting from a specified pattern label, augmented by vector and cycle offsets. |
    +--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
    '''
    ...
    | Defined Values:                      |                                         |
    +======================================+=========================================+
    | PPMUApertureTimeUnits.SECONDS (2100) | Specifies the aperture time in seconds. |
    +--------------------------------------+-----------------------------------------+
    ...
    | Defined Values:                          |                                                                                                                                         |
    +==========================================+=========================================================================================================================================+
    | PPMUCurrentLimitBehavior.REGULATE (3100) | Controls output current so that it does not exceed the current limit. Power continues to generate even if the current limit is reached. |
    +------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
    ...
    | Defined Values:                   |                                            |
    +===================================+============================================+
    | PPMUOutputFunction.VOLTAGE (1300) | Specifies the output method to DC Voltage. |
    +-----------------------------------+--------------------------------------------+
    | PPMUOutputFunction.CURRENT (1301) | Specifies the output method to DC Current. |
    +-----------------------------------+--------------------------------------------+
    ...
    | Defined Values:                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
    +====================================+============================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================+
    | SelectedFunction.DIGITAL (1100)    | The pin is connected to the driver, comparator, and active load methods. The PPMU is not sourcing, but can make voltage measurements. The state of the digital pin driver when you change the selected method to Digital is determined by the most recent call to the write_static method or the last vector of the most recently executed pattern burst, whichever happened last. Use the write_static method to control the state of the digital pin driver through software. Use the _burst_pattern method to control the state of the digital pin driver through a pattern. Set the **selectDigitalFunction** parameter of the _burst_pattern method to True to automatically switch the selected method of the pins in the pattern burst to SelectedFunction.DIGITAL. |
    +------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | SelectedFunction.PPMU (1101)       | The pin is connected to the PPMU. The driver, comparator, and active load are off while this method is selected. Call the ppmu_source method to source a voltage or current. The ppmu_source method automatically switches the selected method to the PPMU state and starts sourcing from the PPMU. Changing the selected method to SelectedFunction.DISCONNECT, SelectedFunction.OFF, or SelectedFunction.DIGITAL causes the PPMU to stop sourcing. If you change the selected method to PPMU using the SelectFunction method, the PPMU is initially not sourcing.                                                                                                                                                                                                        |
    +------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | SelectedFunction.OFF (1102)        | The pin is electrically connected, and the PPMU and digital pin driver are off while this method is selected.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
    +------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | SelectedFunction.DISCONNECT (1103) | The pin is electrically disconnected from instrument methods. Selecting this method causes the PPMU to stop sourcing prior to disconnecting the pin.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
    +------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

    Note: You can make PPMU voltage measurements using the ppmu_measure method from within any selected method.
    ...
    Specifies the Start trigger type. The digital pattern instrument waits for this trigger after you call the init method or the _burst_pattern method, and does not burst a pattern until this trigger is received.

    +---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | Defined Values:                 |                                                                                                                                                                                                                                                                                                        |
    +=================================+========================================================================================================================================================================================================================================================================================================+
    | TriggerType.NONE (1700)         | Disables the Start trigger. Pattern bursting starts immediately after you call the init method or the _burst_pattern method.                                                                                                                                                                           |
    +---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | TriggerType.DIGITAL_EDGE (1701) | Pattern bursting does not start until the digital pattern instrument detects a digital edge.                                                                                                                                                                                                           |
    +---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | TriggerType.SOFTWARE (1702)     | Pattern bursting does not start until the digital pattern instrument receives a software Start trigger. Create a software Start trigger by calling the send_software_edge_trigger method and selecting start trigger in the **trigger** parameter.Related information: SendSoftwareEdgeTrigger method. |
    +---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    ...
    def configure_time_set_drive_edges(self, time_set_name, format, drive_on_edge, drive_data_edge, drive_return_edge, drive_off_edge):
        ...
        Args:
            ...
            format (enums.DriveFormat): Drive format of the time set.
                ...
                -   DriveFormat.NR (1500): Non-return.
                -   DriveFormat.RL (1501): Return to low.
                -   DriveFormat.RH (1502): Return to high.
                -   DriveFormat.SBC (1503): Surround by complement.
    ...
    def configure_time_set_drive_format(self, time_set_name, drive_format):
        ...
        Configures the drive format for the pins not specified in the **pinList**. Use this method to modify time set values after applying a timing sheet with the apply_levels_and_timing method, or to create time sets programmatically without the use of timing sheets. This method does not modify the timing sheet file or the timing sheet contents that will be used in future calls to apply_levels_and_timing; it only affects the values of the current timing context.
    ...
    def configure_time_set_edge(self, time_set_name, edge, time):
        ...
        Args:
            ...
            edge (enums.TimeSetEdgeType): Name of the edge.
                ...
                -   TimeSetEdgeType.DRIVE_ON (2800)
                -   TimeSetEdgeType.DRIVE_DATA (2801)
    ...
    def create_capture_waveform_serial(self, waveform_name, sample_width, bit_order):
        ...
        Args:
            ...
            bit_order (enums.BitOrder): Order in which to shift the bits.
                ...
                -   BitOrder.MSB (2500): Specifies the bit order by most significant bit first.
                -   BitOrder.LSB (2501): Specifies the bit order by least significant bit first.
    ...
    def create_source_waveform_parallel(self, waveform_name, data_mapping):
        ...
        Args:
            ...
            data_mapping (enums.SourceDataMapping): Parameter that specifies how to map data on multiple sites.
                ...
                -   SourceDataMapping.BROADCAST (2600): Broadcasts the waveform you specify to all sites.
                -   SourceDataMapping.SITE_UNIQUE (2601): Sources unique waveform data to each site.
    ...
    def _fetch_history_ram_cycle_pin_data(self, pin_list, sample_index, dut_cycle_index):
        ...
        Returns:
            expected_pin_states (list of enums.PinState): The returned pin state as expected by the loaded pattern in the order specified in **pinList**. Pins without defined edges in the specified DUT cycle will return PinState.NOT_A_PIN_STATE (254).

            actual_pin_states (list of enums.PinState): The returned pin state acquired by History RAM in the order specified in **pinList**. Pins without defined edges in the specified DUT cycle will return PinState.NOT_A_PIN_STATE (254).
    ...
    def _get_site_results_site_numbers(self, site_result_type):
        ...
        Args:
            site_result_type (enums.SiteResultType): The type of data specified in the results array.
                ...
                -   _SiteResultType.PASS_FAIL (3300): Get site numbers for pass/fail data.
                -   _SiteResultType.CAPTURE_WAVEFORM (3301): Get site numbers for capture waveforms.
    ...
    def ppmu_measure(self, measurement_type):
        ...
        Args:
            measurement_type (enums.PPMUMeasurementType): Parameter that specifies whether the PPMU measures voltage or current from the DUT.
                ...
                -   PPMUMeasurementType.CURRENT (2400): The PPMU measures current from the DUT.
                -   PPMUMeasurementType.VOLTAGE (2401): The PPMU measures voltage from the DUT.
    ...
    def write_static(self, state):
        ...
        Args:
            state (enums.WriteStaticPinState): Parameter that specifies one of the following digital states to assign to the pin.
                ...
                -   WriteStaticPinState.ZERO (0): Specifies to drive low.
                -   WriteStaticPinState.ONE (1): Specifies to drive high.
                -   WriteStaticPinState.X (5): Specifies to not drive.
