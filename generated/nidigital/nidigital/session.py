...
class _SessionBase(object):
    ...
    def fetch_capture_waveform(self, waveform_name, samples_to_read, timeout):
        ...
        # Get the site list
        site_list = self.get_site_results_site_numbers(self._repeated_capability, enums.SiteResult.CAPTURE_WAVEFORM)
    ...
    @ivi_synchronized
    def fetch_history_ram_cycle_information(self, sample_index):
    ...
    @ivi_synchronized
    def fetch_history_ram_cycle_pin_data(self, pin_list, sample_index, dut_cycle_index):
    ...
    @ivi_synchronized
    def fetch_history_ram_scan_cycle_number(self, sample_index):
