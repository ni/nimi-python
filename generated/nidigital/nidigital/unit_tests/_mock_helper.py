...
class SideEffectsHelper(object):
    ...
    def niDigital_FetchHistoryRAMCycleInformation(
        ...
        if self._defaults["FetchHistoryRAMCycleInformation"]["patternIndex"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCycleInformation", param="patternIndex"
            )
        if pattern_index is not None:
            pattern_index.contents.value = self._defaults[
                "FetchHistoryRAMCycleInformation"
            ]["patternIndex"]
        # time_set_index
        if self._defaults["FetchHistoryRAMCycleInformation"]["timeSetIndex"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCycleInformation", param="timeSetIndex"
            )
        if time_set_index is not None:
            time_set_index.contents.value = self._defaults[
                "FetchHistoryRAMCycleInformation"
            ]["timeSetIndex"]
        # vector_number
        if self._defaults["FetchHistoryRAMCycleInformation"]["vectorNumber"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCycleInformation", param="vectorNumber"
            )
        if vector_number is not None:
            vector_number.contents.value = self._defaults[
                "FetchHistoryRAMCycleInformation"
            ]["vectorNumber"]
        # cycle_number
        if self._defaults["FetchHistoryRAMCycleInformation"]["cycleNumber"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCycleInformation", param="cycleNumber"
            )
        if cycle_number is not None:
            cycle_number.contents.value = self._defaults[
                "FetchHistoryRAMCycleInformation"
            ]["cycleNumber"]
        # num_dut_cycles
        if self._defaults["FetchHistoryRAMCycleInformation"]["numDutCycles"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCycleInformation", param="numDutCycles"
            )
        if num_dut_cycles is not None:
            num_dut_cycles.contents.value = self._defaults[
                "FetchHistoryRAMCycleInformation"
            ]["numDutCycles"]
        return self._defaults["FetchHistoryRAMCycleInformation"]["return"]
    ...
    def niDigital_FetchHistoryRAMCyclePinData(
        ...
        if self._defaults["FetchHistoryRAMCyclePinData"]["actualNumPinData"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCyclePinData", param="actualNumPinData"
            )
        if actual_num_pin_data is not None:
            actual_num_pin_data.contents.value = self._defaults[
                "FetchHistoryRAMCyclePinData"
            ]["actualNumPinData"]
        if self._defaults["FetchHistoryRAMCyclePinData"]["expectedPinStates"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCyclePinData", param="expectedPinStates"
            )
        if pin_data_buffer_size.value == 0:
            return len(
                self._defaults["FetchHistoryRAMCyclePinData"]["expectedPinStates"]
            )
        try:
        ...
        for i in range(
            len(self._defaults["FetchHistoryRAMCyclePinData"]["expectedPinStates"])
        ):
            expected_pin_states_ref[i] = self._defaults["FetchHistoryRAMCyclePinData"][
                "expectedPinStates"
            ][i]
        if self._defaults["FetchHistoryRAMCyclePinData"]["actualPinStates"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCyclePinData", param="actualPinStates"
            )
        if pin_data_buffer_size.value == 0:
        ...
        for i in range(
            len(self._defaults["FetchHistoryRAMCyclePinData"]["actualPinStates"])
        ):
            actual_pin_states_ref[i] = self._defaults["FetchHistoryRAMCyclePinData"][
                "actualPinStates"
            ][i]
        if self._defaults["FetchHistoryRAMCyclePinData"]["perPinPassFail"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMCyclePinData", param="perPinPassFail"
            )
        if pin_data_buffer_size.value == 0:
        ...
        for i in range(
            len(self._defaults["FetchHistoryRAMCyclePinData"]["perPinPassFail"])
        ):
            per_pin_pass_fail_ref[i] = self._defaults["FetchHistoryRAMCyclePinData"][
                "perPinPassFail"
            ][i]
        return self._defaults["FetchHistoryRAMCyclePinData"]["return"]
    ...
    def niDigital_FetchHistoryRAMScanCycleNumber(
        ...
        if self._defaults["FetchHistoryRAMScanCycleNumber"]["scanCycleNumber"] is None:
            raise MockFunctionCallError(
                "niDigital_FetchHistoryRAMScanCycleNumber", param="scanCycleNumber"
            )
        if scan_cycle_number is not None:
            scan_cycle_number.contents.value = self._defaults[
    ...
    def niDigital_FrequencyCounter_MeasureFrequency(
        ...
        # actual_num_frequencies
        if (
            self._defaults["FrequencyCounter_MeasureFrequency"]["actualNumFrequencies"]
            is None
        ):
            raise MockFunctionCallError(
                "niDigital_FrequencyCounter_MeasureFrequency",
                param="actualNumFrequencies",
            )
        if actual_num_frequencies is not None:
            actual_num_frequencies.contents.value = self._defaults[
                "FrequencyCounter_MeasureFrequency"
            ]["actualNumFrequencies"]
        if self._defaults["FrequencyCounter_MeasureFrequency"]["frequencies"] is None:
            raise MockFunctionCallError(
                "niDigital_FrequencyCounter_MeasureFrequency", param="frequencies"
            )
        if frequencies_buffer_size.value == 0:
            return len(
                self._defaults["FrequencyCounter_MeasureFrequency"]["frequencies"]
            )
        try:
        ...
        for i in range(
            len(self._defaults["FrequencyCounter_MeasureFrequency"]["frequencies"])
        ):
            frequencies_ref[i] = self._defaults["FrequencyCounter_MeasureFrequency"][
                "frequencies"
            ][i]
        return self._defaults["FrequencyCounter_MeasureFrequency"]["return"]
    ...
    def niDigital_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["value"] is None:
            raise MockFunctionCallError(
                "niDigital_GetAttributeViBoolean", param="value"
            )
    ...
    def niDigital_GetChannelNameFromString(
        ...
        if self._defaults["GetChannelNameFromString"]["names"] is None:
            raise MockFunctionCallError(
                "niDigital_GetChannelNameFromString", param="names"
            )
        if name_buffer_size.value == 0:
            return len(self._defaults["GetChannelNameFromString"]["names"])
        names.value = self._defaults["GetChannelNameFromString"]["names"].encode(
            "ascii"
        )
        return self._defaults["GetChannelNameFromString"]["return"]
    ...
    def niDigital_GetError(
        ...
        error_description.value = self._defaults["GetError"]["errorDescription"].encode(
            "ascii"
        )
        return self._defaults["GetError"]["return"]
    ...
    def niDigital_GetFailCount(
        ...
        if actual_num_read is not None:
            actual_num_read.contents.value = self._defaults["GetFailCount"][
                "actualNumRead"
            ]
    ...
    def niDigital_GetHistoryRAMSampleCount(self, vi, site, sample_count):  # noqa: N802
        ...
        if self._defaults["GetHistoryRAMSampleCount"]["sampleCount"] is None:
            raise MockFunctionCallError(
                "niDigital_GetHistoryRAMSampleCount", param="sampleCount"
            )
        if sample_count is not None:
            sample_count.contents.value = self._defaults["GetHistoryRAMSampleCount"][
                "sampleCount"
            ]
        return self._defaults["GetHistoryRAMSampleCount"]["return"]
    ...
    def niDigital_GetPinResultsPinInformation(
        ...
        if self._defaults["GetPinResultsPinInformation"]["actualNumValues"] is None:
            raise MockFunctionCallError(
                "niDigital_GetPinResultsPinInformation", param="actualNumValues"
            )
        if actual_num_values is not None:
            actual_num_values.contents.value = self._defaults[
                "GetPinResultsPinInformation"
            ]["actualNumValues"]
        if self._defaults["GetPinResultsPinInformation"]["pinIndexes"] is None:
            raise MockFunctionCallError(
                "niDigital_GetPinResultsPinInformation", param="pinIndexes"
            )
        if buffer_size.value == 0:
        ...
        for i in range(
            len(self._defaults["GetPinResultsPinInformation"]["pinIndexes"])
        ):
            pin_indexes_ref[i] = self._defaults["GetPinResultsPinInformation"][
                "pinIndexes"
            ][i]
        if self._defaults["GetPinResultsPinInformation"]["siteNumbers"] is None:
            raise MockFunctionCallError(
                "niDigital_GetPinResultsPinInformation", param="siteNumbers"
            )
        if buffer_size.value == 0:
        ...
        for i in range(
            len(self._defaults["GetPinResultsPinInformation"]["siteNumbers"])
        ):
            site_numbers_ref[i] = self._defaults["GetPinResultsPinInformation"][
                "siteNumbers"
            ][i]
        if self._defaults["GetPinResultsPinInformation"]["channelIndexes"] is None:
            raise MockFunctionCallError(
                "niDigital_GetPinResultsPinInformation", param="channelIndexes"
            )
        if buffer_size.value == 0:
        ...
        for i in range(
            len(self._defaults["GetPinResultsPinInformation"]["channelIndexes"])
        ):
            channel_indexes_ref[i] = self._defaults["GetPinResultsPinInformation"][
                "channelIndexes"
            ][i]
        return self._defaults["GetPinResultsPinInformation"]["return"]
    ...
    def niDigital_GetSitePassFail(
        ...
        if self._defaults["GetSitePassFail"]["actualNumSites"] is None:
            raise MockFunctionCallError(
                "niDigital_GetSitePassFail", param="actualNumSites"
            )
        if actual_num_sites is not None:
            actual_num_sites.contents.value = self._defaults["GetSitePassFail"][
                "actualNumSites"
            ]
    ...
    def niDigital_GetSiteResultsSiteNumbers(
        ...
        if self._defaults["GetSiteResultsSiteNumbers"]["actualNumSiteNumbers"] is None:
            raise MockFunctionCallError(
                "niDigital_GetSiteResultsSiteNumbers", param="actualNumSiteNumbers"
            )
        if actual_num_site_numbers is not None:
            actual_num_site_numbers.contents.value = self._defaults[
                "GetSiteResultsSiteNumbers"
            ]["actualNumSiteNumbers"]
        if self._defaults["GetSiteResultsSiteNumbers"]["siteNumbers"] is None:
            raise MockFunctionCallError(
                "niDigital_GetSiteResultsSiteNumbers", param="siteNumbers"
            )
        ...
        for i in range(len(self._defaults["GetSiteResultsSiteNumbers"]["siteNumbers"])):
            site_numbers_ref[i] = self._defaults["GetSiteResultsSiteNumbers"][
                "siteNumbers"
            ][i]
        return self._defaults["GetSiteResultsSiteNumbers"]["return"]
    ...
    def niDigital_GetTimeSetDriveFormat(
        ...
        if self._defaults["GetTimeSetDriveFormat"]["format"] is None:
            raise MockFunctionCallError(
                "niDigital_GetTimeSetDriveFormat", param="format"
            )
    ...
    def niDigital_GetTimeSetEdgeMultiplier(
        ...
        if self._defaults["GetTimeSetEdgeMultiplier"]["edgeMultiplier"] is None:
            raise MockFunctionCallError(
                "niDigital_GetTimeSetEdgeMultiplier", param="edgeMultiplier"
            )
        if edge_multiplier is not None:
            edge_multiplier.contents.value = self._defaults["GetTimeSetEdgeMultiplier"][
                "edgeMultiplier"
            ]
        return self._defaults["GetTimeSetEdgeMultiplier"]["return"]
    ...
    def niDigital_LockSession(self, vi, caller_has_lock):  # noqa: N802
        ...
        if caller_has_lock is not None:
            caller_has_lock.contents.value = self._defaults["LockSession"][
                "callerHasLock"
            ]
        return self._defaults["LockSession"]["return"]
    ...
    def niDigital_PPMU_Measure(
        ...
        if actual_num_read is not None:
            actual_num_read.contents.value = self._defaults["PPMU_Measure"][
                "actualNumRead"
            ]
    ...
    def niDigital_ReadSequencerRegister(self, vi, reg, value):  # noqa: N802
        ...
        if self._defaults["ReadSequencerRegister"]["value"] is None:
            raise MockFunctionCallError(
                "niDigital_ReadSequencerRegister", param="value"
            )
        if value is not None:
    ...
    def niDigital_ReadStatic(
        ...
        if actual_num_read is not None:
            actual_num_read.contents.value = self._defaults["ReadStatic"][
                "actualNumRead"
            ]
    ...
    def niDigital_TDR(
        ...
        if actual_num_offsets is not None:
            actual_num_offsets.contents.value = self._defaults["TDR"][
                "actualNumOffsets"
            ]
    ...
    def niDigital_UnlockSession(self, vi, caller_has_lock):  # noqa: N802
        ...
        if self._defaults["UnlockSession"]["callerHasLock"] is None:
            raise MockFunctionCallError(
                "niDigital_UnlockSession", param="callerHasLock"
            )
        if caller_has_lock is not None:
            caller_has_lock.contents.value = self._defaults["UnlockSession"][
                "callerHasLock"
            ]
        return self._defaults["UnlockSession"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niDigital_Abort.side_effect = MockFunctionCallError(
            "niDigital_Abort"
        )
        mock_library.niDigital_Abort.return_value = 0
        mock_library.niDigital_AbortKeepAlive.side_effect = MockFunctionCallError(
            "niDigital_AbortKeepAlive"
        )
        mock_library.niDigital_AbortKeepAlive.return_value = 0
        mock_library.niDigital_ApplyLevelsAndTiming.side_effect = MockFunctionCallError(
            "niDigital_ApplyLevelsAndTiming"
        )
        mock_library.niDigital_ApplyLevelsAndTiming.return_value = 0
        mock_library.niDigital_ApplyTDROffsets.side_effect = MockFunctionCallError(
            "niDigital_ApplyTDROffsets"
        )
        mock_library.niDigital_ApplyTDROffsets.return_value = 0
        mock_library.niDigital_BurstPattern.side_effect = MockFunctionCallError(
            "niDigital_BurstPattern"
        )
        mock_library.niDigital_BurstPattern.return_value = 0
        mock_library.niDigital_ClockGenerator_Abort.side_effect = MockFunctionCallError(
            "niDigital_ClockGenerator_Abort"
        )
        mock_library.niDigital_ClockGenerator_Abort.return_value = 0
        mock_library.niDigital_ClockGenerator_GenerateClock.side_effect = (
            MockFunctionCallError("niDigital_ClockGenerator_GenerateClock")
        )
        mock_library.niDigital_ClockGenerator_GenerateClock.return_value = 0
        mock_library.niDigital_Commit.side_effect = MockFunctionCallError(
            "niDigital_Commit"
        )
        mock_library.niDigital_Commit.return_value = 0
        mock_library.niDigital_ConfigureActiveLoadLevels.side_effect = (
            MockFunctionCallError("niDigital_ConfigureActiveLoadLevels")
        )
        mock_library.niDigital_ConfigureActiveLoadLevels.return_value = 0
        mock_library.niDigital_ConfigurePatternBurstSites.side_effect = (
            MockFunctionCallError("niDigital_ConfigurePatternBurstSites")
        )
        mock_library.niDigital_ConfigurePatternBurstSites.return_value = 0
        mock_library.niDigital_ConfigureTimeSetCompareEdgesStrobe.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetCompareEdgesStrobe")
        )
        mock_library.niDigital_ConfigureTimeSetCompareEdgesStrobe.return_value = 0
        mock_library.niDigital_ConfigureTimeSetCompareEdgesStrobe2x.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetCompareEdgesStrobe2x")
        )
        mock_library.niDigital_ConfigureTimeSetCompareEdgesStrobe2x.return_value = 0
        mock_library.niDigital_ConfigureTimeSetDriveEdges.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetDriveEdges")
        )
        mock_library.niDigital_ConfigureTimeSetDriveEdges.return_value = 0
        mock_library.niDigital_ConfigureTimeSetDriveEdges2x.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetDriveEdges2x")
        )
        mock_library.niDigital_ConfigureTimeSetDriveEdges2x.return_value = 0
        mock_library.niDigital_ConfigureTimeSetDriveFormat.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetDriveFormat")
        )
        mock_library.niDigital_ConfigureTimeSetDriveFormat.return_value = 0
        mock_library.niDigital_ConfigureTimeSetEdge.side_effect = MockFunctionCallError(
            "niDigital_ConfigureTimeSetEdge"
        )
        mock_library.niDigital_ConfigureTimeSetEdge.return_value = 0
        mock_library.niDigital_ConfigureTimeSetEdgeMultiplier.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetEdgeMultiplier")
        )
        mock_library.niDigital_ConfigureTimeSetEdgeMultiplier.return_value = 0
        mock_library.niDigital_ConfigureTimeSetPeriod.side_effect = (
            MockFunctionCallError("niDigital_ConfigureTimeSetPeriod")
        )
        mock_library.niDigital_ConfigureTimeSetPeriod.return_value = 0
        mock_library.niDigital_ConfigureVoltageLevels.side_effect = (
            MockFunctionCallError("niDigital_ConfigureVoltageLevels")
        )
        mock_library.niDigital_ConfigureVoltageLevels.return_value = 0
        mock_library.niDigital_CreateCaptureWaveformFromFileDigicapture.side_effect = (
            MockFunctionCallError("niDigital_CreateCaptureWaveformFromFileDigicapture")
        )
        mock_library.niDigital_CreateCaptureWaveformFromFileDigicapture.return_value = 0
        mock_library.niDigital_CreateCaptureWaveformParallel.side_effect = (
            MockFunctionCallError("niDigital_CreateCaptureWaveformParallel")
        )
        mock_library.niDigital_CreateCaptureWaveformParallel.return_value = 0
        mock_library.niDigital_CreateCaptureWaveformSerial.side_effect = (
            MockFunctionCallError("niDigital_CreateCaptureWaveformSerial")
        )
        mock_library.niDigital_CreateCaptureWaveformSerial.return_value = 0
        mock_library.niDigital_CreateSourceWaveformFromFileTDMS.side_effect = (
            MockFunctionCallError("niDigital_CreateSourceWaveformFromFileTDMS")
        )
        mock_library.niDigital_CreateSourceWaveformFromFileTDMS.return_value = 0
        mock_library.niDigital_CreateSourceWaveformParallel.side_effect = (
            MockFunctionCallError("niDigital_CreateSourceWaveformParallel")
        )
        mock_library.niDigital_CreateSourceWaveformParallel.return_value = 0
        mock_library.niDigital_CreateSourceWaveformSerial.side_effect = (
            MockFunctionCallError("niDigital_CreateSourceWaveformSerial")
        )
        mock_library.niDigital_CreateSourceWaveformSerial.return_value = 0
        mock_library.niDigital_CreateTimeSet.side_effect = MockFunctionCallError(
            "niDigital_CreateTimeSet"
        )
        mock_library.niDigital_CreateTimeSet.return_value = 0
        mock_library.niDigital_DeleteAllTimeSets.side_effect = MockFunctionCallError(
            "niDigital_DeleteAllTimeSets"
        )
        mock_library.niDigital_DeleteAllTimeSets.return_value = 0
        mock_library.niDigital_DisableSites.side_effect = MockFunctionCallError(
            "niDigital_DisableSites"
        )
        mock_library.niDigital_DisableSites.return_value = 0
        mock_library.niDigital_EnableSites.side_effect = MockFunctionCallError(
            "niDigital_EnableSites"
        )
        mock_library.niDigital_EnableSites.return_value = 0
        mock_library.niDigital_FetchHistoryRAMCycleInformation.side_effect = (
            MockFunctionCallError("niDigital_FetchHistoryRAMCycleInformation")
        )
        mock_library.niDigital_FetchHistoryRAMCycleInformation.return_value = 0
        mock_library.niDigital_FetchHistoryRAMCyclePinData.side_effect = (
            MockFunctionCallError("niDigital_FetchHistoryRAMCyclePinData")
        )
        mock_library.niDigital_FetchHistoryRAMCyclePinData.return_value = 0
        mock_library.niDigital_FetchHistoryRAMScanCycleNumber.side_effect = (
            MockFunctionCallError("niDigital_FetchHistoryRAMScanCycleNumber")
        )
        mock_library.niDigital_FetchHistoryRAMScanCycleNumber.return_value = 0
        mock_library.niDigital_FrequencyCounter_MeasureFrequency.side_effect = (
            MockFunctionCallError("niDigital_FrequencyCounter_MeasureFrequency")
        )
        mock_library.niDigital_FrequencyCounter_MeasureFrequency.return_value = 0
        mock_library.niDigital_GetAttributeViBoolean.side_effect = (
            MockFunctionCallError("niDigital_GetAttributeViBoolean")
        )
        mock_library.niDigital_GetAttributeViBoolean.return_value = 0
        mock_library.niDigital_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDigital_GetAttributeViInt32"
        )
        mock_library.niDigital_GetAttributeViInt32.return_value = 0
        mock_library.niDigital_GetAttributeViInt64.side_effect = MockFunctionCallError(
            "niDigital_GetAttributeViInt64"
        )
        mock_library.niDigital_GetAttributeViInt64.return_value = 0
        mock_library.niDigital_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDigital_GetAttributeViReal64"
        )
        mock_library.niDigital_GetAttributeViReal64.return_value = 0
        mock_library.niDigital_GetAttributeViString.side_effect = MockFunctionCallError(
            "niDigital_GetAttributeViString"
        )
        mock_library.niDigital_GetAttributeViString.return_value = 0
        mock_library.niDigital_GetChannelNameFromString.side_effect = (
            MockFunctionCallError("niDigital_GetChannelNameFromString")
        )
        mock_library.niDigital_GetChannelNameFromString.return_value = 0
        mock_library.niDigital_GetError.side_effect = MockFunctionCallError(
            "niDigital_GetError"
        )
        mock_library.niDigital_GetError.return_value = 0
        mock_library.niDigital_GetFailCount.side_effect = MockFunctionCallError(
            "niDigital_GetFailCount"
        )
        mock_library.niDigital_GetFailCount.return_value = 0
        mock_library.niDigital_GetHistoryRAMSampleCount.side_effect = (
            MockFunctionCallError("niDigital_GetHistoryRAMSampleCount")
        )
        mock_library.niDigital_GetHistoryRAMSampleCount.return_value = 0
        mock_library.niDigital_GetPatternName.side_effect = MockFunctionCallError(
            "niDigital_GetPatternName"
        )
        mock_library.niDigital_GetPatternName.return_value = 0
        mock_library.niDigital_GetPatternPinList.side_effect = MockFunctionCallError(
            "niDigital_GetPatternPinList"
        )
        mock_library.niDigital_GetPatternPinList.return_value = 0
        mock_library.niDigital_GetPinName.side_effect = MockFunctionCallError(
            "niDigital_GetPinName"
        )
        mock_library.niDigital_GetPinName.return_value = 0
        mock_library.niDigital_GetPinResultsPinInformation.side_effect = (
            MockFunctionCallError("niDigital_GetPinResultsPinInformation")
        )
        mock_library.niDigital_GetPinResultsPinInformation.return_value = 0
        mock_library.niDigital_GetSitePassFail.side_effect = MockFunctionCallError(
            "niDigital_GetSitePassFail"
        )
        mock_library.niDigital_GetSitePassFail.return_value = 0
        mock_library.niDigital_GetSiteResultsSiteNumbers.side_effect = (
            MockFunctionCallError("niDigital_GetSiteResultsSiteNumbers")
        )
        mock_library.niDigital_GetSiteResultsSiteNumbers.return_value = 0
        mock_library.niDigital_GetTimeSetDriveFormat.side_effect = (
            MockFunctionCallError("niDigital_GetTimeSetDriveFormat")
        )
        mock_library.niDigital_GetTimeSetDriveFormat.return_value = 0
        mock_library.niDigital_GetTimeSetEdge.side_effect = MockFunctionCallError(
            "niDigital_GetTimeSetEdge"
        )
        mock_library.niDigital_GetTimeSetEdge.return_value = 0
        mock_library.niDigital_GetTimeSetEdgeMultiplier.side_effect = (
            MockFunctionCallError("niDigital_GetTimeSetEdgeMultiplier")
        )
        mock_library.niDigital_GetTimeSetEdgeMultiplier.return_value = 0
        mock_library.niDigital_GetTimeSetName.side_effect = MockFunctionCallError(
            "niDigital_GetTimeSetName"
        )
        mock_library.niDigital_GetTimeSetName.return_value = 0
        mock_library.niDigital_GetTimeSetPeriod.side_effect = MockFunctionCallError(
            "niDigital_GetTimeSetPeriod"
        )
        mock_library.niDigital_GetTimeSetPeriod.return_value = 0
        mock_library.niDigital_InitWithOptions.side_effect = MockFunctionCallError(
            "niDigital_InitWithOptions"
        )
        mock_library.niDigital_InitWithOptions.return_value = 0
        mock_library.niDigital_Initiate.side_effect = MockFunctionCallError(
            "niDigital_Initiate"
        )
        mock_library.niDigital_Initiate.return_value = 0
        mock_library.niDigital_IsDone.side_effect = MockFunctionCallError(
            "niDigital_IsDone"
        )
        mock_library.niDigital_IsDone.return_value = 0
        mock_library.niDigital_IsSiteEnabled.side_effect = MockFunctionCallError(
            "niDigital_IsSiteEnabled"
        )
        mock_library.niDigital_IsSiteEnabled.return_value = 0
        mock_library.niDigital_LoadLevels.side_effect = MockFunctionCallError(
            "niDigital_LoadLevels"
        )
        mock_library.niDigital_LoadLevels.return_value = 0
        mock_library.niDigital_LoadPattern.side_effect = MockFunctionCallError(
            "niDigital_LoadPattern"
        )
        mock_library.niDigital_LoadPattern.return_value = 0
        mock_library.niDigital_LoadPinMap.side_effect = MockFunctionCallError(
            "niDigital_LoadPinMap"
        )
        mock_library.niDigital_LoadPinMap.return_value = 0
        mock_library.niDigital_LoadSpecifications.side_effect = MockFunctionCallError(
            "niDigital_LoadSpecifications"
        )
        mock_library.niDigital_LoadSpecifications.return_value = 0
        mock_library.niDigital_LoadTiming.side_effect = MockFunctionCallError(
            "niDigital_LoadTiming"
        )
        mock_library.niDigital_LoadTiming.return_value = 0
        mock_library.niDigital_LockSession.side_effect = MockFunctionCallError(
            "niDigital_LockSession"
        )
        mock_library.niDigital_LockSession.return_value = 0
        mock_library.niDigital_PPMU_Measure.side_effect = MockFunctionCallError(
            "niDigital_PPMU_Measure"
        )
        mock_library.niDigital_PPMU_Measure.return_value = 0
        mock_library.niDigital_PPMU_Source.side_effect = MockFunctionCallError(
            "niDigital_PPMU_Source"
        )
        mock_library.niDigital_PPMU_Source.return_value = 0
        mock_library.niDigital_ReadSequencerFlag.side_effect = MockFunctionCallError(
            "niDigital_ReadSequencerFlag"
        )
        mock_library.niDigital_ReadSequencerFlag.return_value = 0
        mock_library.niDigital_ReadSequencerRegister.side_effect = (
            MockFunctionCallError("niDigital_ReadSequencerRegister")
        )
        mock_library.niDigital_ReadSequencerRegister.return_value = 0
        mock_library.niDigital_ReadStatic.side_effect = MockFunctionCallError(
            "niDigital_ReadStatic"
        )
        mock_library.niDigital_ReadStatic.return_value = 0
        mock_library.niDigital_ResetDevice.side_effect = MockFunctionCallError(
            "niDigital_ResetDevice"
        )
        mock_library.niDigital_ResetDevice.return_value = 0
        mock_library.niDigital_SelfCalibrate.side_effect = MockFunctionCallError(
            "niDigital_SelfCalibrate"
        )
        mock_library.niDigital_SelfCalibrate.return_value = 0
        mock_library.niDigital_SendSoftwareEdgeTrigger.side_effect = (
            MockFunctionCallError("niDigital_SendSoftwareEdgeTrigger")
        )
        mock_library.niDigital_SendSoftwareEdgeTrigger.return_value = 0
        mock_library.niDigital_SetAttributeViBoolean.side_effect = (
            MockFunctionCallError("niDigital_SetAttributeViBoolean")
        )
        mock_library.niDigital_SetAttributeViBoolean.return_value = 0
        mock_library.niDigital_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDigital_SetAttributeViInt32"
        )
        mock_library.niDigital_SetAttributeViInt32.return_value = 0
        mock_library.niDigital_SetAttributeViInt64.side_effect = MockFunctionCallError(
            "niDigital_SetAttributeViInt64"
        )
        mock_library.niDigital_SetAttributeViInt64.return_value = 0
        mock_library.niDigital_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDigital_SetAttributeViReal64"
        )
        mock_library.niDigital_SetAttributeViReal64.return_value = 0
        mock_library.niDigital_SetAttributeViString.side_effect = MockFunctionCallError(
        ...
        mock_library.niDigital_UnloadAllPatterns.side_effect = MockFunctionCallError(
            "niDigital_UnloadAllPatterns"
        )
        mock_library.niDigital_UnloadAllPatterns.return_value = 0
        mock_library.niDigital_UnloadSpecifications.side_effect = MockFunctionCallError(
            "niDigital_UnloadSpecifications"
        )
        mock_library.niDigital_UnloadSpecifications.return_value = 0
        mock_library.niDigital_UnlockSession.side_effect = MockFunctionCallError(
            "niDigital_UnlockSession"
        )
        mock_library.niDigital_UnlockSession.return_value = 0
        mock_library.niDigital_WaitUntilDone.side_effect = MockFunctionCallError(
            "niDigital_WaitUntilDone"
        )
        mock_library.niDigital_WaitUntilDone.return_value = 0
        mock_library.niDigital_WriteSequencerFlag.side_effect = MockFunctionCallError(
            "niDigital_WriteSequencerFlag"
        )
        mock_library.niDigital_WriteSequencerFlag.return_value = 0
        mock_library.niDigital_WriteSequencerRegister.side_effect = (
            MockFunctionCallError("niDigital_WriteSequencerRegister")
        )
        mock_library.niDigital_WriteSequencerRegister.return_value = 0
        mock_library.niDigital_WriteSourceWaveformBroadcastU32.side_effect = (
            MockFunctionCallError("niDigital_WriteSourceWaveformBroadcastU32")
        )
        mock_library.niDigital_WriteSourceWaveformBroadcastU32.return_value = 0
        mock_library.niDigital_WriteSourceWaveformDataFromFileTDMS.side_effect = (
            MockFunctionCallError("niDigital_WriteSourceWaveformDataFromFileTDMS")
        )
        mock_library.niDigital_WriteSourceWaveformDataFromFileTDMS.return_value = 0
        mock_library.niDigital_WriteSourceWaveformSiteUniqueU32.side_effect = (
            MockFunctionCallError("niDigital_WriteSourceWaveformSiteUniqueU32")
        )
        mock_library.niDigital_WriteSourceWaveformSiteUniqueU32.return_value = 0
        mock_library.niDigital_WriteStatic.side_effect = MockFunctionCallError(
            "niDigital_WriteStatic"
        )
        mock_library.niDigital_WriteStatic.return_value = 0
        mock_library.niDigital_close.side_effect = MockFunctionCallError(
            "niDigital_close"
        )
        mock_library.niDigital_close.return_value = 0
        mock_library.niDigital_error_message.side_effect = MockFunctionCallError(
            "niDigital_error_message"
        )
        mock_library.niDigital_error_message.return_value = 0
        mock_library.niDigital_reset.side_effect = MockFunctionCallError(
            "niDigital_reset"
        )
        mock_library.niDigital_reset.return_value = 0
        mock_library.niDigital_self_test.side_effect = MockFunctionCallError(
            "niDigital_self_test"
        )
