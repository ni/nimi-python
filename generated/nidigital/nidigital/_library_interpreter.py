...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def abort_keep_alive(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niDigital_AbortKeepAlive(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def apply_levels_and_timing(self, session_handle, encoding, site_list, levels_sheet, timing_sheet, initial_state_high_pins, initial_state_low_pins, initial_state_tristate_pins):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
        levels_sheet_ctype = ctypes.create_string_buffer(levels_sheet.encode(encoding))  # case C020
        timing_sheet_ctype = ctypes.create_string_buffer(timing_sheet.encode(encoding))  # case C020
        initial_state_high_pins_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(initial_state_high_pins).encode(encoding))  # case C040
        initial_state_low_pins_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(initial_state_low_pins).encode(encoding))  # case C040
        initial_state_tristate_pins_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(initial_state_tristate_pins).encode(encoding))  # case C040
    ...
    def apply_tdr_offsets(self, session_handle, encoding, channel_list, offsets):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def burst_pattern(self, session_handle, encoding, site_list, start_label, select_digital_function, wait_until_done, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
        start_label_ctype = ctypes.create_string_buffer(start_label.encode(encoding))  # case C020
    ...
    def clock_generator_abort(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def clock_generator_generate_clock(self, session_handle, encoding, channel_list, frequency, select_digital_function):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def commit(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niDigital_Commit(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def configure_active_load_levels(self, session_handle, encoding, channel_list, iol, ioh, vcom):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def configure_pattern_burst_sites(self, session_handle, encoding, site_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
    ...
    def configure_time_set_compare_edges_strobe(self, session_handle, encoding, pin_list, time_set_name, strobe_edge):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_time_set_compare_edges_strobe2x(self, session_handle, encoding, pin_list, time_set_name, strobe_edge, strobe2_edge):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
        strobe_edge_ctype = _converters.convert_timedelta_to_seconds_real64(strobe_edge)  # case S140
    ...
    def configure_time_set_drive_edges(self, session_handle, encoding, pin_list, time_set_name, format, drive_on_edge, drive_data_edge, drive_return_edge, drive_off_edge):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_time_set_drive_edges2x(self, session_handle, encoding, pin_list, time_set_name, format, drive_on_edge, drive_data_edge, drive_return_edge, drive_off_edge, drive_data2_edge, drive_return2_edge):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
        format_ctype = _visatype.ViInt32(format.value)  # case S130
    ...
    def configure_time_set_drive_format(self, session_handle, encoding, pin_list, time_set_name, drive_format):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_time_set_edge(self, session_handle, encoding, pin_list, time_set_name, edge, time):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_time_set_edge_multiplier(self, session_handle, encoding, pin_list, time_set_name, edge_multiplier):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_time_set_period(self, session_handle, encoding, time_set_name, period):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def configure_voltage_levels(self, session_handle, encoding, channel_list, vil, vih, vol, voh, vterm):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def create_capture_waveform_from_file_digicapture(self, session_handle, encoding, waveform_name, waveform_file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        waveform_file_path_ctype = ctypes.create_string_buffer(waveform_file_path.encode(encoding))  # case C020
    ...
    def create_capture_waveform_parallel(self, session_handle, encoding, pin_list, waveform_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def create_capture_waveform_serial(self, session_handle, encoding, pin_list, waveform_name, sample_width, bit_order):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def create_source_waveform_from_file_tdms(self, session_handle, encoding, waveform_name, waveform_file_path, write_waveform_data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        waveform_file_path_ctype = ctypes.create_string_buffer(waveform_file_path.encode(encoding))  # case C020
    ...
    def create_source_waveform_parallel(self, session_handle, encoding, pin_list, waveform_name, data_mapping):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def create_source_waveform_serial(self, session_handle, encoding, pin_list, waveform_name, data_mapping, sample_width, bit_order):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        data_mapping_ctype = _visatype.ViInt32(data_mapping.value)  # case S130
    ...
    def create_time_set(self, session_handle, encoding, name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        name_ctype = ctypes.create_string_buffer(name.encode(encoding))  # case C020
        error_code = self._library.niDigital_CreateTimeSet(vi_ctype, name_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def delete_all_time_sets(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niDigital_DeleteAllTimeSets(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def disable_sites(self, session_handle, encoding, site_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
    ...
    def enable_sites(self, session_handle, encoding, site_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
    ...
    def fetch_capture_waveform(self, session_handle, encoding, site_list, waveform_name, samples_to_read, timeout):
    ...
    def fetch_history_ram_cycle_information(self, session_handle, encoding, site, sample_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_ctype = ctypes.create_string_buffer(site.encode(encoding))  # case C010
    ...
    def fetch_history_ram_cycle_pin_data(self, session_handle, encoding, site, pin_list, sample_index, dut_cycle_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_ctype = ctypes.create_string_buffer(site.encode(encoding))  # case C010
        pin_list_ctype = ctypes.create_string_buffer(pin_list.encode(encoding))  # case C020
        sample_index_ctype = _visatype.ViInt64(sample_index)  # case S150
    ...
    def fetch_history_ram_scan_cycle_number(self, session_handle, encoding, site, sample_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_ctype = ctypes.create_string_buffer(site.encode(encoding))  # case C010
        sample_index_ctype = _visatype.ViInt64(sample_index)  # case S150
    ...
    def frequency_counter_measure_frequency(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def get_attribute_vi_boolean(self, session_handle, encoding, channel_name, attribute):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_attribute_vi_int32(self, session_handle, encoding, channel_name, attribute):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def get_attribute_vi_int64(self, session_handle, encoding, channel_name, attribute):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def get_attribute_vi_real64(self, session_handle, encoding, channel_name, attribute):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def get_attribute_vi_string(self, session_handle, encoding, channel_name, attribute):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
        ...
        error_code = self._library.niDigital_GetAttributeViString(vi_ctype, channel_name_ctype, attribute_ctype, buffer_size_ctype, value_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return value_ctype.value.decode(encoding)

    def get_channel_names(self, session_handle, encoding, indices):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        indices_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(indices).encode(encoding))  # case C040
        ...
        error_code = self._library.niDigital_GetChannelNameFromString(vi_ctype, indices_ctype, name_buffer_size_ctype, names_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return _converters.convert_comma_separated_string_to_list(names_ctype.value.decode(encoding))
    ...
    def get_error(self, session_handle, encoding):  # noqa: N802
        ...
        return int(error_code_ctype.value), error_description_ctype.value.decode(encoding)

    def get_fail_count(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def get_history_ram_sample_count(self, session_handle, encoding, site):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_ctype = ctypes.create_string_buffer(site.encode(encoding))  # case C010
    ...
    def get_pattern_name(self, session_handle, encoding, pattern_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        ...
        error_code = self._library.niDigital_GetPatternName(vi_ctype, pattern_index_ctype, name_buffer_size_ctype, name_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return name_ctype.value.decode(encoding)

    def get_pattern_pin_names(self, session_handle, encoding, start_label):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        start_label_ctype = ctypes.create_string_buffer(start_label.encode(encoding))  # case C020
        ...
        error_code = self._library.niDigital_GetPatternPinList(vi_ctype, start_label_ctype, pin_list_buffer_size_ctype, pin_list_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return _converters.convert_comma_separated_string_to_list(pin_list_ctype.value.decode(encoding))

    def get_pin_name(self, session_handle, encoding, pin_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_pin_results_pin_information(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        buffer_size_ctype = _visatype.ViInt32(0)  # case S190
    ...
    def get_site_pass_fail(self, session_handle, encoding, site_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
    ...
    def get_site_results_site_numbers(self, session_handle, encoding, site_list, site_result_type):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
    ...
    def get_time_set_drive_format(self, session_handle, encoding, pin, time_set_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_ctype = ctypes.create_string_buffer(pin.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def get_time_set_edge(self, session_handle, encoding, pin, time_set_name, edge):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_ctype = ctypes.create_string_buffer(pin.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
        edge_ctype = _visatype.ViInt32(edge.value)  # case S130
    ...
    def get_time_set_edge_multiplier(self, session_handle, encoding, pin, time_set_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        pin_ctype = ctypes.create_string_buffer(pin.encode(encoding))  # case C010
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def get_time_set_name(self, session_handle, encoding, time_set_index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_time_set_period(self, session_handle, encoding, time_set_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        time_set_name_ctype = ctypes.create_string_buffer(time_set_name.encode(encoding))  # case C020
    ...
    def is_done(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def is_site_enabled(self, session_handle, encoding, site):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_ctype = ctypes.create_string_buffer(site.encode(encoding))  # case C010
    ...
    def load_levels(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def load_pattern(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        file_path_ctype = ctypes.create_string_buffer(file_path.encode(encoding))  # case C020
    ...
    def load_pin_map(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        file_path_ctype = ctypes.create_string_buffer(file_path.encode(encoding))  # case C020
    ...
    def load_specifications(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        file_path_ctype = ctypes.create_string_buffer(file_path.encode(encoding))  # case C020
    ...
    def load_timing(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        file_path_ctype = ctypes.create_string_buffer(file_path.encode(encoding))  # case C020
    ...
    def ppmu_measure(self, session_handle, encoding, channel_list, measurement_type):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def ppmu_source(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def read_sequencer_flag(self, session_handle, encoding, flag):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        flag_ctype = ctypes.create_string_buffer(flag.value.encode(encoding))  # case C030
        value_ctype = _visatype.ViBoolean()  # case S220
    ...
    def read_sequencer_register(self, session_handle, encoding, reg):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        reg_ctype = ctypes.create_string_buffer(reg.value.encode(encoding))  # case C030
        value_ctype = _visatype.ViInt32()  # case S220
    ...
    def read_static(self, session_handle, encoding, channel_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
        buffer_size_ctype = _visatype.ViInt32(0)  # case S190
        data_ctype = None  # case B610
    ...
    def reset_device(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niDigital_ResetDevice(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def self_calibrate(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niDigital_SelfCalibrate(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def send_software_edge_trigger(self, session_handle, encoding, trigger, trigger_identifier):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_ctype = _visatype.ViInt32(trigger.value)  # case S130
        trigger_identifier_ctype = ctypes.create_string_buffer(trigger_identifier.encode(encoding))  # case C020
        error_code = self._library.niDigital_SendSoftwareEdgeTrigger(vi_ctype, trigger_ctype, trigger_identifier_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def set_attribute_vi_boolean(self, session_handle, encoding, channel_name, attribute, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def set_attribute_vi_int32(self, session_handle, encoding, channel_name, attribute, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def set_attribute_vi_int64(self, session_handle, encoding, channel_name, attribute, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def set_attribute_vi_real64(self, session_handle, encoding, channel_name, attribute, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
    ...
    def set_attribute_vi_string(self, session_handle, encoding, channel_name, attribute, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_ctype = _visatype.ViAttr(attribute)  # case S150
        value_ctype = ctypes.create_string_buffer(value.encode(encoding))  # case C020
        error_code = self._library.niDigital_SetAttributeViString(vi_ctype, channel_name_ctype, attribute_ctype, value_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def tdr(self, session_handle, encoding, channel_list, apply_offsets):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def unload_all_patterns(self, session_handle, encoding, unload_keep_alive_pattern):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def unload_specifications(self, session_handle, encoding, file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        file_path_ctype = ctypes.create_string_buffer(file_path.encode(encoding))  # case C020
    ...
    def wait_until_done(self, session_handle, encoding, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
    ...
    def write_sequencer_flag(self, session_handle, encoding, flag, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        flag_ctype = ctypes.create_string_buffer(flag.value.encode(encoding))  # case C030
        value_ctype = _visatype.ViBoolean(value)  # case S150
    ...
    def write_sequencer_register(self, session_handle, encoding, reg, value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        reg_ctype = ctypes.create_string_buffer(reg.value.encode(encoding))  # case C030
        value_ctype = _visatype.ViInt32(value)  # case S150
    ...
    def write_source_waveform_broadcast(self, session_handle, encoding, waveform_name, waveform_data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def write_source_waveform_data_from_file_tdms(self, session_handle, encoding, waveform_name, waveform_file_path):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        waveform_file_path_ctype = ctypes.create_string_buffer(waveform_file_path.encode(encoding))  # case C020
    ...
    def write_source_waveform_site_unique_u32(self, session_handle, encoding, site_list, waveform_name, num_waveforms, samples_per_waveform, waveform_data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        site_list_ctype = ctypes.create_string_buffer(site_list.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def write_static(self, session_handle, encoding, channel_list, state):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_list_ctype = ctypes.create_string_buffer(channel_list.encode(encoding))  # case C010
    ...
    def self_test(self, session_handle, encoding):  # noqa: N802
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return int(test_result_ctype.value), test_message_ctype.value.decode(encoding)
