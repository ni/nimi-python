...
class _SessionBase(object):
    ...
    **Supported Waveform Generators**: PXIe-5413/5423/5433
    ...
    @ivi_synchronized
    def _set_attribute_vi_string(self, attribute_id, attribute_value_raw):
        ...
        Args:
            ...
            attribute_value_raw (str): Specifies the value to which you want to set the property. **Default
                Value**: None
        ...
        '''
        self._interpreter.set_attribute_vi_string(self._repeated_capability, attribute_id, attribute_value_raw)
