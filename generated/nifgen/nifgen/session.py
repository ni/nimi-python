...
class _SessionBase(object):
    ...
    **Supported Waveform Generators**: PXIe-5413/5423/5433
    ...
    """
    analog_path = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.AnalogPath, 1150222
    )
    ...
    """
    bus_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.BusType, 1150215
    )
    """Type: enums.BusType
    ...
    """
    clock_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ClockMode, 1150110
    )
    ...
    """
    data_marker_event_level_polarity = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.DataMarkerEventLevelPolarity, 1150338
    )
    ...
    """
    digital_edge_script_trigger_edge = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ScriptTriggerDigitalEdgeEdge, 1150292
    )
    ...
    digital_edge_start_trigger_edge = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.StartTriggerDigitalEdgeEdge, 1150282
    )
    ...
    One or more of the referenced methods are not in the Python API for this driver.
    """
    exported_onboard_reference_clock_output_terminal = _attributes.AttributeViString(
        1150322
    )
    """Type: str
    ...
    One or more of the referenced methods are not in the Python API for this driver.
    """
    exported_sample_clock_timebase_output_terminal = _attributes.AttributeViString(
        1150329
    )
    """Type: str
    ...
    """
    func_waveform = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.Waveform, 1250101
    )
    """Type: enums.Waveform
    ...
    """
    idle_behavior = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.IdleBehavior, 1150377
    )
    ...
    """
    output_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.OutputMode, 1250001
    )
    ...
    """
    reference_clock_source = _attributes.AttributeEnum(
        _attributes.AttributeViString, enums.ReferenceClockSource, 1150113
    )
    ...
    """
    sample_clock_source = _attributes.AttributeEnum(
        _attributes.AttributeViString, enums.SampleClockSource, 1150112
    )
    ...
    Note: The signal generator must not be in the Generating state when you change this property.
    """
    sample_clock_timebase_source = _attributes.AttributeEnum(
        _attributes.AttributeViString, enums.SampleClockTimebaseSource, 1150367
    )
    ...
    """
    script_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ScriptTriggerType, 1150290
    )
    ...
    start_trigger_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.StartTriggerType, 1150280
    )
    ...
    """
    terminal_configuration = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TerminalConfiguration, 1150365
    )
    ...
    """
    trigger_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerMode, 1150108
    )
    ...
    """
    wait_behavior = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.WaitBehavior, 1150379
    )
    ...
    def __init__(
        ...
        self.script_triggers = _RepeatedCapabilities(
            self, "ScriptTrigger", repeated_capability_list
        )
        self.markers = _RepeatedCapabilities(self, "Marker", repeated_capability_list)
        self.data_markers = _RepeatedCapabilities(
            self, "DataMarker", repeated_capability_list
        )
    ...
    def __repr__(self):
        return "{0}.{1}({2})".format(
            "nifgen", self.__class__.__name__, self._param_list
        )
    ...
    def allocate_named_waveform(self, waveform_name, waveform_size):
        ...
        error_code = self._library.niFgen_AllocateNamedWaveform(
            vi_ctype, channel_name_ctype, waveform_name_ctype, waveform_size_ctype
        )
        errors.handle_error(
    ...
    def allocate_waveform(self, waveform_size):
        ...
        error_code = self._library.niFgen_AllocateWaveform(
            vi_ctype,
            channel_name_ctype,
            waveform_size_ctype,
            None
            if waveform_handle_ctype is None
            else (ctypes.pointer(waveform_handle_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def clear_user_standard_waveform(self):
        ...
        error_code = self._library.niFgen_ClearUserStandardWaveform(
    ...
    def configure_arb_sequence(self, sequence_handle, gain, offset):
        ...
        error_code = self._library.niFgen_ConfigureArbSequence(
            vi_ctype,
            channel_name_ctype,
            sequence_handle_ctype,
            gain_ctype,
            offset_ctype,
        )
        errors.handle_error(
    ...
    def configure_arb_waveform(self, waveform_handle, gain, offset):
        ...
        gain_ctype = _visatype.ViReal64(gain)  # case S150
        offset_ctype = _visatype.ViReal64(offset)  # case S150
        error_code = self._library.niFgen_ConfigureArbWaveform(
            vi_ctype,
            channel_name_ctype,
            waveform_handle_ctype,
            gain_ctype,
            offset_ctype,
        )
        errors.handle_error(
    ...
    @ivi_synchronized
    def configure_freq_list(
        self, frequency_list_handle, amplitude, dc_offset=0.0, start_phase=0.0
    ):
        ...
        frequency_list_handle_ctype = _visatype.ViInt32(
        ...
        error_code = self._library.niFgen_ConfigureFreqList(
            vi_ctype,
            channel_name_ctype,
            frequency_list_handle_ctype,
            amplitude_ctype,
            dc_offset_ctype,
            start_phase_ctype,
        )
    ...
    def configure_standard_waveform(
        self, waveform, amplitude, frequency, dc_offset=0.0, start_phase=0.0
    ):
        ...
        **outputMode** parameter set to OutputMode.FUNC before calling
        ...
        start_phase_ctype = _visatype.ViReal64(start_phase)  # case S150
        error_code = self._library.niFgen_ConfigureStandardWaveform(
            vi_ctype,
            channel_name_ctype,
            waveform_ctype,
            amplitude_ctype,
    ...
    def create_waveform(self, waveform_data_array):
        ...
        if str(type(waveform_data_array)).find("'numpy.ndarray'") != -1:
            ...
            if waveform_data_array.dtype == numpy.float64:
                ...
                raise TypeError(
                    "Unsupported dtype. Is {0}, expected {1} or {2}".format(
                        waveform_data_array.dtype, numpy.float64, numpy.int16
                    )
                )
            ...
            if waveform_data_array.typecode == "d":
                ...
                raise TypeError(
                    "Unsupported dtype. Is {0}, expected {1} or {2}".format(
                        waveform_data_array.typecode, "d (double)", "h (16 bit int)"
                    )
                )
    ...
    def _create_waveform_f64(self, waveform_data_array):
        ...
        **outputMode** parameter to OutputMode.ARB or
        ...
        waveform_size_ctype = _visatype.ViInt32(
            0 if waveform_data_array is None else len(waveform_data_array)
        )  # case S160
        waveform_data_array_array = get_ctypes_and_array(
            value=waveform_data_array, array_type="d"
        )  # case B550
        waveform_data_array_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_data_array_array, library_type=_visatype.ViReal64
        )  # case B550
        waveform_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateWaveformF64(
            vi_ctype,
            channel_name_ctype,
            waveform_size_ctype,
            waveform_data_array_ctype,
            None
            if waveform_handle_ctype is None
            else (ctypes.pointer(waveform_handle_ctype)),
        )
    ...
    def _create_waveform_f64_numpy(self, waveform_data_array):
        ...
        **outputMode** parameter to OutputMode.ARB or
        ...
        if type(waveform_data_array) is not numpy.ndarray:
            raise TypeError(
                "waveform_data_array must be {0}, is {1}".format(
                    numpy.ndarray, type(waveform_data_array)
                )
            )
        ...
        if waveform_data_array.dtype is not numpy.dtype("float64"):
            raise TypeError(
                "waveform_data_array must be numpy.ndarray of dtype=float64, is "
                + str(waveform_data_array.dtype)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
    ...
    def create_waveform_from_file_f64(self, file_name, byte_order):
        ...
        if type(byte_order) is not enums.ByteOrder:
            raise TypeError(
                "Parameter byte_order must be of type " + str(enums.ByteOrder)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        )  # case C010
        file_name_ctype = ctypes.create_string_buffer(
            file_name.encode(self._encoding)
        )  # case C020
        byte_order_ctype = _visatype.ViInt32(byte_order.value)  # case S130
        waveform_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateWaveformFromFileF64(
            vi_ctype,
            channel_name_ctype,
            file_name_ctype,
            byte_order_ctype,
    ...
    def create_waveform_from_file_i16(self, file_name, byte_order):
        ...
        byte_order_ctype = _visatype.ViInt32(byte_order.value)  # case S130
        waveform_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateWaveformFromFileI16(
            vi_ctype,
            channel_name_ctype,
            file_name_ctype,
            byte_order_ctype,
    ...
    def _create_waveform_i16_numpy(self, waveform_data_array):
        ...
        **outputMode** parameter to OutputMode.ARB or
        ...
        if waveform_data_array.dtype is not numpy.dtype("int16"):
            raise TypeError(
                "waveform_data_array must be numpy.ndarray of dtype=int16, is "
                + str(waveform_data_array.dtype)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
        ...
        waveform_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateWaveformI16(
            vi_ctype,
            channel_name_ctype,
            waveform_size_ctype,
            waveform_data_array_ctype,
    ...
    def define_user_standard_waveform(self, waveform_data_array):
        ...
        **outputMode** parameter to OutputMode.FUNC or
        ...
        waveform_data_array_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_data_array, library_type=_visatype.ViReal64
        )  # case B550
        error_code = self._library.niFgen_DefineUserStandardWaveform(
            vi_ctype, channel_name_ctype, waveform_size_ctype, waveform_data_array_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _delete_named_waveform(self, waveform_name):
        ...
        error_code = self._library.niFgen_DeleteNamedWaveform(
            vi_ctype, channel_name_ctype, waveform_name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def delete_script(self, script_name):
        ...
        script_name_ctype = ctypes.create_string_buffer(
            script_name.encode(self._encoding)
        )  # case C020
        error_code = self._library.niFgen_DeleteScript(
            vi_ctype, channel_name_ctype, script_name_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _get_attribute_vi_boolean(self, attribute_id):
        ...
        error_code = self._library.niFgen_GetAttributeViBoolean(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_int32(self, attribute_id):
        ...
        error_code = self._library.niFgen_GetAttributeViInt32(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_real64(self, attribute_id):
        ...
        error_code = self._library.niFgen_GetAttributeViReal64(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_string(self, attribute_id):
        ...
        error_code = self._library.niFgen_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            array_size_ctype,
        ...
        attribute_value_ctype = (
            _visatype.ViChar * array_size_ctype.value
        )()  # case C060
        error_code = self._library.niFgen_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
    ...
    def _get_error(self):
        ...
        **vi** parameter, this method retrieves and then clears the error
        ...
        error_code = self._library.niFgen_GetError(
            vi_ctype,
    ...
    def send_software_edge_trigger(self, trigger=None, trigger_id=None):
        ...
        if trigger is None or trigger_id is None:
            ...
            raise ValueError(
                "Both trigger ({0}) and trigger_id ({1}) should be passed in to the method".format(
                    str(trigger), str(trigger_id)
                )
            )
        ...
        trigger_id_ctype = ctypes.create_string_buffer(
            trigger_id.encode(self._encoding)
        )  # case C020
        error_code = self._library.niFgen_SendSoftwareEdgeTrigger(
            vi_ctype, trigger_ctype, trigger_id_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _set_attribute_vi_boolean(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFgen_SetAttributeViBoolean(
    ...
    def _set_attribute_vi_int32(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFgen_SetAttributeViInt32(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_real64(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFgen_SetAttributeViReal64(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_string(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niFgen_SetAttributeViString(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    @ivi_synchronized
    def _set_named_waveform_next_write_position(
        self, waveform_name, relative_to, offset
    ):
        ...
        if type(relative_to) is not enums.RelativeTo:
            raise TypeError(
                "Parameter relative_to must be of type " + str(enums.RelativeTo)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niFgen_SetNamedWaveformNextWritePosition(
            vi_ctype,
            channel_name_ctype,
            waveform_name_ctype,
            relative_to_ctype,
    ...
    def set_next_write_position(self, waveform_name_or_handle, relative_to, offset):
        ...
        """
        if isinstance(waveform_name_or_handle, str):
            return self._set_named_waveform_next_write_position(
                waveform_name_or_handle, relative_to, offset
            )
        else:
            return self._set_waveform_next_write_position(
                waveform_name_or_handle, relative_to, offset
            )
    ...
    def _set_waveform_next_write_position(self, waveform_handle, relative_to, offset):
        ...
        relative_to_ctype = _visatype.ViInt32(relative_to.value)  # case S130
        offset_ctype = _visatype.ViInt32(offset)  # case S150
        error_code = self._library.niFgen_SetWaveformNextWritePosition(
            vi_ctype,
            channel_name_ctype,
            waveform_handle_ctype,
            relative_to_ctype,
    ...
    def _write_binary16_waveform_numpy(self, waveform_handle, data):
        ...
        if type(data) is not numpy.ndarray:
            raise TypeError(
                "data must be {0}, is {1}".format(numpy.ndarray, type(data))
            )
        if numpy.isfortran(data) is True:
            raise TypeError("data must be in C-order")
        if data.dtype is not numpy.dtype("int16"):
            raise TypeError(
                "data must be numpy.ndarray of dtype=int16, is " + str(data.dtype)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
        ...
        error_code = self._library.niFgen_WriteBinary16Waveform(
            vi_ctype, channel_name_ctype, waveform_handle_ctype, size_ctype, data_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _write_named_waveform_f64(self, waveform_name, data):
        ...
        data_ctype = get_ctypes_pointer_for_buffer(
            value=data_array, library_type=_visatype.ViReal64
        )  # case B550
        error_code = self._library.niFgen_WriteNamedWaveformF64(
            vi_ctype, channel_name_ctype, waveform_name_ctype, size_ctype, data_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _write_named_waveform_f64_numpy(self, waveform_name, data):
        ...
        if data.dtype is not numpy.dtype("float64"):
            raise TypeError(
                "data must be numpy.ndarray of dtype=float64, is " + str(data.dtype)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(
            self._repeated_capability.encode(self._encoding)
    ...
    def _write_named_waveform_i16_numpy(self, waveform_name, data):
        ...
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
        data_ctype = get_ctypes_pointer_for_buffer(value=data)  # case B510
        error_code = self._library.niFgen_WriteNamedWaveformI16(
            vi_ctype, channel_name_ctype, waveform_name_ctype, size_ctype, data_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def write_script(self, script):
        ...
        script_ctype = ctypes.create_string_buffer(
            script.encode(self._encoding)
        )  # case C020
        error_code = self._library.niFgen_WriteScript(
            vi_ctype, channel_name_ctype, script_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _write_waveform(self, waveform_handle, data):
        ...
        error_code = self._library.niFgen_WriteWaveform(
            vi_ctype, channel_name_ctype, waveform_handle_ctype, size_ctype, data_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def write_waveform(self, waveform_name_or_handle, data):
        ...
        if str(type(data)).find("'numpy.ndarray'") != -1:
            ...
            if data.dtype == numpy.float64:
                return (
                    self._write_named_waveform_f64_numpy(waveform_name_or_handle, data)
                    if use_named
                    else self._write_waveform_numpy(waveform_name_or_handle, data)
                )
            elif data.dtype == numpy.int16:
                return (
                    self._write_named_waveform_i16_numpy(waveform_name_or_handle, data)
                    if use_named
                    else self._write_binary16_waveform_numpy(
                        waveform_name_or_handle, data
                    )
                )
            else:
                raise TypeError(
                    "Unsupported dtype. Is {0}, expected {1} or {2}".format(
                        data.dtype, numpy.float64, numpy.int16
                    )
                )
        elif isinstance(data, array.array):
            if data.typecode == "d":
                return (
                    self._write_named_waveform_f64(waveform_name_or_handle, data)
                    if use_named
                    else self._write_waveform(waveform_name_or_handle, data)
                )
            elif data.typecode == "h":
                return (
                    self._write_named_waveform_i16(waveform_name_or_handle, data)
                    if use_named
                    else self._write_binary16_waveform(waveform_name_or_handle, data)
                )
            else:
                raise TypeError(
                    "Unsupported dtype. Is {0}, expected {1} or {2}".format(
                        data.typecode, "d (double)", "h (16 bit int)"
                    )
                )
    ...
    def _error_message(self, error_code):
        ...
        error_code = self._library.niFgen_error_message(
...
class Session(_SessionBase):
    ...
    def __init__(
        self, resource_name, channel_name=None, reset_device=False, options={}
    ):
        ...
        channel_name = _converters.convert_repeated_capabilities_without_prefix(
            channel_name
        )
        ...
        self._vi = self._initialize_with_channels(
            resource_name, channel_name, reset_device, options
        )
    ...
    def clear_arb_sequence(self, sequence_handle):
        ...
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        sequence_handle_ctype = _visatype.ViInt32(sequence_handle)  # case S150
        error_code = self._library.niFgen_ClearArbSequence(
            vi_ctype, sequence_handle_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _clear_arb_waveform(self, waveform_handle):
        ...
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
        error_code = self._library.niFgen_ClearArbWaveform(
            vi_ctype, waveform_handle_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def clear_freq_list(self, frequency_list_handle):
        ...
        error_code = self._library.niFgen_ClearFreqList(
            vi_ctype, frequency_list_handle_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def create_advanced_arb_sequence(
        ...
        **outputMode** parameter to OutputMode.SEQ before calling this
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        sequence_length_ctype = _visatype.ViInt32(
            0 if waveform_handles_array is None else len(waveform_handles_array)
        )  # case S160
        if loop_counts_array is not None and len(loop_counts_array) != len(
            waveform_handles_array
        ):  # case S160
            raise ValueError(
                "Length of loop_counts_array and waveform_handles_array parameters do not match."
            )  # case S160
        if sample_counts_array is not None and len(sample_counts_array) != len(
            waveform_handles_array
        ):  # case S160
            raise ValueError(
                "Length of sample_counts_array and waveform_handles_array parameters do not match."
            )  # case S160
        if marker_location_array is not None and len(marker_location_array) != len(
            waveform_handles_array
        ):  # case S160
            raise ValueError(
                "Length of marker_location_array and waveform_handles_array parameters do not match."
            )  # case S160
        waveform_handles_array_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_handles_array, library_type=_visatype.ViInt32
        )  # case B550
        loop_counts_array_ctype = get_ctypes_pointer_for_buffer(
            value=loop_counts_array, library_type=_visatype.ViInt32
        )  # case B550
        sample_counts_array_ctype = get_ctypes_pointer_for_buffer(
            value=sample_counts_array, library_type=_visatype.ViInt32
        )  # case B550
        marker_location_array_ctype = get_ctypes_pointer_for_buffer(
            value=marker_location_array, library_type=_visatype.ViInt32
        )  # case B550
        coerced_markers_array_size = (
            0 if marker_location_array is None else len(marker_location_array)
        )  # case B560
        coerced_markers_array_ctype = get_ctypes_pointer_for_buffer(
            library_type=_visatype.ViInt32, size=coerced_markers_array_size
        )  # case B560
        sequence_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateAdvancedArbSequence(
            vi_ctype,
            sequence_length_ctype,
            waveform_handles_array_ctype,
            loop_counts_array_ctype,
            sample_counts_array_ctype,
            marker_location_array_ctype,
            coerced_markers_array_ctype,
            None
            if sequence_handle_ctype is None
            else (ctypes.pointer(sequence_handle_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return [
            int(coerced_markers_array_ctype[i])
            for i in range(
                (0 if marker_location_array is None else len(marker_location_array))
            )
        ], int(sequence_handle_ctype.value)
    ...
    def create_arb_sequence(self, waveform_handles_array, loop_counts_array):
        ...
        **outputMode** parameter to OutputMode.SEQ before calling this
        ...
        sequence_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateArbSequence(
            vi_ctype,
            sequence_length_ctype,
            waveform_handles_array_ctype,
            loop_counts_array_ctype,
    ...
    def create_freq_list(self, waveform, frequency_array, duration_array):
        ...
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        waveform_ctype = _visatype.ViInt32(waveform.value)  # case S130
        frequency_list_length_ctype = _visatype.ViInt32(
            0 if frequency_array is None else len(frequency_array)
        )  # case S160
        if duration_array is not None and len(duration_array) != len(
            frequency_array
        ):  # case S160
            raise ValueError(
                "Length of duration_array and frequency_array parameters do not match."
            )  # case S160
        frequency_array_ctype = get_ctypes_pointer_for_buffer(
            value=frequency_array, library_type=_visatype.ViReal64
        )  # case B550
        duration_array_ctype = get_ctypes_pointer_for_buffer(
            value=duration_array, library_type=_visatype.ViReal64
        )  # case B550
        frequency_list_handle_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_CreateFreqList(
            vi_ctype,
            waveform_ctype,
            frequency_list_length_ctype,
            frequency_array_ctype,
            duration_array_ctype,
            None
            if frequency_list_handle_ctype is None
            else (ctypes.pointer(frequency_list_handle_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def export_attribute_configuration_buffer(self):
        ...
        error_code = self._library.niFgen_ExportAttributeConfigurationBuffer(
            vi_ctype, size_in_bytes_ctype, configuration_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def export_attribute_configuration_file(self, file_path):
        ...
        error_code = self._library.niFgen_ExportAttributeConfigurationFile(
    ...
    def get_channel_name(self, index):
        ...
        error_code = self._library.niFgen_GetChannelName(
            vi_ctype, index_ctype, buffer_size_ctype, channel_string_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        buffer_size_ctype = _visatype.ViInt32(error_code)  # case S180
        channel_string_ctype = (
    ...
    def _get_ext_cal_last_date_and_time(self):
        ...
        **hour** parameter and 30 for the **minute** parameter.
        ...
        error_code = self._library.niFgen_GetExtCalLastDateAndTime(
            vi_ctype,
    ...
    def get_ext_cal_last_temp(self):
        ...
        error_code = self._library.niFgen_GetExtCalLastTemp(
            vi_ctype,
    ...
    def get_ext_cal_recommended_interval(self):
        ...
        error_code = self._library.niFgen_GetExtCalRecommendedInterval(
    ...
    def get_hardware_state(self):
        ...
        error_code = self._library.niFgen_GetHardwareState(
            vi_ctype, None if state_ctype is None else (ctypes.pointer(state_ctype))
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _get_self_cal_last_date_and_time(self):
        ...
        **hours** parameter and 30 for the **minutes** parameter.
        ...
        hour_ctype = _visatype.ViInt32()  # case S220
        minute_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niFgen_GetSelfCalLastDateAndTime(
            vi_ctype,
            None if year_ctype is None else (ctypes.pointer(year_ctype)),
            None if month_ctype is None else (ctypes.pointer(month_ctype)),
            None if day_ctype is None else (ctypes.pointer(day_ctype)),
    ...
    def get_self_cal_last_temp(self):
        ...
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        temperature_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niFgen_GetSelfCalLastTemp(
            vi_ctype,
            None if temperature_ctype is None else (ctypes.pointer(temperature_ctype)),
        )
        errors.handle_error(
    ...
    def get_self_cal_supported(self):
        ...
        error_code = self._library.niFgen_GetSelfCalSupported(
            vi_ctype,
            None
            if self_cal_supported_ctype is None
            else (ctypes.pointer(self_cal_supported_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def import_attribute_configuration_buffer(self, configuration):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        size_in_bytes_ctype = _visatype.ViInt32(
        ...
        error_code = self._library.niFgen_ImportAttributeConfigurationBuffer(
            vi_ctype, size_in_bytes_ctype, configuration_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def import_attribute_configuration_file(self, file_path):
        ...
        error_code = self._library.niFgen_ImportAttributeConfigurationFile(
            vi_ctype, file_path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _initialize_with_channels(
        self, resource_name, channel_name=None, reset_device=False, option_string=""
    ):
        ...
        error_code = self._library.niFgen_InitializeWithChannels(
            resource_name_ctype,
            channel_name_ctype,
            reset_device_ctype,
            option_string_ctype,
    ...
    def is_done(self):
        ...
        error_code = self._library.niFgen_IsDone(
    ...
    def query_arb_seq_capabilities(self):
        ...
        error_code = self._library.niFgen_QueryArbSeqCapabilities(
            vi_ctype,
            None
            if maximum_number_of_sequences_ctype is None
            else (ctypes.pointer(maximum_number_of_sequences_ctype)),
            None
            if minimum_sequence_length_ctype is None
            else (ctypes.pointer(minimum_sequence_length_ctype)),
            None
            if maximum_sequence_length_ctype is None
            else (ctypes.pointer(maximum_sequence_length_ctype)),
            None
            if maximum_loop_count_ctype is None
            else (ctypes.pointer(maximum_loop_count_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return (
            int(maximum_number_of_sequences_ctype.value),
            int(minimum_sequence_length_ctype.value),
            int(maximum_sequence_length_ctype.value),
            int(maximum_loop_count_ctype.value),
        )
    ...
    def query_arb_wfm_capabilities(self):
        ...
        error_code = self._library.niFgen_QueryArbWfmCapabilities(
            vi_ctype,
            None
            if maximum_number_of_waveforms_ctype is None
            else (ctypes.pointer(maximum_number_of_waveforms_ctype)),
            None
            if waveform_quantum_ctype is None
            else (ctypes.pointer(waveform_quantum_ctype)),
            None
            if minimum_waveform_size_ctype is None
            else (ctypes.pointer(minimum_waveform_size_ctype)),
            None
            if maximum_waveform_size_ctype is None
            else (ctypes.pointer(maximum_waveform_size_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return (
            int(maximum_number_of_waveforms_ctype.value),
            int(waveform_quantum_ctype.value),
            int(minimum_waveform_size_ctype.value),
            int(maximum_waveform_size_ctype.value),
        )
    ...
    def query_freq_list_capabilities(self):
        ...
        error_code = self._library.niFgen_QueryFreqListCapabilities(
            vi_ctype,
            None
            if maximum_number_of_freq_lists_ctype is None
            else (ctypes.pointer(maximum_number_of_freq_lists_ctype)),
            None
            if minimum_frequency_list_length_ctype is None
            else (ctypes.pointer(minimum_frequency_list_length_ctype)),
            None
            if maximum_frequency_list_length_ctype is None
            else (ctypes.pointer(maximum_frequency_list_length_ctype)),
            None
            if minimum_frequency_list_duration_ctype is None
            else (ctypes.pointer(minimum_frequency_list_duration_ctype)),
            None
            if maximum_frequency_list_duration_ctype is None
            else (ctypes.pointer(maximum_frequency_list_duration_ctype)),
            None
            if frequency_list_duration_quantum_ctype is None
            else (ctypes.pointer(frequency_list_duration_quantum_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
        return (
            int(maximum_number_of_freq_lists_ctype.value),
            int(minimum_frequency_list_length_ctype.value),
            int(maximum_frequency_list_length_ctype.value),
            float(minimum_frequency_list_duration_ctype.value),
            float(maximum_frequency_list_duration_ctype.value),
            float(frequency_list_duration_quantum_ctype.value),
        )
    ...
    def read_current_temperature(self):
        ...
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        temperature_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niFgen_ReadCurrentTemperature(
            vi_ctype,
            None if temperature_ctype is None else (ctypes.pointer(temperature_ctype)),
        )
        errors.handle_error(
    ...
    def wait_until_done(self, max_time=hightime.timedelta(seconds=10.0)):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        max_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(
            max_time
        )  # case S140
    ...
    def _self_test(self):
        ...
        error_code = self._library.niFgen_self_test(
            vi_ctype,
            None
