...
class SideEffectsHelper(object):
    ...
    def niFgen_AllocateWaveform(
        ...
        if self._defaults["AllocateWaveform"]["waveformHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_AllocateWaveform", param="waveformHandle"
            )
        if waveform_handle is not None:
            waveform_handle.contents.value = self._defaults["AllocateWaveform"][
                "waveformHandle"
            ]
        return self._defaults["AllocateWaveform"]["return"]
    ...
    def niFgen_CreateAdvancedArbSequence(
        ...
        if self._defaults["CreateAdvancedArbSequence"]["coercedMarkersArray"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateAdvancedArbSequence", param="coercedMarkersArray"
            )
        ...
        if self._defaults["CreateAdvancedArbSequence"]["sequenceHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateAdvancedArbSequence", param="sequenceHandle"
            )
        if sequence_handle is not None:
            sequence_handle.contents.value = self._defaults[
    ...
    def niFgen_CreateArbSequence(
        ...
        if self._defaults["CreateArbSequence"]["sequenceHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateArbSequence", param="sequenceHandle"
            )
        if sequence_handle is not None:
            sequence_handle.contents.value = self._defaults["CreateArbSequence"][
                "sequenceHandle"
            ]
        return self._defaults["CreateArbSequence"]["return"]
    ...
    def niFgen_CreateFreqList(
        ...
        if self._defaults["CreateFreqList"]["frequencyListHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateFreqList", param="frequencyListHandle"
            )
        if frequency_list_handle is not None:
            frequency_list_handle.contents.value = self._defaults["CreateFreqList"][
                "frequencyListHandle"
            ]
        return self._defaults["CreateFreqList"]["return"]
    ...
    def niFgen_CreateWaveformF64(
        ...
        if self._defaults["CreateWaveformF64"]["waveformHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateWaveformF64", param="waveformHandle"
            )
        if waveform_handle is not None:
            waveform_handle.contents.value = self._defaults["CreateWaveformF64"][
                "waveformHandle"
            ]
        return self._defaults["CreateWaveformF64"]["return"]
    ...
    def niFgen_CreateWaveformFromFileF64(
        ...
        if self._defaults["CreateWaveformFromFileF64"]["waveformHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateWaveformFromFileF64", param="waveformHandle"
            )
        if waveform_handle is not None:
            waveform_handle.contents.value = self._defaults[
    ...
    def niFgen_CreateWaveformFromFileI16(
        ...
        if self._defaults["CreateWaveformFromFileI16"]["waveformHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateWaveformFromFileI16", param="waveformHandle"
            )
        if waveform_handle is not None:
            waveform_handle.contents.value = self._defaults[
    ...
    def niFgen_CreateWaveformI16(
        ...
        if self._defaults["CreateWaveformI16"]["waveformHandle"] is None:
            raise MockFunctionCallError(
                "niFgen_CreateWaveformI16", param="waveformHandle"
            )
        if waveform_handle is not None:
            waveform_handle.contents.value = self._defaults["CreateWaveformI16"][
                "waveformHandle"
            ]
        return self._defaults["CreateWaveformI16"]["return"]
    ...
    def niFgen_ExportAttributeConfigurationBuffer(
        ...
        if (
            self._defaults["ExportAttributeConfigurationBuffer"]["configuration"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_ExportAttributeConfigurationBuffer", param="configuration"
            )
        ...
        for i in range(
            len(self._defaults["ExportAttributeConfigurationBuffer"]["configuration"])
        ):
            configuration_ref[i] = self._defaults["ExportAttributeConfigurationBuffer"][
                "configuration"
            ][i]
        return self._defaults["ExportAttributeConfigurationBuffer"]["return"]
    ...
    def niFgen_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFgen_GetAttributeViBoolean", param="attributeValue"
            )
        if attribute_value is not None:
            attribute_value.contents.value = self._defaults["GetAttributeViBoolean"][
                "attributeValue"
            ]
        return self._defaults["GetAttributeViBoolean"]["return"]
    ...
    def niFgen_GetAttributeViInt32(
        ...
        if self._defaults["GetAttributeViInt32"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFgen_GetAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
            attribute_value.contents.value = self._defaults["GetAttributeViInt32"][
                "attributeValue"
            ]
        return self._defaults["GetAttributeViInt32"]["return"]
    ...
    def niFgen_GetAttributeViReal64(
        ...
        if self._defaults["GetAttributeViReal64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFgen_GetAttributeViReal64", param="attributeValue"
            )
        if attribute_value is not None:
            attribute_value.contents.value = self._defaults["GetAttributeViReal64"][
                "attributeValue"
            ]
        return self._defaults["GetAttributeViReal64"]["return"]
    ...
    def niFgen_GetAttributeViString(
        ...
        if self._defaults["GetAttributeViString"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niFgen_GetAttributeViString", param="attributeValue"
            )
        if array_size.value == 0:
            return len(self._defaults["GetAttributeViString"]["attributeValue"])
        attribute_value.value = self._defaults["GetAttributeViString"][
            "attributeValue"
        ].encode("ascii")
        return self._defaults["GetAttributeViString"]["return"]
    ...
    def niFgen_GetChannelName(
        ...
        channel_string.value = self._defaults["GetChannelName"]["channelString"].encode(
            "ascii"
        )
        return self._defaults["GetChannelName"]["return"]
    ...
    def niFgen_GetExtCalLastDateAndTime(
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niFgen_GetExtCalLastDateAndTime", param="month"
            )
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["minute"] is None:
            raise MockFunctionCallError(
                "niFgen_GetExtCalLastDateAndTime", param="minute"
            )
    ...
    def niFgen_GetExtCalLastTemp(self, vi, temperature):  # noqa: N802
        ...
        if temperature is not None:
            temperature.contents.value = self._defaults["GetExtCalLastTemp"][
                "temperature"
            ]
        return self._defaults["GetExtCalLastTemp"]["return"]
    ...
    def niFgen_GetExtCalRecommendedInterval(self, vi, months):  # noqa: N802
        ...
        if self._defaults["GetExtCalRecommendedInterval"]["months"] is None:
            raise MockFunctionCallError(
                "niFgen_GetExtCalRecommendedInterval", param="months"
            )
        if months is not None:
            months.contents.value = self._defaults["GetExtCalRecommendedInterval"][
                "months"
            ]
        return self._defaults["GetExtCalRecommendedInterval"]["return"]
    ...
    def niFgen_GetLastExtCalLastDateAndTime(self, vi, month):  # noqa: N802
        ...
        if self._defaults["GetLastExtCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niFgen_GetLastExtCalLastDateAndTime", param="month"
            )
        if month is not None:
            month.contents.value = self._defaults["GetLastExtCalLastDateAndTime"][
                "month"
            ]
        return self._defaults["GetLastExtCalLastDateAndTime"]["return"]
    ...
    def niFgen_GetLastSelfCalLastDateAndTime(self, vi, month):  # noqa: N802
        ...
        if self._defaults["GetLastSelfCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niFgen_GetLastSelfCalLastDateAndTime", param="month"
            )
        if month is not None:
            month.contents.value = self._defaults["GetLastSelfCalLastDateAndTime"][
                "month"
            ]
        return self._defaults["GetLastSelfCalLastDateAndTime"]["return"]
    ...
    def niFgen_GetSelfCalLastDateAndTime(
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["year"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalLastDateAndTime", param="year"
            )
        if year is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalLastDateAndTime", param="month"
            )
        if month is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["hour"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalLastDateAndTime", param="hour"
            )
        if hour is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["minute"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalLastDateAndTime", param="minute"
            )
        if minute is not None:
    ...
    def niFgen_GetSelfCalLastTemp(self, vi, temperature):  # noqa: N802
        ...
        if self._defaults["GetSelfCalLastTemp"]["temperature"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalLastTemp", param="temperature"
            )
        if temperature is not None:
            temperature.contents.value = self._defaults["GetSelfCalLastTemp"][
                "temperature"
            ]
        return self._defaults["GetSelfCalLastTemp"]["return"]
    ...
    def niFgen_GetSelfCalSupported(self, vi, self_cal_supported):  # noqa: N802
        ...
        if self._defaults["GetSelfCalSupported"]["selfCalSupported"] is None:
            raise MockFunctionCallError(
                "niFgen_GetSelfCalSupported", param="selfCalSupported"
            )
        if self_cal_supported is not None:
            self_cal_supported.contents.value = self._defaults["GetSelfCalSupported"][
                "selfCalSupported"
            ]
        return self._defaults["GetSelfCalSupported"]["return"]
    ...
    def niFgen_QueryArbSeqCapabilities(
        ...
        # maximum_number_of_sequences
        if (
            self._defaults["QueryArbSeqCapabilities"]["maximumNumberOfSequences"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryArbSeqCapabilities", param="maximumNumberOfSequences"
            )
        if maximum_number_of_sequences is not None:
            maximum_number_of_sequences.contents.value = self._defaults[
                "QueryArbSeqCapabilities"
            ]["maximumNumberOfSequences"]
        # minimum_sequence_length
        if self._defaults["QueryArbSeqCapabilities"]["minimumSequenceLength"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbSeqCapabilities", param="minimumSequenceLength"
            )
        if minimum_sequence_length is not None:
            minimum_sequence_length.contents.value = self._defaults[
                "QueryArbSeqCapabilities"
            ]["minimumSequenceLength"]
        # maximum_sequence_length
        if self._defaults["QueryArbSeqCapabilities"]["maximumSequenceLength"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbSeqCapabilities", param="maximumSequenceLength"
            )
        if maximum_sequence_length is not None:
            maximum_sequence_length.contents.value = self._defaults[
                "QueryArbSeqCapabilities"
            ]["maximumSequenceLength"]
        # maximum_loop_count
        if self._defaults["QueryArbSeqCapabilities"]["maximumLoopCount"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbSeqCapabilities", param="maximumLoopCount"
            )
        if maximum_loop_count is not None:
            maximum_loop_count.contents.value = self._defaults[
                "QueryArbSeqCapabilities"
            ]["maximumLoopCount"]
        return self._defaults["QueryArbSeqCapabilities"]["return"]
    ...
    def niFgen_QueryArbWfmCapabilities(
        ...
        # maximum_number_of_waveforms
        if (
            self._defaults["QueryArbWfmCapabilities"]["maximumNumberOfWaveforms"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryArbWfmCapabilities", param="maximumNumberOfWaveforms"
            )
        if maximum_number_of_waveforms is not None:
            maximum_number_of_waveforms.contents.value = self._defaults[
                "QueryArbWfmCapabilities"
            ]["maximumNumberOfWaveforms"]
        # waveform_quantum
        if self._defaults["QueryArbWfmCapabilities"]["waveformQuantum"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbWfmCapabilities", param="waveformQuantum"
            )
        if waveform_quantum is not None:
            waveform_quantum.contents.value = self._defaults["QueryArbWfmCapabilities"][
                "waveformQuantum"
            ]
        # minimum_waveform_size
        if self._defaults["QueryArbWfmCapabilities"]["minimumWaveformSize"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbWfmCapabilities", param="minimumWaveformSize"
            )
        if minimum_waveform_size is not None:
            minimum_waveform_size.contents.value = self._defaults[
                "QueryArbWfmCapabilities"
            ]["minimumWaveformSize"]
        # maximum_waveform_size
        if self._defaults["QueryArbWfmCapabilities"]["maximumWaveformSize"] is None:
            raise MockFunctionCallError(
                "niFgen_QueryArbWfmCapabilities", param="maximumWaveformSize"
            )
        if maximum_waveform_size is not None:
            maximum_waveform_size.contents.value = self._defaults[
                "QueryArbWfmCapabilities"
            ]["maximumWaveformSize"]
        return self._defaults["QueryArbWfmCapabilities"]["return"]
    ...
    def niFgen_QueryFreqListCapabilities(
        ...
        # maximum_number_of_freq_lists
        if (
            self._defaults["QueryFreqListCapabilities"]["maximumNumberOfFreqLists"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="maximumNumberOfFreqLists"
            )
        if maximum_number_of_freq_lists is not None:
            maximum_number_of_freq_lists.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["maximumNumberOfFreqLists"]
        # minimum_frequency_list_length
        if (
            self._defaults["QueryFreqListCapabilities"]["minimumFrequencyListLength"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="minimumFrequencyListLength"
            )
        if minimum_frequency_list_length is not None:
            minimum_frequency_list_length.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["minimumFrequencyListLength"]
        # maximum_frequency_list_length
        if (
            self._defaults["QueryFreqListCapabilities"]["maximumFrequencyListLength"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="maximumFrequencyListLength"
            )
        if maximum_frequency_list_length is not None:
            maximum_frequency_list_length.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["maximumFrequencyListLength"]
        # minimum_frequency_list_duration
        if (
            self._defaults["QueryFreqListCapabilities"]["minimumFrequencyListDuration"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="minimumFrequencyListDuration"
            )
        if minimum_frequency_list_duration is not None:
            minimum_frequency_list_duration.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["minimumFrequencyListDuration"]
        # maximum_frequency_list_duration
        if (
            self._defaults["QueryFreqListCapabilities"]["maximumFrequencyListDuration"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="maximumFrequencyListDuration"
            )
        if maximum_frequency_list_duration is not None:
            maximum_frequency_list_duration.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["maximumFrequencyListDuration"]
        # frequency_list_duration_quantum
        if (
            self._defaults["QueryFreqListCapabilities"]["frequencyListDurationQuantum"]
            is None
        ):
            raise MockFunctionCallError(
                "niFgen_QueryFreqListCapabilities", param="frequencyListDurationQuantum"
            )
        if frequency_list_duration_quantum is not None:
            frequency_list_duration_quantum.contents.value = self._defaults[
                "QueryFreqListCapabilities"
            ]["frequencyListDurationQuantum"]
        return self._defaults["QueryFreqListCapabilities"]["return"]
    ...
    def niFgen_ReadCurrentTemperature(self, vi, temperature):  # noqa: N802
        ...
        if self._defaults["ReadCurrentTemperature"]["temperature"] is None:
            raise MockFunctionCallError(
                "niFgen_ReadCurrentTemperature", param="temperature"
            )
        if temperature is not None:
            temperature.contents.value = self._defaults["ReadCurrentTemperature"][
                "temperature"
            ]
        return self._defaults["ReadCurrentTemperature"]["return"]
    ...
    def niFgen_self_test(self, vi, self_test_result, self_test_message):  # noqa: N802
        ...
        if self_test_result is not None:
            self_test_result.contents.value = self._defaults["self_test"][
                "selfTestResult"
            ]
        # self_test_message
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niFgen_AbortGeneration.side_effect = MockFunctionCallError(
            "niFgen_AbortGeneration"
        )
        mock_library.niFgen_AbortGeneration.return_value = 0
        mock_library.niFgen_AllocateNamedWaveform.side_effect = MockFunctionCallError(
            "niFgen_AllocateNamedWaveform"
        )
        mock_library.niFgen_AllocateNamedWaveform.return_value = 0
        mock_library.niFgen_AllocateWaveform.side_effect = MockFunctionCallError(
            "niFgen_AllocateWaveform"
        )
        mock_library.niFgen_AllocateWaveform.return_value = 0
        mock_library.niFgen_ClearArbMemory.side_effect = MockFunctionCallError(
            "niFgen_ClearArbMemory"
        )
        mock_library.niFgen_ClearArbMemory.return_value = 0
        mock_library.niFgen_ClearArbSequence.side_effect = MockFunctionCallError(
            "niFgen_ClearArbSequence"
        )
        mock_library.niFgen_ClearArbSequence.return_value = 0
        mock_library.niFgen_ClearArbWaveform.side_effect = MockFunctionCallError(
            "niFgen_ClearArbWaveform"
        )
        mock_library.niFgen_ClearArbWaveform.return_value = 0
        mock_library.niFgen_ClearFreqList.side_effect = MockFunctionCallError(
            "niFgen_ClearFreqList"
        )
        mock_library.niFgen_ClearFreqList.return_value = 0
        mock_library.niFgen_ClearUserStandardWaveform.side_effect = (
            MockFunctionCallError("niFgen_ClearUserStandardWaveform")
        )
        ...
        mock_library.niFgen_ConfigureArbSequence.side_effect = MockFunctionCallError(
            "niFgen_ConfigureArbSequence"
        )
        mock_library.niFgen_ConfigureArbSequence.return_value = 0
        mock_library.niFgen_ConfigureArbWaveform.side_effect = MockFunctionCallError(
            "niFgen_ConfigureArbWaveform"
        )
        mock_library.niFgen_ConfigureArbWaveform.return_value = 0
        mock_library.niFgen_ConfigureFreqList.side_effect = MockFunctionCallError(
            "niFgen_ConfigureFreqList"
        )
        mock_library.niFgen_ConfigureFreqList.return_value = 0
        mock_library.niFgen_ConfigureStandardWaveform.side_effect = (
            MockFunctionCallError("niFgen_ConfigureStandardWaveform")
        )
        mock_library.niFgen_ConfigureStandardWaveform.return_value = 0
        mock_library.niFgen_CreateAdvancedArbSequence.side_effect = (
            MockFunctionCallError("niFgen_CreateAdvancedArbSequence")
        )
        mock_library.niFgen_CreateAdvancedArbSequence.return_value = 0
        mock_library.niFgen_CreateArbSequence.side_effect = MockFunctionCallError(
            "niFgen_CreateArbSequence"
        )
        mock_library.niFgen_CreateArbSequence.return_value = 0
        mock_library.niFgen_CreateFreqList.side_effect = MockFunctionCallError(
            "niFgen_CreateFreqList"
        )
        mock_library.niFgen_CreateFreqList.return_value = 0
        mock_library.niFgen_CreateWaveformF64.side_effect = MockFunctionCallError(
            "niFgen_CreateWaveformF64"
        )
        mock_library.niFgen_CreateWaveformF64.return_value = 0
        mock_library.niFgen_CreateWaveformFromFileF64.side_effect = (
            MockFunctionCallError("niFgen_CreateWaveformFromFileF64")
        )
        mock_library.niFgen_CreateWaveformFromFileF64.return_value = 0
        mock_library.niFgen_CreateWaveformFromFileI16.side_effect = (
            MockFunctionCallError("niFgen_CreateWaveformFromFileI16")
        )
        mock_library.niFgen_CreateWaveformFromFileI16.return_value = 0
        mock_library.niFgen_CreateWaveformI16.side_effect = MockFunctionCallError(
            "niFgen_CreateWaveformI16"
        )
        mock_library.niFgen_CreateWaveformI16.return_value = 0
        mock_library.niFgen_DefineUserStandardWaveform.side_effect = (
            MockFunctionCallError("niFgen_DefineUserStandardWaveform")
        )
        mock_library.niFgen_DefineUserStandardWaveform.return_value = 0
        mock_library.niFgen_DeleteNamedWaveform.side_effect = MockFunctionCallError(
            "niFgen_DeleteNamedWaveform"
        )
        mock_library.niFgen_DeleteNamedWaveform.return_value = 0
        mock_library.niFgen_DeleteScript.side_effect = MockFunctionCallError(
            "niFgen_DeleteScript"
        )
        mock_library.niFgen_DeleteScript.return_value = 0
        mock_library.niFgen_Disable.side_effect = MockFunctionCallError(
            "niFgen_Disable"
        )
        mock_library.niFgen_Disable.return_value = 0
        mock_library.niFgen_ExportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niFgen_ExportAttributeConfigurationBuffer")
        )
        mock_library.niFgen_ExportAttributeConfigurationBuffer.return_value = 0
        mock_library.niFgen_ExportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niFgen_ExportAttributeConfigurationFile")
        )
        mock_library.niFgen_ExportAttributeConfigurationFile.return_value = 0
        mock_library.niFgen_GetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niFgen_GetAttributeViBoolean"
        )
        mock_library.niFgen_GetAttributeViBoolean.return_value = 0
        mock_library.niFgen_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niFgen_GetAttributeViInt32"
        )
        mock_library.niFgen_GetAttributeViInt32.return_value = 0
        mock_library.niFgen_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niFgen_GetAttributeViReal64"
        )
        mock_library.niFgen_GetAttributeViReal64.return_value = 0
        mock_library.niFgen_GetAttributeViString.side_effect = MockFunctionCallError(
            "niFgen_GetAttributeViString"
        )
        mock_library.niFgen_GetAttributeViString.return_value = 0
        mock_library.niFgen_GetChannelName.side_effect = MockFunctionCallError(
            "niFgen_GetChannelName"
        )
        mock_library.niFgen_GetChannelName.return_value = 0
        mock_library.niFgen_GetError.side_effect = MockFunctionCallError(
            "niFgen_GetError"
        )
        mock_library.niFgen_GetError.return_value = 0
        mock_library.niFgen_GetExtCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niFgen_GetExtCalLastDateAndTime")
        )
        mock_library.niFgen_GetExtCalLastDateAndTime.return_value = 0
        mock_library.niFgen_GetExtCalLastTemp.side_effect = MockFunctionCallError(
            "niFgen_GetExtCalLastTemp"
        )
        mock_library.niFgen_GetExtCalLastTemp.return_value = 0
        mock_library.niFgen_GetExtCalRecommendedInterval.side_effect = (
            MockFunctionCallError("niFgen_GetExtCalRecommendedInterval")
        )
        mock_library.niFgen_GetExtCalRecommendedInterval.return_value = 0
        mock_library.niFgen_GetHardwareState.side_effect = MockFunctionCallError(
            "niFgen_GetHardwareState"
        )
        mock_library.niFgen_GetHardwareState.return_value = 0
        mock_library.niFgen_GetLastExtCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niFgen_GetLastExtCalLastDateAndTime")
        )
        mock_library.niFgen_GetLastExtCalLastDateAndTime.return_value = 0
        mock_library.niFgen_GetLastSelfCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niFgen_GetLastSelfCalLastDateAndTime")
        )
        mock_library.niFgen_GetLastSelfCalLastDateAndTime.return_value = 0
        mock_library.niFgen_GetSelfCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niFgen_GetSelfCalLastDateAndTime")
        )
        mock_library.niFgen_GetSelfCalLastDateAndTime.return_value = 0
        mock_library.niFgen_GetSelfCalLastTemp.side_effect = MockFunctionCallError(
            "niFgen_GetSelfCalLastTemp"
        )
        mock_library.niFgen_GetSelfCalLastTemp.return_value = 0
        mock_library.niFgen_GetSelfCalSupported.side_effect = MockFunctionCallError(
            "niFgen_GetSelfCalSupported"
        )
        mock_library.niFgen_GetSelfCalSupported.return_value = 0
        mock_library.niFgen_ImportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niFgen_ImportAttributeConfigurationBuffer")
        )
        mock_library.niFgen_ImportAttributeConfigurationBuffer.return_value = 0
        mock_library.niFgen_ImportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niFgen_ImportAttributeConfigurationFile")
        )
        mock_library.niFgen_ImportAttributeConfigurationFile.return_value = 0
        mock_library.niFgen_InitializeWithChannels.side_effect = MockFunctionCallError(
            "niFgen_InitializeWithChannels"
        )
        mock_library.niFgen_InitializeWithChannels.return_value = 0
        mock_library.niFgen_InitiateGeneration.side_effect = MockFunctionCallError(
        ...
        mock_library.niFgen_LockSession.side_effect = MockFunctionCallError(
            "niFgen_LockSession"
        )
        mock_library.niFgen_LockSession.return_value = 0
        mock_library.niFgen_QueryArbSeqCapabilities.side_effect = MockFunctionCallError(
            "niFgen_QueryArbSeqCapabilities"
        )
        mock_library.niFgen_QueryArbSeqCapabilities.return_value = 0
        mock_library.niFgen_QueryArbWfmCapabilities.side_effect = MockFunctionCallError(
            "niFgen_QueryArbWfmCapabilities"
        )
        mock_library.niFgen_QueryArbWfmCapabilities.return_value = 0
        mock_library.niFgen_QueryFreqListCapabilities.side_effect = (
            MockFunctionCallError("niFgen_QueryFreqListCapabilities")
        )
        mock_library.niFgen_QueryFreqListCapabilities.return_value = 0
        mock_library.niFgen_ReadCurrentTemperature.side_effect = MockFunctionCallError(
            "niFgen_ReadCurrentTemperature"
        )
        mock_library.niFgen_ReadCurrentTemperature.return_value = 0
        mock_library.niFgen_ResetDevice.side_effect = MockFunctionCallError(
            "niFgen_ResetDevice"
        )
        mock_library.niFgen_ResetDevice.return_value = 0
        mock_library.niFgen_ResetWithDefaults.side_effect = MockFunctionCallError(
            "niFgen_ResetWithDefaults"
        )
        mock_library.niFgen_ResetWithDefaults.return_value = 0
        mock_library.niFgen_SelfCal.side_effect = MockFunctionCallError(
            "niFgen_SelfCal"
        )
        mock_library.niFgen_SelfCal.return_value = 0
        mock_library.niFgen_SendSoftwareEdgeTrigger.side_effect = MockFunctionCallError(
            "niFgen_SendSoftwareEdgeTrigger"
        )
        mock_library.niFgen_SendSoftwareEdgeTrigger.return_value = 0
        mock_library.niFgen_SetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niFgen_SetAttributeViBoolean"
        )
        mock_library.niFgen_SetAttributeViBoolean.return_value = 0
        mock_library.niFgen_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niFgen_SetAttributeViInt32"
        )
        mock_library.niFgen_SetAttributeViInt32.return_value = 0
        mock_library.niFgen_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niFgen_SetAttributeViReal64"
        )
        mock_library.niFgen_SetAttributeViReal64.return_value = 0
        mock_library.niFgen_SetAttributeViString.side_effect = MockFunctionCallError(
            "niFgen_SetAttributeViString"
        )
        mock_library.niFgen_SetAttributeViString.return_value = 0
        mock_library.niFgen_SetNamedWaveformNextWritePosition.side_effect = (
            MockFunctionCallError("niFgen_SetNamedWaveformNextWritePosition")
        )
        mock_library.niFgen_SetNamedWaveformNextWritePosition.return_value = 0
        mock_library.niFgen_SetWaveformNextWritePosition.side_effect = (
            MockFunctionCallError("niFgen_SetWaveformNextWritePosition")
        )
        mock_library.niFgen_SetWaveformNextWritePosition.return_value = 0
        mock_library.niFgen_UnlockSession.side_effect = MockFunctionCallError(
            "niFgen_UnlockSession"
        )
        mock_library.niFgen_UnlockSession.return_value = 0
        mock_library.niFgen_WaitUntilDone.side_effect = MockFunctionCallError(
            "niFgen_WaitUntilDone"
        )
        mock_library.niFgen_WaitUntilDone.return_value = 0
        mock_library.niFgen_WriteBinary16Waveform.side_effect = MockFunctionCallError(
            "niFgen_WriteBinary16Waveform"
        )
        mock_library.niFgen_WriteBinary16Waveform.return_value = 0
        mock_library.niFgen_WriteNamedWaveformF64.side_effect = MockFunctionCallError(
            "niFgen_WriteNamedWaveformF64"
        )
        mock_library.niFgen_WriteNamedWaveformF64.return_value = 0
        mock_library.niFgen_WriteNamedWaveformI16.side_effect = MockFunctionCallError(
            "niFgen_WriteNamedWaveformI16"
        )
        mock_library.niFgen_WriteNamedWaveformI16.return_value = 0
        mock_library.niFgen_WriteScript.side_effect = MockFunctionCallError(
            "niFgen_WriteScript"
        )
        mock_library.niFgen_WriteScript.return_value = 0
        mock_library.niFgen_WriteWaveform.side_effect = MockFunctionCallError(
        ...
        mock_library.niFgen_error_message.side_effect = MockFunctionCallError(
        ...
        mock_library.niFgen_self_test.side_effect = MockFunctionCallError(
            "niFgen_self_test"
        )
