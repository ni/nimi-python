...
class SideEffectsHelper(object):
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niFgen_AbortGeneration_cfunc.side_effect = MockFunctionCallError("niFgen_AbortGeneration_cfunc")
        mock_library.niFgen_AbortGeneration_cfunc.return_value = 0
        mock_library.niFgen_AllocateNamedWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_AllocateNamedWaveform_cfunc")
        mock_library.niFgen_AllocateNamedWaveform_cfunc.return_value = 0
        mock_library.niFgen_AllocateWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_AllocateWaveform_cfunc")
        mock_library.niFgen_AllocateWaveform_cfunc.return_value = 0
        mock_library.niFgen_ClearArbMemory_cfunc.side_effect = MockFunctionCallError("niFgen_ClearArbMemory_cfunc")
        mock_library.niFgen_ClearArbMemory_cfunc.return_value = 0
        mock_library.niFgen_ClearArbSequence_cfunc.side_effect = MockFunctionCallError("niFgen_ClearArbSequence_cfunc")
        mock_library.niFgen_ClearArbSequence_cfunc.return_value = 0
        mock_library.niFgen_ClearArbWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_ClearArbWaveform_cfunc")
        mock_library.niFgen_ClearArbWaveform_cfunc.return_value = 0
        mock_library.niFgen_ClearFreqList_cfunc.side_effect = MockFunctionCallError("niFgen_ClearFreqList_cfunc")
        mock_library.niFgen_ClearFreqList_cfunc.return_value = 0
        mock_library.niFgen_ClearUserStandardWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_ClearUserStandardWaveform_cfunc")
        mock_library.niFgen_ClearUserStandardWaveform_cfunc.return_value = 0
        mock_library.niFgen_Commit_cfunc.side_effect = MockFunctionCallError("niFgen_Commit_cfunc")
        mock_library.niFgen_Commit_cfunc.return_value = 0
        mock_library.niFgen_ConfigureArbSequence_cfunc.side_effect = MockFunctionCallError("niFgen_ConfigureArbSequence_cfunc")
        mock_library.niFgen_ConfigureArbSequence_cfunc.return_value = 0
        mock_library.niFgen_ConfigureArbWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_ConfigureArbWaveform_cfunc")
        mock_library.niFgen_ConfigureArbWaveform_cfunc.return_value = 0
        mock_library.niFgen_ConfigureFreqList_cfunc.side_effect = MockFunctionCallError("niFgen_ConfigureFreqList_cfunc")
        mock_library.niFgen_ConfigureFreqList_cfunc.return_value = 0
        mock_library.niFgen_ConfigureStandardWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_ConfigureStandardWaveform_cfunc")
        mock_library.niFgen_ConfigureStandardWaveform_cfunc.return_value = 0
        mock_library.niFgen_CreateAdvancedArbSequence_cfunc.side_effect = MockFunctionCallError("niFgen_CreateAdvancedArbSequence_cfunc")
        mock_library.niFgen_CreateAdvancedArbSequence_cfunc.return_value = 0
        mock_library.niFgen_CreateArbSequence_cfunc.side_effect = MockFunctionCallError("niFgen_CreateArbSequence_cfunc")
        mock_library.niFgen_CreateArbSequence_cfunc.return_value = 0
        mock_library.niFgen_CreateFreqList_cfunc.side_effect = MockFunctionCallError("niFgen_CreateFreqList_cfunc")
        mock_library.niFgen_CreateFreqList_cfunc.return_value = 0
        mock_library.niFgen_CreateWaveformF64_cfunc.side_effect = MockFunctionCallError("niFgen_CreateWaveformF64_cfunc")
        mock_library.niFgen_CreateWaveformF64_cfunc.return_value = 0
        mock_library.niFgen_CreateWaveformFromFileF64_cfunc.side_effect = MockFunctionCallError("niFgen_CreateWaveformFromFileF64_cfunc")
        mock_library.niFgen_CreateWaveformFromFileF64_cfunc.return_value = 0
        mock_library.niFgen_CreateWaveformFromFileI16_cfunc.side_effect = MockFunctionCallError("niFgen_CreateWaveformFromFileI16_cfunc")
        mock_library.niFgen_CreateWaveformFromFileI16_cfunc.return_value = 0
        mock_library.niFgen_CreateWaveformI16_cfunc.side_effect = MockFunctionCallError("niFgen_CreateWaveformI16_cfunc")
        mock_library.niFgen_CreateWaveformI16_cfunc.return_value = 0
        mock_library.niFgen_DefineUserStandardWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_DefineUserStandardWaveform_cfunc")
        mock_library.niFgen_DefineUserStandardWaveform_cfunc.return_value = 0
        mock_library.niFgen_DeleteNamedWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_DeleteNamedWaveform_cfunc")
        mock_library.niFgen_DeleteNamedWaveform_cfunc.return_value = 0
        mock_library.niFgen_DeleteScript_cfunc.side_effect = MockFunctionCallError("niFgen_DeleteScript_cfunc")
        mock_library.niFgen_DeleteScript_cfunc.return_value = 0
        mock_library.niFgen_Disable_cfunc.side_effect = MockFunctionCallError("niFgen_Disable_cfunc")
        mock_library.niFgen_Disable_cfunc.return_value = 0
        mock_library.niFgen_ExportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niFgen_ExportAttributeConfigurationBuffer_cfunc")
        mock_library.niFgen_ExportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niFgen_ExportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niFgen_ExportAttributeConfigurationFile_cfunc")
        mock_library.niFgen_ExportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niFgen_GetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niFgen_GetAttributeViBoolean_cfunc")
        mock_library.niFgen_GetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niFgen_GetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niFgen_GetAttributeViInt32_cfunc")
        mock_library.niFgen_GetAttributeViInt32_cfunc.return_value = 0
        mock_library.niFgen_GetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niFgen_GetAttributeViReal64_cfunc")
        mock_library.niFgen_GetAttributeViReal64_cfunc.return_value = 0
        mock_library.niFgen_GetAttributeViString_cfunc.side_effect = MockFunctionCallError("niFgen_GetAttributeViString_cfunc")
        mock_library.niFgen_GetAttributeViString_cfunc.return_value = 0
        mock_library.niFgen_GetChannelName_cfunc.side_effect = MockFunctionCallError("niFgen_GetChannelName_cfunc")
        mock_library.niFgen_GetChannelName_cfunc.return_value = 0
        mock_library.niFgen_GetError_cfunc.side_effect = MockFunctionCallError("niFgen_GetError_cfunc")
        mock_library.niFgen_GetError_cfunc.return_value = 0
        mock_library.niFgen_GetExtCalLastDateAndTime_cfunc.side_effect = MockFunctionCallError("niFgen_GetExtCalLastDateAndTime_cfunc")
        mock_library.niFgen_GetExtCalLastDateAndTime_cfunc.return_value = 0
        mock_library.niFgen_GetExtCalLastTemp_cfunc.side_effect = MockFunctionCallError("niFgen_GetExtCalLastTemp_cfunc")
        mock_library.niFgen_GetExtCalLastTemp_cfunc.return_value = 0
        mock_library.niFgen_GetExtCalRecommendedInterval_cfunc.side_effect = MockFunctionCallError("niFgen_GetExtCalRecommendedInterval_cfunc")
        mock_library.niFgen_GetExtCalRecommendedInterval_cfunc.return_value = 0
        mock_library.niFgen_GetHardwareState_cfunc.side_effect = MockFunctionCallError("niFgen_GetHardwareState_cfunc")
        mock_library.niFgen_GetHardwareState_cfunc.return_value = 0
        mock_library.niFgen_GetSelfCalLastDateAndTime_cfunc.side_effect = MockFunctionCallError("niFgen_GetSelfCalLastDateAndTime_cfunc")
        mock_library.niFgen_GetSelfCalLastDateAndTime_cfunc.return_value = 0
        mock_library.niFgen_GetSelfCalLastTemp_cfunc.side_effect = MockFunctionCallError("niFgen_GetSelfCalLastTemp_cfunc")
        mock_library.niFgen_GetSelfCalLastTemp_cfunc.return_value = 0
        mock_library.niFgen_GetSelfCalSupported_cfunc.side_effect = MockFunctionCallError("niFgen_GetSelfCalSupported_cfunc")
        mock_library.niFgen_GetSelfCalSupported_cfunc.return_value = 0
        mock_library.niFgen_ImportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niFgen_ImportAttributeConfigurationBuffer_cfunc")
        mock_library.niFgen_ImportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niFgen_ImportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niFgen_ImportAttributeConfigurationFile_cfunc")
        mock_library.niFgen_ImportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niFgen_InitializeWithChannels_cfunc.side_effect = MockFunctionCallError("niFgen_InitializeWithChannels_cfunc")
        mock_library.niFgen_InitializeWithChannels_cfunc.return_value = 0
        mock_library.niFgen_InitiateGeneration_cfunc.side_effect = MockFunctionCallError("niFgen_InitiateGeneration_cfunc")
        mock_library.niFgen_InitiateGeneration_cfunc.return_value = 0
        mock_library.niFgen_IsDone_cfunc.side_effect = MockFunctionCallError("niFgen_IsDone_cfunc")
        mock_library.niFgen_IsDone_cfunc.return_value = 0
        mock_library.niFgen_LockSession_cfunc.side_effect = MockFunctionCallError("niFgen_LockSession_cfunc")
        mock_library.niFgen_LockSession_cfunc.return_value = 0
        mock_library.niFgen_QueryArbSeqCapabilities_cfunc.side_effect = MockFunctionCallError("niFgen_QueryArbSeqCapabilities_cfunc")
        mock_library.niFgen_QueryArbSeqCapabilities_cfunc.return_value = 0
        mock_library.niFgen_QueryArbWfmCapabilities_cfunc.side_effect = MockFunctionCallError("niFgen_QueryArbWfmCapabilities_cfunc")
        mock_library.niFgen_QueryArbWfmCapabilities_cfunc.return_value = 0
        mock_library.niFgen_QueryFreqListCapabilities_cfunc.side_effect = MockFunctionCallError("niFgen_QueryFreqListCapabilities_cfunc")
        mock_library.niFgen_QueryFreqListCapabilities_cfunc.return_value = 0
        mock_library.niFgen_ReadCurrentTemperature_cfunc.side_effect = MockFunctionCallError("niFgen_ReadCurrentTemperature_cfunc")
        mock_library.niFgen_ReadCurrentTemperature_cfunc.return_value = 0
        mock_library.niFgen_ResetDevice_cfunc.side_effect = MockFunctionCallError("niFgen_ResetDevice_cfunc")
        mock_library.niFgen_ResetDevice_cfunc.return_value = 0
        mock_library.niFgen_ResetWithDefaults_cfunc.side_effect = MockFunctionCallError("niFgen_ResetWithDefaults_cfunc")
        mock_library.niFgen_ResetWithDefaults_cfunc.return_value = 0
        mock_library.niFgen_SelfCal_cfunc.side_effect = MockFunctionCallError("niFgen_SelfCal_cfunc")
        mock_library.niFgen_SelfCal_cfunc.return_value = 0
        mock_library.niFgen_SendSoftwareEdgeTrigger_cfunc.side_effect = MockFunctionCallError("niFgen_SendSoftwareEdgeTrigger_cfunc")
        mock_library.niFgen_SendSoftwareEdgeTrigger_cfunc.return_value = 0
        mock_library.niFgen_SetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niFgen_SetAttributeViBoolean_cfunc")
        mock_library.niFgen_SetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niFgen_SetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niFgen_SetAttributeViInt32_cfunc")
        mock_library.niFgen_SetAttributeViInt32_cfunc.return_value = 0
        mock_library.niFgen_SetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niFgen_SetAttributeViReal64_cfunc")
        mock_library.niFgen_SetAttributeViReal64_cfunc.return_value = 0
        mock_library.niFgen_SetAttributeViString_cfunc.side_effect = MockFunctionCallError("niFgen_SetAttributeViString_cfunc")
        mock_library.niFgen_SetAttributeViString_cfunc.return_value = 0
        mock_library.niFgen_SetNamedWaveformNextWritePosition_cfunc.side_effect = MockFunctionCallError("niFgen_SetNamedWaveformNextWritePosition_cfunc")
        mock_library.niFgen_SetNamedWaveformNextWritePosition_cfunc.return_value = 0
        mock_library.niFgen_SetWaveformNextWritePosition_cfunc.side_effect = MockFunctionCallError("niFgen_SetWaveformNextWritePosition_cfunc")
        mock_library.niFgen_SetWaveformNextWritePosition_cfunc.return_value = 0
        mock_library.niFgen_UnlockSession_cfunc.side_effect = MockFunctionCallError("niFgen_UnlockSession_cfunc")
        mock_library.niFgen_UnlockSession_cfunc.return_value = 0
        mock_library.niFgen_WaitUntilDone_cfunc.side_effect = MockFunctionCallError("niFgen_WaitUntilDone_cfunc")
        mock_library.niFgen_WaitUntilDone_cfunc.return_value = 0
        mock_library.niFgen_WriteBinary16Waveform_cfunc.side_effect = MockFunctionCallError("niFgen_WriteBinary16Waveform_cfunc")
        mock_library.niFgen_WriteBinary16Waveform_cfunc.return_value = 0
        mock_library.niFgen_WriteNamedWaveformF64_cfunc.side_effect = MockFunctionCallError("niFgen_WriteNamedWaveformF64_cfunc")
        mock_library.niFgen_WriteNamedWaveformF64_cfunc.return_value = 0
        mock_library.niFgen_WriteNamedWaveformI16_cfunc.side_effect = MockFunctionCallError("niFgen_WriteNamedWaveformI16_cfunc")
        mock_library.niFgen_WriteNamedWaveformI16_cfunc.return_value = 0
        mock_library.niFgen_WriteScript_cfunc.side_effect = MockFunctionCallError("niFgen_WriteScript_cfunc")
        mock_library.niFgen_WriteScript_cfunc.return_value = 0
        mock_library.niFgen_WriteWaveform_cfunc.side_effect = MockFunctionCallError("niFgen_WriteWaveform_cfunc")
        mock_library.niFgen_WriteWaveform_cfunc.return_value = 0
        mock_library.niFgen_close_cfunc.side_effect = MockFunctionCallError("niFgen_close_cfunc")
        mock_library.niFgen_close_cfunc.return_value = 0
        mock_library.niFgen_error_message_cfunc.side_effect = MockFunctionCallError("niFgen_error_message_cfunc")
        mock_library.niFgen_error_message_cfunc.return_value = 0
        mock_library.niFgen_reset_cfunc.side_effect = MockFunctionCallError("niFgen_reset_cfunc")
        mock_library.niFgen_reset_cfunc.return_value = 0
        mock_library.niFgen_self_test_cfunc.side_effect = MockFunctionCallError("niFgen_self_test_cfunc")
        mock_library.niFgen_self_test_cfunc.return_value = 0
