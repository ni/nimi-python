...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def allocate_named_waveform(self, session_handle, encoding, channel_name, waveform_name, waveform_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def allocate_waveform(self, session_handle, encoding, channel_name, waveform_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_size_ctype = _visatype.ViInt32(waveform_size)  # case S150
    ...
    def clear_arb_memory(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        error_code = self._library.niFgen_ClearArbMemory(vi_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def clear_arb_sequence(self, session_handle, encoding, sequence_handle):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def clear_arb_waveform(self, session_handle, encoding, waveform_handle):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def clear_freq_list(self, session_handle, encoding, frequency_list_handle):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def clear_user_standard_waveform(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def configure_arb_sequence(self, session_handle, encoding, channel_name, sequence_handle, gain, offset):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        sequence_handle_ctype = _visatype.ViInt32(sequence_handle)  # case S150
    ...
    def configure_arb_waveform(self, session_handle, encoding, channel_name, waveform_handle, gain, offset):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
        gain_ctype = _visatype.ViReal64(gain)  # case S150
    ...
    def configure_freq_list(self, session_handle, encoding, channel_name, frequency_list_handle, amplitude, dc_offset, start_phase):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        frequency_list_handle_ctype = _visatype.ViInt32(frequency_list_handle)  # case S150
    ...
    def configure_standard_waveform(self, session_handle, encoding, channel_name, waveform, amplitude, dc_offset, frequency, start_phase):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def create_advanced_arb_sequence(self, session_handle, encoding, waveform_handles_array, loop_counts_array, sample_counts_array, marker_location_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def create_arb_sequence(self, session_handle, encoding, waveform_handles_array, loop_counts_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        sequence_length_ctype = _visatype.ViInt32(0 if waveform_handles_array is None else len(waveform_handles_array))  # case S160
        if loop_counts_array is not None and len(loop_counts_array) != len(waveform_handles_array):  # case S160
            raise ValueError("Length of loop_counts_array and waveform_handles_array parameters do not match.")  # case S160
    ...
    def create_freq_list(self, session_handle, encoding, waveform, frequency_array, duration_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        waveform_ctype = _visatype.ViInt32(waveform.value)  # case S130
    ...
    def create_waveform_f64(self, session_handle, encoding, channel_name, waveform_data_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def create_waveform_f64_numpy(self, session_handle, encoding, channel_name, waveform_data_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_size_ctype = _visatype.ViInt32(0 if waveform_data_array is None else len(waveform_data_array))  # case S160
    ...
    def create_waveform_from_file_f64(self, session_handle, encoding, channel_name, file_name, byte_order):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        file_name_ctype = ctypes.create_string_buffer(file_name.encode(encoding))  # case C020
    ...
    def create_waveform_from_file_i16(self, session_handle, encoding, channel_name, file_name, byte_order):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        file_name_ctype = ctypes.create_string_buffer(file_name.encode(encoding))  # case C020
        byte_order_ctype = _visatype.ViInt32(byte_order.value)  # case S130
    ...
    def create_waveform_i16_numpy(self, session_handle, encoding, channel_name, waveform_data_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_size_ctype = _visatype.ViInt32(0 if waveform_data_array is None else len(waveform_data_array))  # case S160
        waveform_data_array_ctype = _get_ctypes_pointer_for_buffer(value=waveform_data_array)  # case B510
    ...
    def define_user_standard_waveform(self, session_handle, encoding, channel_name, waveform_data_array):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_size_ctype = _visatype.ViInt32(0 if waveform_data_array is None else len(waveform_data_array))  # case S160
    ...
    def delete_named_waveform(self, session_handle, encoding, channel_name, waveform_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def delete_script(self, session_handle, encoding, channel_name, script_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        script_name_ctype = ctypes.create_string_buffer(script_name.encode(encoding))  # case C020
    ...
    def get_channel_name(self, session_handle, encoding, index):  # noqa: N802
        ...
        error_code = self._library.niFgen_GetChannelName(vi_ctype, index_ctype, buffer_size_ctype, channel_string_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return channel_string_ctype.value.decode(encoding)
    ...
    def get_hardware_state(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def initialize_with_channels(self, session_handle, encoding, resource_name, channel_name, reset_device, option_string):  # noqa: N802
        resource_name_ctype = ctypes.create_string_buffer(resource_name.encode(encoding))  # case C020
        channel_name_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(channel_name).encode(encoding))  # case C040
    ...
    def initiate_generation(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def query_arb_seq_capabilities(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def query_arb_wfm_capabilities(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def query_freq_list_capabilities(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def send_software_edge_trigger(self, session_handle, encoding, trigger, trigger_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        trigger_ctype = _visatype.ViInt32(trigger.value)  # case S130
        trigger_id_ctype = ctypes.create_string_buffer(trigger_id.encode(encoding))  # case C020
    ...
    def set_named_waveform_next_write_position(self, session_handle, encoding, channel_name, waveform_name, relative_to, offset):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
    ...
    def set_waveform_next_write_position(self, session_handle, encoding, channel_name, waveform_handle, relative_to, offset):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
        relative_to_ctype = _visatype.ViInt32(relative_to.value)  # case S130
    ...
    def wait_until_done(self, session_handle, encoding, max_time):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def write_binary16_waveform_numpy(self, session_handle, encoding, channel_name, waveform_handle, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
    ...
    def write_named_waveform_f64(self, session_handle, encoding, channel_name, waveform_name, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
    ...
    def write_named_waveform_f64_numpy(self, session_handle, encoding, channel_name, waveform_name, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
    ...
    def write_named_waveform_i16_numpy(self, session_handle, encoding, channel_name, waveform_name, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_name_ctype = ctypes.create_string_buffer(waveform_name.encode(encoding))  # case C020
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
    ...
    def write_script(self, session_handle, encoding, channel_name, script):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        script_ctype = ctypes.create_string_buffer(script.encode(encoding))  # case C020
        error_code = self._library.niFgen_WriteScript(vi_ctype, channel_name_ctype, script_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return

    def write_waveform(self, session_handle, encoding, channel_name, waveform_handle, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
    ...
    def write_waveform_numpy(self, session_handle, encoding, channel_name, waveform_handle, data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        waveform_handle_ctype = _visatype.ViInt32(waveform_handle)  # case S150
        size_ctype = _visatype.ViInt32(0 if data is None else len(data))  # case S160
