...
from nisync.enums import *  # noqa: F403,F401,H303
from nisync.errors import DriverWarning  # noqa: F401
from nisync.errors import Error  # noqa: F401
from nisync.session import Session  # noqa: F401
...
def get_diagnostic_information():
    ...
    if platform.system() == 'Windows':
        ...
        os_name = 'Windows'
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\NI-Sync\CurrentVersion")
    ...
    info['driver']['name'] = "NI-Sync"
    info['driver']['version'] = driver_version
    info['module']['name'] = 'nisync'
