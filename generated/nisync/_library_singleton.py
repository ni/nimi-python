...
import ctypes
import nisync._library as _library
...
_library_info = {'Linux': {'64bit': {'name': 'libnisync.so', 'type': 'cdll'}},
                 'Windows': {'32bit': {'name': 'nisync_32.dll', 'type': 'windll'},
                             '64bit': {'name': 'nisync_64.dll', 'type': 'cdll'}}}
...
def get():
    ...
    Returns the library.Library singleton for nisync.
    '''
    global _instance
