...
class DriverNotInstalledError(Exception):
    ...
    def __init__(self):
        super(DriverNotInstalledError, self).__init__('The NI-DCPower runtime is not installed. Please visit http://www.ni.com/downloads/drivers/ to download and install it.')
