...
Additional examples for NI-DCPower are located in src/nidcpower/examples/ directory `on GitHub <https://github.com/ni/nimi-python/tree/master/src/nidcpower/examples>`_.
