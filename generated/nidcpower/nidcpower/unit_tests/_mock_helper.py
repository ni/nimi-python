...
class SideEffectsHelper(object):
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niDCPower_AbortWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_AbortWithChannels_cfunc")
        mock_library.niDCPower_AbortWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_CalSelfCalibrate_cfunc.side_effect = MockFunctionCallError("niDCPower_CalSelfCalibrate_cfunc")
        mock_library.niDCPower_CalSelfCalibrate_cfunc.return_value = 0
        mock_library.niDCPower_ClearLatchedOutputCutoffState_cfunc.side_effect = MockFunctionCallError("niDCPower_ClearLatchedOutputCutoffState_cfunc")
        mock_library.niDCPower_ClearLatchedOutputCutoffState_cfunc.return_value = 0
        mock_library.niDCPower_CommitWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_CommitWithChannels_cfunc")
        mock_library.niDCPower_CommitWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_ConfigureApertureTime_cfunc.side_effect = MockFunctionCallError("niDCPower_ConfigureApertureTime_cfunc")
        mock_library.niDCPower_ConfigureApertureTime_cfunc.return_value = 0
        mock_library.niDCPower_ConfigureLCRCustomCableCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_ConfigureLCRCustomCableCompensation_cfunc")
        mock_library.niDCPower_ConfigureLCRCustomCableCompensation_cfunc.return_value = 0
        mock_library.niDCPower_CreateAdvancedSequenceCommitStepWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_CreateAdvancedSequenceCommitStepWithChannels_cfunc")
        mock_library.niDCPower_CreateAdvancedSequenceCommitStepWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_CreateAdvancedSequenceStepWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_CreateAdvancedSequenceStepWithChannels_cfunc")
        mock_library.niDCPower_CreateAdvancedSequenceStepWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_CreateAdvancedSequenceWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_CreateAdvancedSequenceWithChannels_cfunc")
        mock_library.niDCPower_CreateAdvancedSequenceWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_DeleteAdvancedSequenceWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_DeleteAdvancedSequenceWithChannels_cfunc")
        mock_library.niDCPower_DeleteAdvancedSequenceWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_Disable_cfunc.side_effect = MockFunctionCallError("niDCPower_Disable_cfunc")
        mock_library.niDCPower_Disable_cfunc.return_value = 0
        mock_library.niDCPower_ExportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niDCPower_ExportAttributeConfigurationBuffer_cfunc")
        mock_library.niDCPower_ExportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niDCPower_ExportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niDCPower_ExportAttributeConfigurationFile_cfunc")
        mock_library.niDCPower_ExportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niDCPower_FancyInitialize_cfunc.side_effect = MockFunctionCallError("niDCPower_FancyInitialize_cfunc")
        mock_library.niDCPower_FancyInitialize_cfunc.return_value = 0
        mock_library.niDCPower_FetchMultiple_cfunc.side_effect = MockFunctionCallError("niDCPower_FetchMultiple_cfunc")
        mock_library.niDCPower_FetchMultiple_cfunc.return_value = 0
        mock_library.niDCPower_FetchMultipleLCR_cfunc.side_effect = MockFunctionCallError("niDCPower_FetchMultipleLCR_cfunc")
        mock_library.niDCPower_FetchMultipleLCR_cfunc.return_value = 0
        mock_library.niDCPower_GetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niDCPower_GetAttributeViBoolean_cfunc")
        mock_library.niDCPower_GetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niDCPower_GetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niDCPower_GetAttributeViInt32_cfunc")
        mock_library.niDCPower_GetAttributeViInt32_cfunc.return_value = 0
        mock_library.niDCPower_GetAttributeViInt64_cfunc.side_effect = MockFunctionCallError("niDCPower_GetAttributeViInt64_cfunc")
        mock_library.niDCPower_GetAttributeViInt64_cfunc.return_value = 0
        mock_library.niDCPower_GetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niDCPower_GetAttributeViReal64_cfunc")
        mock_library.niDCPower_GetAttributeViReal64_cfunc.return_value = 0
        mock_library.niDCPower_GetAttributeViString_cfunc.side_effect = MockFunctionCallError("niDCPower_GetAttributeViString_cfunc")
        mock_library.niDCPower_GetAttributeViString_cfunc.return_value = 0
        mock_library.niDCPower_GetChannelName_cfunc.side_effect = MockFunctionCallError("niDCPower_GetChannelName_cfunc")
        mock_library.niDCPower_GetChannelName_cfunc.return_value = 0
        mock_library.niDCPower_GetChannelNameFromString_cfunc.side_effect = MockFunctionCallError("niDCPower_GetChannelNameFromString_cfunc")
        mock_library.niDCPower_GetChannelNameFromString_cfunc.return_value = 0
        mock_library.niDCPower_GetError_cfunc.side_effect = MockFunctionCallError("niDCPower_GetError_cfunc")
        mock_library.niDCPower_GetError_cfunc.return_value = 0
        mock_library.niDCPower_GetExtCalLastDateAndTime_cfunc.side_effect = MockFunctionCallError("niDCPower_GetExtCalLastDateAndTime_cfunc")
        mock_library.niDCPower_GetExtCalLastDateAndTime_cfunc.return_value = 0
        mock_library.niDCPower_GetExtCalLastTemp_cfunc.side_effect = MockFunctionCallError("niDCPower_GetExtCalLastTemp_cfunc")
        mock_library.niDCPower_GetExtCalLastTemp_cfunc.return_value = 0
        mock_library.niDCPower_GetExtCalRecommendedInterval_cfunc.side_effect = MockFunctionCallError("niDCPower_GetExtCalRecommendedInterval_cfunc")
        mock_library.niDCPower_GetExtCalRecommendedInterval_cfunc.return_value = 0
        mock_library.niDCPower_GetLCRCompensationLastDateAndTime_cfunc.side_effect = MockFunctionCallError("niDCPower_GetLCRCompensationLastDateAndTime_cfunc")
        mock_library.niDCPower_GetLCRCompensationLastDateAndTime_cfunc.return_value = 0
        mock_library.niDCPower_GetLCRCustomCableCompensationData_cfunc.side_effect = MockFunctionCallError("niDCPower_GetLCRCustomCableCompensationData_cfunc")
        mock_library.niDCPower_GetLCRCustomCableCompensationData_cfunc.return_value = 0
        mock_library.niDCPower_GetSelfCalLastDateAndTime_cfunc.side_effect = MockFunctionCallError("niDCPower_GetSelfCalLastDateAndTime_cfunc")
        mock_library.niDCPower_GetSelfCalLastDateAndTime_cfunc.return_value = 0
        mock_library.niDCPower_GetSelfCalLastTemp_cfunc.side_effect = MockFunctionCallError("niDCPower_GetSelfCalLastTemp_cfunc")
        mock_library.niDCPower_GetSelfCalLastTemp_cfunc.return_value = 0
        mock_library.niDCPower_ImportAttributeConfigurationBuffer_cfunc.side_effect = MockFunctionCallError("niDCPower_ImportAttributeConfigurationBuffer_cfunc")
        mock_library.niDCPower_ImportAttributeConfigurationBuffer_cfunc.return_value = 0
        mock_library.niDCPower_ImportAttributeConfigurationFile_cfunc.side_effect = MockFunctionCallError("niDCPower_ImportAttributeConfigurationFile_cfunc")
        mock_library.niDCPower_ImportAttributeConfigurationFile_cfunc.return_value = 0
        mock_library.niDCPower_InitializeWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_InitializeWithChannels_cfunc")
        mock_library.niDCPower_InitializeWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_InitializeWithIndependentChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_InitializeWithIndependentChannels_cfunc")
        mock_library.niDCPower_InitializeWithIndependentChannels_cfunc.return_value = 0
        mock_library.niDCPower_InitiateWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_InitiateWithChannels_cfunc")
        mock_library.niDCPower_InitiateWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_LockSession_cfunc.side_effect = MockFunctionCallError("niDCPower_LockSession_cfunc")
        mock_library.niDCPower_LockSession_cfunc.return_value = 0
        mock_library.niDCPower_Measure_cfunc.side_effect = MockFunctionCallError("niDCPower_Measure_cfunc")
        mock_library.niDCPower_Measure_cfunc.return_value = 0
        mock_library.niDCPower_MeasureMultiple_cfunc.side_effect = MockFunctionCallError("niDCPower_MeasureMultiple_cfunc")
        mock_library.niDCPower_MeasureMultiple_cfunc.return_value = 0
        mock_library.niDCPower_MeasureMultipleLCR_cfunc.side_effect = MockFunctionCallError("niDCPower_MeasureMultipleLCR_cfunc")
        mock_library.niDCPower_MeasureMultipleLCR_cfunc.return_value = 0
        mock_library.niDCPower_ParseChannelCount_cfunc.side_effect = MockFunctionCallError("niDCPower_ParseChannelCount_cfunc")
        mock_library.niDCPower_ParseChannelCount_cfunc.return_value = 0
        mock_library.niDCPower_PerformLCRLoadCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_PerformLCRLoadCompensation_cfunc")
        mock_library.niDCPower_PerformLCRLoadCompensation_cfunc.return_value = 0
        mock_library.niDCPower_PerformLCROpenCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_PerformLCROpenCompensation_cfunc")
        mock_library.niDCPower_PerformLCROpenCompensation_cfunc.return_value = 0
        mock_library.niDCPower_PerformLCROpenCustomCableCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_PerformLCROpenCustomCableCompensation_cfunc")
        mock_library.niDCPower_PerformLCROpenCustomCableCompensation_cfunc.return_value = 0
        mock_library.niDCPower_PerformLCRShortCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_PerformLCRShortCompensation_cfunc")
        mock_library.niDCPower_PerformLCRShortCompensation_cfunc.return_value = 0
        mock_library.niDCPower_PerformLCRShortCustomCableCompensation_cfunc.side_effect = MockFunctionCallError("niDCPower_PerformLCRShortCustomCableCompensation_cfunc")
        mock_library.niDCPower_PerformLCRShortCustomCableCompensation_cfunc.return_value = 0
        mock_library.niDCPower_QueryInCompliance_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryInCompliance_cfunc")
        mock_library.niDCPower_QueryInCompliance_cfunc.return_value = 0
        mock_library.niDCPower_QueryLatchedOutputCutoffState_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryLatchedOutputCutoffState_cfunc")
        mock_library.niDCPower_QueryLatchedOutputCutoffState_cfunc.return_value = 0
        mock_library.niDCPower_QueryMaxCurrentLimit_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryMaxCurrentLimit_cfunc")
        mock_library.niDCPower_QueryMaxCurrentLimit_cfunc.return_value = 0
        mock_library.niDCPower_QueryMaxVoltageLevel_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryMaxVoltageLevel_cfunc")
        mock_library.niDCPower_QueryMaxVoltageLevel_cfunc.return_value = 0
        mock_library.niDCPower_QueryMinCurrentLimit_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryMinCurrentLimit_cfunc")
        mock_library.niDCPower_QueryMinCurrentLimit_cfunc.return_value = 0
        mock_library.niDCPower_QueryOutputState_cfunc.side_effect = MockFunctionCallError("niDCPower_QueryOutputState_cfunc")
        mock_library.niDCPower_QueryOutputState_cfunc.return_value = 0
        mock_library.niDCPower_ReadCurrentTemperature_cfunc.side_effect = MockFunctionCallError("niDCPower_ReadCurrentTemperature_cfunc")
        mock_library.niDCPower_ReadCurrentTemperature_cfunc.return_value = 0
        mock_library.niDCPower_ResetDevice_cfunc.side_effect = MockFunctionCallError("niDCPower_ResetDevice_cfunc")
        mock_library.niDCPower_ResetDevice_cfunc.return_value = 0
        mock_library.niDCPower_ResetWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_ResetWithChannels_cfunc")
        mock_library.niDCPower_ResetWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_ResetWithDefaults_cfunc.side_effect = MockFunctionCallError("niDCPower_ResetWithDefaults_cfunc")
        mock_library.niDCPower_ResetWithDefaults_cfunc.return_value = 0
        mock_library.niDCPower_SendSoftwareEdgeTriggerWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_SendSoftwareEdgeTriggerWithChannels_cfunc")
        mock_library.niDCPower_SendSoftwareEdgeTriggerWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_SetAttributeViBoolean_cfunc.side_effect = MockFunctionCallError("niDCPower_SetAttributeViBoolean_cfunc")
        mock_library.niDCPower_SetAttributeViBoolean_cfunc.return_value = 0
        mock_library.niDCPower_SetAttributeViInt32_cfunc.side_effect = MockFunctionCallError("niDCPower_SetAttributeViInt32_cfunc")
        mock_library.niDCPower_SetAttributeViInt32_cfunc.return_value = 0
        mock_library.niDCPower_SetAttributeViInt64_cfunc.side_effect = MockFunctionCallError("niDCPower_SetAttributeViInt64_cfunc")
        mock_library.niDCPower_SetAttributeViInt64_cfunc.return_value = 0
        mock_library.niDCPower_SetAttributeViReal64_cfunc.side_effect = MockFunctionCallError("niDCPower_SetAttributeViReal64_cfunc")
        mock_library.niDCPower_SetAttributeViReal64_cfunc.return_value = 0
        mock_library.niDCPower_SetAttributeViString_cfunc.side_effect = MockFunctionCallError("niDCPower_SetAttributeViString_cfunc")
        mock_library.niDCPower_SetAttributeViString_cfunc.return_value = 0
        mock_library.niDCPower_SetSequence_cfunc.side_effect = MockFunctionCallError("niDCPower_SetSequence_cfunc")
        mock_library.niDCPower_SetSequence_cfunc.return_value = 0
        mock_library.niDCPower_UnlockSession_cfunc.side_effect = MockFunctionCallError("niDCPower_UnlockSession_cfunc")
        mock_library.niDCPower_UnlockSession_cfunc.return_value = 0
        mock_library.niDCPower_WaitForEventWithChannels_cfunc.side_effect = MockFunctionCallError("niDCPower_WaitForEventWithChannels_cfunc")
        mock_library.niDCPower_WaitForEventWithChannels_cfunc.return_value = 0
        mock_library.niDCPower_close_cfunc.side_effect = MockFunctionCallError("niDCPower_close_cfunc")
        mock_library.niDCPower_close_cfunc.return_value = 0
        mock_library.niDCPower_error_message_cfunc.side_effect = MockFunctionCallError("niDCPower_error_message_cfunc")
        mock_library.niDCPower_error_message_cfunc.return_value = 0
        mock_library.niDCPower_self_test_cfunc.side_effect = MockFunctionCallError("niDCPower_self_test_cfunc")
        mock_library.niDCPower_self_test_cfunc.return_value = 0
