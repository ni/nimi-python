...
class SideEffectsHelper(object):
    ...
    def niDCPower_CreateAdvancedSequenceCommitStepWithChannels(
        ...
        if (
            self._defaults["CreateAdvancedSequenceCommitStepWithChannels"]["return"]
            != 0
        ):
            return self._defaults["CreateAdvancedSequenceCommitStepWithChannels"][
                "return"
            ]
    ...
    def niDCPower_ExportAttributeConfigurationBuffer(
        ...
        if (
            ...
            raise MockFunctionCallError(
                "niDCPower_ExportAttributeConfigurationBuffer", param="configuration"
            )
        if size.value == 0:
            return len(
                self._defaults["ExportAttributeConfigurationBuffer"]["configuration"]
    ...
    def niDCPower_FetchMultiple(
        ...
        if self._defaults["FetchMultiple"]["voltageMeasurements"] is None:
            raise MockFunctionCallError(
                "niDCPower_FetchMultiple", param="voltageMeasurements"
            )
        ...
        if self._defaults["FetchMultiple"]["currentMeasurements"] is None:
            raise MockFunctionCallError(
                "niDCPower_FetchMultiple", param="currentMeasurements"
            )
    ...
    def niDCPower_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetAttributeViBoolean", param="attributeValue"
            )
    ...
    def niDCPower_GetAttributeViInt32(
        ...
        if self._defaults["GetAttributeViInt32"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niDCPower_GetAttributeViInt64(
        ...
        if self._defaults["GetAttributeViInt64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetAttributeViInt64", param="attributeValue"
            )
        if attribute_value is not None:
            attribute_value.contents.value = self._defaults["GetAttributeViInt64"][
                "attributeValue"
            ]
        return self._defaults["GetAttributeViInt64"]["return"]
    ...
    def niDCPower_GetAttributeViReal64(
        ...
        if self._defaults["GetAttributeViReal64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetAttributeViReal64", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niDCPower_GetAttributeViString(
        ...
        if self._defaults["GetAttributeViString"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetAttributeViString", param="attributeValue"
            )
    ...
    def niDCPower_GetChannelName(
        ...
        channel_name.value = self._defaults["GetChannelName"]["channelName"].encode(
            "ascii"
        )
        return self._defaults["GetChannelName"]["return"]
    ...
    def niDCPower_GetChannelNameFromString(
        ...
        if self._defaults["GetChannelNameFromString"]["channelName"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetChannelNameFromString", param="channelName"
            )
        if buffer_size.value == 0:
            return len(self._defaults["GetChannelNameFromString"]["channelName"])
        names.value = self._defaults["GetChannelNameFromString"]["channelName"].encode(
            "ascii"
        )
        return self._defaults["GetChannelNameFromString"]["return"]
    ...
    def niDCPower_GetExtCalLastDateAndTime(
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["year"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastDateAndTime", param="year"
            )
        if year is not None:
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastDateAndTime", param="month"
            )
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["day"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastDateAndTime", param="day"
            )
        if day is not None:
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["hour"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastDateAndTime", param="hour"
            )
        if hour is not None:
        ...
        if self._defaults["GetExtCalLastDateAndTime"]["minute"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastDateAndTime", param="minute"
            )
    ...
    def niDCPower_GetExtCalLastTemp(self, vi, temperature):  # noqa: N802
        ...
        if self._defaults["GetExtCalLastTemp"]["temperature"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalLastTemp", param="temperature"
            )
    ...
    def niDCPower_GetExtCalRecommendedInterval(self, vi, months):  # noqa: N802
        ...
        if self._defaults["GetExtCalRecommendedInterval"]["months"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetExtCalRecommendedInterval", param="months"
            )
    ...
    def niDCPower_GetSelfCalLastDateAndTime(
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["year"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastDateAndTime", param="year"
            )
        if year is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["month"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastDateAndTime", param="month"
            )
        if month is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["day"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastDateAndTime", param="day"
            )
        if day is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["hour"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastDateAndTime", param="hour"
            )
        if hour is not None:
        ...
        if self._defaults["GetSelfCalLastDateAndTime"]["minute"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastDateAndTime", param="minute"
            )
        if minute is not None:
    ...
    def niDCPower_GetSelfCalLastTemp(self, vi, temperature):  # noqa: N802
        ...
        if self._defaults["GetSelfCalLastTemp"]["temperature"] is None:
            raise MockFunctionCallError(
                "niDCPower_GetSelfCalLastTemp", param="temperature"
            )
        if temperature is not None:
    ...
    def niDCPower_InitializeWithIndependentChannels(
        ...
        if self._defaults["InitializeWithIndependentChannels"]["vi"] is None:
            raise MockFunctionCallError(
                "niDCPower_InitializeWithIndependentChannels", param="vi"
            )
        if vi is not None:
            vi.contents.value = self._defaults["InitializeWithIndependentChannels"][
                "vi"
            ]
        return self._defaults["InitializeWithIndependentChannels"]["return"]
    ...
    def niDCPower_MeasureMultiple(
        ...
        if self._defaults["MeasureMultiple"]["voltageMeasurements"] is None:
            raise MockFunctionCallError(
                "niDCPower_MeasureMultiple", param="voltageMeasurements"
            )
        ...
        if self._defaults["MeasureMultiple"]["currentMeasurements"] is None:
            raise MockFunctionCallError(
                "niDCPower_MeasureMultiple", param="currentMeasurements"
            )
    ...
    def niDCPower_ParseChannelCount(
        ...
        if self._defaults["ParseChannelCount"]["numberOfChannels"] is None:
            raise MockFunctionCallError(
                "niDCPower_ParseChannelCount", param="numberOfChannels"
            )
        if number_of_channels is not None:
            number_of_channels.contents.value = self._defaults["ParseChannelCount"][
                "numberOfChannels"
            ]
        return self._defaults["ParseChannelCount"]["return"]
    ...
    def niDCPower_QueryInCompliance(
        ...
        if self._defaults["QueryInCompliance"]["inCompliance"] is None:
            raise MockFunctionCallError(
                "niDCPower_QueryInCompliance", param="inCompliance"
            )
        if in_compliance is not None:
            in_compliance.contents.value = self._defaults["QueryInCompliance"][
                "inCompliance"
            ]
        return self._defaults["QueryInCompliance"]["return"]
    ...
    def niDCPower_QueryLatchedOutputCutoffState(
        ...
        if self._defaults["QueryLatchedOutputCutoffState"]["outputCutoffState"] is None:
            raise MockFunctionCallError(
                "niDCPower_QueryLatchedOutputCutoffState", param="outputCutoffState"
            )
        if output_cutoff_state is not None:
            output_cutoff_state.contents.value = self._defaults[
    ...
    def niDCPower_QueryMaxCurrentLimit(
        ...
        if self._defaults["QueryMaxCurrentLimit"]["maxCurrentLimit"] is None:
            raise MockFunctionCallError(
                "niDCPower_QueryMaxCurrentLimit", param="maxCurrentLimit"
            )
        if max_current_limit is not None:
            max_current_limit.contents.value = self._defaults["QueryMaxCurrentLimit"][
                "maxCurrentLimit"
            ]
        return self._defaults["QueryMaxCurrentLimit"]["return"]
    ...
    def niDCPower_QueryMaxVoltageLevel(
        ...
        if self._defaults["QueryMaxVoltageLevel"]["maxVoltageLevel"] is None:
            raise MockFunctionCallError(
                "niDCPower_QueryMaxVoltageLevel", param="maxVoltageLevel"
            )
        if max_voltage_level is not None:
            max_voltage_level.contents.value = self._defaults["QueryMaxVoltageLevel"][
                "maxVoltageLevel"
            ]
        return self._defaults["QueryMaxVoltageLevel"]["return"]
    ...
    def niDCPower_QueryMinCurrentLimit(
        ...
        if self._defaults["QueryMinCurrentLimit"]["minCurrentLimit"] is None:
            raise MockFunctionCallError(
                "niDCPower_QueryMinCurrentLimit", param="minCurrentLimit"
            )
        if min_current_limit is not None:
            min_current_limit.contents.value = self._defaults["QueryMinCurrentLimit"][
                "minCurrentLimit"
            ]
        return self._defaults["QueryMinCurrentLimit"]["return"]
    ...
    def niDCPower_ReadCurrentTemperature(self, vi, temperature):  # noqa: N802
        ...
        if self._defaults["ReadCurrentTemperature"]["temperature"] is None:
            raise MockFunctionCallError(
                "niDCPower_ReadCurrentTemperature", param="temperature"
            )
        if temperature is not None:
    ...
    def niDCPower_UnlockSession(self, vi, caller_has_lock):  # noqa: N802
        ...
        if self._defaults["UnlockSession"]["callerHasLock"] is None:
            raise MockFunctionCallError(
                "niDCPower_UnlockSession", param="callerHasLock"
            )
        if caller_has_lock is not None:
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niDCPower_AbortWithChannels.side_effect = MockFunctionCallError(
            "niDCPower_AbortWithChannels"
        )
        mock_library.niDCPower_AbortWithChannels.return_value = 0
        mock_library.niDCPower_CalSelfCalibrate.side_effect = MockFunctionCallError(
            "niDCPower_CalSelfCalibrate"
        )
        mock_library.niDCPower_CalSelfCalibrate.return_value = 0
        mock_library.niDCPower_ClearLatchedOutputCutoffState.side_effect = (
            MockFunctionCallError("niDCPower_ClearLatchedOutputCutoffState")
        )
        mock_library.niDCPower_ClearLatchedOutputCutoffState.return_value = 0
        mock_library.niDCPower_CommitWithChannels.side_effect = MockFunctionCallError(
            "niDCPower_CommitWithChannels"
        )
        mock_library.niDCPower_CommitWithChannels.return_value = 0
        mock_library.niDCPower_ConfigureApertureTime.side_effect = (
            MockFunctionCallError("niDCPower_ConfigureApertureTime")
        )
        mock_library.niDCPower_ConfigureApertureTime.return_value = 0
        mock_library.niDCPower_CreateAdvancedSequenceCommitStepWithChannels.side_effect = MockFunctionCallError(
            "niDCPower_CreateAdvancedSequenceCommitStepWithChannels"
        )
        mock_library.niDCPower_CreateAdvancedSequenceCommitStepWithChannels.return_value = (
            0
        )
        mock_library.niDCPower_CreateAdvancedSequenceStepWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_CreateAdvancedSequenceStepWithChannels")
        )
        mock_library.niDCPower_CreateAdvancedSequenceStepWithChannels.return_value = 0
        mock_library.niDCPower_CreateAdvancedSequenceWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_CreateAdvancedSequenceWithChannels")
        )
        mock_library.niDCPower_CreateAdvancedSequenceWithChannels.return_value = 0
        mock_library.niDCPower_DeleteAdvancedSequenceWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_DeleteAdvancedSequenceWithChannels")
        )
        mock_library.niDCPower_DeleteAdvancedSequenceWithChannels.return_value = 0
        mock_library.niDCPower_Disable.side_effect = MockFunctionCallError(
            "niDCPower_Disable"
        )
        mock_library.niDCPower_Disable.return_value = 0
        mock_library.niDCPower_ExportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niDCPower_ExportAttributeConfigurationBuffer")
        )
        mock_library.niDCPower_ExportAttributeConfigurationBuffer.return_value = 0
        mock_library.niDCPower_ExportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niDCPower_ExportAttributeConfigurationFile")
        )
        mock_library.niDCPower_ExportAttributeConfigurationFile.return_value = 0
        mock_library.niDCPower_FancyInitialize.side_effect = MockFunctionCallError(
            "niDCPower_FancyInitialize"
        )
        mock_library.niDCPower_FancyInitialize.return_value = 0
        mock_library.niDCPower_FetchMultiple.side_effect = MockFunctionCallError(
            "niDCPower_FetchMultiple"
        )
        mock_library.niDCPower_FetchMultiple.return_value = 0
        mock_library.niDCPower_GetAttributeViBoolean.side_effect = (
            MockFunctionCallError("niDCPower_GetAttributeViBoolean")
        )
        mock_library.niDCPower_GetAttributeViBoolean.return_value = 0
        mock_library.niDCPower_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDCPower_GetAttributeViInt32"
        )
        mock_library.niDCPower_GetAttributeViInt32.return_value = 0
        mock_library.niDCPower_GetAttributeViInt64.side_effect = MockFunctionCallError(
            "niDCPower_GetAttributeViInt64"
        )
        mock_library.niDCPower_GetAttributeViInt64.return_value = 0
        mock_library.niDCPower_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDCPower_GetAttributeViReal64"
        )
        mock_library.niDCPower_GetAttributeViReal64.return_value = 0
        mock_library.niDCPower_GetAttributeViString.side_effect = MockFunctionCallError(
            "niDCPower_GetAttributeViString"
        )
        mock_library.niDCPower_GetAttributeViString.return_value = 0
        mock_library.niDCPower_GetChannelName.side_effect = MockFunctionCallError(
            "niDCPower_GetChannelName"
        )
        mock_library.niDCPower_GetChannelName.return_value = 0
        mock_library.niDCPower_GetChannelNameFromString.side_effect = (
            MockFunctionCallError("niDCPower_GetChannelNameFromString")
        )
        mock_library.niDCPower_GetChannelNameFromString.return_value = 0
        mock_library.niDCPower_GetError.side_effect = MockFunctionCallError(
            "niDCPower_GetError"
        )
        mock_library.niDCPower_GetError.return_value = 0
        mock_library.niDCPower_GetExtCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niDCPower_GetExtCalLastDateAndTime")
        )
        mock_library.niDCPower_GetExtCalLastDateAndTime.return_value = 0
        mock_library.niDCPower_GetExtCalLastTemp.side_effect = MockFunctionCallError(
            "niDCPower_GetExtCalLastTemp"
        )
        mock_library.niDCPower_GetExtCalLastTemp.return_value = 0
        mock_library.niDCPower_GetExtCalRecommendedInterval.side_effect = (
            MockFunctionCallError("niDCPower_GetExtCalRecommendedInterval")
        )
        mock_library.niDCPower_GetExtCalRecommendedInterval.return_value = 0
        mock_library.niDCPower_GetSelfCalLastDateAndTime.side_effect = (
            MockFunctionCallError("niDCPower_GetSelfCalLastDateAndTime")
        )
        mock_library.niDCPower_GetSelfCalLastDateAndTime.return_value = 0
        mock_library.niDCPower_GetSelfCalLastTemp.side_effect = MockFunctionCallError(
            "niDCPower_GetSelfCalLastTemp"
        )
        mock_library.niDCPower_GetSelfCalLastTemp.return_value = 0
        mock_library.niDCPower_ImportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niDCPower_ImportAttributeConfigurationBuffer")
        )
        mock_library.niDCPower_ImportAttributeConfigurationBuffer.return_value = 0
        mock_library.niDCPower_ImportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niDCPower_ImportAttributeConfigurationFile")
        )
        mock_library.niDCPower_ImportAttributeConfigurationFile.return_value = 0
        mock_library.niDCPower_InitializeWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_InitializeWithChannels")
        )
        mock_library.niDCPower_InitializeWithChannels.return_value = 0
        mock_library.niDCPower_InitializeWithIndependentChannels.side_effect = (
            MockFunctionCallError("niDCPower_InitializeWithIndependentChannels")
        )
        mock_library.niDCPower_InitializeWithIndependentChannels.return_value = 0
        mock_library.niDCPower_InitiateWithChannels.side_effect = MockFunctionCallError(
            "niDCPower_InitiateWithChannels"
        )
        mock_library.niDCPower_InitiateWithChannels.return_value = 0
        mock_library.niDCPower_LockSession.side_effect = MockFunctionCallError(
            "niDCPower_LockSession"
        )
        mock_library.niDCPower_LockSession.return_value = 0
        mock_library.niDCPower_Measure.side_effect = MockFunctionCallError(
            "niDCPower_Measure"
        )
        mock_library.niDCPower_Measure.return_value = 0
        mock_library.niDCPower_MeasureMultiple.side_effect = MockFunctionCallError(
            "niDCPower_MeasureMultiple"
        )
        mock_library.niDCPower_MeasureMultiple.return_value = 0
        mock_library.niDCPower_ParseChannelCount.side_effect = MockFunctionCallError(
            "niDCPower_ParseChannelCount"
        )
        mock_library.niDCPower_ParseChannelCount.return_value = 0
        mock_library.niDCPower_QueryInCompliance.side_effect = MockFunctionCallError(
            "niDCPower_QueryInCompliance"
        )
        mock_library.niDCPower_QueryInCompliance.return_value = 0
        mock_library.niDCPower_QueryLatchedOutputCutoffState.side_effect = (
            MockFunctionCallError("niDCPower_QueryLatchedOutputCutoffState")
        )
        mock_library.niDCPower_QueryLatchedOutputCutoffState.return_value = 0
        mock_library.niDCPower_QueryMaxCurrentLimit.side_effect = MockFunctionCallError(
            "niDCPower_QueryMaxCurrentLimit"
        )
        mock_library.niDCPower_QueryMaxCurrentLimit.return_value = 0
        mock_library.niDCPower_QueryMaxVoltageLevel.side_effect = MockFunctionCallError(
            "niDCPower_QueryMaxVoltageLevel"
        )
        mock_library.niDCPower_QueryMaxVoltageLevel.return_value = 0
        mock_library.niDCPower_QueryMinCurrentLimit.side_effect = MockFunctionCallError(
            "niDCPower_QueryMinCurrentLimit"
        )
        mock_library.niDCPower_QueryMinCurrentLimit.return_value = 0
        mock_library.niDCPower_QueryOutputState.side_effect = MockFunctionCallError(
            "niDCPower_QueryOutputState"
        )
        mock_library.niDCPower_QueryOutputState.return_value = 0
        mock_library.niDCPower_ReadCurrentTemperature.side_effect = (
            MockFunctionCallError("niDCPower_ReadCurrentTemperature")
        )
        mock_library.niDCPower_ReadCurrentTemperature.return_value = 0
        mock_library.niDCPower_ResetDevice.side_effect = MockFunctionCallError(
            "niDCPower_ResetDevice"
        )
        mock_library.niDCPower_ResetDevice.return_value = 0
        mock_library.niDCPower_ResetWithChannels.side_effect = MockFunctionCallError(
            "niDCPower_ResetWithChannels"
        )
        mock_library.niDCPower_ResetWithChannels.return_value = 0
        mock_library.niDCPower_ResetWithDefaults.side_effect = MockFunctionCallError(
            "niDCPower_ResetWithDefaults"
        )
        mock_library.niDCPower_ResetWithDefaults.return_value = 0
        mock_library.niDCPower_SendSoftwareEdgeTriggerWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_SendSoftwareEdgeTriggerWithChannels")
        )
        mock_library.niDCPower_SendSoftwareEdgeTriggerWithChannels.return_value = 0
        mock_library.niDCPower_SetAttributeViBoolean.side_effect = (
            MockFunctionCallError("niDCPower_SetAttributeViBoolean")
        )
        mock_library.niDCPower_SetAttributeViBoolean.return_value = 0
        mock_library.niDCPower_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDCPower_SetAttributeViInt32"
        )
        mock_library.niDCPower_SetAttributeViInt32.return_value = 0
        mock_library.niDCPower_SetAttributeViInt64.side_effect = MockFunctionCallError(
            "niDCPower_SetAttributeViInt64"
        )
        mock_library.niDCPower_SetAttributeViInt64.return_value = 0
        mock_library.niDCPower_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDCPower_SetAttributeViReal64"
        )
        mock_library.niDCPower_SetAttributeViReal64.return_value = 0
        mock_library.niDCPower_SetAttributeViString.side_effect = MockFunctionCallError(
            "niDCPower_SetAttributeViString"
        )
        mock_library.niDCPower_SetAttributeViString.return_value = 0
        mock_library.niDCPower_SetSequence.side_effect = MockFunctionCallError(
            "niDCPower_SetSequence"
        )
        mock_library.niDCPower_SetSequence.return_value = 0
        mock_library.niDCPower_UnlockSession.side_effect = MockFunctionCallError(
            "niDCPower_UnlockSession"
        )
        mock_library.niDCPower_UnlockSession.return_value = 0
        mock_library.niDCPower_WaitForEventWithChannels.side_effect = (
            MockFunctionCallError("niDCPower_WaitForEventWithChannels")
        )
        mock_library.niDCPower_WaitForEventWithChannels.return_value = 0
        mock_library.niDCPower_close.side_effect = MockFunctionCallError(
            "niDCPower_close"
        )
        mock_library.niDCPower_close.return_value = 0
        mock_library.niDCPower_error_message.side_effect = MockFunctionCallError(
            "niDCPower_error_message"
        )
        mock_library.niDCPower_error_message.return_value = 0
        mock_library.niDCPower_self_test.side_effect = MockFunctionCallError(
            "niDCPower_self_test"
        )
