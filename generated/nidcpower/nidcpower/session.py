...
class _SessionBase(object):
    ...
    **Related Topics:**
    ...
    '''
    isolation_state = _attributes.AttributeEnumWithConverter(_attributes.AttributeViInt32, enums._IsolationState, 1150302, _converters.convert_from___isolation_state_enum_value, _converters.convert_to___isolation_state_enum_value)
    '''Type: bool
