...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def abort(self, session_handle, encoding, channel_name):  # noqa: N802
    ...
    def self_cal(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def clear_latched_output_cutoff_state(self, session_handle, encoding, channel_name, output_cutoff_reason):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def commit(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def configure_aperture_time(self, session_handle, encoding, channel_name, aperture_time, units):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def configure_lcr_custom_cable_compensation(self, session_handle, encoding, channel_name, custom_cable_compensation_data):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def create_advanced_sequence_commit_step(self, session_handle, encoding, channel_name, set_as_active_step):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def create_advanced_sequence_step(self, session_handle, encoding, channel_name, set_as_active_step):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        set_as_active_step_ctype = _visatype.ViBoolean(set_as_active_step)  # case S150
    ...
    def create_advanced_sequence_with_channels(self, session_handle, encoding, channel_name, sequence_name, attribute_ids, set_as_active_sequence):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        sequence_name_ctype = ctypes.create_string_buffer(sequence_name.encode(encoding))  # case C020
    ...
    def delete_advanced_sequence(self, session_handle, encoding, channel_name, sequence_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        sequence_name_ctype = ctypes.create_string_buffer(sequence_name.encode(encoding))  # case C020
    ...
    def fancy_initialize(self, session_handle, encoding, resource_name, channels, reset, option_string, independent_channels):  # noqa: N802
        resource_name_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(resource_name).encode(encoding))  # case C040
        channels_ctype = ctypes.create_string_buffer(_converters.convert_repeated_capabilities_without_prefix(channels).encode(encoding))  # case C040
    ...
    def fetch_multiple(self, session_handle, encoding, channel_name, timeout, count):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def fetch_multiple_lcr(self, session_handle, encoding, channel_name, timeout, count):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        timeout_ctype = _converters.convert_timedelta_to_seconds_real64(timeout)  # case S140
        count_ctype = _visatype.ViInt32(count)  # case S210
    ...
    def get_attribute_vi_int64(self, session_handle, encoding, channel_name, attribute_id):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def get_channel_name(self, session_handle, encoding, index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        ...
        error_code = self._library.niDCPower_GetChannelName(vi_ctype, index_ctype, buffer_size_ctype, channel_name_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return channel_name_ctype.value.decode(encoding)
    ...
    def get_error(self, session_handle, encoding):  # noqa: N802
        ...
        return int(code_ctype.value), description_ctype.value.decode(encoding)

    def get_ext_cal_last_date_and_time(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_ext_cal_last_temp(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_lcr_compensation_last_date_and_time(self, session_handle, encoding, channel_name, compensation_type):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def get_lcr_custom_cable_compensation_data(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def get_self_cal_last_date_and_time(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        year_ctype = _visatype.ViInt32()  # case S220
        month_ctype = _visatype.ViInt32()  # case S220
        day_ctype = _visatype.ViInt32()  # case S220
    ...
    def get_self_cal_last_temp(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        temperature_ctype = _visatype.ViReal64()  # case S220
    ...
    def initialize_with_channels(self, session_handle, encoding, resource_name, channels, reset, option_string):  # noqa: N802
        resource_name_ctype = ctypes.create_string_buffer(resource_name.encode(encoding))  # case C020
        channels_ctype = ctypes.create_string_buffer(channels.encode(encoding))  # case C020
        reset_ctype = _visatype.ViBoolean(reset)  # case S150
        option_string_ctype = ctypes.create_string_buffer(option_string.encode(encoding))  # case C020
        vi_ctype = _visatype.ViSession()  # case S220
    ...
    def initialize_with_independent_channels(self, session_handle, encoding, resource_name, reset, option_string):  # noqa: N802
        resource_name_ctype = ctypes.create_string_buffer(resource_name.encode(encoding))  # case C020
        reset_ctype = _visatype.ViBoolean(reset)  # case S150
        option_string_ctype = ctypes.create_string_buffer(option_string.encode(encoding))  # case C020
        vi_ctype = _visatype.ViSession()  # case S220
    ...
    def initiate_with_channels(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def measure(self, session_handle, encoding, channel_name, measurement_type):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def measure_multiple(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        voltage_measurements_size = self.parse_channel_count(session_handle, encoding, channel_name)  # case B560
        ...
        current_measurements_size = self.parse_channel_count(session_handle, encoding, channel_name)  # case B560
    ...
    def measure_multiple_lcr(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        measurements_size = self.parse_channel_count(session_handle, encoding, channel_name)  # case B560
        ...
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return [lcr_measurement.LCRMeasurement(measurements_ctype[i]) for i in range(self.parse_channel_count(session_handle, encoding, channel_name))]

    def parse_channel_count(self, session_handle, encoding, channels_string):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channels_string_ctype = ctypes.create_string_buffer(channels_string.encode(encoding))  # case C010
    ...
    def perform_lcr_load_compensation(self, session_handle, encoding, channel_name, compensation_spots):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def perform_lcr_open_compensation(self, session_handle, encoding, channel_name, additional_frequencies):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def perform_lcr_open_custom_cable_compensation(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def perform_lcr_short_compensation(self, session_handle, encoding, channel_name, additional_frequencies):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        num_frequencies_ctype = _visatype.ViInt32(0 if additional_frequencies is None else len(additional_frequencies))  # case S160
        additional_frequencies_ctype = _get_ctypes_pointer_for_buffer(value=additional_frequencies, library_type=_visatype.ViReal64)  # case B550
    ...
    def perform_lcr_short_custom_cable_compensation(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def query_in_compliance(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def query_latched_output_cutoff_state(self, session_handle, encoding, channel_name, output_cutoff_reason):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        output_cutoff_reason_ctype = _visatype.ViInt32(output_cutoff_reason.value)  # case S130
    ...
    def query_max_current_limit(self, session_handle, encoding, channel_name, voltage_level):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def query_max_voltage_level(self, session_handle, encoding, channel_name, current_limit):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def query_min_current_limit(self, session_handle, encoding, channel_name, voltage_level):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        voltage_level_ctype = _visatype.ViReal64(voltage_level)  # case S150
    ...
    def query_output_state(self, session_handle, encoding, channel_name, output_state):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def read_current_temperature(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        temperature_ctype = _visatype.ViReal64()  # case S220
    ...
    def reset(self, session_handle, encoding, channel_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def send_software_edge_trigger(self, session_handle, encoding, channel_name, trigger):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def set_attribute_vi_int64(self, session_handle, encoding, channel_name, attribute_id, attribute_value):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
        attribute_id_ctype = _visatype.ViAttr(attribute_id)  # case S150
    ...
    def set_sequence(self, session_handle, encoding, channel_name, values, source_delays):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
    ...
    def wait_for_event(self, session_handle, encoding, channel_name, event_id, timeout):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel_name_ctype = ctypes.create_string_buffer(channel_name.encode(encoding))  # case C010
