...
Additional examples for NI-ModInst are located in src/nimodinst/examples/ directory `on GitHub <https://github.com/ni/nimi-python/tree/master/src/nimodinst/examples>`_.
