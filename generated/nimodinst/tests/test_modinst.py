...
class TestSession(object):
    def setup_method(self, method):
        ...
        self.patched_library_singleton_get = patch('nimodinst.session.library_singleton.LibrarySingleton.get', return_value=self.patched_library)
    ...
    def test_open(self):
        ...
        self.patched_errors._handle_error.assert_called_once_with(session, self.patched_library.niModInst_OpenInstalledDevicesSession.return_value)
