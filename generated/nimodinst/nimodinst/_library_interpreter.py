...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def close_installed_devices_session(self, session_handle, encoding):  # noqa: N802
        handle_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_extended_error_info(self, session_handle, encoding):  # noqa: N802
        ...
        return error_info_ctype.value.decode(encoding)

    def get_installed_device_attribute_vi_int32(self, session_handle, encoding, index, attribute_id):  # noqa: N802
        handle_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def get_installed_device_attribute_vi_string(self, session_handle, encoding, index, attribute_id):  # noqa: N802
        handle_ctype = _visatype.ViSession(session_handle)  # case S110
        index_ctype = _visatype.ViInt32(index)  # case S150
        attribute_id_ctype = _visatype.ViInt32(attribute_id)  # case S150
    ...
    def open_installed_devices_session(self, session_handle, encoding, driver):  # noqa: N802
        driver_ctype = ctypes.create_string_buffer(driver.encode(encoding))  # case C020
