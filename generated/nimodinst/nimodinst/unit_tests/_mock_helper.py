...
class SideEffectsHelper(object):
    ...
    def niModInst_GetExtendedErrorInfo(
        ...
        if self._defaults["GetExtendedErrorInfo"]["errorInfo"] is None:
            raise MockFunctionCallError(
                "niModInst_GetExtendedErrorInfo", param="errorInfo"
            )
        if error_info_buffer_size.value == 0:
            return len(self._defaults["GetExtendedErrorInfo"]["errorInfo"])
        error_info.value = self._defaults["GetExtendedErrorInfo"]["errorInfo"].encode(
            "ascii"
        )
        return self._defaults["GetExtendedErrorInfo"]["return"]
    ...
    def niModInst_GetInstalledDeviceAttributeViInt32(
        ...
        # attribute_value
        if (
            self._defaults["GetInstalledDeviceAttributeViInt32"]["attributeValue"]
            is None
        ):
            raise MockFunctionCallError(
                "niModInst_GetInstalledDeviceAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
            attribute_value.contents.value = self._defaults[
    ...
    def niModInst_GetInstalledDeviceAttributeViString(
        ...
        if (
            self._defaults["GetInstalledDeviceAttributeViString"]["attributeValue"]
            is None
        ):
            raise MockFunctionCallError(
                "niModInst_GetInstalledDeviceAttributeViString", param="attributeValue"
            )
        if attribute_value_buffer_size.value == 0:
            return len(
                self._defaults["GetInstalledDeviceAttributeViString"]["attributeValue"]
            )
        attribute_value.value = self._defaults["GetInstalledDeviceAttributeViString"][
            "attributeValue"
        ].encode("ascii")
        return self._defaults["GetInstalledDeviceAttributeViString"]["return"]
    ...
    def niModInst_OpenInstalledDevicesSession(
        ...
        if self._defaults["OpenInstalledDevicesSession"]["handle"] is None:
            raise MockFunctionCallError(
                "niModInst_OpenInstalledDevicesSession", param="handle"
            )
        if handle is not None:
            handle.contents.value = self._defaults["OpenInstalledDevicesSession"][
                "handle"
            ]
        # device_count
        if self._defaults["OpenInstalledDevicesSession"]["deviceCount"] is None:
            raise MockFunctionCallError(
                "niModInst_OpenInstalledDevicesSession", param="deviceCount"
            )
        if device_count is not None:
            device_count.contents.value = self._defaults["OpenInstalledDevicesSession"][
                "deviceCount"
            ]
        return self._defaults["OpenInstalledDevicesSession"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niModInst_CloseInstalledDevicesSession.side_effect = (
            MockFunctionCallError("niModInst_CloseInstalledDevicesSession")
        )
        mock_library.niModInst_CloseInstalledDevicesSession.return_value = 0
        mock_library.niModInst_GetExtendedErrorInfo.side_effect = MockFunctionCallError(
            "niModInst_GetExtendedErrorInfo"
        )
        mock_library.niModInst_GetExtendedErrorInfo.return_value = 0
        mock_library.niModInst_GetInstalledDeviceAttributeViInt32.side_effect = (
            MockFunctionCallError("niModInst_GetInstalledDeviceAttributeViInt32")
        )
        mock_library.niModInst_GetInstalledDeviceAttributeViInt32.return_value = 0
        mock_library.niModInst_GetInstalledDeviceAttributeViString.side_effect = (
            MockFunctionCallError("niModInst_GetInstalledDeviceAttributeViString")
        )
        mock_library.niModInst_GetInstalledDeviceAttributeViString.return_value = 0
        mock_library.niModInst_OpenInstalledDevicesSession.side_effect = (
            MockFunctionCallError("niModInst_OpenInstalledDevicesSession")
        )
