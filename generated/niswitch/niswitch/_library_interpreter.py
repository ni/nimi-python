...
class LibraryInterpreter(object):
    ...
    * Converting errors returned by Library into Python exceptions.
    ...
    def can_connect(self, session_handle, encoding, channel1, channel2):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def connect(self, session_handle, encoding, channel1, channel2):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel1_ctype = ctypes.create_string_buffer(channel1.encode(encoding))  # case C020
        channel2_ctype = ctypes.create_string_buffer(channel2.encode(encoding))  # case C020
    ...
    def connect_multiple(self, session_handle, encoding, connection_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        connection_list_ctype = ctypes.create_string_buffer(connection_list.encode(encoding))  # case C020
    ...
    def disconnect(self, session_handle, encoding, channel1, channel2):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel1_ctype = ctypes.create_string_buffer(channel1.encode(encoding))  # case C020
        channel2_ctype = ctypes.create_string_buffer(channel2.encode(encoding))  # case C020
    ...
    def disconnect_multiple(self, session_handle, encoding, disconnection_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        disconnection_list_ctype = ctypes.create_string_buffer(disconnection_list.encode(encoding))  # case C020
    ...
    def get_channel_name(self, session_handle, encoding, index):  # noqa: N802
        ...
        error_code = self._library.niSwitch_GetChannelName(vi_ctype, index_ctype, buffer_size_ctype, channel_name_buffer_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return channel_name_buffer_ctype.value.decode(encoding)
    ...
    def get_path(self, session_handle, encoding, channel1, channel2):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        channel1_ctype = ctypes.create_string_buffer(channel1.encode(encoding))  # case C020
        channel2_ctype = ctypes.create_string_buffer(channel2.encode(encoding))  # case C020
        buffer_size_ctype = _visatype.ViInt32()  # case S170
        ...
        error_code = self._library.niSwitch_GetPath(vi_ctype, channel1_ctype, channel2_ctype, buffer_size_ctype, path_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return path_ctype.value.decode(encoding)

    def get_relay_count(self, session_handle, encoding, relay_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        relay_name_ctype = ctypes.create_string_buffer(relay_name.encode(encoding))  # case C020
    ...
    def get_relay_name(self, session_handle, encoding, index):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        index_ctype = _visatype.ViInt32(index)  # case S150
        ...
        error_code = self._library.niSwitch_GetRelayName(vi_ctype, index_ctype, relay_name_buffer_size_ctype, relay_name_buffer_ctype)
        errors.handle_error(self, session_handle, encoding, error_code, ignore_warnings=False, is_error_handling=False)
        return relay_name_buffer_ctype.value.decode(encoding)

    def get_relay_position(self, session_handle, encoding, relay_name):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        relay_name_ctype = ctypes.create_string_buffer(relay_name.encode(encoding))  # case C020
    ...
    def init_with_topology(self, session_handle, encoding, resource_name, topology, simulate, reset_device):  # noqa: N802
        resource_name_ctype = ctypes.create_string_buffer(resource_name.encode(encoding))  # case C020
        topology_ctype = ctypes.create_string_buffer(topology.encode(encoding))  # case C020
    ...
    def initiate_scan(self, session_handle, encoding):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def relay_control(self, session_handle, encoding, relay_name, relay_action):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        relay_name_ctype = ctypes.create_string_buffer(relay_name.encode(encoding))  # case C020
    ...
    def route_scan_advanced_output(self, session_handle, encoding, scan_advanced_output_connector, scan_advanced_output_bus_line, invert):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def route_trigger_input(self, session_handle, encoding, trigger_input_connector, trigger_input_bus_line, invert):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
    ...
    def set_path(self, session_handle, encoding, path_list):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        path_list_ctype = ctypes.create_string_buffer(path_list.encode(encoding))  # case C020
    ...
    def wait_for_scan_complete(self, session_handle, encoding, maximum_time_ms):  # noqa: N802
        vi_ctype = _visatype.ViSession(session_handle)  # case S110
        maximum_time_ms_ctype = _converters.convert_timedelta_to_milliseconds_int32(maximum_time_ms)  # case S140
