...
class _SessionBase(object):
    ...
    """
    handshaking_initiation = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.HandshakingInitiation, 1150013
    )
    ...
    """
    scan_advanced_output = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ScanAdvancedOutput, 1250023
    )
    ...
    """
    scan_advanced_polarity = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ScanAdvancedPolarity, 1150011
    )
    ...
    """
    scan_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ScanMode, 1250021
    )
    """Type: enums.ScanMode
    ...
    """
    trigger_input = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerInput, 1250022
    )
    ...
    """
    trigger_input_polarity = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerInputPolarity, 1150010
    )
    ...
    def __repr__(self):
        return "{0}.{1}({2})".format(
            "niswitch", self.__class__.__name__, self._param_list
        )
    ...
    def _get_attribute_vi_boolean(self, attribute_id):
        ...
        error_code = self._library.niSwitch_GetAttributeViBoolean(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_int32(self, attribute_id):
        ...
        error_code = self._library.niSwitch_GetAttributeViInt32(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_real64(self, attribute_id):
        ...
        error_code = self._library.niSwitch_GetAttributeViReal64(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_string(self, attribute_id):
        ...
        error_code = self._library.niSwitch_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            array_size_ctype,
    ...
    def _get_error(self):
        ...
        error_code = self._library.niSwitch_GetError(
            vi_ctype,
    ...
    def _set_attribute_vi_boolean(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niSwitch_SetAttributeViBoolean(
    ...
    def _set_attribute_vi_int32(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niSwitch_SetAttributeViInt32(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_real64(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niSwitch_SetAttributeViReal64(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_string(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niSwitch_SetAttributeViString(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _error_message(self, error_code):
        ...
        error_code = self._library.niSwitch_error_message(
...
class Session(_SessionBase):
    ...
    def __init__(
        ...
        self._vi = self._init_with_topology(
            resource_name, topology, simulate, reset_device
        )
    ...
    def can_connect(self, channel1, channel2):
        ...
        error_code = self._library.niSwitch_CanConnect(
            vi_ctype,
            channel1_ctype,
            channel2_ctype,
            None
    ...
    def connect(self, channel1, channel2):
        ...
        error_code = self._library.niSwitch_Connect(
            vi_ctype, channel1_ctype, channel2_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def connect_multiple(self, connection_list):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        connection_list_ctype = ctypes.create_string_buffer(
            connection_list.encode(self._encoding)
        )  # case C020
        error_code = self._library.niSwitch_ConnectMultiple(
            vi_ctype, connection_list_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def disconnect(self, channel1, channel2):
        ...
        error_code = self._library.niSwitch_Disconnect(
            vi_ctype, channel1_ctype, channel2_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def disconnect_multiple(self, disconnection_list):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        disconnection_list_ctype = ctypes.create_string_buffer(
            disconnection_list.encode(self._encoding)
        )  # case C020
        error_code = self._library.niSwitch_DisconnectMultiple(
            vi_ctype, disconnection_list_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_channel_name(self, index):
        ...
        error_code = self._library.niSwitch_GetChannelName(
            vi_ctype, index_ctype, buffer_size_ctype, channel_name_buffer_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        buffer_size_ctype = _visatype.ViInt32(error_code)  # case S180
        channel_name_buffer_ctype = (
    ...
    def get_path(self, channel1, channel2):
        ...
        error_code = self._library.niSwitch_GetPath(
            vi_ctype, channel1_ctype, channel2_ctype, buffer_size_ctype, path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
    ...
    def get_relay_count(self, relay_name):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        relay_name_ctype = ctypes.create_string_buffer(
            relay_name.encode(self._encoding)
        )  # case C020
        relay_count_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niSwitch_GetRelayCount(
            vi_ctype,
            relay_name_ctype,
            None if relay_count_ctype is None else (ctypes.pointer(relay_count_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def get_relay_name(self, index):
        ...
        error_code = self._library.niSwitch_GetRelayName(
            vi_ctype, index_ctype, relay_name_buffer_size_ctype, relay_name_buffer_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=True, is_error_handling=False
        )
        relay_name_buffer_size_ctype = _visatype.ViInt32(error_code)  # case S180
        relay_name_buffer_ctype = (
            _visatype.ViChar * relay_name_buffer_size_ctype.value
        )()  # case C060
        error_code = self._library.niSwitch_GetRelayName(
            vi_ctype, index_ctype, relay_name_buffer_size_ctype, relay_name_buffer_ctype
        )
    ...
    def get_relay_position(self, relay_name):
        ...
        error_code = self._library.niSwitch_GetRelayPosition(
            vi_ctype,
            relay_name_ctype,
            None
            if relay_position_ctype is None
            else (ctypes.pointer(relay_position_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def _init_with_topology(
        ...
        topology_ctype = ctypes.create_string_buffer(
            topology.encode(self._encoding)
        )  # case C020
        simulate_ctype = _visatype.ViBoolean(simulate)  # case S150
        reset_device_ctype = _visatype.ViBoolean(reset_device)  # case S150
        vi_ctype = _visatype.ViSession()  # case S220
        error_code = self._library.niSwitch_InitWithTopology(
            resource_name_ctype,
            topology_ctype,
            simulate_ctype,
            reset_device_ctype,
    ...
    def relay_control(self, relay_name, relay_action):
        ...
        if type(relay_action) is not enums.RelayAction:
            raise TypeError(
                "Parameter relay_action must be of type " + str(enums.RelayAction)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        relay_name_ctype = ctypes.create_string_buffer(
            relay_name.encode(self._encoding)
        ...
        error_code = self._library.niSwitch_RelayControl(
            vi_ctype, relay_name_ctype, relay_action_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def route_scan_advanced_output(
        self,
        ...
        if type(scan_advanced_output_connector) is not enums.ScanAdvancedOutput:
            raise TypeError(
                "Parameter scan_advanced_output_connector must be of type "
                + str(enums.ScanAdvancedOutput)
            )
        if type(scan_advanced_output_bus_line) is not enums.ScanAdvancedOutput:
            raise TypeError(
                "Parameter scan_advanced_output_bus_line must be of type "
                + str(enums.ScanAdvancedOutput)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        scan_advanced_output_connector_ctype = _visatype.ViInt32(
            scan_advanced_output_connector.value
        )  # case S130
        scan_advanced_output_bus_line_ctype = _visatype.ViInt32(
            scan_advanced_output_bus_line.value
        )  # case S130
        invert_ctype = _visatype.ViBoolean(invert)  # case S150
        error_code = self._library.niSwitch_RouteScanAdvancedOutput(
            vi_ctype,
            scan_advanced_output_connector_ctype,
            scan_advanced_output_bus_line_ctype,
            invert_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    @ivi_synchronized
    def route_trigger_input(
        self, trigger_input_connector, trigger_input_bus_line, invert=False
    ):
        ...
        if type(trigger_input_connector) is not enums.TriggerInput:
            raise TypeError(
                "Parameter trigger_input_connector must be of type "
                + str(enums.TriggerInput)
            )
        if type(trigger_input_bus_line) is not enums.TriggerInput:
            raise TypeError(
                "Parameter trigger_input_bus_line must be of type "
                + str(enums.TriggerInput)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        trigger_input_connector_ctype = _visatype.ViInt32(
            trigger_input_connector.value
        )  # case S130
        trigger_input_bus_line_ctype = _visatype.ViInt32(
            trigger_input_bus_line.value
        )  # case S130
        invert_ctype = _visatype.ViBoolean(invert)  # case S150
        error_code = self._library.niSwitch_RouteTriggerInput(
            vi_ctype,
            trigger_input_connector_ctype,
            trigger_input_bus_line_ctype,
            invert_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def set_path(self, path_list):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        path_list_ctype = ctypes.create_string_buffer(
            path_list.encode(self._encoding)
        )  # case C020
    ...
    def wait_for_debounce(self, maximum_time_ms=hightime.timedelta(milliseconds=5000)):
        ...
        error_code = self._library.niSwitch_WaitForDebounce(
    ...
    def wait_for_scan_complete(
        self, maximum_time_ms=hightime.timedelta(milliseconds=5000)
    ):
        ...
        error_code = self._library.niSwitch_WaitForScanComplete(
            vi_ctype, maximum_time_ms_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _self_test(self):
        ...
        error_code = self._library.niSwitch_self_test(
            vi_ctype,
            None
