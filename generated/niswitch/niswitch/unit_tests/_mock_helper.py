...
class SideEffectsHelper(object):
    ...
    def niSwitch_CanConnect(
        ...
        if path_capability is not None:
            path_capability.contents.value = self._defaults["CanConnect"][
                "pathCapability"
            ]
        return self._defaults["CanConnect"]["return"]
    ...
    def niSwitch_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetAttributeViBoolean", param="attributeValue"
            )
    ...
    def niSwitch_GetAttributeViInt32(
        ...
        if self._defaults["GetAttributeViInt32"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niSwitch_GetAttributeViReal64(
        ...
        if self._defaults["GetAttributeViReal64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetAttributeViReal64", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niSwitch_GetAttributeViString(
        ...
        if self._defaults["GetAttributeViString"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetAttributeViString", param="attributeValue"
            )
    ...
    def niSwitch_GetChannelName(
        ...
        if self._defaults["GetChannelName"]["channelNameBuffer"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetChannelName", param="channelNameBuffer"
            )
        if buffer_size.value == 0:
            return len(self._defaults["GetChannelName"]["channelNameBuffer"])
        channel_name_buffer.value = self._defaults["GetChannelName"][
            "channelNameBuffer"
        ].encode("ascii")
        return self._defaults["GetChannelName"]["return"]
    ...
    def niSwitch_GetRelayName(
        ...
        if self._defaults["GetRelayName"]["relayNameBuffer"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetRelayName", param="relayNameBuffer"
            )
        if relay_name_buffer_size.value == 0:
            return len(self._defaults["GetRelayName"]["relayNameBuffer"])
        relay_name_buffer.value = self._defaults["GetRelayName"][
            "relayNameBuffer"
        ].encode("ascii")
        return self._defaults["GetRelayName"]["return"]
    ...
    def niSwitch_GetRelayPosition(self, vi, relay_name, relay_position):  # noqa: N802
        ...
        if self._defaults["GetRelayPosition"]["relayPosition"] is None:
            raise MockFunctionCallError(
                "niSwitch_GetRelayPosition", param="relayPosition"
            )
        if relay_position is not None:
            relay_position.contents.value = self._defaults["GetRelayPosition"][
                "relayPosition"
            ]
        return self._defaults["GetRelayPosition"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        mock_library.niSwitch_AbortScan.side_effect = MockFunctionCallError(
            "niSwitch_AbortScan"
        )
        mock_library.niSwitch_AbortScan.return_value = 0
        mock_library.niSwitch_CanConnect.side_effect = MockFunctionCallError(
            "niSwitch_CanConnect"
        )
        mock_library.niSwitch_CanConnect.return_value = 0
        mock_library.niSwitch_Commit.side_effect = MockFunctionCallError(
            "niSwitch_Commit"
        )
        mock_library.niSwitch_Commit.return_value = 0
        mock_library.niSwitch_Connect.side_effect = MockFunctionCallError(
            "niSwitch_Connect"
        )
        mock_library.niSwitch_Connect.return_value = 0
        mock_library.niSwitch_ConnectMultiple.side_effect = MockFunctionCallError(
            "niSwitch_ConnectMultiple"
        )
        mock_library.niSwitch_ConnectMultiple.return_value = 0
        mock_library.niSwitch_Disable.side_effect = MockFunctionCallError(
            "niSwitch_Disable"
        )
        mock_library.niSwitch_Disable.return_value = 0
        mock_library.niSwitch_Disconnect.side_effect = MockFunctionCallError(
            "niSwitch_Disconnect"
        )
        mock_library.niSwitch_Disconnect.return_value = 0
        mock_library.niSwitch_DisconnectAll.side_effect = MockFunctionCallError(
            "niSwitch_DisconnectAll"
        )
        mock_library.niSwitch_DisconnectAll.return_value = 0
        mock_library.niSwitch_DisconnectMultiple.side_effect = MockFunctionCallError(
            "niSwitch_DisconnectMultiple"
        )
        mock_library.niSwitch_DisconnectMultiple.return_value = 0
        mock_library.niSwitch_GetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niSwitch_GetAttributeViBoolean"
        )
        mock_library.niSwitch_GetAttributeViBoolean.return_value = 0
        mock_library.niSwitch_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niSwitch_GetAttributeViInt32"
        )
        mock_library.niSwitch_GetAttributeViInt32.return_value = 0
        mock_library.niSwitch_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niSwitch_GetAttributeViReal64"
        )
        mock_library.niSwitch_GetAttributeViReal64.return_value = 0
        mock_library.niSwitch_GetAttributeViString.side_effect = MockFunctionCallError(
            "niSwitch_GetAttributeViString"
        )
        mock_library.niSwitch_GetAttributeViString.return_value = 0
        mock_library.niSwitch_GetChannelName.side_effect = MockFunctionCallError(
            "niSwitch_GetChannelName"
        )
        mock_library.niSwitch_GetChannelName.return_value = 0
        mock_library.niSwitch_GetError.side_effect = MockFunctionCallError(
            "niSwitch_GetError"
        )
        mock_library.niSwitch_GetError.return_value = 0
        mock_library.niSwitch_GetPath.side_effect = MockFunctionCallError(
            "niSwitch_GetPath"
        )
        mock_library.niSwitch_GetPath.return_value = 0
        mock_library.niSwitch_GetRelayCount.side_effect = MockFunctionCallError(
            "niSwitch_GetRelayCount"
        )
        mock_library.niSwitch_GetRelayCount.return_value = 0
        mock_library.niSwitch_GetRelayName.side_effect = MockFunctionCallError(
            "niSwitch_GetRelayName"
        )
        mock_library.niSwitch_GetRelayName.return_value = 0
        mock_library.niSwitch_GetRelayPosition.side_effect = MockFunctionCallError(
            "niSwitch_GetRelayPosition"
        )
        mock_library.niSwitch_GetRelayPosition.return_value = 0
        mock_library.niSwitch_InitWithTopology.side_effect = MockFunctionCallError(
            "niSwitch_InitWithTopology"
        )
        mock_library.niSwitch_InitWithTopology.return_value = 0
        mock_library.niSwitch_InitiateScan.side_effect = MockFunctionCallError(
            "niSwitch_InitiateScan"
        )
        mock_library.niSwitch_InitiateScan.return_value = 0
        mock_library.niSwitch_LockSession.side_effect = MockFunctionCallError(
            "niSwitch_LockSession"
        )
        mock_library.niSwitch_LockSession.return_value = 0
        mock_library.niSwitch_RelayControl.side_effect = MockFunctionCallError(
            "niSwitch_RelayControl"
        )
        mock_library.niSwitch_RelayControl.return_value = 0
        mock_library.niSwitch_ResetWithDefaults.side_effect = MockFunctionCallError(
            "niSwitch_ResetWithDefaults"
        )
        mock_library.niSwitch_ResetWithDefaults.return_value = 0
        mock_library.niSwitch_RouteScanAdvancedOutput.side_effect = (
            MockFunctionCallError("niSwitch_RouteScanAdvancedOutput")
        )
        mock_library.niSwitch_RouteScanAdvancedOutput.return_value = 0
        mock_library.niSwitch_RouteTriggerInput.side_effect = MockFunctionCallError(
            "niSwitch_RouteTriggerInput"
        )
        mock_library.niSwitch_RouteTriggerInput.return_value = 0
        mock_library.niSwitch_SendSoftwareTrigger.side_effect = MockFunctionCallError(
            "niSwitch_SendSoftwareTrigger"
        )
        mock_library.niSwitch_SendSoftwareTrigger.return_value = 0
        mock_library.niSwitch_SetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niSwitch_SetAttributeViBoolean"
        )
        mock_library.niSwitch_SetAttributeViBoolean.return_value = 0
        mock_library.niSwitch_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niSwitch_SetAttributeViInt32"
        )
        mock_library.niSwitch_SetAttributeViInt32.return_value = 0
        mock_library.niSwitch_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niSwitch_SetAttributeViReal64"
        )
        mock_library.niSwitch_SetAttributeViReal64.return_value = 0
        mock_library.niSwitch_SetAttributeViString.side_effect = MockFunctionCallError(
            "niSwitch_SetAttributeViString"
        )
        mock_library.niSwitch_SetAttributeViString.return_value = 0
        mock_library.niSwitch_SetPath.side_effect = MockFunctionCallError(
            "niSwitch_SetPath"
        )
        mock_library.niSwitch_SetPath.return_value = 0
        mock_library.niSwitch_UnlockSession.side_effect = MockFunctionCallError(
            "niSwitch_UnlockSession"
        )
        mock_library.niSwitch_UnlockSession.return_value = 0
        mock_library.niSwitch_WaitForDebounce.side_effect = MockFunctionCallError(
            "niSwitch_WaitForDebounce"
        )
        mock_library.niSwitch_WaitForDebounce.return_value = 0
        mock_library.niSwitch_WaitForScanComplete.side_effect = MockFunctionCallError(
            "niSwitch_WaitForScanComplete"
        )
        mock_library.niSwitch_WaitForScanComplete.return_value = 0
        mock_library.niSwitch_close.side_effect = MockFunctionCallError(
            "niSwitch_close"
        )
        mock_library.niSwitch_close.return_value = 0
        mock_library.niSwitch_error_message.side_effect = MockFunctionCallError(
            "niSwitch_error_message"
        )
        mock_library.niSwitch_error_message.return_value = 0
        mock_library.niSwitch_reset.side_effect = MockFunctionCallError(
            "niSwitch_reset"
        )
        mock_library.niSwitch_reset.return_value = 0
        mock_library.niSwitch_self_test.side_effect = MockFunctionCallError(
            "niSwitch_self_test"
        )
