...
This corresponds to LabVIEW property Configuration:Measurement Options:Max Frequency
...
Specifies the minimum frequency component of the input signal for AC measurements. This property affects the DMM only when you set the Function property to AC measurements. The valid range is 1 Hz-300 kHz for the NI 4080/4081/4082 and NI 4070/4071/4072, 10 Hz-100 Hz for the NI 4065, and 20 Hz-25 kHz for the NI 4050 and NI 4060.

This corresponds to LabVIEW property Configuration:Measurement Options:Min Frequency
...
This corresponds to LabVIEW property Configuration:Measurement Options:ADC Calibration
...
'''
adc_calibration = None

'''

Specifies the measurement aperture time for the current configuration. Aperture time is specified in units set by the Aperture Time Units property. To override the default aperture, set this property to the desired aperture time after calling niDMM Config Measurement . To return to the default, set this property to Aperture Time Auto (-1).

This corresponds to LabVIEW property Configuration:Advanced:Aperture Time
...
On the NI 4065 the minimum aperture time is 333 micro s and the maximum aperture time is 78.2 s. If setting the number of averages directly, the total measurement time is aperture time X the number of averages, which must be less than 72.8 s. The aperture times allowed are 333 micro s, 667 micro s, or multiples of 1.11 ms--for example 1.11 ms, 2.22 ms, 3.33 ms, and so on. If you set an aperture time other than 333 micro s, 667 micro s, or multiples of 1.11 ms, the value will be coerced up to the
...
This corresponds to LabVIEW property Configuration:Advanced:Aperture Time Units
...
'''
auto_range_value = None

'''

Specifies the AutoZero mode. This property is not supported for the NI 4050.

This corresponds to LabVIEW property Configuration:Measurement Options:Auto Zero
...
This corresponds to LabVIEW property Multi Point Acquisition:Advanced:Buffer Size
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Cable Compensation Type
...
This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Cache
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Capabilities:Channel Count
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Identification:Instrument Product ID
...
This corresponds to LabVIEW property Configuration:Measurement Options:Current Source
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Advanced:DC Bias
...
This corresponds to LabVIEW property Configuration:Measurement Options:DC Noise Rejection
...
'''
dc_noise_rejection = None

'''

This property indicates the Driver Setup string that the user specified when initializing the driver. Some cases exist where the end-user must specify instrument driver options at initialization time. An example of this is specifying a particular instrument model from among a family of instruments that the driver supports. This is useful when using simulation. The end-user can specify driver-specific options through the Driver Setup keyword in the Option String parameter in niDMM Initialize With
Options . If the user does not specify a Driver Setup string, this property returns an empty string.

This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Driver Setup
...
This corresponds to LabVIEW property Configuration:Measurement Options:Frequency Voltage Auto Range Value
...
'''
freq_voltage_auto_range_value = None
...
This corresponds to LabVIEW property Configuration:Measurement Options:Frequency Voltage Range
...
This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Capabilities:Group Capabilities
...
This corresponds to LabVIEW property Configuration:Measurement Options:Input Resistance
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Identification:Instrument Firmware Revision
...
'''
instrument_firmware_revision = None

'''

A string containing the manufacturer of the instrument.

This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Identification:Instrument Manufacturer
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Identification:Instrument Model
...
Specifies whether to perform interchangeability checking and log interchangeability warnings when you call niDMM VIs. Interchangeability warnings indicate that using your application with a different instrument might cause different behavior. Use niDMM Get Next Interchange Warning to extract interchange warnings. Use niDMM Clear Interchange Warnings to clear the list of interchangeability warnings without reading them. Interchangeability checking examines the properties in a capability group
only if you specify a value for at least one property within that group. Interchangeability warnings can occur when a property affects the behavior of the instrument and you have not set that property, or the property has been invalidated since you set it.

This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Interchange Check
...
'''
interchange_check = None

'''

A string containing the resource descriptor of the instrument.

This corresponds to LabVIEW property Inherent IVI Attributes:Advanced Session Information:I/O Resource Descriptor
...
This corresponds to LabVIEW property Multi Point Acquisition:Advanced:Latency
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Advanced:Calculation Model
...
'''
lc_calculation_model = None

'''

For the NI 4082 and NI 4072 only, specifies the number of LC measurements that are averaged to produce one reading.

This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Number of LC Measurements To Average
...
'''
lc_number_meas_to_average = None

'''

A string containing the logical name of the instrument.

This corresponds to LabVIEW property Inherent IVI Attributes:Advanced Session Information:Logical Name
...
To determine which values are supported by each device, refer to the LabVIEW Trigger Routing section in the _NI Digital Multimeters Help_.

This corresponds to LabVIEW property Trigger:Measurement Complete Dest
...
'''
meas_complete_dest = None

'''

Specifies the polarity of the generated measurement complete signal.

This corresponds to LabVIEW property Trigger:Measurement Destination Slope
...
This corresponds to LabVIEW property Configuration:Advanced:Number Of Averages
...
This corresponds to LabVIEW property Configuration:Measurement Options:Offset Compensated Ohms
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Open Cable Compensation Values:Conductance
...
'''
open_cable_comp_conductance = None
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Open Cable Compensation Values:Susceptance
...
'''
open_cable_comp_susceptance = None
...
When you call niDMM Config Measurement , NI-DMM sets this property to IVIDMM Mode. When you call niDMM Configure Waveform Acquisition , NI-DMM sets this property to Waveform Mode. If you are programming properties directly, you must set this property before setting other configuration properties.

This corresponds to LabVIEW property Configuration:Advanced:Operation Mode
...
Specifies the powerline frequency. The NI 4060 and NI 4050 use this value to select an aperture time to reject powerline noise by selecting the appropriate internal sample clock and filter. The NI 4065, NI 4070/4071/4072, and NI 4080/4081/4082 use this value to select timebases for setting the Aperture Time property in powerline cycles.

This corresponds to LabVIEW property Configuration:Measurement Options:Powerline Frequency
...
Specifies whether the instrument driver queries the instrument status after each operation. Querying the instrument status is very useful for debugging. After the user program is validated, this property can be set to FALSE (0) to disable status checking and maximize performance. The instrument driver can choose to ignore status checking for particular properties regardless of the setting of this property. The default value is TRUE (1). Use niDMM Initialize With Options to override the default
setting.

This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Query Instrument Status
...
This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Range Check
...
This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Record Value Coercions
...
This corresponds to LabVIEW property Configuration:Absolute Resolution
...
'''
resolution_digits = None

'''

Specifies the number of measurements the DMM takes each time it receives a trigger in a multiple point acquisition. Setting Sample Count to 0 on the NI 4050 and NI 4060 causes the device to take continuous measurements. Otherwise, setting Sample Count to 0 causes the conditional statement "Measurements equal to Sample Count" to always evaluate to False, and causes the DMM to continue taking measurements in the inner loop.

This corresponds to LabVIEW property Multi Point Acquisition:Sample Count
...
This corresponds to LabVIEW property Multi Point Acquisition:Sample Interval
...
On the NI 4060, the value for this property is used as the settling time. When this property is set to 0, the NI 4060 does not settle between measurement cycles. The onboard timing resolution is 1 micro s on the NI 4060.
...
This corresponds to LabVIEW property Multi Point Acquisition:Sample Trigger
...
This corresponds to LabVIEW property Multi Point Acquisition:Sample Trig Slope
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Identification:Instrument Serial Number
...
This corresponds to LabVIEW property Configuration:Advanced:Settle Time
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Short Cable Compensation Values:Reactance
...
'''
short_cable_comp_reactance = None
...
This corresponds to LabVIEW property Configuration:Measurement Options:Capacitance and Inductance:Short Cable Compensation Values:Resistance
...
'''
short_cable_comp_resistance = None

'''

For the NI 4050 only, specifies the shunt resistance value.

This corresponds to LabVIEW property Configuration:Measurement Options:Shunt Value
...
This corresponds to LabVIEW property Inherent IVI Attributes:User Options:Simulate
...
This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Identification:Specific Driver Class Spec Major Version
...
'''
specific_driver_class_spec_major_version = None

'''

The minor version number of the class specification for the specific driver.

This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Identification:Specific Driver Class Spec Minor Version
...
'''
specific_driver_class_spec_minor_version = None

'''

A string containing a description of the specific driver.

This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Identification:Specific Driver Description
...
'''
specific_driver_description = None
...
This corresponds to LabVIEW property Inherent IVI Attributes:Instrument Capabilities:Specific Driver Prefix
...
'''
specific_driver_prefix = None

'''

A string that contains additional version information about this instrument driver.

This corresponds to LabVIEW property Inherent IVI Attributes:Version Info:Specific Driver Revision
...
'''
specific_driver_revision = None

'''

A string containing the vendor of the specific driver.

This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Identification:Specific Driver Vendor
...
'''
specific_driver_vendor = None

'''

A string containing the instrument models supported by the specific driver.

This corresponds to LabVIEW property Inherent IVI Attributes:Specific Driver Capabilities:Supported Instrument Models
...
'''
supported_instrument_models = None

'''

Specifies the Callendar-Van Dusen A coefficient for RTD scaling when the **RTD Type property** is set to Custom.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Resistance Temperature Detector:RTD A
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Resistance Temperature Detector:RTD B
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Resistance Temperature Detector:RTD C
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Resistance Temperature Detector:RTD Resistance
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Resistance Temperature Detector:RTD Type
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermocouple:Fixed Reference Junction
...
'''
temp_tc_fixed_ref_junc = None

'''

Specifies the thermocouple reference junction type.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermocouple:Reference Junction Type
...
'''
temp_tc_ref_junc_type = None

'''

Specifies the thermocouple type.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermocouple:Thermocouple Type
...
This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermistor:Thermistor A
...
'''
temp_thermistor_a = None

'''

Specifies the Steinhart-Hart B coefficient for thermistor scaling when the **Thermistor Type property** is set to Custom.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermistor:Thermistor B
...
'''
temp_thermistor_b = None

'''

Specifies the Steinhart-Hart C coefficient for thermistor scaling when the **Thermistor Type property** is set to Custom.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermistor:Thermistor C
...
'''
temp_thermistor_c = None

'''

Specifies the thermistor type.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Thermistor:Thermistor Type
...
'''
temp_thermistor_type = None

'''

Specifies the transducer type.

This corresponds to LabVIEW property Configuration:Measurement Options:Temperature:Transducer Type
...
Refer to Multiple Point Acquisitions in the _NI Digital Multimeters Help _for more information.

This corresponds to LabVIEW property Multi Point Acquisition:Trigger Count
...
This corresponds to LabVIEW property Waveform Acquisition:Waveform Coupling
...
This corresponds to LabVIEW property Waveform Acquisition:Waveform Rate
