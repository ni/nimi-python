...
class SideEffectsHelper(object):
    ...
    def niDMM_GetAttributeViString(self, vi, channel_name, attribute_id, buffer_size, attribute_value):  # noqa: N802
        ...
        t = nidmm.visatype.ViChar(self._defaults['GetAttributeViString']['attributeValue'].encode('ascii'))
        attribute_value.value = ctypes.cast(t, nidmm.visatype.ViChar).value
        return self._defaults['GetAttributeViString']['return']
    ...
    def niDMM_GetError(self, vi, error_code, buffer_size, description):  # noqa: N802
        ...
        t = nidmm.visatype.ViChar(self._defaults['GetError']['description'].encode('ascii'))
        description.value = ctypes.cast(t, nidmm.visatype.ViChar).value
        return self._defaults['GetError']['return']
