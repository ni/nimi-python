    ...
    def niDMM_GetChannelName(self, vi, index, buffer_size, name):  # noqa: N802
        with self._func_lock:
            if self.niDMM_GetChannelName_cfunc is None:
                ...
                self.niDMM_GetChannelName_cfunc.argtypes = [ViSession_ctype, ViInt32_ctype, ViInt32_ctype, ViChar_ctype]  # noqa: F405
    ...
    def niDMM_GetNextCoercionRecord(self, vi, buffer_size, record):  # noqa: N802
        with self._func_lock:
            if self.niDMM_GetNextCoercionRecord_cfunc is None:
                ...
                self.niDMM_GetNextCoercionRecord_cfunc.argtypes = [ViSession_ctype, ViInt32_ctype, ViChar_ctype]  # noqa: F405
    ...
    def niDMM_InitWithOptions(self, resource_name, id_query, reset_device, options_string, new_vi):  # noqa: N802
        with self._func_lock:
            if self.niDMM_InitWithOptions_cfunc is None:
                ...
                self.niDMM_InitWithOptions_cfunc.argtypes = [ViRsrc_ctype, ViBoolean_ctype, ViBoolean_ctype, ViString_ctype, ctypes.POINTER(ViSession_ctype)]  # noqa: F405
    ...
    def niDMM_InvalidateAllAttributes(self, vi):  # noqa: N802
        with self._func_lock:
            if self.niDMM_InvalidateAllAttributes_cfunc is None:
                ...
                self.niDMM_InvalidateAllAttributes_cfunc.argtypes = [ViSession_ctype]  # noqa: F405
    ...
    def niDMM_revision_query(self, vi, driver_rev, instr_rev):  # noqa: N802
        with self._func_lock:
            if self.niDMM_revision_query_cfunc is None:
                ...
                self.niDMM_revision_query_cfunc.argtypes = [ViSession_ctype, ViChar_ctype, ViChar_ctype]  # noqa: F405
