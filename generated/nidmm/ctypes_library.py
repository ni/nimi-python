...
class nidmm_ctypes_library:
    ...
    def niDMM_InitWithOptions(self, resource_name, id_query, reset_device, options_string, new_vi):
        ...
        return self.niDMM_InitWithOptions_cfunc(resource_name, id_query, reset_device, options_string, new_vi)
    ...
    def niDMM_GetError(self, vi, error_code, buffer_size, description):
        if self.niDMM_GetError_cfunc is None:
            ...
            self.niDMM_GetError_cfunc.argtypes = [ViSession_ctype, ctypes.POINTER(ViStatus_ctype), ViInt32_ctype, ctypes.POINTER(ViChar_ctype)]
    ...
    def niDMM_GetErrorMessage(self, vi, error_code, buffer_size, err_message):
        if self.niDMM_GetErrorMessage_cfunc is None:
            ...
            self.niDMM_GetErrorMessage_cfunc.argtypes = [ViSession_ctype, ViStatus_ctype, ViInt32_ctype, ctypes.POINTER(ViChar_ctype)]
            self.niDMM_GetErrorMessage_cfunc.restype = nidmm.python_types.ViStatus
        return self.niDMM_GetErrorMessage_cfunc(vi, error_code, buffer_size, err_message)
    ...
    def niDMM_self_test(self, vi, self_test_result, self_test_message):
        if self.niDMM_self_test_cfunc is None:
            ...
            self.niDMM_self_test_cfunc.argtypes = [ViSession_ctype, ctypes.POINTER(ViInt16_ctype), ctypes.POINTER(ViChar_ctype)]
    ...
    def niDMM_revision_query(self, vi, driver_rev, instr_rev):
        ...
        return self.niDMM_revision_query_cfunc(vi, driver_rev, instr_rev)

    def niDMM_InvalidateAllAttributes(self, vi):
        if self.niDMM_InvalidateAllAttributes_cfunc is None:
            self.niDMM_InvalidateAllAttributes_cfunc = self._library.niDMM_InvalidateAllAttributes
            self.niDMM_InvalidateAllAttributes_cfunc.argtypes = [ViSession_ctype]
            self.niDMM_InvalidateAllAttributes_cfunc.restype = nidmm.python_types.ViStatus
        return self.niDMM_InvalidateAllAttributes_cfunc(vi)
    ...
    def niDMM_ConfigureTrigger(self, vi, trig_source, trigger_delay):
        ...
        return self.niDMM_ConfigureTrigger_cfunc(vi, trig_source, trigger_delay)
    ...
    def niDMM_Read(self, vi, max_time, reading):
        ...
        return self.niDMM_Read_cfunc(vi, max_time, reading)
    ...
    def niDMM_Fetch(self, vi, max_time, reading):
        ...
        return self.niDMM_Fetch_cfunc(vi, max_time, reading)
    ...
    def niDMM_ConfigureACBandwidth(self, vi, min_freq, max_freq):
        ...
        return self.niDMM_ConfigureACBandwidth_cfunc(vi, min_freq, max_freq)
    ...
    def niDMM_ConfigureFrequencyVoltageRange(self, vi, frequency_voltage_range):
        ...
        return self.niDMM_ConfigureFrequencyVoltageRange_cfunc(vi, frequency_voltage_range)
    ...
    def niDMM_ConfigureMeasCompleteDest(self, vi, destination):
        ...
        return self.niDMM_ConfigureMeasCompleteDest_cfunc(vi, destination)
    ...
    def niDMM_ConfigureTriggerSlope(self, vi, polarity):
        ...
        return self.niDMM_ConfigureTriggerSlope_cfunc(vi, polarity)
    ...
    def niDMM_GetAutoRangeValue(self, vi, auto_range_value):
        ...
        return self.niDMM_GetAutoRangeValue_cfunc(vi, auto_range_value)
    ...
    def niDMM_ConfigurePowerLineFrequency(self, vi, frequency):
        ...
        return self.niDMM_ConfigurePowerLineFrequency_cfunc(vi, frequency)
    ...
    def niDMM_ConfigureMeasurementDigits(self, vi, meas_function, range, resolution_digits):
        ...
        return self.niDMM_ConfigureMeasurementDigits_cfunc(vi, meas_function, range, resolution_digits)
    ...
    def niDMM_ConfigureMeasurementAbsolute(self, vi, meas_function, range, resolution_absolute):
        ...
        return self.niDMM_ConfigureMeasurementAbsolute_cfunc(vi, meas_function, range, resolution_absolute)
    ...
    def niDMM_ConfigureMeasCompleteSlope(self, vi, polarity):
        ...
        return self.niDMM_ConfigureMeasCompleteSlope_cfunc(vi, polarity)
    ...
    def niDMM_ConfigureSampleTriggerSlope(self, vi, polarity):
        ...
        return self.niDMM_ConfigureSampleTriggerSlope_cfunc(vi, polarity)
    ...
    def niDMM_ReadStatus(self, vi, acq_backlog, acq_done):
        ...
        return self.niDMM_ReadStatus_cfunc(vi, acq_backlog, acq_done)
    ...
    def niDMM_ConfigureADCCalibration(self, vi, adc_gain_comp):
        ...
        return self.niDMM_ConfigureADCCalibration_cfunc(vi, adc_gain_comp)
    ...
    def niDMM_ConfigureCurrentSource(self, vi, diode_current_src):
        ...
        return self.niDMM_ConfigureCurrentSource_cfunc(vi, diode_current_src)
    ...
    def niDMM_ConfigureCableCompType(self, vi, type_of_compensation):
        ...
        return self.niDMM_ConfigureCableCompType_cfunc(vi, type_of_compensation)
    ...
    def niDMM_ConfigureWaveformAcquisition(self, vi, function, range, rate, waveform_points):
        ...
        return self.niDMM_ConfigureWaveformAcquisition_cfunc(vi, function, range, rate, waveform_points)
    ...
    def niDMM_ConfigureWaveformCoupling(self, vi, coupling):
        ...
        return self.niDMM_ConfigureWaveformCoupling_cfunc(vi, coupling)
    ...
    def niDMM_GetAttributeViInt32(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_GetAttributeViInt32_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_SetAttributeViInt32(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_SetAttributeViInt32_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_GetAttributeViReal64(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_GetAttributeViReal64_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_SetAttributeViReal64(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_SetAttributeViReal64_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_SetAttributeViString(self, vi, channel_name, attribute_id, value):
        if self.niDMM_SetAttributeViString_cfunc is None:
            ...
            self.niDMM_SetAttributeViString_cfunc.argtypes = [ViSession_ctype, ViConstString_ctype, ViAttr_ctype, ViString_ctype]
            self.niDMM_SetAttributeViString_cfunc.restype = nidmm.python_types.ViStatus
        return self.niDMM_SetAttributeViString_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_GetAttributeViSession(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_GetAttributeViSession_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_SetAttributeViSession(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_SetAttributeViSession_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_GetAttributeViBoolean(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_GetAttributeViBoolean_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_SetAttributeViBoolean(self, vi, channel_name, attribute_id, value):
        ...
        return self.niDMM_SetAttributeViBoolean_cfunc(vi, channel_name, attribute_id, value)
    ...
    def niDMM_GetNextCoercionRecord(self, vi, buffer_size, record):
        ...
        return self.niDMM_GetNextCoercionRecord_cfunc(vi, buffer_size, record)
    ...
    def niDMM_GetNextInterchangeWarning(self, vi, buffer_size, warn_string):
        if self.niDMM_GetNextInterchangeWarning_cfunc is None:
            ...
            self.niDMM_GetNextInterchangeWarning_cfunc.argtypes = [ViSession_ctype, ViInt32_ctype, ctypes.POINTER(ViChar_ctype)]
            self.niDMM_GetNextInterchangeWarning_cfunc.restype = nidmm.python_types.ViStatus
        return self.niDMM_GetNextInterchangeWarning_cfunc(vi, buffer_size, warn_string)
    ...
    def niDMM_GetChannelName(self, vi, index, buffer_size, name):
        ...
        return self.niDMM_GetChannelName_cfunc(vi, index, buffer_size, name)
    ...
    def niDMM_GetSelfCalSupported(self, vi, self_cal_supported):
        if self.niDMM_GetSelfCalSupported_cfunc is None:
            ...
            self.niDMM_GetSelfCalSupported_cfunc.argtypes = [ViSession_ctype, ctypes.POINTER(ViBoolean_ctype)]
    ...
    def niDMM_GetCalDateAndTime(self, vi, cal_type, month, day, year, hour, minute):
        if self.niDMM_GetCalDateAndTime_cfunc is None:
            ...
            self.niDMM_GetCalDateAndTime_cfunc.argtypes = [ViSession_ctype, ViInt32_ctype, ctypes.POINTER(ViInt32_ctype), ctypes.POINTER(ViInt32_ctype), ctypes.POINTER(ViInt32_ctype), ctypes.POINTER(ViInt32_ctype), ctypes.POINTER(ViInt32_ctype)]
    ...
    def niDMM_GetDevTemp(self, vi, reserved, temperature):
        ...
        return self.niDMM_GetDevTemp_cfunc(vi, reserved, temperature)
    ...
    def niDMM_ConfigureThermocouple(self, vi, thermocouple_type, ref_junction_type):
        ...
        return self.niDMM_ConfigureThermocouple_cfunc(vi, thermocouple_type, ref_junction_type)
    ...
    def niDMM_ConfigureFixedRefJunction(self, vi, fixed_ref_junction):
        ...
        return self.niDMM_ConfigureFixedRefJunction_cfunc(vi, fixed_ref_junction)
    ...
    def niDMM_ConfigureRTDType(self, vi, rtd_type, resistance):
        ...
        return self.niDMM_ConfigureRTDType_cfunc(vi, rtd_type, resistance)
    ...
    def niDMM_ConfigureRTDCustom(self, vi, a, b, c):
        ...
        return self.niDMM_ConfigureRTDCustom_cfunc(vi, a, b, c)
    ...
    def niDMM_ConfigureThermistorCustom(self, vi, a, b, c):
        ...
        return self.niDMM_ConfigureThermistorCustom_cfunc(vi, a, b, c)
