...
class _SessionBase(object):
    ...
    The valid range is 1 Hz-300 kHz for the NI 4070/4071/4072, 10 Hz-100 kHz  for the NI 4065, and 20 Hz-25 kHz for the NI 4050 and NI 4060.
    """
    adc_calibration = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ADCCalibration, 1150022
    )
    ...
    aperture_time_units = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ApertureTimeUnits, 1250322
    )
    ...
    auto_zero = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.AutoZero, 1250332
    )
    """Type: enums.AutoZero
    ...
    One or more of the referenced values are not in the Python API for this driver. Enums that only define values, or represent True/False, have been removed.
    """
    cable_comp_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.CableCompensationType, 1150045
    )
    ...
    dc_noise_rejection = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.DCNoiseRejection, 1150026
    )
    ...
    """
    function = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.Function, 1250001
    )
    """Type: enums.Function
    ...
    """
    lc_calculation_model = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.LCCalculationModel, 1150052
    )
    ...
    """
    meas_complete_dest = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.MeasurementCompleteDest, 1250305
    )
    ...
    Changing the method or the range through this property or through configure_measurement_digits  resets the value of this property to the default value.
    """
    operation_mode = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.OperationMode, 1150014
    )
    ...
    The NI 4050 is not supported.
    """
    sample_trigger = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.SampleTrigger, 1250302
    )
    ...
    """
    temp_rtd_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.RTDType, 1150120
    )
    """Type: enums.RTDType
    ...
    """
    temp_tc_ref_junc_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ThermocoupleReferenceJunctionType, 1250232
    )
    ...
    One or more of the referenced values are not in the Python API for this driver. Enums that only define values, or represent True/False, have been removed.
    """
    temp_tc_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ThermocoupleType, 1250231
    )
    ...
    """
    temp_thermistor_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.ThermistorType, 1150124
    )
    ...
    """
    temp_transducer_type = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TransducerType, 1250201
    )
    ...
    One or more of the referenced values are not in the Python API for this driver. Enums that only define values, or represent True/False, have been removed.
    """
    trigger_source = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.TriggerSource, 1250004
    )
    ...
    To determine which values are supported by each device, refer to the LabWindows/CVI Trigger Routing section in  the NI Digital Multimeters Help.
    """
    waveform_coupling = _attributes.AttributeEnum(
        _attributes.AttributeViInt32, enums.WaveformCoupling, 1150027
    )
    ...
    def _get_attribute_vi_boolean(self, attribute_id):
        ...
        error_code = self._library.niDMM_GetAttributeViBoolean(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_int32(self, attribute_id):
        ...
        error_code = self._library.niDMM_GetAttributeViInt32(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_real64(self, attribute_id):
        ...
        error_code = self._library.niDMM_GetAttributeViReal64(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            None
    ...
    def _get_attribute_vi_string(self, attribute_id):
        ...
        error_code = self._library.niDMM_GetAttributeViString(
            vi_ctype,
            channel_name_ctype,
            attribute_id_ctype,
            buffer_size_ctype,
    ...
    def _get_error(self):
        ...
        **Instrument_Handle** unwired, this method retrieves and then clears
        ...
        error_code = self._library.niDMM_GetError(
            vi_ctype,
    ...
    def _set_attribute_vi_boolean(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niDMM_SetAttributeViBoolean(
    ...
    def _set_attribute_vi_int32(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niDMM_SetAttributeViInt32(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_real64(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niDMM_SetAttributeViReal64(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _set_attribute_vi_string(self, attribute_id, attribute_value):
        ...
        error_code = self._library.niDMM_SetAttributeViString(
            vi_ctype, channel_name_ctype, attribute_id_ctype, attribute_value_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _error_message(self, error_code):
        ...
        error_code = self._library.niDMM_error_message(
...
class Session(_SessionBase):
    ...
    @ivi_synchronized
    def configure_measurement_absolute(
        self, measurement_function, range, resolution_absolute
    ):
        ...
        if type(measurement_function) is not enums.Function:
            raise TypeError(
                "Parameter measurement_function must be of type " + str(enums.Function)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        measurement_function_ctype = _visatype.ViInt32(
            measurement_function.value
        )  # case S130
        range_ctype = _visatype.ViReal64(range)  # case S150
        resolution_absolute_ctype = _visatype.ViReal64(resolution_absolute)  # case S150
        error_code = self._library.niDMM_ConfigureMeasurementAbsolute(
            vi_ctype, measurement_function_ctype, range_ctype, resolution_absolute_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_measurement_digits(
        self, measurement_function, range, resolution_digits
    ):
        ...
        error_code = self._library.niDMM_ConfigureMeasurementDigits(
            vi_ctype, measurement_function_ctype, range_ctype, resolution_digits_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def configure_multi_point(
        self,
        trigger_count,
        sample_count,
        sample_trigger=enums.SampleTrigger.IMMEDIATE,
        ...
        if type(sample_trigger) is not enums.SampleTrigger:
            raise TypeError(
                "Parameter sample_trigger must be of type " + str(enums.SampleTrigger)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        ...
        sample_interval_ctype = _converters.convert_timedelta_to_seconds_real64(
            sample_interval
        )  # case S140
        error_code = self._library.niDMM_ConfigureMultiPoint(
            vi_ctype,
            trigger_count_ctype,
            sample_count_ctype,
            sample_trigger_ctype,
            sample_interval_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_rtd_custom(self, rtd_a, rtd_b, rtd_c):
        ...
        error_code = self._library.niDMM_ConfigureRTDCustom(
            vi_ctype, rtd_a_ctype, rtd_b_ctype, rtd_c_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_rtd_type(self, rtd_type, rtd_resistance):
        ...
        error_code = self._library.niDMM_ConfigureRTDType(
            vi_ctype, rtd_type_ctype, rtd_resistance_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_thermistor_custom(self, thermistor_a, thermistor_b, thermistor_c):
        ...
        error_code = self._library.niDMM_ConfigureThermistorCustom(
            vi_ctype, thermistor_a_ctype, thermistor_b_ctype, thermistor_c_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_thermocouple(
        self,
        thermocouple_type,
        reference_junction_type=enums.ThermocoupleReferenceJunctionType.FIXED,
    ):
        ...
        if type(thermocouple_type) is not enums.ThermocoupleType:
            raise TypeError(
                "Parameter thermocouple_type must be of type "
                + str(enums.ThermocoupleType)
            )
        if type(reference_junction_type) is not enums.ThermocoupleReferenceJunctionType:
            raise TypeError(
                "Parameter reference_junction_type must be of type "
                + str(enums.ThermocoupleReferenceJunctionType)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        thermocouple_type_ctype = _visatype.ViInt32(
            thermocouple_type.value
        )  # case S130
        reference_junction_type_ctype = _visatype.ViInt32(
            reference_junction_type.value
        )  # case S130
        error_code = self._library.niDMM_ConfigureThermocouple(
            vi_ctype, thermocouple_type_ctype, reference_junction_type_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def configure_trigger(
        self, trigger_source, trigger_delay=hightime.timedelta(seconds=-1)
    ):
        r"""configure_trigger
        ...
        if type(trigger_source) is not enums.TriggerSource:
            raise TypeError(
                "Parameter trigger_source must be of type " + str(enums.TriggerSource)
            )
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        trigger_source_ctype = _visatype.ViInt32(trigger_source.value)  # case S130
        trigger_delay_ctype = _converters.convert_timedelta_to_seconds_real64(
            trigger_delay
        )  # case S140
        error_code = self._library.niDMM_ConfigureTrigger(
            vi_ctype, trigger_source_ctype, trigger_delay_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    @ivi_synchronized
    def configure_waveform_acquisition(
        self, measurement_function, range, rate, waveform_points
    ):
        ...
        error_code = self._library.niDMM_ConfigureWaveformAcquisition(
            vi_ctype,
            measurement_function_ctype,
            range_ctype,
            rate_ctype,
            waveform_points_ctype,
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def export_attribute_configuration_buffer(self):
        ...
        **Related Topics:**
        ...
        error_code = self._library.niDMM_ExportAttributeConfigurationBuffer(
    ...
    def export_attribute_configuration_file(self, file_path):
        ...
        **Related Topics:**
        ...
        error_code = self._library.niDMM_ExportAttributeConfigurationFile(
    ...
    def fetch(self, maximum_time=hightime.timedelta(milliseconds=-1)):
        ...
        error_code = self._library.niDMM_Fetch(
            vi_ctype,
            maximum_time_ctype,
    ...
    def fetch_multi_point(
        self, array_size, maximum_time=hightime.timedelta(milliseconds=-1)
    ):
        r"""fetch_multi_point
        ...
        reading_array_ctype = get_ctypes_pointer_for_buffer(
            value=reading_array_array, library_type=_visatype.ViReal64
        )  # case B600
        actual_number_of_points_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDMM_FetchMultiPoint(
            vi_ctype,
            maximum_time_ctype,
            array_size_ctype,
            reading_array_ctype,
            None
            if actual_number_of_points_ctype is None
            else (ctypes.pointer(actual_number_of_points_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def fetch_waveform(
        ...
        waveform_array_ctype = get_ctypes_pointer_for_buffer(
            value=waveform_array_array, library_type=_visatype.ViReal64
        )  # case B600
        actual_number_of_points_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDMM_FetchWaveform(
            vi_ctype,
            maximum_time_ctype,
            array_size_ctype,
            waveform_array_ctype,
            None
            if actual_number_of_points_ctype is None
            else (ctypes.pointer(actual_number_of_points_ctype)),
        )
    ...
    @ivi_synchronized
    def fetch_waveform_into(
        self, waveform_array, maximum_time=hightime.timedelta(milliseconds=-1)
    ):
        r"""fetch_waveform
        ...
        if type(waveform_array) is not numpy.ndarray:
            raise TypeError(
                "waveform_array must be {0}, is {1}".format(
                    numpy.ndarray, type(waveform_array)
                )
            )
        ...
        if waveform_array.dtype is not numpy.dtype("float64"):
            raise TypeError(
                "waveform_array must be numpy.ndarray of dtype=float64, is "
                + str(waveform_array.dtype)
            )
    ...
    def get_dev_temp(self, options=""):
        ...
        """
        vi_ctype = _visatype.ViSession(self._vi)  # case S110
        options_ctype = ctypes.create_string_buffer(
            options.encode(self._encoding)
        )  # case C020
        temperature_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niDMM_GetDevTemp(
            vi_ctype,
            options_ctype,
    ...
    def get_ext_cal_recommended_interval(self):
        ...
        **Months**.
        ...
        error_code = self._library.niDMM_GetExtCalRecommendedInterval(
    ...
    def get_last_cal_temp(self, cal_type):
        ...
        cal_type_ctype = _visatype.ViInt32(cal_type)  # case S150
        temperature_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niDMM_GetLastCalTemp(
            vi_ctype,
            cal_type_ctype,
            None if temperature_ctype is None else (ctypes.pointer(temperature_ctype)),
        )
    ...
    def get_self_cal_supported(self):
        ...
        error_code = self._library.niDMM_GetSelfCalSupported(
            vi_ctype,
            None
    ...
    def import_attribute_configuration_buffer(self, configuration):
        ...
        **Related Topics:**
        ...
        error_code = self._library.niDMM_ImportAttributeConfigurationBuffer(
            vi_ctype, size_ctype, configuration_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def import_attribute_configuration_file(self, file_path):
        ...
        **Related Topics:**
        ...
        error_code = self._library.niDMM_ImportAttributeConfigurationFile(
            vi_ctype, file_path_ctype
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
    ...
    def _init_with_options(
        ...
        error_code = self._library.niDMM_InitWithOptions(
            resource_name_ctype,
            id_query_ctype,
            reset_device_ctype,
            option_string_ctype,
    ...
    def perform_open_cable_comp(self):
        ...
        error_code = self._library.niDMM_PerformOpenCableComp(
            vi_ctype,
            None if conductance_ctype is None else (ctypes.pointer(conductance_ctype)),
            None if susceptance_ctype is None else (ctypes.pointer(susceptance_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def perform_short_cable_comp(self):
        ...
        **Resistance** and **Reactance** values. You can use the return values
        ...
        error_code = self._library.niDMM_PerformShortCableComp(
            vi_ctype,
            None if resistance_ctype is None else (ctypes.pointer(resistance_ctype)),
            None if reactance_ctype is None else (ctypes.pointer(reactance_ctype)),
        )
        errors.handle_error(
            self, error_code, ignore_warnings=False, is_error_handling=False
        )
    ...
    def read(self, maximum_time=hightime.timedelta(milliseconds=-1)):
        ...
        reading_ctype = _visatype.ViReal64()  # case S220
        error_code = self._library.niDMM_Read(
            vi_ctype,
            maximum_time_ctype,
            None if reading_ctype is None else (ctypes.pointer(reading_ctype)),
        )
    ...
    def read_multi_point(
        ...
        actual_number_of_points_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDMM_ReadMultiPoint(
            vi_ctype,
            maximum_time_ctype,
            array_size_ctype,
            reading_array_ctype,
    ...
    def read_status(self):
        ...
        error_code = self._library.niDMM_ReadStatus(
            vi_ctype,
            None
            if acquisition_backlog_ctype is None
            else (ctypes.pointer(acquisition_backlog_ctype)),
            None
        ...
        return int(acquisition_backlog_ctype.value), enums.AcquisitionStatus(
            acquisition_status_ctype.value
        )
    ...
    def read_waveform(
        ...
        actual_number_of_points_ctype = _visatype.ViInt32()  # case S220
        error_code = self._library.niDMM_ReadWaveform(
            vi_ctype,
            maximum_time_ctype,
            array_size_ctype,
            waveform_array_ctype,
    ...
    def _self_test(self):
        ...
        error_code = self._library.niDMM_self_test(
            vi_ctype,
            None
