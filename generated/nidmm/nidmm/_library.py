...
class Library(object):
    ...
    def configure_multi_point(self, session, trigger_count, sample_count, sample_trigger, sample_interval):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
    ...
    def configure_thermocouple(self, session, thermocouple_type, reference_junction_type):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
    ...
    def configure_trigger(self, session, trigger_source, trigger_delay):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
    ...
    def fetch(self, session, maximum_time):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
    ...
    def fetch_multi_point(self, session, maximum_time, array_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
        maximum_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(maximum_time)  # case S140
    ...
    def fetch_waveform(self, session, maximum_time, array_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
        maximum_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(maximum_time)  # case S140
        array_size_ctype = _visatype.ViInt32(array_size)  # case S210
    ...
    def read_multi_point(self, session, maximum_time, array_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
        maximum_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(maximum_time)  # case S140
        array_size_ctype = _visatype.ViInt32(array_size)  # case S210
        reading_array_size = array_size  # case B600
    ...
    def read_waveform(self, session, maximum_time, array_size):  # noqa: N802
        vi_ctype = _visatype.ViSession(session._vi)  # case S110
        maximum_time_ctype = _converters.convert_timedelta_to_milliseconds_int32(maximum_time)  # case S140
        array_size_ctype = _visatype.ViInt32(array_size)  # case S210
        waveform_array_size = array_size  # case B600
