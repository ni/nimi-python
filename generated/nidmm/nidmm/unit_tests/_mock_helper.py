...
class SideEffectsHelper(object):
    ...
    def niDMM_ExportAttributeConfigurationBuffer(
        ...
        if (
            ...
            raise MockFunctionCallError(
                "niDMM_ExportAttributeConfigurationBuffer", param="configuration"
            )
        if size.value == 0:
            return len(
                self._defaults["ExportAttributeConfigurationBuffer"]["configuration"]
    ...
    def niDMM_FetchMultiPoint(
        ...
        if self._defaults["FetchMultiPoint"]["actualNumberOfPoints"] is None:
            raise MockFunctionCallError(
                "niDMM_FetchMultiPoint", param="actualNumberOfPoints"
            )
        if actual_number_of_points is not None:
            actual_number_of_points.contents.value = self._defaults["FetchMultiPoint"][
    ...
    def niDMM_FetchWaveform(
        ...
        if self._defaults["FetchWaveform"]["actualNumberOfPoints"] is None:
            raise MockFunctionCallError(
                "niDMM_FetchWaveform", param="actualNumberOfPoints"
            )
        if actual_number_of_points is not None:
            actual_number_of_points.contents.value = self._defaults["FetchWaveform"][
                "actualNumberOfPoints"
            ]
        return self._defaults["FetchWaveform"]["return"]
    ...
    def niDMM_GetAttributeViBoolean(
        ...
        if self._defaults["GetAttributeViBoolean"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDMM_GetAttributeViBoolean", param="attributeValue"
            )
    ...
    def niDMM_GetAttributeViInt32(
        ...
        if self._defaults["GetAttributeViInt32"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDMM_GetAttributeViInt32", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niDMM_GetAttributeViReal64(
        ...
        if self._defaults["GetAttributeViReal64"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDMM_GetAttributeViReal64", param="attributeValue"
            )
        if attribute_value is not None:
    ...
    def niDMM_GetAttributeViString(
        ...
        if self._defaults["GetAttributeViString"]["attributeValue"] is None:
            raise MockFunctionCallError(
                "niDMM_GetAttributeViString", param="attributeValue"
            )
    ...
    def niDMM_GetExtCalRecommendedInterval(self, vi, months):  # noqa: N802
        ...
        if self._defaults["GetExtCalRecommendedInterval"]["months"] is None:
            raise MockFunctionCallError(
                "niDMM_GetExtCalRecommendedInterval", param="months"
            )
    ...
    def niDMM_GetSelfCalSupported(self, vi, self_cal_supported):  # noqa: N802
        ...
        if self._defaults["GetSelfCalSupported"]["selfCalSupported"] is None:
            raise MockFunctionCallError(
                "niDMM_GetSelfCalSupported", param="selfCalSupported"
            )
    ...
    def niDMM_PerformOpenCableComp(self, vi, conductance, susceptance):  # noqa: N802
        ...
        if self._defaults["PerformOpenCableComp"]["conductance"] is None:
            raise MockFunctionCallError(
                "niDMM_PerformOpenCableComp", param="conductance"
            )
        if conductance is not None:
            conductance.contents.value = self._defaults["PerformOpenCableComp"][
                "conductance"
            ]
        # susceptance
        if self._defaults["PerformOpenCableComp"]["susceptance"] is None:
            raise MockFunctionCallError(
                "niDMM_PerformOpenCableComp", param="susceptance"
            )
        if susceptance is not None:
            susceptance.contents.value = self._defaults["PerformOpenCableComp"][
                "susceptance"
            ]
        return self._defaults["PerformOpenCableComp"]["return"]
    ...
    def niDMM_PerformShortCableComp(self, vi, resistance, reactance):  # noqa: N802
        ...
        if self._defaults["PerformShortCableComp"]["resistance"] is None:
            raise MockFunctionCallError(
                "niDMM_PerformShortCableComp", param="resistance"
            )
        if resistance is not None:
            resistance.contents.value = self._defaults["PerformShortCableComp"][
                "resistance"
            ]
        # reactance
        if self._defaults["PerformShortCableComp"]["reactance"] is None:
            raise MockFunctionCallError(
                "niDMM_PerformShortCableComp", param="reactance"
            )
        if reactance is not None:
            reactance.contents.value = self._defaults["PerformShortCableComp"][
                "reactance"
            ]
        return self._defaults["PerformShortCableComp"]["return"]
    ...
    def niDMM_ReadMultiPoint(
        ...
        if self._defaults["ReadMultiPoint"]["actualNumberOfPoints"] is None:
            raise MockFunctionCallError(
                "niDMM_ReadMultiPoint", param="actualNumberOfPoints"
            )
        if actual_number_of_points is not None:
            actual_number_of_points.contents.value = self._defaults["ReadMultiPoint"][
                "actualNumberOfPoints"
            ]
        return self._defaults["ReadMultiPoint"]["return"]
    ...
    def niDMM_ReadStatus(
        ...
        if acquisition_backlog is not None:
            acquisition_backlog.contents.value = self._defaults["ReadStatus"][
                "acquisitionBacklog"
            ]
        # acquisition_status
        ...
        if acquisition_status is not None:
            acquisition_status.contents.value = self._defaults["ReadStatus"][
                "acquisitionStatus"
            ]
        return self._defaults["ReadStatus"]["return"]
    ...
    def niDMM_ReadWaveform(
        ...
        if self._defaults["ReadWaveform"]["actualNumberOfPoints"] is None:
            raise MockFunctionCallError(
                "niDMM_ReadWaveform", param="actualNumberOfPoints"
            )
        if actual_number_of_points is not None:
            actual_number_of_points.contents.value = self._defaults["ReadWaveform"][
                "actualNumberOfPoints"
            ]
        return self._defaults["ReadWaveform"]["return"]
    ...
    def set_side_effects_and_return_values(self, mock_library):
        ...
        mock_library.niDMM_ConfigureMeasurementAbsolute.side_effect = (
            MockFunctionCallError("niDMM_ConfigureMeasurementAbsolute")
        )
        mock_library.niDMM_ConfigureMeasurementAbsolute.return_value = 0
        mock_library.niDMM_ConfigureMeasurementDigits.side_effect = (
            MockFunctionCallError("niDMM_ConfigureMeasurementDigits")
        )
        mock_library.niDMM_ConfigureMeasurementDigits.return_value = 0
        mock_library.niDMM_ConfigureMultiPoint.side_effect = MockFunctionCallError(
            "niDMM_ConfigureMultiPoint"
        )
        mock_library.niDMM_ConfigureMultiPoint.return_value = 0
        mock_library.niDMM_ConfigureRTDCustom.side_effect = MockFunctionCallError(
            "niDMM_ConfigureRTDCustom"
        )
        mock_library.niDMM_ConfigureRTDCustom.return_value = 0
        mock_library.niDMM_ConfigureRTDType.side_effect = MockFunctionCallError(
            "niDMM_ConfigureRTDType"
        )
        mock_library.niDMM_ConfigureRTDType.return_value = 0
        mock_library.niDMM_ConfigureThermistorCustom.side_effect = (
            MockFunctionCallError("niDMM_ConfigureThermistorCustom")
        )
        mock_library.niDMM_ConfigureThermistorCustom.return_value = 0
        mock_library.niDMM_ConfigureThermocouple.side_effect = MockFunctionCallError(
            "niDMM_ConfigureThermocouple"
        )
        mock_library.niDMM_ConfigureThermocouple.return_value = 0
        mock_library.niDMM_ConfigureTrigger.side_effect = MockFunctionCallError(
            "niDMM_ConfigureTrigger"
        )
        mock_library.niDMM_ConfigureTrigger.return_value = 0
        mock_library.niDMM_ConfigureWaveformAcquisition.side_effect = (
            MockFunctionCallError("niDMM_ConfigureWaveformAcquisition")
        )
        ...
        mock_library.niDMM_ExportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niDMM_ExportAttributeConfigurationBuffer")
        )
        mock_library.niDMM_ExportAttributeConfigurationBuffer.return_value = 0
        mock_library.niDMM_ExportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niDMM_ExportAttributeConfigurationFile")
        )
        ...
        mock_library.niDMM_FetchMultiPoint.side_effect = MockFunctionCallError(
            "niDMM_FetchMultiPoint"
        )
        mock_library.niDMM_FetchMultiPoint.return_value = 0
        mock_library.niDMM_FetchWaveform.side_effect = MockFunctionCallError(
            "niDMM_FetchWaveform"
        )
        mock_library.niDMM_FetchWaveform.return_value = 0
        mock_library.niDMM_GetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niDMM_GetAttributeViBoolean"
        )
        mock_library.niDMM_GetAttributeViBoolean.return_value = 0
        mock_library.niDMM_GetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDMM_GetAttributeViInt32"
        )
        mock_library.niDMM_GetAttributeViInt32.return_value = 0
        mock_library.niDMM_GetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDMM_GetAttributeViReal64"
        )
        mock_library.niDMM_GetAttributeViReal64.return_value = 0
        mock_library.niDMM_GetAttributeViString.side_effect = MockFunctionCallError(
            "niDMM_GetAttributeViString"
        )
        mock_library.niDMM_GetAttributeViString.return_value = 0
        mock_library.niDMM_GetCalDateAndTime.side_effect = MockFunctionCallError(
            "niDMM_GetCalDateAndTime"
        )
        mock_library.niDMM_GetCalDateAndTime.return_value = 0
        mock_library.niDMM_GetDevTemp.side_effect = MockFunctionCallError(
            "niDMM_GetDevTemp"
        )
        mock_library.niDMM_GetDevTemp.return_value = 0
        mock_library.niDMM_GetError.side_effect = MockFunctionCallError(
            "niDMM_GetError"
        )
        mock_library.niDMM_GetError.return_value = 0
        mock_library.niDMM_GetExtCalRecommendedInterval.side_effect = (
            MockFunctionCallError("niDMM_GetExtCalRecommendedInterval")
        )
        mock_library.niDMM_GetExtCalRecommendedInterval.return_value = 0
        mock_library.niDMM_GetLastCalTemp.side_effect = MockFunctionCallError(
            "niDMM_GetLastCalTemp"
        )
        mock_library.niDMM_GetLastCalTemp.return_value = 0
        mock_library.niDMM_GetSelfCalSupported.side_effect = MockFunctionCallError(
            "niDMM_GetSelfCalSupported"
        )
        mock_library.niDMM_GetSelfCalSupported.return_value = 0
        mock_library.niDMM_ImportAttributeConfigurationBuffer.side_effect = (
            MockFunctionCallError("niDMM_ImportAttributeConfigurationBuffer")
        )
        mock_library.niDMM_ImportAttributeConfigurationBuffer.return_value = 0
        mock_library.niDMM_ImportAttributeConfigurationFile.side_effect = (
            MockFunctionCallError("niDMM_ImportAttributeConfigurationFile")
        )
        mock_library.niDMM_ImportAttributeConfigurationFile.return_value = 0
        mock_library.niDMM_InitWithOptions.side_effect = MockFunctionCallError(
            "niDMM_InitWithOptions"
        )
        mock_library.niDMM_InitWithOptions.return_value = 0
        mock_library.niDMM_Initiate.side_effect = MockFunctionCallError(
            "niDMM_Initiate"
        )
        mock_library.niDMM_Initiate.return_value = 0
        mock_library.niDMM_LockSession.side_effect = MockFunctionCallError(
            "niDMM_LockSession"
        )
        mock_library.niDMM_LockSession.return_value = 0
        mock_library.niDMM_PerformOpenCableComp.side_effect = MockFunctionCallError(
            "niDMM_PerformOpenCableComp"
        )
        mock_library.niDMM_PerformOpenCableComp.return_value = 0
        mock_library.niDMM_PerformShortCableComp.side_effect = MockFunctionCallError(
        ...
        mock_library.niDMM_ReadMultiPoint.side_effect = MockFunctionCallError(
            "niDMM_ReadMultiPoint"
        )
        mock_library.niDMM_ReadMultiPoint.return_value = 0
        mock_library.niDMM_ReadStatus.side_effect = MockFunctionCallError(
            "niDMM_ReadStatus"
        )
        mock_library.niDMM_ReadStatus.return_value = 0
        mock_library.niDMM_ReadWaveform.side_effect = MockFunctionCallError(
            "niDMM_ReadWaveform"
        )
        mock_library.niDMM_ReadWaveform.return_value = 0
        mock_library.niDMM_ResetWithDefaults.side_effect = MockFunctionCallError(
        ...
        mock_library.niDMM_SendSoftwareTrigger.side_effect = MockFunctionCallError(
            "niDMM_SendSoftwareTrigger"
        )
        mock_library.niDMM_SendSoftwareTrigger.return_value = 0
        mock_library.niDMM_SetAttributeViBoolean.side_effect = MockFunctionCallError(
            "niDMM_SetAttributeViBoolean"
        )
        mock_library.niDMM_SetAttributeViBoolean.return_value = 0
        mock_library.niDMM_SetAttributeViInt32.side_effect = MockFunctionCallError(
            "niDMM_SetAttributeViInt32"
        )
        mock_library.niDMM_SetAttributeViInt32.return_value = 0
        mock_library.niDMM_SetAttributeViReal64.side_effect = MockFunctionCallError(
            "niDMM_SetAttributeViReal64"
        )
        mock_library.niDMM_SetAttributeViReal64.return_value = 0
        mock_library.niDMM_SetAttributeViString.side_effect = MockFunctionCallError(
            "niDMM_SetAttributeViString"
        )
        mock_library.niDMM_SetAttributeViString.return_value = 0
        mock_library.niDMM_UnlockSession.side_effect = MockFunctionCallError(
            "niDMM_UnlockSession"
        )
        ...
        mock_library.niDMM_error_message.side_effect = MockFunctionCallError(
            "niDMM_error_message"
        )
        ...
        mock_library.niDMM_self_test.side_effect = MockFunctionCallError(
            "niDMM_self_test"
        )
