...
class _SessionBase(object):
    ...
    '''Data Type: CableCompensationType
    ...
    '''Data Type: MeasurementCompleteDest
    ...
    '''Data Type: MeasurementDestinationSlope
    ...
    '''Data Type: ThermocoupleReferenceJunctionType
