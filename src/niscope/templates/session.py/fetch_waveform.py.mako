...
%>\
    def ${f['python_name']}${suffix}(${helper.get_params_snippet(f, helper.ParameterUsageOptions.SESSION_NUMPY_INTO_METHOD_DECLARATION)}) -> typing.Iterable['waveform_info.WaveformInfo']:
        '''${f['python_name']}
