        ...
        'parameters': [
            ...
            },
            {
                ...
                'size': {
                    ...
                    'value': '(num_samples * self.actual_num_wfms(session_handle, encoding, channel_list))'
                },
    ...
    'Fetch': {
        ...
        'parameters': [
            ...
            },
            {
                ...
                'size': {
                    'mechanism': 'python-code',
                    'value': 'self.actual_num_wfms(session_handle, encoding, channel_list)'
                },
                'type': 'struct niScope_wfmInfo[]'
            }
        ],
    ...
    'FetchArrayMeasurement': {
        ...
        'parameters': [
            ...
            },
            {
                ...
                'size': {
                    'mechanism': 'python-code',
                    'value': '(measurement_waveform_size * self.actual_num_wfms(session_handle, encoding, channel_list))'
                },
                'type': 'ViReal64[]'
            },
            {
