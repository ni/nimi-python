...
functions_default_value = {
    ...
    'CalSelfCalibrate':                              { 'parameters': { 2: { 'default_value': 'enums.Option.SELF_CALIBRATE_ALL_CHANNELS', }, }, },
    'ClearWaveformMeasurementStats':                 { 'parameters': { 2: { 'default_value': 'enums.ClearableMeasurement.ALL_MEASUREMENTS', }, }, },
    'ConfigureTriggerDigital':                       { 'parameters': { 2: { 'default_value': 'enums.TriggerSlope.POSITIVE', },
                                                                       3: { 'default_value': 0.0, },
                                                                       4: { 'default_value': 0.0, }, }, },
    'ConfigureTriggerEdge':                          { 'parameters': { 2: { 'default_value': 0.0, },
                                                                       3: { 'default_value': 'enums.TriggerSlope.POSITIVE', },
                                                                       5: { 'default_value': 0.0, },
                                                                       6: { 'default_value': 0.0, }, }, },
    'ConfigureTriggerHysteresis':                    { 'parameters': { 2: { 'default_value': 0.0, },
                                                                       3: { 'default_value': 0.05, },
                                                                       4: { 'default_value': 'enums.TriggerSlope.POSITIVE', },
                                                                       6: { 'default_value': 0.0, },
                                                                       7: { 'default_value': 0.0, }, }, },
}
