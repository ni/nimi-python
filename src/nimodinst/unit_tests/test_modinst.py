...
class TestSession(object):
    ...
    def test_get_error_description_fails(self):
        ...
        with nimodinst.Session('') as session:
            try:
                session.device[0].chassis_number
    ...
    def test_get_attribute_session(self):
        ...
        with nimodinst.Session('') as session:
            attr_int = session.device[0].chassis_number
            assert(attr_int == val)
    ...
    def test_get_attribute_vi_int32_for_loop_index(self):
        ...
        index = 0
        with nimodinst.Session('') as session:
            attr_int = session.device[index].chassis_number
            index += 1
    ...
    def test_get_attribute_vi_string_for_loop_index(self):
        ...
        index = 0
        with nimodinst.Session('') as session:
            attr_int = session.device[index].device_name
            index += 1
    ...
    def test_cannot_add_properties_to_device_set(self):
        with nimodinst.Session('') as session:
            try:
                session.device[0].non_existent_property = 5
                assert False
            except AttributeError as e:
                assert str(e) == "__setattr__ not supported."
    ...
    def test_cannot_add_properties_to_device_get(self):
        with nimodinst.Session('') as session:
            try:
                session.device[0].non_existent_property
                assert False
            except AttributeError as e:
    ...
    def test_vi_int32_attribute_read_only(self):
        ...
        with nimodinst.Session('') as session:
            try:
                session.device[0].chassis_number = 5
                assert False
            except AttributeError as e:
                assert str(e) == "__setattr__ not supported."
    ...
    def test_vi_string_attribute_read_only(self):
        ...
        with nimodinst.Session('') as session:
            try:
                session.device[0].device_name = "Not Possible"
                assert False
            except AttributeError as e:
                assert str(e) == "__setattr__ not supported."
