...
def _main(argsv):
    parser = argparse.ArgumentParser(description='Prints information for the specified NI-Switch module.', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-n', '--resource-name', default='PXI1Slot2', help='Resource name of a NI Switch.')
