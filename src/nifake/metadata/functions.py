    ...
    'MultipleArraysSameSize': {
        ...
        'parameters': [
            ...
            },
            {
                ...
                'type': 'ViChar[]',
                'documentation': {
                    'description': 'Specifies the output channel to which this configuration value applies.',
                },
            },
            {
                'direction': 'in',
                ...
                'type': 'ViReal64[]',
                'documentation': {
                    'description': 'Array 1 of a same size',
                },
            },
            {
                'direction': 'in',
                ...
                'type': 'ViReal64[]',
                'documentation': {
                    'description': 'Array 2 of the same size',
                },
            },
            {
                'direction': 'in',
        ...
        'documentation': {
            'description': 'Function to test multiple arrays that must all be the same size',
        },
    },
}
