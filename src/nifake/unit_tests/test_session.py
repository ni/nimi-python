...
class TestSession(object):
    ...
    def test_init_with_options_and_close(self):
        with patch('nifake._library_interpreter.errors', spec_set=['handle_error', '_is_error']) as patched_errors:
            ...
            patched_errors.handle_error.assert_called_once_with(session._library, self.patched_library.niFake_InitWithOptions.return_value, ignore_warnings=False, is_error_handling=False)
            session.close()
