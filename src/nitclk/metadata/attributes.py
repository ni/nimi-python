# -*- coding: utf-8 -*-
# This file is generated from NI-TClk API metadata version 20.7.0f91
attributes = {
    1: {
        'access': 'read-write',
        'documentation': {
    ...
    3: {
        ...
        'type': 'ViSession',
        'type_in_documentation': 'instrument-specific session or nitclk.SessionReference instance'
    },
    4: {
        'access': 'read-write',
        'attribute_class': 'AttributeSessionReference',
