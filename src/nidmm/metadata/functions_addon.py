...
# Super secret FormatMeasDigitsResolution
        ...
        'parameters': [
            {
                ...
                'name': 'productID',
                'type': 'ViInt32',
                'documentation': {'description': 'PID of device', },
            },
            {
                'direction': 'in',
                'name': 'measurementFunction',
                'type': 'ViInt32',
                'documentation': {'description': 'Specifies the **measurement\_function** used to acquire the measurement. The driver sets NIDMM\_ATTR\_FUNCTION to this value.', },
            },
            {
                'direction': 'in',
                'name': 'Range',
                'type': 'ViReal64',
                'documentation': {'description': 'Specifies the NIDMM\_ATTR\_RANGE used to acquire the **Measurement**.', },
            },
            {
                'direction': 'in',
                'name': 'Resolution',
                'type': 'ViReal64',
                'documentation': {'description': 'Specifies the NIDMM\_ATTR\_RESOLUTION of the **Measurement**.', },
            },
            {
                'direction': 'in',
                'name': 'Measurement',
                'type': 'ViReal64',
                'documentation': {'description': 'Specifies the measured value returned from the DMM.', },
            },
            {
                ...
                'name': 'modeString',
                'type': 'ViChar[ ]',
                'documentation': {'description': 'Returns a string containing the units of the **Measurement** mode.', },
            },
            {
                'size': {'mechanism':'fixed', 'value':256},
                'direction': 'out',
                'name': 'rangeString',
                'type': 'ViChar[ ]',
                'documentation': {'description': 'Returns the NIDMM\_ATTR\_RANGE of the **Measurement**, formatted into a string with the correct number of display digits.', },
            },
            {
                'size': {'mechanism':'fixed', 'value':256},
                'direction': 'out',
                'name': 'dataString',
                'type': 'ViChar[ ]',
                'documentation': {'description': 'Returns the **Measurement**, formatted according to the NIDMM\_ATTR\_FUNCTION, NIDMM\_ATTR\_RANGE, and NIDMM\_ATTR\_RESOLUTION\_ABSOLUTE.', },
            },
        ],
        'documentation': {'description': 'Formats the **Measurement** to the proper number of displayed digits according to the **Measurement\_Function**, **Range**, and **Resolution**. Returns the formatted data, range, and mode strings.', },
    },
}
