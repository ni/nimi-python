                ...
                {   'name': 'GetMeasurementPeriod',
                    ...
                    'parameters': [   {'direction': 'in', 'enum': None,
                                      ...
                                      {'direction': 'out', 'enum': None,
                                       ...
                                       'default_for_test': 42.2}],
                    'returns': 'ViStatus'},
                {   'name': 'ConfigureTrigger',
                    'codegen_method': 'public',
                    'parameters': [   {'direction': 'in', 'enum': None,
                                       'name': 'vi', 'type': 'ViSession'},
                                      {'direction': 'in', 'enum': 'Terminal',
                                       'name': 'trigSource',
                                       'type': 'ViInt32'},
                                      {'direction': 'in', 'enum': None,
                                       'name': 'triggerDelay',
                ...
                {   'name': 'PerformOpenCableComp',
                    ...
                    'parameters': [   {'direction': 'in', 'enum': None,
                                      ...
                                      {'direction': 'out', 'enum': None,
                                       'name': 'conductance',
                                       'type': 'ViReal64',
                                       'default_for_test': 400.1},
                                      {'direction': 'out', 'enum': None,
                                       'name': 'susceptance',
                                       'type': 'ViReal64',
                                       'default_for_test': 400.2}],
                    'returns': 'ViStatus'},
                {   'name': 'PerformShortCableComp',
                    ...
                    'parameters': [   {'direction': 'in', 'enum': None,
                                      ...
                                      {'direction': 'out', 'enum': None,
                                       'name': 'resistance',
                                       'type': 'ViReal64',
                                       'default_for_test': 10000},
                                      {'direction': 'out', 'enum': None,
                                       'name': 'reactance',
                                       'type': 'ViReal64',
                                       'default_for_test': 10000.1}],
                    'returns': 'ViStatus'},
