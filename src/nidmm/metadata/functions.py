...
''',
            'table_body': [['|image0|  .. |image0| image:: note.gif',
                            '**Notes**\xa0\xa0The NI\xa04050 and NI\xa04060 are not supported. Refer to the calibration procedure for your device before using this function.']],
        },
    },
    'CalAdjustLC': {
        'codegen_method': 'public',
...
''',
            ...
            },
            {
                ...
                'documentation': {
                    ...
                    'table_body': [['L & C Open (default)', 'Calibrates the open compensation.'], ['L & C Short',
                                                                                                   'Calibrates the short compensation.'],
                                   ['L & C 25 Ω', 'Calibrates the 25 Ω resistance.'], ['L & C 1 kΩ',
                                                                                     'Calibrates the 1 kΩ resistance.'],
                                   ['L & C 5 kΩ', 'Calibrates the 5 kΩ resistance.'], ['L & C 100 kΩ',
...
''',
            ...
            },
            {
                ...
                'documentation': {
                    ...
                    'table_body': [['NIDMM\\_EXTCAL\\_MISCCAL\\_VREF (default)', 'Calibrate the Voltage Reference.'],
                                   ...
                                   ['NIDMM\\_EXTCAL\\_MISCCAL\\_2WIRELEAKAGE',
                                                                                                              'Calibrate the 2-wire Leakage resistance.'],
                                   ['NIDMM\\_EXTCAL\\_MISCCAL\\_4WIRELEAKAGE',
                                                                                                                                                            'Calibrate the 4-wire Leakage resistance.'],
                                   ['NIDMM\\_EXTCAL\\_MISCCAL\\_SECTION',
...
**ADC\_Calibration**.
''',
                    'table_body': [['NIDMM\\_VAL\\_ADC\\_CALIBRATION\\_AUTO\xa0(default)', '-1.0',
                                    'The DMM enables or disables **ADC\\_Calibration** based on the configured function and resolution.'],
                                   ['NIDMM\\_VAL\\_ADC\\_CALIBRATION\\_OFF', '0',
                                                                                                                                            'The DMM does not compensate for changes to the gain.'],
                                   ['NIDMM\\_VAL\\_ADC\\_CALIBRATION\\_ON', '1',
...
''',
                    ...
                    'table_body': [['NIDMM\\_VAL\\_AUTO\\_ZERO\\_AUTO\xa0(default)', '-1',
                                   ...
                                   ['NIDMM\\_VAL\\_AUTO\\_ZERO\\_ONCE', '2',
...
''',
                    'table_body': [['NIDMM\\_VAL\\_1\\_MICROAMP', '1 µA', 'NI 4080/4081/4082 and NI 4070/4071/4072'],
                                   ['NIDMM\\_VAL\\_10\\_MICROAMP', '10 µA',
                                                                                                                      'NI 4080/4081/4082 and NI 4070/4071/4072 only'],
                                   ['NIDMM\\_VAL\\_100\\_MICROAMP', '100 µA',
                                                                                                                                                                        'NI 4080/4081/4082, NI 4070/4071/4072, and NI 4065'],
                                   ['NIDMM\\_VAL\\_1\\_MILLIAMP (default)', '1 mA',
                                                                                                                                                                                                                               'NI 4080/4081/4082, NI 4070/4071/4072, and NI 4065']],
                },
            },
        ],
...
''',
                    'table_body': [['NIDMM\\_VAL\\_AUTO\\_RANGE\\_ON\xa0(default)', '-1.0',
                                   ...
                                   ['NIDMM\\_VAL\\_AUTO\\_RANGE\\_OFF', '-2.0',
...
''',
                    'table_body': [['Rising Edge', '0', 'NIDMM\\_VAL\\_POSITIVE',
                                    'The driver triggers on the rising edge of the trigger signal.'],
                                   ['Falling Edge (default)', '1', 'NIDMM\\_VAL\\_NEGATIVE',
...
''',
                    'table_body': [['NIDMM\\_VAL\\_AUTO\\_RANGE\\_ON', '-1.0',
                                    'NI-DMM performs an Auto Range before acquiring the measurement.'],
                                   ['NIDMM\\_VAL\\_AUTO\\_RANGE\\_OFF', '-2.0',
                                                                                                         'NI-DMM sets the Range to the current NIDMM\\_ATTR\\_AUTO\\_RANGE\\_VALUE and uses this range for all subsequent measurements until the measurement configuration is changed.'],
                                   ['NIDMM\\_VAL\\_AUTO\\_RANGE\\_ONCE', '-3.0',
                                                                                                                                                                                                                                                                                           'NI-DMM performs an Auto Range before acquiring the measurement. The NIDMM\\_ATTR\\_AUTO\\_RANGE\\_VALUE is stored and used for all subsequent measurements until the measurement configuration is changed.']],
                },
            },
            {
                'direction': 'in',
...
''',
                    'table_body': [['NIDMM\\_VAL\\_OFFSET\\_COMP\\_OHMS\\_OFF\xa0(default)', '0',
                                    'Off\xa0disables\xa0\\ **Offset\\_Comp\\_Ohms**.'],
                                   ['NIDMM\\_VAL\\_OFFSET\\_COMP\\_OHMS\\_ON', '1',
                                                                                         'On enables **Offset\\_Comp\\_Ohms**.']],
                    'table_header': ['Name', 'Value', 'Description'],
                },
            },
        ],
...
''',
                    'table_body': [['Callendar-Van Dusen Coefficient'], ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3851',
                                                                         ...
                                                                         'Most common RTDs'],
                                   ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3750', 'Low-cost vendor compliant RTD\\*',
                                                                                               'Platinum', '.003750',
                                                                                               '1000 Ω',
                                                                                               'A = 3.81 × 10\\ :sup:`–3` B = –6.02×10:sup:`–7` C = –6.0×10:sup:`–12`',
                                                                                               'Low-cost RTD'],
                                   ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3916', 'JISC 1604', 'Platinum', '.003916', '100 Ω',
                                                                                                                 'A = 3.9739 × 10\\ :sup:`–3` B = –5.870×10:sup:`–7` C = –4.4 ×10\\ :sup:`–12`',
                                                                                                                 'Used in primarily in Japan'],
                                   ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3920', 'US Industrial Standard D-100 American',
                                                                                                                                                 'Platinum',
                                                                                                                                                 '.003920',
                                                                                                                                                 '100 Ω',
                                                                                                                                                 'A = 3.9787 × 10\\ :sup:`–3` B = –5.8686×10:sup:`–7` C = –4.167 ×10\\ :sup:`–12`',
                                                                                                                                                 'Low-cost RTD'],
                                   ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3911', 'US Industrial Standard American', 'Platinum',
                                                                                                                                                                   '.003911',
                                                                                                                                                                   '100 Ω',
                                                                                                                                                                   'A = 3.9692 × 10\\ :sup:`–3` B = –5.8495×10:sup:`–7` C = –4.233 ×10\\ :sup:`–12`',
                                                                                                                                                                   'Low-cost RTD'],
                                   ['NIDMM\\_VAL\\_TEMP\\_RTD\\_PT3928', 'ITS-90', 'Platinum', '.003928', '100 Ω',
...
''',
                    'table_body': [['NIDMM\\_VAL\\_TEMP\\_TC\\_B', 'Thermocouple type B'],
...
''',
                    'table_body': [['NIDMM\\_VAL\\_2\\_WIRE\\_RTD', '2-wire RTD'], ['NIDMM\\_VAL\\_4\\_WIRE\\_RTD',
                                                                                    '4-wire RTD'],
                                   ['NIDMM\\_VAL\\_THERMISTOR', 'Thermistor'], ['NIDMM\\_VAL\\_THERMOCOUPLE',
                                                                                'Thermocouple']],
                },
            },
        ],
...
''',
                    'table_body': [['NIDMM\\_VAL\\_POSITIVE', '0',
                                    'The driver triggers on the rising edge of the trigger signal.'],
                                   ['NIDMM\\_VAL\\_NEGATIVE\xa0(default)', '1',
                                                                                                       'The driver triggers on the falling edge of the trigger signal.']],
                },
            },
        ],
...
The driver sets NIDMM\_ATTR\_FUNCTION to this value.
''',
                    'table_body': [['NIDMM\\_VAL\\_WAVEFORM\\_VOLTAGE (default)', '1003', 'Voltage Waveform'],
...
''',
                    'table_body': [['NIDMM\\_VAL\\_WAVEFORM\\_COUPLING\\_AC', '0', 'AC coupling'],
...
''',
            'table_body': [['|image0|  .. |image0| image:: note.gif',
                            '**Notes**\xa0\xa0The NI 4050 and NI 4060 are not supported. Calling this function while the DMM is taking measurements results in an error. After the DMM is finished taking measurements, calling this function will make any unfetched data points unavailable.']],
        },
    },
    'Disable': {
        'codegen_method': 'public',
...
attribute.
''',
                    'table_body': [['NIDMM\\_VAL\\_SECONDS', '0', 'Seconds'], ['NIDMM\\_VAL\\_POWER\\_LINE\\_CYCLES',
                                                                               '1', 'Powerline Cycles']],
                },
            },
        ],
...
''',
                    ...
                    'table_body': [['NIDMM\\_VAL\\_INTERNAL\\_AREA\xa0(default)', '0', 'Self-Calibration'],
...
given session.
''',
                    'table_body': [['VI\\_TRUE', '1', 'The DMM that you are using can perform self-calibration.'],
...
state.
''',
            'table_body': [['|image0|  .. |image0| image:: note.gif', '**Notes**',
                            'The NI\xa04050 and NI\xa04060 are not supported. Refer to the *NI\xa04065 6½ Digit DMM Calibration Procedure*, the *NI\xa04070/4072 6½ Digit FlexDMM Calibration Procedure*, or the *NI\xa04071 7½–Digit FlexDMM Calibration Procedure* before using this function. This function creates a new session the first time you invoke it for a device. If you call this function on the same resource, an error is returned. You should use niDMM\\_CloseExtCal to close a session obtained using this function.']],
        },
    },
    'InitWithOptions': {
        'codegen_method': 'public',
...
Defined Values:
''',
                    'table_body': [['VI\\_TRUE (default)', '1', 'Perform ID Query'], ['VI\\_FALSE', '0',
                                                                                      'Skip ID Query']],
                },
            },
            {
...
for more information.
''',
                    'table_body': [['Check', 'NIDMM\\_ATTR\\_RANGE\\_CHECK', 'VI\\_TRUE', '1'], ['QueryInstrStatus',
                                                                                                 'NIDMM\\_ATTR\\_QUERY\\_INSTR\\_STATUS',
                                                                                                 'VI\\_FALSE', '0'],
                                   ['Cache', 'NIDMM\\_ATTR\\_CACHE', 'VI\\_TRUE', '1'], ['Simulate',
                                                                                         'NIDMM\\_ATTR\\_SIMULATE',
                                                                                         'VI\\_FALSE', '0'],
...
overrange condition.
''',
                    'table_body': [['VI\\_TRUE', '1', 'The value indicates that an overrange condition occurred.'],
...
''',
                    'table_body': [['VI\\_TRUE', '1', 'The value indicates that an underrange condition occurred.'],
                                   ['VI\\_FALSE', '0', 'The value is a valid measurement.']],
                },
            },
        ],
...
acquisition states:
''',
                    'table_body': [['0', 'Running'], ['1', 'Finished with backlog'], ['2', 'Finished with no backlog'],
                                   ['3', 'Paused'], ['4', 'No acquisition in progress']],
                },
            },
        ],
        'documentation': {
...
''',
            'table_body': [['|image0|  .. |image0| image:: note.gif', '**Notes**',
                            'The NI\xa04050 and NI\xa04060 are not supported. A password is required for external calibration. Be sure to record the password in a secure location.']],
        },
    },
