...
def test_simple_read(patched_library, patched_ctypes_library, patched_errors):
    ...
    with nidmm.Session("Dev1") as session:
        ...
        patched_errors._handle_error.assert_called_once_with(patched_ctypes_library, session.vi, patched_ctypes_library.niDMM_InitWithOptions.return_value.value)
        ...
        patched_errors._handle_error.assert_called_with(patched_ctypes_library, ANY, patched_ctypes_library.niDMM_InitWithOptions.return_value.value)
