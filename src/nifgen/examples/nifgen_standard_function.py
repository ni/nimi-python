...
parser.add_argument('-f', '--frequency', default=1e6, type=int, help='Frequency (Hz)')
parser.add_argument('-a', '--amplitude', default=1.0, type=float, help='Amplitude (V)')
parser.add_argument('-o', '--offset', default=0.0, type=float, help='DC Offset (Vpk-pk)')
