<%
    ...
    if v.dev is None and v.pre is None:
        url = 'https://github.com/ni/nimi-python/releases/download/{0}/examples.zip'.format(global_version)
    else:
        url = 'https://github.com/ni/nimi-python/blob/master/examples.zip'
%>\
${helper.get_rst_header_snippet('Examples', '=')}

Download examples for all drivers and any required helper files at `examples.zip <${url}>`_
