...
def _get_ctype_variable_definition_snippet_for_buffers(parameter, parameters, ivi_dance_step, use_numpy_array, custom_type, module_name):
    '''These are the different cases for initializing the ctype variable for buffers:
        ...
        B520. Input buffer of simple types with converter:                         _get_ctypes_pointer_for_buffer(value=convert(array.array('d', list)), library_type=visatype.ViReal64)
    ...
    if parameter['numpy'] is True and use_numpy_array is True:
        ...
        if custom_type is not None:
            ...
            if parameter['use_array']:
                ...
                definition = '_get_ctypes_pointer_for_buffer(value={0}_converted, library_type={1}.{2})  # case B520'.format(parameter['python_name'], module_name, parameter['ctypes_type'])
            else:
...
parameters_for_testing = [
    ...
    {  # 1
        ...
        'library_interpreter_method_call_snippet': 'output',
        'name': 'output',
        'python_name': 'output',
    ...
    {  # 2
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'error_message',
        'name': 'errorMessage',
    ...
    {  # 3
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'array_out',
        'name': 'arrayOut',
    ...
    {  # 4
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'number_of_elements',
    ...
    {  # 6
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'an_int_enum',
        'name': 'anIntEnum',
    ...
    {  # 8
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'number_of_elements_python_code',
    ...
    {  # 9
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'input',
        'name': 'input',
        'numpy': False,
        'python_name': 'input',
    ...
    {  # 10
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'input_array',
        'name': 'inputArray',
        'numpy': False,
    ...
    {  # 11
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'input_array_size',
        'name': 'inputArraySize',
        'numpy': False,
    ...
    {  # 12
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'string_size',
        'name': 'stringSize',
        'numpy': False,
    ...
    {  # 13
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_string',
        'name': 'aString',
        'numpy': False,
    ...
    {  # 14
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'timeout',
        'name': 'Timeout',
        'numpy': False,
        'python_name': 'timeout',
    ...
    {  # 15
        ...
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'self._repeated_capability',
        'name': 'channelList',
        'numpy': False,
    ...
    {  # 17
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'array_in',
        'name': 'arrayOut',
        'original_type': 'custom_struct[]',
    ...
    {  # 18
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'an_int',
        'name': 'anInt',
        'python_name': 'an_int',
    ...
    {  # 19
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_string_2',
        'name': 'aString2',
        'numpy': False,
    ...
    {  # 20
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_string_3',
        'name': 'aStrin3g',
        'numpy': False,
    ...
    {  # 21
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_string_twist',
        'name': 'aStringTwist',
        'numpy': False,
    ...
    {  # 22
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'output_twist',
        'name': 'output_twist',
    ...
    {  # 23
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'string_size_twist',
    ...
    {  # 24
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_buffer',
        'name': 'aBufferArray',
        'numpy': False,
    ...
    {  # 28
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'input_array_2',
        'name': 'inputArray2',
        'numpy': False,
    ...
    {  # 30
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'input_array_3',
        'name': 'inputArray3',
        'numpy': False,
        'python_api_converter_name': 'convert_to_nitclk_session_num_list',
    ...
    {  # 33
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'a_string_enum',
        'name': 'aStringEnum',
        'numpy': False,
    ...
    {  # 34
        ...
        'is_repeated_capability': False,
        'is_session_handle': False,
        'library_interpreter_method_call_snippet': 'indices',
        'name': 'indices',
        'numpy': False,
        'original_type': 'ViChar[]',
...
def test_get_ctype_variable_declaration_snippet_case_b520_list():
    ...
    expected = [
        ...
        'input_array_2_ctype = _get_ctypes_pointer_for_buffer(value=input_array_2_converted, library_type=_visatype.ViReal64)  # case B520',
    ]
    assert len(actual) == len(expected)
    for i in range(max(len(actual), len(expected))):
        assert actual[i] == expected[i]
