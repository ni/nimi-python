...
def _add_method_templates(f):
    ...
    if 'method_templates' not in f:
        f['method_templates'] = [{'filename': 'session_default_method.py.mako', 'suffix': '', }, ]
...
def test_add_all_metadata_simple():
    functions = {
        'MakeAFoo': {
            ...
            'returns': 'ViStatus',
            'method_templates': [{'filename': '/cool_template.py.mako', 'suffix': '', }, ],
            'parameters': [
                {
                    'direction': 'in',
                    'enum': None,
    ...
    expected = {
        ...
        'MakeAPrivateMethod': {
            'codegen_method': 'private',
            'returns': 'ViStatus',
            'method_templates': [{'filename': '/session_default_method.py.mako', 'suffix': '', }, ],
            'parameters': [{
                'direction': 'in',
                'enum': None,
                'numpy': False,
