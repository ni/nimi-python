...
`You can download all nidcpower examples for latest version here <https://github.com/ni/nimi-python/releases/download/1.4.2/nidcpower_examples.zip>`_
...
.. literalinclude:: ../../src/nidcpower/examples/nidcpower_measure_record_grpc.py
   :language: python
   :linenos:
   :encoding: utf8
   :caption: `(nidcpower_measure_record_grpc.py) <https://github.com/ni/nimi-python/blob/master/src/nidcpower/examples/nidcpower_measure_record_grpc.py>`_
