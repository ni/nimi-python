...
# -*- coding: utf-8 -*-
#
# NI-DCPower Python API documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'NIDCPowerPythonAPI.tex', 'NI-DCPower Python API Documentation',
     'NI', 'manual'),
]
...
man_pages = [
    (master_doc, 'nidcpowerpythonapi', 'NI-DCPower Python API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NIDCPowerPythonAPI', 'NI-DCPower Python API Documentation',
     author, 'NIDCPowerPythonAPI', 'One line description of project.',
     'Miscellaneous'),
]
