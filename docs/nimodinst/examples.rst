...
`You can download all nimodinst examples for latest version here <https://github.com/ni/nimi-python/releases/download/nimodinst-1.5.0/nimodinst_examples.zip>`_
