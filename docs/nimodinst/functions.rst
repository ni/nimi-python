...
.. function:: _close_installed_devices_session(handle)
    ...
    :py:func:`nimodinst._open_installed_devices_session`. Call this function when you are
    ...
    :param handle:
        ...
        :py:func:`nimodinst._open_installed_devices_session`.
...
.. function:: _get_installed_device_attribute_vi_int32(handle, index, attribute_id, attribute_value)
    ...
    :py:func:`nimodinst._open_installed_devices_session`. It therefore acts as a handle to
    ...
    :param index:
        ...
        returned by :py:func:`nimodinst._open_installed_devices_session`.
...
.. function:: _get_installed_device_attribute_vi_string(handle, index, attribute_id, attribute_value_buffer_size, attribute_value)
    ...
    parameter is expected to be a valid handle returned by
    :py:func:`nimodinst._open_installed_devices_session`. Therefore, it acts as a handle
    ...
    :param attribute_id:
        ...
        :py:data:`nimodinst.DEVICE\_NAME`--the name of the device, which can be used
        to open an instrument driver session for that device
        :py:data:`nimodinst.DEVICE\_MODEL`--the model of the device (for example, NI
        PXI-5122) :py:data:`nimodinst.SERIAL\_NUMBER`--the serial number of the
        device
...
.. function:: _open_installed_devices_session(driver, handle, device_count)
    ...
    :py:func:`nimodinst._close_installed_devices_session` and create a new handle using
    this function.
