...
.. function:: create_waveform_complex_f64(number_of_samples, waveform_data_array)

    Creates an onboard waveform from complex double-precision floating-point
    (F64) data for use with the :py:data:`nifgen.OUTPUT\_MODE` attribute set to
    Arbitrary Waveform or Arbitrary Sequence output mode on devices with the
    :py:data:`nifgen.OUTPUT\_ENABLED` attribute set to VI\_TRUE and the
    :py:data:`nifgen.OSP\_DATA\_PROCESSING\_MODE` attribute set to
    ...
    :param number_of_samples:
        ...
        **minimumWaveformSize**, and **waveformQuantum** parameters of the
        :py:func:`nifgen.query_arb_wfm_capabilities` function.
...
.. function:: get_stream_endpoint_handle(stream_endpoint)
...
.. function:: write_complex_binary16_waveform(waveform_handle, size, data)
    ...
    :py:func:`nifgen.write_complex_binary16_waveform` function continues writing data
...
.. function:: write_named_waveform_complex_f64(waveform_name, size, data)

    Writes complex floating–point data to the named waveform in onboard
    memory on devices with the :py:data:`nifgen.OSP\_ENABLED` attribute set to
    VI\_TRUE and the :py:data:`nifgen.OSP\_DATA\_PROCESSING\_MODE` attribute set
    ...
    By default, the subsequent call to the
    :py:func:`nifgen.write_named_waveform_complex_f64` function continues writing data
    from the position of the last sample written. You can set the write
...
.. function:: write_named_waveform_complex_i16(waveform_name, size, data)

    Writes complex binary data to the named waveform in onboard memory on
    devices with the :py:data:`nifgen.OSP\_ENABLED` attribute set to VI\_TRUE
    and the :py:data:`nifgen.OSP\_DATA\_PROCESSING\_MODE` attribute set to
    ...
    By default, the subsequent call to the
    :py:func:`nifgen.WriteNamedWaveformComplexi16` function continues writing data
    from the position of the last sample written. You can set the write
    position and offset by calling the
    nifgen\_SetNamedWaveformNextWritePosition function. If streaming is
    enabled, you can write more data than the allocated waveform size in
...
.. function:: write_waveform_complex_f64(number_of_samples, data, waveform_handle)

    Writes complex data to the waveform in onboard memory on devices with
    the :py:data:`nifgen.OUTPUT\_ENABLED` attribute set to VI\_TRUE and the
    :py:data:`nifgen.OSP\_DATA\_PROCESSING\_MODE` attribute set to
    NIFGEN\_VAL\_OSP\_COMPLEX. The waveform handle passed in must have been
    created by a call to the nifgen\_AllocateWaveform function or to one of
    the following niFgen Create Waveform functions:
    ...
    By default, the subsequent call to the :py:func:`nifgen.write_waveform_complex_f64`
    function continues writing data from the position of the last sample
    written. You can set the write position and offset by calling the
    nifgen\_SetWaveformNextWritePosition function. If streaming is enabled,
    you can write more data than the allocated waveform size in onboard
