...
`You can download all niswitch examples for latest version here <https://github.com/ni/nimi-python/releases/download/niswitch-1.5.0/niswitch_examples.zip>`_
