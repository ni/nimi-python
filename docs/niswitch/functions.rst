...
.. py:method:: lock_session()
    ...
    application called :py:meth:`niswitch.Session.lock_session`. - A call to the instrument
    driver locked the session. - A call to the IVI engine locked the
    session. After your call to :py:meth:`niswitch.Session.lock_session` returns successfully,
    no other threads can access the instrument session until you call
    :py:meth:`niswitch.Session.unlock_session`. Use :py:meth:`niswitch.Session.lock_session` and
    :py:meth:`niswitch.Session.unlock_session` around a sequence of calls to instrument driver
    ...
    :py:meth:`niswitch.Session.lock_session` within the same thread. To completely unlock the
    session, you must balance each call to :py:meth:`niswitch.Session.lock_session` with a call
    to :py:meth:`niswitch.Session.unlock_session`. If, however, you use the Caller Has Lock
    parameter in all calls to :py:meth:`niswitch.Session.lock_session` and
    :py:meth:`niswitch.Session.unlock_session` within a method, the IVI Library locks the
    session only once within the method regardless of the number of calls
    you make to :py:meth:`niswitch.Session.lock_session`. This allows you to call
    :py:meth:`niswitch.Session.unlock_session` just once at the end of the method.
    ...
    :return:
            ...
            :py:meth:`niswitch.Session.lock_session` or :py:meth:`niswitch.Session.unlock_session` in the same method.
            The parameter is an input/output parameter. :py:meth:`niswitch.Session.lock_session` and
            :py:meth:`niswitch.Session.unlock_session` each inspect the current value and take the
            following actions: - If the value is True, :py:meth:`niswitch.Session.lock_session`
            does not lock the session again. If the value is False,
            :py:meth:`niswitch.Session.lock_session` obtains the lock and sets the value of the
            parameter to True. - If the value is False,
            :py:meth:`niswitch.Session.unlock_session` does not attempt to unlock the session. If the
            value is True, :py:meth:`niswitch.Session.unlock_session` releases the lock and sets
            the value of the parameter to False. Thus, you can, call
            :py:meth:`niswitch.Session.unlock_session` at the end of your method without worrying
            ...
            haveLock = False; if (flags & BIT_1) { viCheckErr(
            :py:meth:`niswitch.Session.lock_session`(vi, &haveLock;)); viCheckErr( TakeAction1(vi)); if
            (flags & BIT_2) { viCheckErr( :py:meth:`niswitch.Session.unlock_session`(vi, &haveLock;));
            viCheckErr( TakeAction2(vi)); viCheckErr( :py:meth:`niswitch.Session.lock_session`(vi,
            ...
            :py:meth:`niswitch.Session.unlock_session`(vi, &haveLock;); return error; }
...
.. py:method:: unlock_session()
    ...
    using :py:meth:`niswitch.Session.lock_session`. Refer to :py:meth:`niswitch.Session.lock_session` for
