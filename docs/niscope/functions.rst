...
.. function:: actual_record_length()
    ...
    :return:
            ...
            :py:data:`niscope.HORZ\_RECORD\_LENGTH` attribute.
...
.. function:: adjust_sample_clock_relative_delay(delay)
...
.. function:: check_attribute_vi_boolean(attribute_id, value)
...
.. function:: check_attribute_vi_int32(attribute_id, value)
...
.. function:: check_attribute_vi_int64(attribute_id, value)
...
.. function:: check_attribute_vi_real64(attribute_id, value)
...
.. function:: check_attribute_vi_string(attribute_id, value)
...
.. function:: configure_acquisition(acquisition_type)
    ...
    :param acquisition_type:
        ...
        waveform record; NI-SCOPE sets :py:data:`niscope.ACQUISITION\_TYPE` to this
        value.
        ...
        **Defined Values**
        ...
        .. note:: NISCOPE\_VAL\_DDC applies to the NI 5620/5621 only. To use DDC mode in
            the NI 5142/5622, leave **acquisitionType** set to NISCOPE\_VAL\_NORMAL
            and set :py:data:`niscope.DDC\_ENABLED` to True.


    :type acquisition_type: int

.. function:: configure_acquisition_record(time_per_record, min_num_points, acquisition_start_time)
    ...
    :type time_per_record: float
    :param min_num_points:


        Pass the minimum number of points you require in the record for each
        channel. Call :py:func:`niscope.actual_record_length` to obtain the actual record
        length used.
    ...
    :type min_num_points: int
    :param acquisition_start_time:
    ...
    :type acquisition_start_time: float
...
.. function:: configure_channel(channel, range, offset, coupling, probe_attenuation, enabled)
    ...
    :param enabled:
        ...
        when you call :py:func:`niscope._initiate_acquisition` or :py:func:`niscope.read_waveform`.
...
.. function:: configure_clock(input_clock_source, output_clock_source, clock_sync_pulse_source, master_enabled)
    ...
    :param input_clock_source:


        Specifies the input source for the reference clock to which the 100 MHz
        sample clock is phase-locked. Refer to
        :py:data:`niscope.INPUT\_CLOCK\_SOURCE` for more information.

        


    :type input_clock_source: string
    :param output_clock_source:


        Specifies the output source for the reference clock to which another
        scope's sample clock can be phased-locked. Refer to
        :py:data:`niscope.OUTPUT\_CLOCK\_SOURCE` for more information

        


    :type output_clock_source: string
    :param clock_sync_pulse_source:
        ...
        :py:data:`niscope.CLOCK\_SYNC\_PULSE\_SOURCE` for more information.

        


    :type clock_sync_pulse_source: string
    :param master_enabled:
        ...
        Refer to :py:data:`niscope.MASTER\_ENABLE` for more information.

        


    :type master_enabled: bool

.. function:: configure_edge_trigger_source(source, level, slope)
...
.. function:: configure_horizontal_timing(min_sample_rate, min_num_pts, ref_position, num_records, enforce_realtime)
    ...
    :param min_num_pts:
        ...
        call :py:func:`niscope.actual_record_length` to obtain the actual record length
        used.
...
.. function:: is_device_ready(resource_name)
...
.. function:: read_waveform(channel, waveform_size, max_time)
    ...
    Use :py:func:`niscope.actual_record_length` to determine the required size for the
    **waveform** array.
