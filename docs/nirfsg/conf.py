...
# -*- coding: utf-8 -*-
#
# NI-RFSG Python API documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'NIRFSGPythonAPI.tex', 'NI-RFSG Python API Documentation',
     'NI', 'manual'),
]
...
man_pages = [
    (master_doc, 'nirfsgpythonapi', 'NI-RFSG Python API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NIRFSGPythonAPI', 'NI-RFSG Python API Documentation',
     author, 'NIRFSGPythonAPI', 'One line description of project.',
     'Miscellaneous'),
]
