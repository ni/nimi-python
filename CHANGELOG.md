...
* ### NI-Digital Pattern Driver
    ...
    * #### Changed
        ...
        * Change the type of applicable properties and method parameters from `datetime.timedelta` to `hightime.timedelta`. - [#1368](https://github.com/ni/nimi-python/issues/1368) 
    * #### Removed
* ### NI-DMM
    * #### Added
    * #### Changed
