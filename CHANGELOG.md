...
* ### ALL
    ...
    * #### Changed
        * `import_attribute_configuration_buffer()` now accepts list of int8, `array.array('b')`, `str`, `bytes`, `bytearray` for configuration buffer - [#1013](https://github.com/ni/nimi-python/issues/1013)
